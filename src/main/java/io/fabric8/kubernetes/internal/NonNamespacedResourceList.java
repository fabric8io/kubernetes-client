...
public class NonNamespacedResourceList<Type extends HasMetadata, TypeList extends KubernetesResourceList, TypeBuilder extends Builder<Type>>
  ...
  implements io.fabric8.kubernetes.NonNamespacedResourceList<Type, TypeList, TypeBuilder> {
  ...
  @Override
  public io.fabric8.kubernetes.NamedResource<Type, TypeBuilder> withName(String name) {
