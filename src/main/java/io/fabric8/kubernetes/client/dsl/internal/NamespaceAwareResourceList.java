...
public class NamespaceAwareResourceList<T extends HasMetadata, L extends KubernetesResourceList, B extends Builder<T>>
  extends DefaultResourceList<T, L, B>
  implements io.fabric8.kubernetes.client.dsl.NamespaceAwareResourceList<T, L, B> {
  ...
  @Override
  public NamespacedResourceList<T, L, B> inNamespace(String namespace) {
