...
@Component
@Service
public class ServiceAccountHandler implements ResourceHandler<ServiceAccount> {
  @Override
  ...
  @Override
  public Boolean delete(Client client, String namespace, ServiceAccount item) {
    return new ServiceAccountOperationsImpl<Client>(client, namespace, null, true, item).delete(item);
  }
}
