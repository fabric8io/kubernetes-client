...
public class ReaperFactory {
  ...
  static Reaper getReaper(BaseOperation oper) {
    if (oper instanceof ReplicationControllerOperationsImpl) {
      return new ReplicationControllerReaper((ReplicationControllerOperationsImpl) oper);
    }
    return null;
  }
