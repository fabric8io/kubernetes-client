...
public class SecurityContextConstraintsHandler implements ResourceHandler<SecurityContextConstraints> {
  ...
  @Override
  public Boolean delete(Client client, String namespace, SecurityContextConstraints item) {
    return new SecurityContextConstraintsOperationsImpl<Client>(client, namespace, null, true, item).delete(item);
  }
}
