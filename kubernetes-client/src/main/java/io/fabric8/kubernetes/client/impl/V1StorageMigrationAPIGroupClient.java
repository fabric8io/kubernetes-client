...
import io.fabric8.kubernetes.api.model.storagemigration.v1.StorageVersionMigrationList;
import io.fabric8.kubernetes.client.dsl.NonNamespaceOperation;
import io.fabric8.kubernetes.client.dsl.Resource;
import io.fabric8.kubernetes.client.dsl.V1StorageMigrationAPIGroupDSL;
import io.fabric8.kubernetes.client.extension.ClientAdapter;

public class V1StorageMigrationAPIGroupClient extends ClientAdapter<V1StorageMigrationAPIGroupClient>
    implements V1StorageMigrationAPIGroupDSL {
  ...
  @Override
  public V1StorageMigrationAPIGroupClient newInstance() {
    return new V1StorageMigrationAPIGroupClient();
  }
}
