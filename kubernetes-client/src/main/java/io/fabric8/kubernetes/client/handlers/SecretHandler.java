...
public class SecretHandler implements ResourceHandler<Secret> {
  ...
  @Override
  public Secret create(AsyncHttpClient client, Config config, String namespace, Secret item) {
    return new SecretOperationsImpl(client, config, namespace, null, true, item).create();
  }

  @Override
  public Boolean delete(AsyncHttpClient client, Config config, String namespace, Secret item) {
