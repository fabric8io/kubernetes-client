...
public class NamespaceOperationsImpl  extends HasMetadataOperation<Namespace, NamespaceList, DoneableNamespace, ClientResource<Namespace, DoneableNamespace>> {
  ...
  public NamespaceOperationsImpl(OkHttpClient client, Config config, String apiVersion, String namespace, String name, Boolean cascading, Namespace item, String resourceVersion) {
    super(client, config, null, apiVersion, "namespaces", namespace, name, cascading, item, resourceVersion);
  }
