...
### CustomResourceAnnotationProcessor Options

The annotation processor for the CRD-Generator can be configured via compiler options:
...
Or via a `crd-generator.properties` file in e.g. `src/main/resources`:

```properties
io.fabric8.crd.generator.parallel= true
io.fabric8.crd.generator.versions= v1,v1beta1
io.fabric8.crd.generator.labels= my-label1=my-value1,my-label2=my-value2
```

Compiler options are taking precedence over options from the properties file.

The following options are supported:

| Option                                       | Type     | Default                                                                | Description                                         |
|----------------------------------------------|----------|------------------------------------------------------------------------|-----------------------------------------------------|
| io.fabric8.crd.generator.parallel            | bool     | false                                                                  | Whether or not to generate the CRDs in parallel.    |
| io.fabric8.crd.generator.outputPath          | string   | /META-INF/fabric8/                                                     | The output path of the generated CRDs.              |
| io.fabric8.crd.generator.versions            | string[] | v1, v1beta1                                                            | The CRD versions to generate. Choice of v1, v1beta. |
| io.fabric8.crd.generator.describeDefinitions | bool     | false                                                                  | Enables some debug output.                          |
| io.fabric8.crd.generator.labels              | string[] | []                                                                     | Add additional labels to generated CRDs.            |
| io.fabric8.crd.generator.annotations         | string[] | []                                                                     | Add additional annotations to generated CRDs.       |
| io.fabric8.crd.generator.header              | string   | Generated by Fabric8 CRDGenerator, manual edits might get overwritten! | The comment in the header of the generated CRDs.    |
