...
#### Bugs
* Fix #7966: (kubernetes-client-api) ConfigMap creation from local file inputs now rejects symbolic links instead of reading the linked target into ConfigMap data
