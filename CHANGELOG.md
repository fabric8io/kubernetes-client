...
#### Bugs
* Fix #7945: (kubernetes-client) encode typed API path segments and reject traversal syntax so caller-supplied names, namespaces, API groups, metrics targets, and OpenShift webhook values cannot retarget requests through raw separators or dot segments
