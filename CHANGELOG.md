...
#### Bugs
* Fix #7955: (java-generator) CRD schema enum values are parsed by declared type and descriptions neutralize Java Unicode escape introducers before source generation, preventing malformed schema values from injecting generated Java code
