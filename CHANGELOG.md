...
#### Bugs
* Fix #7949: (httpclient-jetty, httpclient-vertx-5) WebSocket clients now apply the configured proxy settings, so exec, attach, port-forward, and WebSocket watches use the same proxy route as regular HTTP requests
