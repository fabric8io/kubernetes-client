...
#### Bugs
* Fix #7948: (kubernetes-client-api) kubeconfig `proxy-url` is applied for both HTTP and HTTPS API server URLs, and explicit `https://` proxy URLs now fail closed instead of being silently skipped or downgraded to plaintext proxy transport
