...
#### Bugs
* Fix #7965: (kubernetes-client-api) Kubeconfig exec credential plugins now receive `exec.args` as literal argv entries instead of shell-evaluated command text, matching client-go/kubectl behavior
