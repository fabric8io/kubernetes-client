...
#### Bugs
* Fix #7963: (kubernetes-client) Pod uploads now shell-quote temporary tar paths derived from the remote directory before `tar` and `rm` commands, preventing metacharacters in the destination path from being executed in the container
