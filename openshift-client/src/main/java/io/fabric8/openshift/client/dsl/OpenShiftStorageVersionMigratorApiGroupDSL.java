...
public interface OpenShiftStorageVersionMigratorApiGroupDSL extends Client {
  /**
   * API entrypoint for StorageState (migration.k8s.io/v1alpha1)
   *
   * @return {@link NonNamespaceOperation} for StorageState
   */
  NonNamespaceOperation<StorageState, StorageStateList, Resource<StorageState>> storageStates();

  /**
   * API entrypoint for StorageVersionMigration (migration.k8s.io/v1alpha1)
   *
