...
public interface OpenShiftTunedAPIGroupDSL extends Client {
  /**
   * API entrypoint for Tuned(tuned.openshift.io/v1)
   *
   * @return {@link MixedOperation} for Tuned
   */
  MixedOperation<Tuned, TunedList, Resource<Tuned>> tuneds();

  /**
   * API entrypoint for Profile(tuned.openshift.io/v1)
   *
   * @return {@link MixedOperation} for Profile
   */
