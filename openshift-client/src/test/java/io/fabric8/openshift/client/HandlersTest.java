...
public class HandlersTest {
  ...
  @Test
  public void shouldLoadOpenShiftResourceFromOpenShiftResourceHandler() {
    assertNotNull(OpenShiftHandlers.get("DeploymentConfig", "v1"));
    assertNotNull(OpenShiftHandlers.get("Build", "v1"));
    assertNotNull(OpenShiftHandlers.get("BuildConfig", "v1"));
    assertNotNull(OpenShiftHandlers.get("Group", "v1"));
    assertNotNull(OpenShiftHandlers.get("ImageStream", "v1"));
    assertNotNull(OpenShiftHandlers.get("ImageStreamTag", "v1"));
    assertNotNull(OpenShiftHandlers.get("Project", "v1"));
    assertNotNull(OpenShiftHandlers.get("Route", "v1"));
    assertNotNull(OpenShiftHandlers.get("SecurityContextConstraints", "v1"));
    assertNotNull(OpenShiftHandlers.get("User", "v1"));
  }

  @Test
  public void shouldLoadKubernetesResourceFromOpenShiftResourceHandler() {
    assertNotNull(OpenShiftHandlers.get("Deployment", "apps/v1"));
    assertNotNull(OpenShiftHandlers.get("StatefulSet", "apps/v1"));
    assertNotNull(OpenShiftHandlers.get("DaemonSet", "apps/v1"));
    assertNotNull(OpenShiftHandlers.get("ReplicaSet", "apps/v1"));
    assertNotNull(OpenShiftHandlers.get("Service", "v1"));
    assertNotNull(OpenShiftHandlers.get("Pod", "v1"));
  }
