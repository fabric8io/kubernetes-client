...
public interface V1beta1StorageMigrationAPIGroupDSL extends Client {

  /**
   * DSL entrypoint for storagemigration.k8s.io/v1beta1 StorageVersionMigration (cluster-scoped)
   *
