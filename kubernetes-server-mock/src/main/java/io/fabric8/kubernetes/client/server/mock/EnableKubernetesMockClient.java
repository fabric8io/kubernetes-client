...
public @interface EnableKubernetesMockClient {
   ...
   * <br>Each is a simple expression of the form: group[/version]
   * <br>where * is a wildcard.
   * <br>For example to exclude all openshift support, you would specify
   * openshift.io
   * <br>To exclude a specific apiVersion, you would fully specify
   * route.openshift.io/v1
   * <p>NOTE this affects calls to {@link Client#hasApiGroup(String, boolean)}
