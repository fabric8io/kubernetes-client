...
public class ServiceInstanceOperationImpl extends HasMetadataOperation<ServiceInstance, ServiceInstanceList, DoneableServiceInstance, Resource<ServiceInstance, DoneableServiceInstance>> {
  ...
  public ServiceInstanceOperationImpl(OkHttpClient client, Config config) {
    ...
    super(client, config, apiGroup, apiVersion, "clusterinstances", namespace, name, cascading, item, resourceVersion, reloadingFromServer, gracePeriodSeconds, labels, labelsNot, labelsIn, labelsNotIn, fields);
  }
