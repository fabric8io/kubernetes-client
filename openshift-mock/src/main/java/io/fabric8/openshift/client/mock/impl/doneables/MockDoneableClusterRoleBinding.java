...
public class MockDoneableClusterRoleBinding extends ClusterRoleBindingFluentImpl<MockDoneableClusterRoleBinding> implements MockDoneable<ClusterRoleBinding> {
  ...
  private interface DelegateInterface extends Doneable<ClusterRoleBinding>, ClusterRoleBindingFluent<DoneableClusterRoleBinding> {}
  private final Function<ClusterRoleBinding, ClusterRoleBinding> visitor = new Function<ClusterRoleBinding, ClusterRoleBinding>() {
    @Override
    public ClusterRoleBinding apply(ClusterRoleBinding item) {return item;}
  };

  private final DelegateInterface delegate;

  public MockDoneableClusterRoleBinding() {
    super(new ClusterRoleBindingBuilder()
  ...
  @Override
  public IExpectationSetters<ClusterRoleBinding> done() {
  ...
  public Doneable<ClusterRoleBinding> getDelegate() {
    return new DoneableClusterRoleBinding(new ClusterRoleBindingBuilder(this).build(), visitor) {
      @Override
