...
public class EgressIP implements Editable<EgressIPBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EgressIP)) {
            return false;
        }
        EgressIP other = (EgressIP) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EgressIP;
    }
    ...
    public String toString() {
        return "EgressIP(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
