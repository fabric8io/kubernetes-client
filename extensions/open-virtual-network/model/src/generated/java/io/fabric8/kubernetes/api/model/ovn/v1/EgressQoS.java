...
public class EgressQoS implements Editable<EgressQoSBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EgressQoS)) {
            return false;
        }
        EgressQoS other = (EgressQoS) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EgressQoS;
    }
    ...
    public String toString() {
        return "EgressQoS(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
