...
public class AdminPolicyBasedExternalRoute implements Editable<AdminPolicyBasedExternalRouteBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminPolicyBasedExternalRoute)) {
            return false;
        }
        AdminPolicyBasedExternalRoute other = (AdminPolicyBasedExternalRoute) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AdminPolicyBasedExternalRoute;
    }
    ...
    public String toString() {
        return "AdminPolicyBasedExternalRoute(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
