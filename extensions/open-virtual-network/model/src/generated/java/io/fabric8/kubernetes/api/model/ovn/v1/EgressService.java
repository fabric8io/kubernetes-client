...
public class EgressService implements Editable<EgressServiceBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EgressService)) {
            return false;
        }
        EgressService other = (EgressService) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EgressService;
    }
    ...
    public String toString() {
        return "EgressService(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
