...
public class EgressIPStatusFluent<A extends io.fabric8.kubernetes.api.model.ovn.v1.EgressIPStatusFluent<A>> extends BaseFluent<A>{
  ...
  public A addNewItem(String egressIP,String node) {
    return (A) this.addToItems(new EgressIPStatusItem(egressIP, node));
  }
  ...
  public A addToItems(EgressIPStatusItem... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (EgressIPStatusItem item : items) {
  ...
  public A removeFromItems(EgressIPStatusItem... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (EgressIPStatusItem item : items) {
  ...
  public A removeMatchingFromItems(Predicate<EgressIPStatusItemBuilder> predicate) {
    ...
    Iterator<EgressIPStatusItemBuilder> each = items.iterator();
  ...
  public A withItems(EgressIPStatusItem... items) {
    if (this.items != null) {
        this.items.clear();
