...
public class VolumeSnapshotContent implements HasMetadata
{
     ...
     * @param status
     */
    public VolumeSnapshotContent(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, VolumeSnapshotContentSpec spec, VolumeSnapshotContentStatus status) {
        super();
