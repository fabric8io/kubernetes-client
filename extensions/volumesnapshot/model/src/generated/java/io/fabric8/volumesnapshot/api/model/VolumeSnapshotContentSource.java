...
public class VolumeSnapshotContentSource implements Editable<VolumeSnapshotContentSourceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VolumeSnapshotContentSource)) {
            return false;
        }
        VolumeSnapshotContentSource other = (VolumeSnapshotContentSource) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof VolumeSnapshotContentSource;
    }
    ...
    public String toString() {
        return "VolumeSnapshotContentSource(" + "snapshotHandle=" + this.getSnapshotHandle() + ", volumeHandle=" + this.getVolumeHandle() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
