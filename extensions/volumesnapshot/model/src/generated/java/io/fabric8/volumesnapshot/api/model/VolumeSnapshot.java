...
public class VolumeSnapshot implements Editable<VolumeSnapshotBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VolumeSnapshot)) {
            return false;
        }
        VolumeSnapshot other = (VolumeSnapshot) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof VolumeSnapshot;
    }
    ...
    public String toString() {
        return "VolumeSnapshot(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
