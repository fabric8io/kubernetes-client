...
public class VolumeSnapshot implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public VolumeSnapshot(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, VolumeSnapshotSpec spec, VolumeSnapshotStatus status) {
        super();
