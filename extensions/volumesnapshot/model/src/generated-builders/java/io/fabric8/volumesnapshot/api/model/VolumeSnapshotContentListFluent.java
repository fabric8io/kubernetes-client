...
public class VolumeSnapshotContentListFluent<A extends io.fabric8.volumesnapshot.api.model.VolumeSnapshotContentListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<VolumeSnapshotContentBuilder> items = new ArrayList<VolumeSnapshotContentBuilder>();
  private String kind;
  private ListMeta metadata;

  public VolumeSnapshotContentListFluent() {
  }
  
  public VolumeSnapshotContentListFluent(VolumeSnapshotContentList instance) {
  ...
  public ItemsNested<A> addNewItemLike(VolumeSnapshotContent item) {
  ...
  public A addToItems(int index,VolumeSnapshotContent item) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    VolumeSnapshotContentBuilder builder = new VolumeSnapshotContentBuilder(item);
  ...
  public VolumeSnapshotContent buildItem(int index) {
  ...
  public VolumeSnapshotContent buildMatchingItem(Predicate<VolumeSnapshotContentBuilder> predicate) {
      for (VolumeSnapshotContentBuilder item : items) {
  ...
  protected void copyInstance(VolumeSnapshotContentList instance) {
    instance = instance != null ? instance : new VolumeSnapshotContentList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<VolumeSnapshotContentBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    VolumeSnapshotContentListFluent that = (VolumeSnapshotContentListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<VolumeSnapshotContentBuilder> predicate) {
    ...
    Iterator<VolumeSnapshotContentBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,VolumeSnapshotContent item) {
    return new ItemsNested(index, item);
  }
  
  public A setToItems(int index,VolumeSnapshotContent item) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    VolumeSnapshotContentBuilder builder = new VolumeSnapshotContentBuilder(item);
  ...
  public class ItemsNested<N> extends VolumeSnapshotContentFluent<ItemsNested<N>> implements Nested<N>{
  
    VolumeSnapshotContentBuilder builder;
    int index;
  
    ItemsNested(int index,VolumeSnapshotContent item) {
      this.index = index;
      this.builder = new VolumeSnapshotContentBuilder(this, item);
    }
  
    public N and() {
      return (N) VolumeSnapshotContentListFluent.this.setToItems(index, builder.build());
    }
