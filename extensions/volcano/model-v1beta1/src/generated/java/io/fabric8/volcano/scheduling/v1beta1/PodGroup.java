...
public class PodGroup implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public PodGroup(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, PodGroupSpec spec, PodGroupStatus status) {
        super();
