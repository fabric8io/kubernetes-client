...
public class Guarantee implements Editable<GuaranteeBuilder>, KubernetesResource
{
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Guarantee;
    }
    ...
    public String toString() {
        return "Guarantee(" + "resource=" + this.getResource() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
