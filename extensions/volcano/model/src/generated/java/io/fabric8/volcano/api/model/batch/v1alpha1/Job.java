...
public class Job implements Editable<JobBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Job(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
