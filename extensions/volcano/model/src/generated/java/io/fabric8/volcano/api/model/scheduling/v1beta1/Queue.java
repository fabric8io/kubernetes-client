...
public class Queue implements Editable<QueueBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "Queue(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
