...
public class PatchFluent<A extends io.fabric8.volcano.api.model.flow.v1alpha1.PatchFluent<A>> extends BaseFluent<A>{
  ...
  public class JobSpecNested<N> extends JobSpecFluent<JobSpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PatchFluent.this.withJobSpec(builder.build());
    }
