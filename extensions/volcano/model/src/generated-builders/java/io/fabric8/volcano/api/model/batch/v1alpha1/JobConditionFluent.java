...
public class JobConditionFluent<A extends io.fabric8.volcano.api.model.batch.v1alpha1.JobConditionFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(lastTransitionTime, status, additionalProperties);
  }
