...
public class ResolutionRequestSpecFluent<A extends io.fabric8.tekton.resolution.v1beta1.ResolutionRequestSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(params, url, additionalProperties);
  }
  ...
  public class ParamsNested<N> extends ParamFluent<ParamsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ResolutionRequestSpecFluent.this.setToParams(index, builder.build());
    }
