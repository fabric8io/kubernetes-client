...
public class TaskRefFluent<A extends io.fabric8.tekton.v1beta1.TaskRefFluent<A>> extends BaseFluent<A>{
  ...
  public TaskRefFluent() {
  }
  
  public TaskRefFluent(TaskRef instance) {
  ...
  protected void copyInstance(TaskRef instance) {
    instance = instance != null ? instance : new TaskRef();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    TaskRefFluent that = (TaskRefFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, bundle, kind, name, params, resolver, additionalProperties);
  }
  ...
  public class ParamsNested<N> extends ParamFluent<ParamsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRefFluent.this.setToParams(index, builder.build());
    }
