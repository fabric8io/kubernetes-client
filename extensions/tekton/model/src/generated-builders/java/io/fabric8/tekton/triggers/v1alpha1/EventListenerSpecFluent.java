...
public class EventListenerSpecFluent<A extends io.fabric8.tekton.triggers.v1alpha1.EventListenerSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(labelSelector, namespaceSelector, resources, serviceAccountName, triggers, additionalProperties);
  }
