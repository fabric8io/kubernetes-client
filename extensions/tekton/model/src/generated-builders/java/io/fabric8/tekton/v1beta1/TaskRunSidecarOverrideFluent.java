...
public class TaskRunSidecarOverrideFluent<A extends io.fabric8.tekton.v1beta1.TaskRunSidecarOverrideFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String name;
  private ResourceRequirementsBuilder resources;

  public TaskRunSidecarOverrideFluent() {
  }
  
  public TaskRunSidecarOverrideFluent(TaskRunSidecarOverride instance) {
  ...
  protected void copyInstance(TaskRunSidecarOverride instance) {
    instance = instance != null ? instance : new TaskRunSidecarOverride();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    TaskRunSidecarOverrideFluent that = (TaskRunSidecarOverrideFluent) o;
  ...
  public class ResourcesNested<N> extends ResourceRequirementsFluent<ResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRunSidecarOverrideFluent.this.withResources(builder.build());
    }
