...
public class ClusterTriggerBindingListFluent<A extends io.fabric8.tekton.triggers.v1alpha1.ClusterTriggerBindingListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ClusterTriggerBindingBuilder> items = new ArrayList<ClusterTriggerBindingBuilder>();
  private String kind;
  private ListMeta metadata;

  public ClusterTriggerBindingListFluent() {
  }
  
  public ClusterTriggerBindingListFluent(ClusterTriggerBindingList instance) {
  ...
  public ItemsNested<A> addNewItemLike(ClusterTriggerBinding item) {
  ...
  public ClusterTriggerBinding buildMatchingItem(Predicate<ClusterTriggerBindingBuilder> predicate) {
      for (ClusterTriggerBindingBuilder item : items) {
  ...
  protected void copyInstance(ClusterTriggerBindingList instance) {
    instance = instance != null ? instance : new ClusterTriggerBindingList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ClusterTriggerBindingBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ClusterTriggerBindingListFluent that = (ClusterTriggerBindingListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ClusterTriggerBindingBuilder> predicate) {
    ...
    Iterator<ClusterTriggerBindingBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,ClusterTriggerBinding item) {
  ...
  public class ItemsNested<N> extends ClusterTriggerBindingFluent<ItemsNested<N>> implements Nested<N>{
  
    ClusterTriggerBindingBuilder builder;
    int index;
  
    ItemsNested(int index,ClusterTriggerBinding item) {
      this.index = index;
      this.builder = new ClusterTriggerBindingBuilder(this, item);
    }
  
    public N and() {
      return (N) ClusterTriggerBindingListFluent.this.setToItems(index, builder.build());
    }
