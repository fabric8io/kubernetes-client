...
public class CustomRunStatusFluent<A extends io.fabric8.tekton.v1beta1.CustomRunStatusFluent<A>> extends BaseFluent<A>{
  ...
  public CustomRunStatusFluent() {
  }
  
  public CustomRunStatusFluent(CustomRunStatus instance) {
  ...
  protected void copyInstance(CustomRunStatus instance) {
    instance = instance != null ? instance : new CustomRunStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    CustomRunStatusFluent that = (CustomRunStatusFluent) o;
  ...
  public class ResultsNested<N> extends CustomRunResultFluent<ResultsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CustomRunStatusFluent.this.setToResults(index, builder.build());
    }
  ...
  public class RetriesStatusNested<N> extends CustomRunStatusFluent<RetriesStatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CustomRunStatusFluent.this.setToRetriesStatus(index, builder.build());
    }
