...
public class TaskSpecBuilder extends TaskSpecFluent<TaskSpecBuilder> implements VisitableBuilder<TaskSpec,TaskSpecBuilder>{
  ...
  public TaskSpec build() {
    TaskSpec buildable = new TaskSpec(fluent.getDescription(), fluent.getDisplayName(), fluent.buildParams(), fluent.buildResources(), fluent.buildResults(), fluent.buildSidecars(), fluent.buildStepTemplate(), fluent.buildSteps(), fluent.buildVolumes(), fluent.buildWorkspaces());
