...
public class TaskRunStatusFluent<A extends io.fabric8.tekton.v1.TaskRunStatusFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(annotations, artifacts, completionTime, conditions, observedGeneration, podName, provenance, results, retriesStatus, sidecars, spanContext, startTime, steps, taskSpec, additionalProperties);
  }
  ...
  public class ArtifactsNested<N> extends ArtifactsFluent<ArtifactsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRunStatusFluent.this.withArtifacts(builder.build());
    }
  ...
  public class ResultsNested<N> extends TaskRunResultFluent<ResultsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRunStatusFluent.this.setToResults(index, builder.build());
    }
