...
public class TaskRunStepSpecFluent<A extends io.fabric8.tekton.v1.TaskRunStepSpecFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private ResourceRequirementsBuilder computeResources;
  private String name;

  public TaskRunStepSpecFluent() {
  }
  
  public TaskRunStepSpecFluent(TaskRunStepSpec instance) {
  ...
  protected void copyInstance(TaskRunStepSpec instance) {
    instance = instance != null ? instance : new TaskRunStepSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    TaskRunStepSpecFluent that = (TaskRunStepSpecFluent) o;
  ...
  public class ComputeResourcesNested<N> extends ResourceRequirementsFluent<ComputeResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRunStepSpecFluent.this.withComputeResources(builder.build());
    }
