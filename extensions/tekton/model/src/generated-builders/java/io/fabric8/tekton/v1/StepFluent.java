...
public class StepFluent<A extends io.fabric8.tekton.v1.StepFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(args, command, computeResources, displayName, env, envFrom, image, imagePullPolicy, name, onError, params, ref, results, script, securityContext, stderrConfig, stdoutConfig, timeout, volumeDevices, volumeMounts, when, workingDir, workspaces, additionalProperties);
  }
  ...
  public class ComputeResourcesNested<N> extends ResourceRequirementsFluent<ComputeResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StepFluent.this.withComputeResources(builder.build());
    }
