...
public class ArtifactValueFluent<A extends io.fabric8.tekton.v1beta1.ArtifactValueFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private Map<String,String> digest;
  private String uri;

  public ArtifactValueFluent() {
  }
  
  public ArtifactValueFluent(ArtifactValue instance) {
  ...
  protected void copyInstance(ArtifactValue instance) {
    instance = instance != null ? instance : new ArtifactValue();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ArtifactValueFluent that = (ArtifactValueFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(digest, uri, additionalProperties);
  }
