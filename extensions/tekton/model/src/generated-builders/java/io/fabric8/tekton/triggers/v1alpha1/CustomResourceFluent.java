...
public class CustomResourceFluent<A extends io.fabric8.tekton.triggers.v1alpha1.CustomResourceFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(CustomResource instance) {
    instance = instance != null ? instance : new CustomResource();
    if (instance != null) {
