...
public class PipelineSpecBuilder extends PipelineSpecFluent<PipelineSpecBuilder> implements VisitableBuilder<PipelineSpec,PipelineSpecBuilder>{
  ...
  public PipelineSpec build() {
    PipelineSpec buildable = new PipelineSpec(fluent.getDescription(), fluent.getDisplayName(), fluent.buildFinally(), fluent.buildParams(), fluent.buildResults(), fluent.buildTasks(), fluent.buildWorkspaces());
