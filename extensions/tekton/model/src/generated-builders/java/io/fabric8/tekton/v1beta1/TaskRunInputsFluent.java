...
public class TaskRunInputsFluent<A extends io.fabric8.tekton.v1beta1.TaskRunInputsFluent<A>> extends BaseFluent<A>{
  ...
  public TaskRunInputsFluent() {
  }
  
  public TaskRunInputsFluent(TaskRunInputs instance) {
  ...
  protected void copyInstance(TaskRunInputs instance) {
    instance = instance != null ? instance : new TaskRunInputs();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    TaskRunInputsFluent that = (TaskRunInputsFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(params, resources, additionalProperties);
  }
  ...
  public class ParamsNested<N> extends ParamFluent<ParamsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRunInputsFluent.this.setToParams(index, builder.build());
    }
  ...
  public class ResourcesNested<N> extends TaskResourceBindingFluent<ResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRunInputsFluent.this.setToResources(index, builder.build());
    }
