...
public class PipelineTaskRunSpecBuilder extends PipelineTaskRunSpecFluent<PipelineTaskRunSpecBuilder> implements VisitableBuilder<PipelineTaskRunSpec,PipelineTaskRunSpecBuilder>{
  ...
  public PipelineTaskRunSpec build() {
    PipelineTaskRunSpec buildable = new PipelineTaskRunSpec(fluent.buildComputeResources(), fluent.buildMetadata(), fluent.getPipelineTaskName(), fluent.buildPodTemplate(), fluent.getServiceAccountName(), fluent.buildSidecarSpecs(), fluent.buildStepSpecs(), fluent.getTimeout());
