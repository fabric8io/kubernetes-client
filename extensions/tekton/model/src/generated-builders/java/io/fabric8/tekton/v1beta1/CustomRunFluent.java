...
public class CustomRunFluent<A extends io.fabric8.tekton.v1beta1.CustomRunFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private String kind;
  private ObjectMetaBuilder metadata;
  private CustomRunSpecBuilder spec;
  private CustomRunStatusBuilder status;

  public CustomRunFluent() {
  }
  
  public CustomRunFluent(CustomRun instance) {
  ...
  public CustomRunSpec buildSpec() {
  ...
  protected void copyInstance(CustomRun instance) {
    instance = instance != null ? instance : new CustomRun();
    if (instance != null) {
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new CustomRunSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(CustomRunSpec item) {
  ...
  public boolean equals(Object o) {
    ...
    CustomRunFluent that = (CustomRunFluent) o;
  ...
  public SpecNested<A> withNewSpecLike(CustomRunSpec item) {
  ...
  public A withSpec(CustomRunSpec spec) {
    this._visitables.remove("spec");
    if (spec != null) {
        this.spec = new CustomRunSpecBuilder(spec);
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CustomRunFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends CustomRunSpecFluent<SpecNested<N>> implements Nested<N>{
  
    CustomRunSpecBuilder builder;
  
    SpecNested(CustomRunSpec item) {
      this.builder = new CustomRunSpecBuilder(this, item);
    }
  
    public N and() {
      return (N) CustomRunFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends CustomRunStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CustomRunFluent.this.withStatus(builder.build());
    }
