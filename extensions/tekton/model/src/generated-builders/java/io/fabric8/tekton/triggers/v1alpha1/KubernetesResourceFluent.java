...
public class KubernetesResourceFluent<A extends io.fabric8.tekton.triggers.v1alpha1.KubernetesResourceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(replicas, serviceType, spec, additionalProperties);
  }
