...
public class ProvenanceFluent<A extends io.fabric8.tekton.v1beta1.ProvenanceFluent<A>> extends BaseFluent<A>{
  ...
  public ConfigSourceNested<A> editOrNewConfigSource() {
    return this.withNewConfigSourceLike(Optional.ofNullable(this.buildConfigSource()).orElse(new ConfigSourceBuilder().build()));
  }
  
  public ConfigSourceNested<A> editOrNewConfigSourceLike(ConfigSource item) {
  ...
  public int hashCode() {
    return Objects.hash(configSource, featureFlags, refSource, additionalProperties);
  }
  ...
  public ConfigSourceNested<A> withNewConfigSourceLike(ConfigSource item) {
  ...
  public class ConfigSourceNested<N> extends ConfigSourceFluent<ConfigSourceNested<N>> implements Nested<N>{
  
    ConfigSourceBuilder builder;
  
    ConfigSourceNested(ConfigSource item) {
      this.builder = new ConfigSourceBuilder(this, item);
    }
  
    public N and() {
      return (N) ProvenanceFluent.this.withConfigSource(builder.build());
    }
