...
public class StepTemplateFluent<A extends io.fabric8.tekton.v1beta1.StepTemplateFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(args, command, env, envFrom, image, imagePullPolicy, lifecycle, livenessProbe, name, ports, readinessProbe, resources, securityContext, startupProbe, stdin, stdinOnce, terminationMessagePath, terminationMessagePolicy, tty, volumeDevices, volumeMounts, workingDir, additionalProperties);
  }
  ...
  public class PortsNested<N> extends ContainerPortFluent<PortsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StepTemplateFluent.this.setToPorts(index, builder.build());
    }
  ...
  public class ResourcesNested<N> extends ResourceRequirementsFluent<ResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StepTemplateFluent.this.withResources(builder.build());
    }
