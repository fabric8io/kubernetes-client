...
public class EmbeddedTaskFluent<A extends io.fabric8.tekton.v1.EmbeddedTaskFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, description, displayName, kind, metadata, params, results, sidecars, spec, stepTemplate, steps, volumes, workspaces, additionalProperties);
  }
