...
public class ResolutionRequestStatusFieldsFluent<A extends io.fabric8.tekton.resolution.v1beta1.ResolutionRequestStatusFieldsFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(data, refSource, source, additionalProperties);
  }
  ...
  public class SourceNested<N> extends RefSourceFluent<SourceNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ResolutionRequestStatusFieldsFluent.this.withSource(builder.build());
    }
