...
public class TaskListFluent<A extends io.fabric8.tekton.v1beta1.TaskListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<TaskBuilder> items = new ArrayList<TaskBuilder>();
  private String kind;
  private ListMeta metadata;

  public TaskListFluent() {
  }
  
  public TaskListFluent(TaskList instance) {
  ...
  public ItemsNested<A> addNewItemLike(Task item) {
  ...
  public Task buildMatchingItem(Predicate<TaskBuilder> predicate) {
      for (TaskBuilder item : items) {
  ...
  protected void copyInstance(TaskList instance) {
    instance = instance != null ? instance : new TaskList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<TaskBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    TaskListFluent that = (TaskListFluent) o;
  ...
  public boolean hasMatchingItem(Predicate<TaskBuilder> predicate) {
      for (TaskBuilder item : items) {
        if (predicate.test(item)) {
          return true;
        }
  ...
  public A removeMatchingFromItems(Predicate<TaskBuilder> predicate) {
    if (items == null) {
      return (A) this;
    }
    Iterator<TaskBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,Task item) {
  ...
  public class ItemsNested<N> extends TaskFluent<ItemsNested<N>> implements Nested<N>{
  
    TaskBuilder builder;
    int index;
  
    ItemsNested(int index,Task item) {
      this.index = index;
      this.builder = new TaskBuilder(this, item);
    }
  
    public N and() {
      return (N) TaskListFluent.this.setToItems(index, builder.build());
    }
