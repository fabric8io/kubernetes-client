...
public class ParamSpecFluent<A extends io.fabric8.tekton.triggers.v1alpha1.ParamSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(_default, description, name, additionalProperties);
  }
