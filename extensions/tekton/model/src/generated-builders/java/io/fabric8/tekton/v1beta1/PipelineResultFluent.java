...
public class PipelineResultFluent<A extends io.fabric8.tekton.v1beta1.PipelineResultFluent<A>> extends BaseFluent<A>{
  ...
  public PipelineResultFluent(PipelineResult instance) {
  ...
  protected void copyInstance(PipelineResult instance) {
    instance = instance != null ? instance : new PipelineResult();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    PipelineResultFluent that = (PipelineResultFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(description, name, type, value, additionalProperties);
  }
  ...
  public class ValueNested<N> extends ParamValueFluent<ValueNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PipelineResultFluent.this.withValue(builder.build());
    }
