...
public class TaskSpecFluent<A extends io.fabric8.tekton.v1beta1.TaskSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(description, displayName, params, resources, results, sidecars, stepTemplate, steps, volumes, workspaces, additionalProperties);
  }
  ...
  public class ResourcesNested<N> extends TaskResourcesFluent<ResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskSpecFluent.this.withResources(builder.build());
    }
