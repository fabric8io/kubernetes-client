...
public class TriggerListFluent<A extends io.fabric8.tekton.triggers.v1alpha1.TriggerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<TriggerBuilder> items = new ArrayList<TriggerBuilder>();
  private String kind;
  private ListMeta metadata;

  public TriggerListFluent() {
  }
  
  public TriggerListFluent(TriggerList instance) {
  ...
  public ItemsNested<A> addNewItemLike(Trigger item) {
  ...
  protected void copyInstance(TriggerList instance) {
    instance = instance != null ? instance : new TriggerList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<TriggerBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    TriggerListFluent that = (TriggerListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<TriggerBuilder> predicate) {
    ...
    Iterator<TriggerBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        TriggerBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Trigger item) {
  ...
  public class ItemsNested<N> extends TriggerFluent<ItemsNested<N>> implements Nested<N>{
  
    TriggerBuilder builder;
    int index;
  
    ItemsNested(int index,Trigger item) {
      this.index = index;
      this.builder = new TriggerBuilder(this, item);
    }
  
    public N and() {
      return (N) TriggerListFluent.this.setToItems(index, builder.build());
    }
