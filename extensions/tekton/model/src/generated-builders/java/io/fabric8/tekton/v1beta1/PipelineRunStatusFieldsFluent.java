...
public class PipelineRunStatusFieldsFluent<A extends io.fabric8.tekton.v1beta1.PipelineRunStatusFieldsFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(childReferences, completionTime, finallyStartTime, pipelineResults, pipelineSpec, provenance, runs, skippedTasks, spanContext, startTime, taskRuns, additionalProperties);
  }
