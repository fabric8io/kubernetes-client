...
public class PipelineRunSpecFluent<A extends io.fabric8.tekton.v1.PipelineRunSpecFluent<A>> extends BaseFluent<A>{
  ...
  public TaskRunTemplateNested<A> editOrNewTaskRunTemplate() {
    return this.withNewTaskRunTemplateLike(Optional.ofNullable(this.buildTaskRunTemplate()).orElse(new PipelineTaskRunTemplateBuilder().build()));
  }
  
  public TaskRunTemplateNested<A> editOrNewTaskRunTemplateLike(PipelineTaskRunTemplate item) {
    return this.withNewTaskRunTemplateLike(Optional.ofNullable(this.buildTaskRunTemplate()).orElse(item));
  }
  ...
  public TaskRunTemplateNested<A> editTaskRunTemplate() {
    return this.withNewTaskRunTemplateLike(Optional.ofNullable(this.buildTaskRunTemplate()).orElse(null));
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(taskRunTemplate, that.taskRunTemplate))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(managedBy, params, pipelineRef, pipelineSpec, status, taskRunSpecs, taskRunTemplate, timeouts, workspaces, additionalProperties);
  }
