...
public class PipelineRunStatusFieldsFluent<A extends io.fabric8.tekton.v1.PipelineRunStatusFieldsFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(childReferences, completionTime, finallyStartTime, pipelineSpec, provenance, results, skippedTasks, spanContext, startTime, additionalProperties);
  }
  ...
  public class ResultsNested<N> extends PipelineRunResultFluent<ResultsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PipelineRunStatusFieldsFluent.this.setToResults(index, builder.build());
    }
