...
public class TaskRefFluent<A extends io.fabric8.tekton.v1.TaskRefFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, kind, name, params, resolver, additionalProperties);
  }
