...
public class PipelineRunSpecBuilder extends PipelineRunSpecFluent<PipelineRunSpecBuilder> implements VisitableBuilder<PipelineRunSpec,PipelineRunSpecBuilder>{
  ...
  public PipelineRunSpec build() {
    PipelineRunSpec buildable = new PipelineRunSpec(fluent.getManagedBy(), fluent.buildParams(), fluent.buildPipelineRef(), fluent.buildPipelineSpec(), fluent.getStatus(), fluent.buildTaskRunSpecs(), fluent.buildTaskRunTemplate(), fluent.buildTimeouts(), fluent.buildWorkspaces());
