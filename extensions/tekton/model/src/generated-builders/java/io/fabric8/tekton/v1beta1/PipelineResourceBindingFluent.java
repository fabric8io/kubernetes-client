...
public class PipelineResourceBindingFluent<A extends io.fabric8.tekton.v1beta1.PipelineResourceBindingFluent<A>> extends BaseFluent<A>{
  ...
  public PipelineResourceBindingFluent(PipelineResourceBinding instance) {
  ...
  protected void copyInstance(PipelineResourceBinding instance) {
    instance = instance != null ? instance : new PipelineResourceBinding();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    PipelineResourceBindingFluent that = (PipelineResourceBindingFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(name, resourceRef, resourceSpec, additionalProperties);
  }
  ...
  public class ResourceRefNested<N> extends PipelineResourceRefFluent<ResourceRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PipelineResourceBindingFluent.this.withResourceRef(builder.build());
    }
  ...
  public class ResourceSpecNested<N> extends PipelineResourceSpecFluent<ResourceSpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PipelineResourceBindingFluent.this.withResourceSpec(builder.build());
    }
