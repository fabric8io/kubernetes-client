...
public class PipelineRefFluent<A extends io.fabric8.tekton.v1beta1.PipelineRefFluent<A>> extends BaseFluent<A>{
  ...
  public PipelineRefFluent(PipelineRef instance) {
  ...
  protected void copyInstance(PipelineRef instance) {
    instance = instance != null ? instance : new PipelineRef();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    PipelineRefFluent that = (PipelineRefFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, bundle, name, params, resolver, additionalProperties);
  }
  ...
  public class ParamsNested<N> extends ParamFluent<ParamsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PipelineRefFluent.this.setToParams(index, builder.build());
    }
