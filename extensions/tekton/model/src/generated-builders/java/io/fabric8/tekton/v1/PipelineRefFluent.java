...
public class PipelineRefFluent<A extends io.fabric8.tekton.v1.PipelineRefFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, name, params, resolver, additionalProperties);
  }
