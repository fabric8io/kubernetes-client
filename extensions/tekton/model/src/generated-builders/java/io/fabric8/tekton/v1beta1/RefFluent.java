...
public class RefFluent<A extends io.fabric8.tekton.v1beta1.RefFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(Ref instance) {
    instance = instance != null ? instance : new Ref();
    if (instance != null) {
  ...
  public int hashCode() {
    return Objects.hash(name, params, resolver, additionalProperties);
  }
  ...
  public class ParamsNested<N> extends ParamFluent<ParamsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RefFluent.this.setToParams(index, builder.build());
    }
