...
public class EventListenerSpecBuilder extends EventListenerSpecFluent<EventListenerSpecBuilder> implements VisitableBuilder<EventListenerSpec,EventListenerSpecBuilder>{
  ...
  public EventListenerSpec build() {
    EventListenerSpec buildable = new EventListenerSpec(fluent.getCloudEventURI(), fluent.buildLabelSelector(), fluent.buildNamespaceSelector(), fluent.buildResources(), fluent.getServiceAccountName(), fluent.buildTriggerGroups(), fluent.buildTriggers());
