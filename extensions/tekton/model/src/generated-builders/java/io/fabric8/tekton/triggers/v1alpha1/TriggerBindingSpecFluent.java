...
public class TriggerBindingSpecFluent<A extends io.fabric8.tekton.triggers.v1alpha1.TriggerBindingSpecFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private ArrayList<ParamBuilder> params = new ArrayList<ParamBuilder>();

  public TriggerBindingSpecFluent() {
  }
  
  public TriggerBindingSpecFluent(TriggerBindingSpec instance) {
  ...
  public A addNewParam(String name,String value) {
    return (A) this.addToParams(new Param(name, value));
  }
  ...
  protected void copyInstance(TriggerBindingSpec instance) {
    instance = instance != null ? instance : new TriggerBindingSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    TriggerBindingSpecFluent that = (TriggerBindingSpecFluent) o;
  ...
  public class ParamsNested<N> extends ParamFluent<ParamsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TriggerBindingSpecFluent.this.setToParams(index, builder.build());
    }
