...
public class PipelineTaskBuilder extends PipelineTaskFluent<PipelineTaskBuilder> implements VisitableBuilder<PipelineTask,PipelineTaskBuilder>{
  ...
  public PipelineTask build() {
    PipelineTask buildable = new PipelineTask(fluent.getDescription(), fluent.getDisplayName(), fluent.buildMatrix(), fluent.getName(), fluent.getOnError(), fluent.buildParams(), fluent.buildPipelineRef(), fluent.buildPipelineSpec(), fluent.buildResources(), fluent.getRetries(), fluent.getRunAfter(), fluent.buildTaskRef(), fluent.buildTaskSpec(), fluent.getTimeout(), fluent.buildWhen(), fluent.buildWorkspaces());
