...
public class PipelineTaskFluent<A extends io.fabric8.tekton.v1.PipelineTaskFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(description, displayName, matrix, name, onError, params, pipelineRef, pipelineSpec, retries, runAfter, taskRef, taskSpec, timeout, when, workspaces, additionalProperties);
  }
