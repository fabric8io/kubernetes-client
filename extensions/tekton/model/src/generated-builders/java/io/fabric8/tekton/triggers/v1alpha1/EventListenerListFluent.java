...
public class EventListenerListFluent<A extends io.fabric8.tekton.triggers.v1alpha1.EventListenerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<EventListenerBuilder> items = new ArrayList<EventListenerBuilder>();
  private String kind;
  private ListMeta metadata;

  public EventListenerListFluent() {
  }
  
  public EventListenerListFluent(EventListenerList instance) {
  ...
  public ItemsNested<A> addNewItemLike(EventListener item) {
  ...
  public EventListener buildMatchingItem(Predicate<EventListenerBuilder> predicate) {
      for (EventListenerBuilder item : items) {
  ...
  protected void copyInstance(EventListenerList instance) {
    instance = instance != null ? instance : new EventListenerList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<EventListenerBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    EventListenerListFluent that = (EventListenerListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<EventListenerBuilder> predicate) {
    ...
    Iterator<EventListenerBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        EventListenerBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,EventListener item) {
  ...
  public class ItemsNested<N> extends EventListenerFluent<ItemsNested<N>> implements Nested<N>{
  
    EventListenerBuilder builder;
    int index;
  
    ItemsNested(int index,EventListener item) {
      this.index = index;
      this.builder = new EventListenerBuilder(this, item);
    }
  
    public N and() {
      return (N) EventListenerListFluent.this.setToItems(index, builder.build());
    }
