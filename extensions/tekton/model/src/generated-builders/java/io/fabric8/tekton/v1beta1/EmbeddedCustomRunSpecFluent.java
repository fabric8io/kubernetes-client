...
public class EmbeddedCustomRunSpecFluent<A extends io.fabric8.tekton.v1beta1.EmbeddedCustomRunSpecFluent<A>> extends BaseFluent<A>{
  ...
  public EmbeddedCustomRunSpecFluent() {
  }
  
  public EmbeddedCustomRunSpecFluent(EmbeddedCustomRunSpec instance) {
  ...
  protected void copyInstance(EmbeddedCustomRunSpec instance) {
    instance = instance != null ? instance : new EmbeddedCustomRunSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    EmbeddedCustomRunSpecFluent that = (EmbeddedCustomRunSpecFluent) o;
  ...
  public class MetadataNested<N> extends PipelineTaskMetadataFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EmbeddedCustomRunSpecFluent.this.withMetadata(builder.build());
    }
