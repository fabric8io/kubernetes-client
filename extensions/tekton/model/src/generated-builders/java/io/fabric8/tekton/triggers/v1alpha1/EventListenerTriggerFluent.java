...
public class EventListenerTriggerFluent<A extends io.fabric8.tekton.triggers.v1alpha1.EventListenerTriggerFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(EventListenerTrigger instance) {
    instance = instance != null ? instance : new EventListenerTrigger();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    EventListenerTriggerFluent that = (EventListenerTriggerFluent) o;
    ...
    if (!(Objects.equals(triggerRef, that.triggerRef))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(bindings, interceptors, name, serviceAccountName, template, triggerRef, additionalProperties);
  }
  ...
  public class BindingsNested<N> extends TriggerSpecBindingFluent<BindingsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EventListenerTriggerFluent.this.setToBindings(index, builder.build());
    }
  ...
  public class InterceptorsNested<N> extends TriggerInterceptorFluent<InterceptorsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EventListenerTriggerFluent.this.setToInterceptors(index, builder.build());
    }
  ...
  public class TemplateNested<N> extends TriggerSpecTemplateFluent<TemplateNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EventListenerTriggerFluent.this.withTemplate(builder.build());
    }
