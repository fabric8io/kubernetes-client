...
public class StepStateFluent<A extends io.fabric8.tekton.v1beta1.StepStateFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(container, imageID, inputs, name, outputs, provenance, results, running, terminated, waiting, additionalProperties);
  }
