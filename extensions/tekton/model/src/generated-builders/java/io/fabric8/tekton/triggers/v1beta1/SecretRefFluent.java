...
public class SecretRefFluent<A extends io.fabric8.tekton.triggers.v1beta1.SecretRefFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(secretKey, secretName, additionalProperties);
  }
