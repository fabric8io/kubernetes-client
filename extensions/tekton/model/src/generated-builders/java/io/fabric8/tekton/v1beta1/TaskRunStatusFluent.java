...
public class TaskRunStatusFluent<A extends io.fabric8.tekton.v1beta1.TaskRunStatusFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(TaskRunStatus instance) {
    instance = instance != null ? instance : new TaskRunStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    TaskRunStatusFluent that = (TaskRunStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(annotations, cloudEvents, completionTime, conditions, observedGeneration, podName, provenance, resourcesResult, retriesStatus, sidecars, spanContext, startTime, steps, taskResults, taskSpec, additionalProperties);
  }
  ...
  public class CloudEventsNested<N> extends CloudEventDeliveryFluent<CloudEventsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRunStatusFluent.this.setToCloudEvents(index, builder.build());
    }
  ...
  public class ProvenanceNested<N> extends ProvenanceFluent<ProvenanceNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRunStatusFluent.this.withProvenance(builder.build());
    }
  ...
  public class ResourcesResultNested<N> extends RunResultFluent<ResourcesResultNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRunStatusFluent.this.setToResourcesResult(index, builder.build());
    }
  ...
  public class RetriesStatusNested<N> extends TaskRunStatusFluent<RetriesStatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRunStatusFluent.this.setToRetriesStatus(index, builder.build());
    }
  ...
  public class SidecarsNested<N> extends SidecarStateFluent<SidecarsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRunStatusFluent.this.setToSidecars(index, builder.build());
    }
  ...
  public class StepsNested<N> extends StepStateFluent<StepsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRunStatusFluent.this.setToSteps(index, builder.build());
    }
  ...
  public class TaskResultsNested<N> extends TaskRunResultFluent<TaskResultsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRunStatusFluent.this.setToTaskResults(index, builder.build());
    }
  ...
  public class TaskSpecNested<N> extends TaskSpecFluent<TaskSpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TaskRunStatusFluent.this.withTaskSpec(builder.build());
    }
