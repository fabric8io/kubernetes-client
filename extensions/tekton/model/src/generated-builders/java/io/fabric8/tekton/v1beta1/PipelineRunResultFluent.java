...
public class PipelineRunResultFluent<A extends io.fabric8.tekton.v1beta1.PipelineRunResultFluent<A>> extends BaseFluent<A>{
  ...
  public PipelineRunResultFluent(PipelineRunResult instance) {
  ...
  protected void copyInstance(PipelineRunResult instance) {
    instance = instance != null ? instance : new PipelineRunResult();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    PipelineRunResultFluent that = (PipelineRunResultFluent) o;
  ...
  public class ValueNested<N> extends ParamValueFluent<ValueNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PipelineRunResultFluent.this.withValue(builder.build());
    }
