...
public class TaskRunStepSpec implements Editable<TaskRunStepSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TaskRunStepSpec)) {
            return false;
        }
        TaskRunStepSpec other = (TaskRunStepSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof TaskRunStepSpec;
    }
    ...
    public String toString() {
        return "TaskRunStepSpec(" + "computeResources=" + this.getComputeResources() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
