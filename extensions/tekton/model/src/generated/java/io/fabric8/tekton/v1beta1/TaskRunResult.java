...
public class TaskRunResult implements Editable<TaskRunResultBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        TaskRunResult other = (TaskRunResult) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof TaskRunResult;
    }
    ...
    public String toString() {
        return "TaskRunResult(" + "name=" + this.getName() + ", type=" + this.getType() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
