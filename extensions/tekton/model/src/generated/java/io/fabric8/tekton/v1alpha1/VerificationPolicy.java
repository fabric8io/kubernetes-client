...
public class VerificationPolicy implements Editable<VerificationPolicyBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VerificationPolicy)) {
            return false;
        }
        VerificationPolicy other = (VerificationPolicy) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof VerificationPolicy;
    }
    ...
    public String toString() {
        return "VerificationPolicy(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
