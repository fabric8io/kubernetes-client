...
public class Run implements Editable<RunBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Run(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
