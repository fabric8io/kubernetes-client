...
public class ClusterTriggerBinding implements Editable<ClusterTriggerBindingBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterTriggerBinding)) {
            return false;
        }
        ClusterTriggerBinding other = (ClusterTriggerBinding) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClusterTriggerBinding;
    }
    ...
    public String toString() {
        return "ClusterTriggerBinding(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
