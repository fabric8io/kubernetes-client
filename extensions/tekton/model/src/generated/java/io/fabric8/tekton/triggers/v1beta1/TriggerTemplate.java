...
public class TriggerTemplate implements Editable<TriggerTemplateBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TriggerTemplate)) {
            return false;
        }
        TriggerTemplate other = (TriggerTemplate) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof TriggerTemplate;
    }
    ...
    public String toString() {
        return "TriggerTemplate(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
