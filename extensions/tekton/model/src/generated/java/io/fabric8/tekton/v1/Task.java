...
public class Task implements Editable<TaskBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Task(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
