...
public class PipelineResult implements Editable<PipelineResultBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "PipelineResult(" + "description=" + this.getDescription() + ", name=" + this.getName() + ", type=" + this.getType() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
