...
public class Interceptor implements Editable<InterceptorBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        Interceptor other = (Interceptor) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Interceptor;
    }
    ...
    public String toString() {
        return "Interceptor(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
