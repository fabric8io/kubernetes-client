...
public class InterceptorSpec implements Editable<InterceptorSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InterceptorSpec)) {
            return false;
        }
        InterceptorSpec other = (InterceptorSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof InterceptorSpec;
    }
    ...
    public String toString() {
        return "InterceptorSpec(" + "clientConfig=" + this.getClientConfig() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
