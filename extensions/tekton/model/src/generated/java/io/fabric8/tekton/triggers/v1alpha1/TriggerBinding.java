...
public class TriggerBinding implements Editable<TriggerBindingBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TriggerBinding)) {
            return false;
        }
        TriggerBinding other = (TriggerBinding) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof TriggerBinding;
    }
    ...
    public String toString() {
        return "TriggerBinding(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
