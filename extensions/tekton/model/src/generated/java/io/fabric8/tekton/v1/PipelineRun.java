...
public class PipelineRun implements Editable<PipelineRunBuilder>, HasMetadata, Namespaced
{
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PipelineRun;
    }
    ...
    public String toString() {
        return "PipelineRun(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
