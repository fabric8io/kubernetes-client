...
public class RunResult implements Editable<RunResultBuilder>, KubernetesResource
{
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RunResult;
    }
    ...
    public String toString() {
        return "RunResult(" + "key=" + this.getKey() + ", resourceName=" + this.getResourceName() + ", type=" + this.getType() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
