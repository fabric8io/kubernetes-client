...
public class ResolutionRequest implements Editable<ResolutionRequestBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResolutionRequest)) {
            return false;
        }
        ResolutionRequest other = (ResolutionRequest) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ResolutionRequest;
    }
    ...
    public String toString() {
        return "ResolutionRequest(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
