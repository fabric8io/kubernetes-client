...
public class Pipeline implements Editable<PipelineBuilder>, HasMetadata, Namespaced
{
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Pipeline;
    }
    ...
    public String toString() {
        return "Pipeline(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
