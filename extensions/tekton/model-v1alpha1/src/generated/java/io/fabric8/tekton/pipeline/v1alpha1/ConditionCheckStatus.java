...
public class ConditionCheckStatus implements KubernetesResource
{
     ...
     */
    public ConditionCheckStatus(ContainerState check, String completionTime, List<Condition> conditions, Long observedGeneration, String podName, String startTime) {
        super();
        this.check = check;
