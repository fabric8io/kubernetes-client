...
public class Pipeline implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public Pipeline(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, PipelineSpec spec, PipelineStatus status) {
        super();
