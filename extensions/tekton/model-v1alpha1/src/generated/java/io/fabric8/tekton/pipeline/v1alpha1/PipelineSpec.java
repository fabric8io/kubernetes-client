...
public class PipelineSpec implements KubernetesResource
{
    ...
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    private List<WorkspacePipelineDeclaration> workspaces = new ArrayList<WorkspacePipelineDeclaration>();
    @JsonIgnore
     ...
     * @param tasks
     */
    public PipelineSpec(List<ParamSpec> params, List<PipelineDeclaredResource> resources, List<PipelineTask> tasks, List<WorkspacePipelineDeclaration> workspaces) {
        super();
        this.params = params;
    ...
    @JsonProperty("workspaces")
    public void setWorkspaces(List<WorkspacePipelineDeclaration> workspaces) {
        this.workspaces = workspaces;
    }
