...
public class WorkspaceBinding implements KubernetesResource
{
     ...
     * @param subPath
     */
    public WorkspaceBinding(ConfigMapVolumeSource configMap, EmptyDirVolumeSource emptyDir, String name, PersistentVolumeClaimVolumeSource persistentVolumeClaim, SecretVolumeSource secret, String subPath) {
        super();
