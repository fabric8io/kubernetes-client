...
public class TaskRun implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public TaskRun(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, TaskRunSpec spec, TaskRunStatus status) {
        super();
