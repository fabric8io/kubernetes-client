...
public class PipelineTaskCondition implements KubernetesResource
{
    ...
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    private List<PipelineTaskInputResource> resources = new ArrayList<PipelineTaskInputResource>();
    @JsonIgnore
     ...
     * @param params
     */
    public PipelineTaskCondition(String conditionRef, List<Param> params, List<PipelineTaskInputResource> resources) {
        super();
    ...
    @JsonProperty("resources")
    public List<PipelineTaskInputResource> getResources() {
        return resources;
    }

    @JsonProperty("resources")
    public void setResources(List<PipelineTaskInputResource> resources) {
        this.resources = resources;
    }
