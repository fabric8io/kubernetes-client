...
public class Resources implements io.fabric8.kubernetes.api.model.KubernetesResource
{
     ...
     */
    public Resources(HasMetadata customResource, io.fabric8.tekton.triggers.v1alpha1.KubernetesResource kubernetesResource) {
        super();
    ...
    @JsonProperty("customResource")
    public void setCustomResource(HasMetadata customResource) {
        this.customResource = customResource;
    }
