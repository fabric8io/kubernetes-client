...
public class PipelineRun implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public PipelineRun(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, PipelineRunSpec spec, PipelineRunStatus status) {
        super();
