...
public class TaskRunStepSpec implements KubernetesResource
{
    ...
    public TaskRunStepSpec(io.fabric8.kubernetes.api.model.ResourceRequirements computeResources, String name) {
        super();
