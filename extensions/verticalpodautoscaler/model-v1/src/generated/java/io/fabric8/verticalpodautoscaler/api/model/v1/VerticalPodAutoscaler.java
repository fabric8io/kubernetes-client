...
public class VerticalPodAutoscaler implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public VerticalPodAutoscaler(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, VerticalPodAutoscalerSpec spec, VerticalPodAutoscalerStatus status) {
        super();
