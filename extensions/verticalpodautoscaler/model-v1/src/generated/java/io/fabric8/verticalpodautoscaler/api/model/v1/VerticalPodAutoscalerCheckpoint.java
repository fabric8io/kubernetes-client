...
public class VerticalPodAutoscalerCheckpoint implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public VerticalPodAutoscalerCheckpoint(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, VerticalPodAutoscalerCheckpointSpec spec, VerticalPodAutoscalerCheckpointStatus status) {
        super();
