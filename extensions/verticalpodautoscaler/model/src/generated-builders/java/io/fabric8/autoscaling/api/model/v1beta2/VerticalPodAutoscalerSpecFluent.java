...
public class VerticalPodAutoscalerSpecFluent<A extends io.fabric8.autoscaling.api.model.v1beta2.VerticalPodAutoscalerSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(resourcePolicy, targetRef, updatePolicy, additionalProperties);
  }
