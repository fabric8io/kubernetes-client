...
public class VerticalPodAutoscalerStatusFluent<A extends io.fabric8.autoscaling.api.model.v1beta1.VerticalPodAutoscalerStatusFluent<A>> extends BaseFluent<A>{
  ...
  public A addNewCondition(String lastTransitionTime,String message,String reason,String status,String type) {
    return (A) this.addToConditions(new VerticalPodAutoscalerCondition(lastTransitionTime, message, reason, status, type));
  }
  ...
  public int hashCode() {
    return Objects.hash(conditions, recommendation, additionalProperties);
  }
