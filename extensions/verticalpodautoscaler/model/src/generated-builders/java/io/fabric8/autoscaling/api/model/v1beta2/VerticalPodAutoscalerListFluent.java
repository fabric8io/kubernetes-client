...
public class VerticalPodAutoscalerListFluent<A extends io.fabric8.autoscaling.api.model.v1beta2.VerticalPodAutoscalerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<VerticalPodAutoscalerBuilder> items = new ArrayList<VerticalPodAutoscalerBuilder>();
  private String kind;
  private ListMeta metadata;

  public VerticalPodAutoscalerListFluent() {
  }
  ...
  public A addAllToItems(Collection<VerticalPodAutoscaler> items) {
    ...
    for (VerticalPodAutoscaler item : items) {
        VerticalPodAutoscalerBuilder builder = new VerticalPodAutoscalerBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(VerticalPodAutoscaler item) {
  ...
  public VerticalPodAutoscaler buildMatchingItem(Predicate<VerticalPodAutoscalerBuilder> predicate) {
      for (VerticalPodAutoscalerBuilder item : items) {
  ...
  protected void copyInstance(VerticalPodAutoscalerList instance) {
    instance = instance != null ? instance : new VerticalPodAutoscalerList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<VerticalPodAutoscalerBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    VerticalPodAutoscalerListFluent that = (VerticalPodAutoscalerListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<VerticalPodAutoscalerBuilder> predicate) {
    ...
    Iterator<VerticalPodAutoscalerBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        VerticalPodAutoscalerBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,VerticalPodAutoscaler item) {
  ...
  public class ItemsNested<N> extends VerticalPodAutoscalerFluent<ItemsNested<N>> implements Nested<N>{
  
    VerticalPodAutoscalerBuilder builder;
    int index;
  
    ItemsNested(int index,VerticalPodAutoscaler item) {
      this.index = index;
      this.builder = new VerticalPodAutoscalerBuilder(this, item);
    }
  
    public N and() {
      return (N) VerticalPodAutoscalerListFluent.this.setToItems(index, builder.build());
    }
