...
public class VerticalPodAutoscalerCondition implements Editable<VerticalPodAutoscalerConditionBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "VerticalPodAutoscalerCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
