...
public class VerticalPodAutoscalerSpec implements Editable<VerticalPodAutoscalerSpecBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "VerticalPodAutoscalerSpec(" + "resourcePolicy=" + this.getResourcePolicy() + ", selector=" + this.getSelector() + ", updatePolicy=" + this.getUpdatePolicy() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
