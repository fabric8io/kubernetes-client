...
public class VerticalPodAutoscalerCondition implements Editable<VerticalPodAutoscalerConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VerticalPodAutoscalerCondition)) {
            return false;
        }
        VerticalPodAutoscalerCondition other = (VerticalPodAutoscalerCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof VerticalPodAutoscalerCondition;
    }
    ...
    public String toString() {
        return "VerticalPodAutoscalerCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", observedGeneration=" + this.getObservedGeneration() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
