...
public class VerticalPodAutoscalerCheckpoint implements Editable<VerticalPodAutoscalerCheckpointBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VerticalPodAutoscalerCheckpoint)) {
            return false;
        }
        VerticalPodAutoscalerCheckpoint other = (VerticalPodAutoscalerCheckpoint) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof VerticalPodAutoscalerCheckpoint;
    }
    ...
    public String toString() {
        return "VerticalPodAutoscalerCheckpoint(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
