...
public class VerticalPodAutoscaler implements Editable<VerticalPodAutoscalerBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VerticalPodAutoscaler)) {
            return false;
        }
        VerticalPodAutoscaler other = (VerticalPodAutoscaler) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof VerticalPodAutoscaler;
    }
    ...
    public String toString() {
        return "VerticalPodAutoscaler(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
