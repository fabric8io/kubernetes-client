...
public class StartupBoost implements Editable<StartupBoostBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartupBoost)) {
            return false;
        }
        StartupBoost other = (StartupBoost) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof StartupBoost;
    }
    ...
    public String toString() {
        return "StartupBoost(" + "cpu=" + this.getCpu() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
