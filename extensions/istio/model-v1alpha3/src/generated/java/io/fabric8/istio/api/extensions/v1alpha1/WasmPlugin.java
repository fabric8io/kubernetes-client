...
public class WasmPlugin implements Editable<WasmPluginBuilder> , HasMetadata, Namespaced
{
    ...
    public WasmPlugin(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, WasmPluginSpec spec, IstioStatus status) {
        super();
    ...
    @JsonProperty("spec")
    public WasmPluginSpec getSpec() {
        return spec;
    }

    @JsonProperty("spec")
    public void setSpec(WasmPluginSpec spec) {
        this.spec = spec;
    }
