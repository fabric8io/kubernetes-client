...
public class EnvoyFilter implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public EnvoyFilter(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, EnvoyFilterSpec spec, IstioStatus status) {
        super();
    ...
    @JsonProperty("spec")
    public void setSpec(EnvoyFilterSpec spec) {
        this.spec = spec;
    }
