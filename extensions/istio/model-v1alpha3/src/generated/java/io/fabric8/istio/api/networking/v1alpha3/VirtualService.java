...
public class VirtualService implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public VirtualService(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, VirtualServiceSpec spec, IstioStatus status) {
        super();
