...
import io.fabric8.istio.api.extensions.v1alpha1.TelemetrySpec;
...
public class Telemetry implements Editable<TelemetryBuilder> , HasMetadata, Namespaced
{
    ...
    public Telemetry(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, TelemetrySpec spec, IstioStatus status) {
        super();
    ...
    @JsonProperty("spec")
    public TelemetrySpec getSpec() {
        return spec;
    }

    @JsonProperty("spec")
    public void setSpec(TelemetrySpec spec) {
        this.spec = spec;
    }
