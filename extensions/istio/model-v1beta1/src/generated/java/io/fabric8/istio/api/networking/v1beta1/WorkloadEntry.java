...
public class WorkloadEntry implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public WorkloadEntry(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, WorkloadEntrySpec spec, IstioStatus status) {
        super();
    ...
    @JsonProperty("spec")
    public void setSpec(WorkloadEntrySpec spec) {
        this.spec = spec;
    }
