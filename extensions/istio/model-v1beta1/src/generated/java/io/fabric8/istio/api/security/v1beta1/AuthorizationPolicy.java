...
public class AuthorizationPolicy implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public AuthorizationPolicy(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, AuthorizationPolicySpec spec, IstioStatus status) {
        super();
