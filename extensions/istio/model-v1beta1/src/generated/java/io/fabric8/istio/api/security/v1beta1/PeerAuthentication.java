...
public class PeerAuthentication implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public PeerAuthentication(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, PeerAuthenticationSpec spec, IstioStatus status) {
        super();
    ...
    @JsonProperty("spec")
    public void setSpec(PeerAuthenticationSpec spec) {
        this.spec = spec;
    }
