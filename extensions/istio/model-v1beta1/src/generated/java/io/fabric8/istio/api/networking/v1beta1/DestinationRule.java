...
public class DestinationRule implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public DestinationRule(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, DestinationRuleSpec spec, IstioStatus status) {
        super();
