...
public class V1beta1APIGroupExtensionAdapter extends APIGroupExtensionAdapter<V1beta1APIGroupDSL> {
  @Override
  ...
  @Override
  public Class<V1beta1APIGroupDSL> getExtensionType() {
    return V1beta1APIGroupDSL.class;
  }
