...
public class ServiceEntryListFluent<A extends io.fabric8.istio.api.networking.v1alpha3.ServiceEntryListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ServiceEntryBuilder> items = new ArrayList<ServiceEntryBuilder>();
  private String kind;
  private ListMeta metadata;

  public ServiceEntryListFluent() {
  }
  
  public ServiceEntryListFluent(ServiceEntryList instance) {
  ...
  public ItemsNested<A> addNewItemLike(ServiceEntry item) {
  ...
  public ServiceEntry buildMatchingItem(Predicate<ServiceEntryBuilder> predicate) {
      for (ServiceEntryBuilder item : items) {
  ...
  protected void copyInstance(ServiceEntryList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ServiceEntryBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ServiceEntryListFluent that = (ServiceEntryListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ServiceEntryBuilder> predicate) {
    ...
    Iterator<ServiceEntryBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,ServiceEntry item) {
  ...
  public class ItemsNested<N> extends ServiceEntryFluent<ItemsNested<N>> implements Nested<N>{
  
    ServiceEntryBuilder builder;
    int index;
  
    ItemsNested(int index,ServiceEntry item) {
      this.index = index;
      this.builder = new ServiceEntryBuilder(this, item);
    }
  
    public N and() {
      return (N) ServiceEntryListFluent.this.setToItems(index, builder.build());
    }
