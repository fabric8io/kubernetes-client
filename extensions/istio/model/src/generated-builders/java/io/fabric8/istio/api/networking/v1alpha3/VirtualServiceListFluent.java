...
public class VirtualServiceListFluent<A extends io.fabric8.istio.api.networking.v1alpha3.VirtualServiceListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<VirtualServiceBuilder> items = new ArrayList<VirtualServiceBuilder>();
  private String kind;
  private ListMeta metadata;

  public VirtualServiceListFluent() {
  }
  
  public VirtualServiceListFluent(VirtualServiceList instance) {
  ...
  public ItemsNested<A> addNewItemLike(VirtualService item) {
  ...
  public VirtualService buildMatchingItem(Predicate<VirtualServiceBuilder> predicate) {
      for (VirtualServiceBuilder item : items) {
  ...
  protected void copyInstance(VirtualServiceList instance) {
    instance = instance != null ? instance : new VirtualServiceList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<VirtualServiceBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    VirtualServiceListFluent that = (VirtualServiceListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<VirtualServiceBuilder> predicate) {
    ...
    Iterator<VirtualServiceBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,VirtualService item) {
  ...
  public class ItemsNested<N> extends VirtualServiceFluent<ItemsNested<N>> implements Nested<N>{
  
    VirtualServiceBuilder builder;
    int index;
  
    ItemsNested(int index,VirtualService item) {
      this.index = index;
      this.builder = new VirtualServiceBuilder(this, item);
    }
  
    public N and() {
      return (N) VirtualServiceListFluent.this.setToItems(index, builder.build());
    }
