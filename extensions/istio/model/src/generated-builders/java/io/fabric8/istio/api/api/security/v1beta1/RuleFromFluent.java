...
public class RuleFromFluent<A extends io.fabric8.istio.api.api.security.v1beta1.RuleFromFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private SourceBuilder source;

  public RuleFromFluent() {
  }
  
  public RuleFromFluent(RuleFrom instance) {
  ...
  protected void copyInstance(RuleFrom instance) {
    instance = instance != null ? instance : new RuleFrom();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    RuleFromFluent that = (RuleFromFluent) o;
  ...
  public class SourceNested<N> extends SourceFluent<SourceNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RuleFromFluent.this.withSource(builder.build());
    }
