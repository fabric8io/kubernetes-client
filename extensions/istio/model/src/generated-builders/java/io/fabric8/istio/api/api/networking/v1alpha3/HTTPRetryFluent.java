...
public class HTTPRetryFluent<A extends io.fabric8.istio.api.api.networking.v1alpha3.HTTPRetryFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(HTTPRetry instance) {
    ...
    if (instance != null) {
        ...
        this.withRetryIgnorePreviousHosts(instance.getRetryIgnorePreviousHosts());
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(retryIgnorePreviousHosts, that.retryIgnorePreviousHosts))) {
      return false;
    }
    if (!(Objects.equals(retryOn, that.retryOn))) {
      return false;
    }
    if (!(Objects.equals(retryRemoteLocalities, that.retryRemoteLocalities))) {
      return false;
    }
  ...
  public Boolean getRetryIgnorePreviousHosts() {
    return this.retryIgnorePreviousHosts;
  }
  ...
  public boolean hasRetryIgnorePreviousHosts() {
    return this.retryIgnorePreviousHosts != null;
  }
  ...
  public int hashCode() {
    return Objects.hash(attempts, backoff, perTryTimeout, retryIgnorePreviousHosts, retryOn, retryRemoteLocalities, additionalProperties);
  }
  ...
  public String toString() {
    ...
    if (!(retryIgnorePreviousHosts == null)) {
        sb.append("retryIgnorePreviousHosts:");
        sb.append(retryIgnorePreviousHosts);
        sb.append(",");
    }
    if (!(retryOn == null)) {
  ...
  public A withPerTryTimeout(String perTryTimeout) {
    this.perTryTimeout = perTryTimeout;
    return (A) this;
  }
  
  public A withRetryIgnorePreviousHosts() {
    return withRetryIgnorePreviousHosts(true);
  }
  
  public A withRetryIgnorePreviousHosts(Boolean retryIgnorePreviousHosts) {
