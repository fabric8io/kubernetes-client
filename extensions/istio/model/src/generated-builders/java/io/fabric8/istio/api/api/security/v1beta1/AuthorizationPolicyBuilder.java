...
public class AuthorizationPolicyBuilder extends AuthorizationPolicyFluent<AuthorizationPolicyBuilder> implements VisitableBuilder<AuthorizationPolicy,AuthorizationPolicyBuilder>{
  ...
  public AuthorizationPolicy build() {
    AuthorizationPolicy buildable = new AuthorizationPolicy(fluent.buildActionDetail(), fluent.getAction(), fluent.buildRules(), fluent.buildSelector(), fluent.buildTargetRef(), fluent.buildTargetRefs());
