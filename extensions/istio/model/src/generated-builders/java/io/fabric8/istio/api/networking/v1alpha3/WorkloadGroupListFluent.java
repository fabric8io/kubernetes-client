...
public class WorkloadGroupListFluent<A extends io.fabric8.istio.api.networking.v1alpha3.WorkloadGroupListFluent<A>> extends BaseFluent<A>{
  ...
  public WorkloadGroupListFluent() {
  }
  
  public WorkloadGroupListFluent(WorkloadGroupList instance) {
  ...
  public ItemsNested<A> addNewItemLike(WorkloadGroup item) {
  ...
  public WorkloadGroup buildMatchingItem(Predicate<WorkloadGroupBuilder> predicate) {
      for (WorkloadGroupBuilder item : items) {
  ...
  protected void copyInstance(WorkloadGroupList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<WorkloadGroupBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    WorkloadGroupListFluent that = (WorkloadGroupListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<WorkloadGroupBuilder> predicate) {
    ...
    Iterator<WorkloadGroupBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,WorkloadGroup item) {
  ...
  public class ItemsNested<N> extends WorkloadGroupFluent<ItemsNested<N>> implements Nested<N>{
  
    WorkloadGroupBuilder builder;
    int index;
  
    ItemsNested(int index,WorkloadGroup item) {
      this.index = index;
      this.builder = new WorkloadGroupBuilder(this, item);
    }
  
    public N and() {
      return (N) WorkloadGroupListFluent.this.setToItems(index, builder.build());
    }
