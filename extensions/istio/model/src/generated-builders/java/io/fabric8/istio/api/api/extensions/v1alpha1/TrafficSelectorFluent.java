...
import io.fabric8.istio.api.api.type.v1beta1.PortSelectorBuilder;
import io.fabric8.istio.api.api.type.v1beta1.PortSelectorFluent;
...
public class TrafficSelectorFluent<A extends io.fabric8.istio.api.api.extensions.v1alpha1.TrafficSelectorFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private Integer mode;
  private ArrayList<PortSelectorBuilder> ports = new ArrayList<PortSelectorBuilder>();

  public TrafficSelectorFluent() {
  }
  
  public TrafficSelectorFluent(TrafficSelector instance) {
  ...
  public A addNewPort(Long number) {
    return (A) this.addToPorts(new PortSelector(number));
  }
  ...
  public PortSelector buildMatchingPort(Predicate<PortSelectorBuilder> predicate) {
      for (PortSelectorBuilder item : ports) {
  ...
  protected void copyInstance(TrafficSelector instance) {
    instance = instance != null ? instance : new TrafficSelector();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    TrafficSelectorFluent that = (TrafficSelectorFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(mode, ports, additionalProperties);
  }
  ...
  public A removeMatchingFromPorts(Predicate<PortSelectorBuilder> predicate) {
    if (ports == null) {
      return (A) this;
    }
    Iterator<PortSelectorBuilder> each = ports.iterator();
  ...
  public class PortsNested<N> extends PortSelectorFluent<PortsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TrafficSelectorFluent.this.setToPorts(index, builder.build());
    }
