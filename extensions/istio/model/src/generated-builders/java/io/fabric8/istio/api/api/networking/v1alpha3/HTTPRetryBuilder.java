...
public class HTTPRetryBuilder extends HTTPRetryFluent<HTTPRetryBuilder> implements VisitableBuilder<HTTPRetry,HTTPRetryBuilder>{
  ...
  public HTTPRetry build() {
    HTTPRetry buildable = new HTTPRetry(fluent.getAttempts(), fluent.getBackoff(), fluent.getPerTryTimeout(), fluent.getRetryIgnorePreviousHosts(), fluent.getRetryOn(), fluent.getRetryRemoteLocalities());
