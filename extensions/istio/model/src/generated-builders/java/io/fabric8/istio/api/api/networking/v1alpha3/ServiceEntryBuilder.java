...
public class ServiceEntryBuilder extends ServiceEntryFluent<ServiceEntryBuilder> implements VisitableBuilder<ServiceEntry,ServiceEntryBuilder>{
  ...
  public ServiceEntry build() {
    ServiceEntry buildable = new ServiceEntry(fluent.getAddresses(), fluent.buildEndpoints(), fluent.getExportTo(), fluent.getHosts(), fluent.getLocation(), fluent.buildPorts(), fluent.getResolution(), fluent.getSubjectAltNames(), fluent.buildWorkloadSelector());
