...
public class WasmPluginTrafficSelectorFluent<A extends io.fabric8.istio.api.api.extensions.v1alpha1.WasmPluginTrafficSelectorFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(WasmPluginTrafficSelector instance) {
    instance = instance != null ? instance : new WasmPluginTrafficSelector();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    WasmPluginTrafficSelectorFluent that = (WasmPluginTrafficSelectorFluent) o;
  ...
  public class PortsNested<N> extends PortSelectorFluent<PortsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WasmPluginTrafficSelectorFluent.this.setToPorts(index, builder.build());
    }
