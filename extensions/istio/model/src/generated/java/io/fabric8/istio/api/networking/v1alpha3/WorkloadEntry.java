...
public class WorkloadEntry implements Editable<WorkloadEntryBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "WorkloadEntry(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
