...
public class ReadinessProbeTcpSocket implements IsReadinessProbeHealthCheckMethod, Editable<ReadinessProbeTcpSocketBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReadinessProbeTcpSocket)) {
            return false;
        }
        ReadinessProbeTcpSocket other = (ReadinessProbeTcpSocket) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ReadinessProbeTcpSocket;
    }
    ...
    public String toString() {
        return "ReadinessProbeTcpSocket(" + "tcpSocket=" + this.getTcpSocket() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
