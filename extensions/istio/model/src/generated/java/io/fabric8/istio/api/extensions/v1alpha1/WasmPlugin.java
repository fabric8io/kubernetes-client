...
public class WasmPlugin implements Editable<WasmPluginBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "WasmPlugin(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
