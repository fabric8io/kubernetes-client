...
public class HTTPFaultInjectionAbortGrpcStatus implements IsHTTPFaultInjectionAbortErrorType, Editable<HTTPFaultInjectionAbortGrpcStatusBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HTTPFaultInjectionAbortGrpcStatus)) {
            return false;
        }
        HTTPFaultInjectionAbortGrpcStatus other = (HTTPFaultInjectionAbortGrpcStatus) o;
        if (!other.canEqual(this)) {
            return false;
        }
        Object this$grpcStatus = this.getGrpcStatus();
        Object other$grpcStatus = other.getGrpcStatus();
        if (this$grpcStatus == null ? other$grpcStatus != null : !this$grpcStatus.equals(other$grpcStatus)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HTTPFaultInjectionAbortGrpcStatus;
    }
    ...
    public int hashCode() {
        final int prime = 59;
        int result = 1;
        Object $grpcStatus = this.getGrpcStatus();
        result = result * prime + ($grpcStatus == null ? 43 : $grpcStatus.hashCode());
    ...
    public String toString() {
        return "HTTPFaultInjectionAbortGrpcStatus(" + "grpcStatus=" + this.getGrpcStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
