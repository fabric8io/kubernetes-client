...
public class HTTPRedirectPort implements IsHTTPRedirectRedirectPort, Editable<HTTPRedirectPortBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HTTPRedirectPort)) {
            return false;
        }
        HTTPRedirectPort other = (HTTPRedirectPort) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HTTPRedirectPort;
    }
    ...
    public String toString() {
        return "HTTPRedirectPort(" + "port=" + this.getPort() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
