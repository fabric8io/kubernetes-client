...
public class VirtualService implements Editable<VirtualServiceBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "VirtualService(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
