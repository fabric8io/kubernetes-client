...
public class MetricsOverridesTagOverride implements Editable<MetricsOverridesTagOverrideBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MetricsOverridesTagOverride)) {
            return false;
        }
        MetricsOverridesTagOverride other = (MetricsOverridesTagOverride) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MetricsOverridesTagOverride;
    }
    ...
    public String toString() {
        return "MetricsOverridesTagOverride(" + "operation=" + this.getOperation() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
