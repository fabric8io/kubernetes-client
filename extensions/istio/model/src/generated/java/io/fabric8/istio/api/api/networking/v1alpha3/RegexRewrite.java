...
public class RegexRewrite implements Editable<RegexRewriteBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RegexRewrite)) {
            return false;
        }
        RegexRewrite other = (RegexRewrite) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RegexRewrite;
    }
    ...
    public String toString() {
        return "RegexRewrite(" + "match=" + this.getMatch() + ", rewrite=" + this.getRewrite() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
