...
public class ServicePort implements Editable<ServicePortBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "ServicePort(" + "name=" + this.getName() + ", number=" + this.getNumber() + ", protocol=" + this.getProtocol() + ", targetPort=" + this.getTargetPort() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
