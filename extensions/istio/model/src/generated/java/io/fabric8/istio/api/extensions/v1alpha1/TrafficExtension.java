...
public class TrafficExtension implements Editable<TrafficExtensionBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "TrafficExtension(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
