...
public class TrafficExtensionLua implements IsTrafficExtensionFilterConfig, Editable<TrafficExtensionLuaBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TrafficExtensionLua)) {
            return false;
        }
        TrafficExtensionLua other = (TrafficExtensionLua) o;
        if (!other.canEqual(this)) {
            return false;
        }
        Object this$lua = this.getLua();
        Object other$lua = other.getLua();
        if (this$lua == null ? other$lua != null : !this$lua.equals(other$lua)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof TrafficExtensionLua;
    }
    ...
    public int hashCode() {
        final int prime = 59;
        int result = 1;
        Object $lua = this.getLua();
        result = result * prime + ($lua == null ? 43 : $lua.hashCode());
    ...
    public String toString() {
        return "TrafficExtensionLua(" + "lua=" + this.getLua() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
