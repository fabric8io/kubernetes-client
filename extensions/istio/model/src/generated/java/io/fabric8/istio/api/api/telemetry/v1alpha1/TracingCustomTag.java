...
public class TracingCustomTag implements Editable<TracingCustomTagBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TracingCustomTag)) {
            return false;
        }
        TracingCustomTag other = (TracingCustomTag) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof TracingCustomTag;
    }
    ...
    public String toString() {
        return "TracingCustomTag(" + "type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
