...
public class DestinationRule implements Editable<DestinationRuleBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "DestinationRule(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
