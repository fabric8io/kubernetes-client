...
public class IstioCondition implements Editable<IstioConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IstioCondition)) {
            return false;
        }
        IstioCondition other = (IstioCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IstioCondition;
    }
    ...
    public String toString() {
        return "IstioCondition(" + "lastProbeTime=" + this.getLastProbeTime() + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", observedGeneration=" + this.getObservedGeneration() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
