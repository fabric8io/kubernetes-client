...
public class TracingCustomTagEnvironment implements IsTracingCustomTagType, Editable<TracingCustomTagEnvironmentBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TracingCustomTagEnvironment)) {
            return false;
        }
        TracingCustomTagEnvironment other = (TracingCustomTagEnvironment) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof TracingCustomTagEnvironment;
    }
    ...
    public String toString() {
        return "TracingCustomTagEnvironment(" + "environment=" + this.getEnvironment() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
