...
public class WorkloadGroup implements Editable<WorkloadGroupBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "WorkloadGroup(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
