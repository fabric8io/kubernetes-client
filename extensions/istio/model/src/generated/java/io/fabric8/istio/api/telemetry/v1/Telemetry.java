...
public class Telemetry implements Editable<TelemetryBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Telemetry(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
