...
public class AuthorizationPolicy implements Editable<AuthorizationPolicyBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "AuthorizationPolicy(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
