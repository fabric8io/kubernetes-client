...
public class EnvoyFilterListenerMatchFilterMatch implements Editable<EnvoyFilterListenerMatchFilterMatchBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnvoyFilterListenerMatchFilterMatch)) {
            return false;
        }
        EnvoyFilterListenerMatchFilterMatch other = (EnvoyFilterListenerMatchFilterMatch) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EnvoyFilterListenerMatchFilterMatch;
    }
    ...
    public String toString() {
        return "EnvoyFilterListenerMatchFilterMatch(" + "name=" + this.getName() + ", subFilter=" + this.getSubFilter() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
