...
public class AccessLoggingFilter implements Editable<AccessLoggingFilterBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AccessLoggingFilter)) {
            return false;
        }
        AccessLoggingFilter other = (AccessLoggingFilter) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AccessLoggingFilter;
    }
    ...
    public String toString() {
        return "AccessLoggingFilter(" + "expression=" + this.getExpression() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
