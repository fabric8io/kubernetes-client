...
public class ServiceEntry implements Editable<ServiceEntryBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "ServiceEntry(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
