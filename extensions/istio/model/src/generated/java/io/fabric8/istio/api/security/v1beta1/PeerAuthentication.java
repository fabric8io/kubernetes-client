...
public class PeerAuthentication implements Editable<PeerAuthenticationBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "PeerAuthentication(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
