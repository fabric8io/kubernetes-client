...
public class LoadBalancerSettingsConsistentHashLBHTTPCookieAttribute implements Editable<LoadBalancerSettingsConsistentHashLBHTTPCookieAttributeBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LoadBalancerSettingsConsistentHashLBHTTPCookieAttribute)) {
            return false;
        }
        LoadBalancerSettingsConsistentHashLBHTTPCookieAttribute other = (LoadBalancerSettingsConsistentHashLBHTTPCookieAttribute) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LoadBalancerSettingsConsistentHashLBHTTPCookieAttribute;
    }
    ...
    public String toString() {
        return "LoadBalancerSettingsConsistentHashLBHTTPCookieAttribute(" + "name=" + this.getName() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
