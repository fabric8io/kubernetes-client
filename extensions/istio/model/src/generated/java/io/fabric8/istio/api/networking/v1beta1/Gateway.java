...
public class Gateway implements Editable<GatewayBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Gateway(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
