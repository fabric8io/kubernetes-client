...
public class Pod implements Editable<PodBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Pod(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
