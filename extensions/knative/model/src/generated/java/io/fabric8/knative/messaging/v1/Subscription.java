...
public class Subscription implements Editable<SubscriptionBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Subscription(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
