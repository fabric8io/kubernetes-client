...
public class EventType implements Editable<EventTypeBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "EventType(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
