...
public class DomainMapping implements HasMetadata, Namespaced
{
    ...
    public DomainMapping(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, DomainMappingSpec spec, DomainMappingStatus status) {
        super();
