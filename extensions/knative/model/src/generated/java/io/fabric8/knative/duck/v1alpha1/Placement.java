...
public class Placement implements Editable<PlacementBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        Object this$vreplicas = this.getVreplicas();
        Object other$vreplicas = other.getVreplicas();
        if (this$vreplicas == null ? other$vreplicas != null : !this$vreplicas.equals(other$vreplicas)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        Object $vreplicas = this.getVreplicas();
        result = result * prime + ($vreplicas == null ? 43 : $vreplicas.hashCode());
    ...
    public String toString() {
        return "Placement(" + "podName=" + this.getPodName() + ", vreplicas=" + this.getVreplicas() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
