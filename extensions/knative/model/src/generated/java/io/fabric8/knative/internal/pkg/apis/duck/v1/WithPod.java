...
public class WithPod implements Editable<WithPodBuilder> , HasMetadata
{
    ...
    public WithPod(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, WithPodSpec spec) {
        super();
