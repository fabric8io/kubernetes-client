...
public class SecretValueFromSource implements Editable<SecretValueFromSourceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecretValueFromSource)) {
            return false;
        }
        SecretValueFromSource other = (SecretValueFromSource) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SecretValueFromSource;
    }
    ...
    public String toString() {
        return "SecretValueFromSource(" + "secretKeyRef=" + this.getSecretKeyRef() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
