...
public class Metric implements Editable<MetricBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Metric(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
