...
public class SequenceChannelStatus implements Editable<SequenceChannelStatusBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SequenceChannelStatus)) {
            return false;
        }
        SequenceChannelStatus other = (SequenceChannelStatus) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SequenceChannelStatus;
    }
    ...
    public String toString() {
        return "SequenceChannelStatus(" + "channel=" + this.getChannel() + ", ready=" + this.getReady() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
