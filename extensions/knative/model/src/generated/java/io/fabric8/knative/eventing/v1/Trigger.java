...
public class Trigger implements Editable<TriggerBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Trigger(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
