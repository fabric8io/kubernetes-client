...
public class Trigger implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public Trigger(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, TriggerSpec spec, TriggerStatus status) {
        super();
