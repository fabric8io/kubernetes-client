...
public class SecretTLS implements Editable<SecretTLSBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecretTLS)) {
            return false;
        }
        SecretTLS other = (SecretTLS) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SecretTLS;
    }
    ...
    public String toString() {
        return "SecretTLS(" + "secretName=" + this.getSecretName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
