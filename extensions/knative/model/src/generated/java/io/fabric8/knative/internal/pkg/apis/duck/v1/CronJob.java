...
public class CronJob implements Editable<CronJobBuilder> , HasMetadata
{
    ...
    public CronJob(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, CronJobSpec spec) {
        super();
