...
public class PodSpecable implements Editable<PodSpecableBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodSpecable)) {
            return false;
        }
        PodSpecable other = (PodSpecable) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PodSpecable;
    }
    ...
    public String toString() {
        return "PodSpecable(" + "metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
