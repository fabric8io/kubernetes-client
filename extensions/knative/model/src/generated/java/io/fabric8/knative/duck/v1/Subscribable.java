...
public class Subscribable implements Editable<SubscribableBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Subscribable)) {
            return false;
        }
        Subscribable other = (Subscribable) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Subscribable;
    }
    ...
    public String toString() {
        return "Subscribable(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
