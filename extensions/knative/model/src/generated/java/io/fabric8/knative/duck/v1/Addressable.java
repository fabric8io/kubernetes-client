...
public class Addressable implements Editable<AddressableBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "Addressable(" + "cACerts=" + this.getCACerts() + ", audience=" + this.getAudience() + ", name=" + this.getName() + ", url=" + this.getUrl() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
