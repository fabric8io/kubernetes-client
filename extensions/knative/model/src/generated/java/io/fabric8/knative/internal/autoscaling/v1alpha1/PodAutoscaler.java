...
public class PodAutoscaler implements HasMetadata, Namespaced
{
    ...
    public PodAutoscaler(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, PodAutoscalerSpec spec, PodAutoscalerStatus status) {
        super();
