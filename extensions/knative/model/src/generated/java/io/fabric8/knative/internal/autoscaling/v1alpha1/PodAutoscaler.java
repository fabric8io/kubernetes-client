...
public class PodAutoscaler implements Editable<PodAutoscalerBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodAutoscaler)) {
            return false;
        }
        PodAutoscaler other = (PodAutoscaler) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PodAutoscaler;
    }
    ...
    public String toString() {
        return "PodAutoscaler(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
