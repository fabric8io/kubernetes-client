...
public class PodScalableStatus implements Editable<PodScalableStatusBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodScalableStatus)) {
            return false;
        }
        PodScalableStatus other = (PodScalableStatus) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PodScalableStatus;
    }
    ...
    public String toString() {
        return "PodScalableStatus(" + "replicas=" + this.getReplicas() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
