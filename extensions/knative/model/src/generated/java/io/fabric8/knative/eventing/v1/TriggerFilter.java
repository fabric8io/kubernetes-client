...
public class TriggerFilter implements Editable<TriggerFilterBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TriggerFilter)) {
            return false;
        }
        TriggerFilter other = (TriggerFilter) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof TriggerFilter;
    }
    ...
    public String toString() {
        return "TriggerFilter(" + "attributes=" + this.getAttributes() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
