...
public class Broker implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public Broker(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, BrokerSpec spec, BrokerStatus status) {
        super();
