...
public class Reference implements Editable<ReferenceBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "Reference(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", selector=" + this.getSelector() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
