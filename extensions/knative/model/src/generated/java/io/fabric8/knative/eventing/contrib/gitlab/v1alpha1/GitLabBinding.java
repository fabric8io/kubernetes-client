...
public class GitLabBinding implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public GitLabBinding(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, GitLabBindingSpec spec, GitLabBindingStatus status) {
        super();
