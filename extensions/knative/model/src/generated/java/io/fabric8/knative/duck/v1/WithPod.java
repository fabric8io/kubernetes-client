...
public class WithPod implements Editable<WithPodBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WithPod)) {
            return false;
        }
        WithPod other = (WithPod) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof WithPod;
    }
    ...
    public String toString() {
        return "WithPod(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
