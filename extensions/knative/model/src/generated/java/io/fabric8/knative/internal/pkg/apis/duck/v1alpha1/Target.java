...
public class Target implements Editable<TargetBuilder> , HasMetadata
{
    ...
    public Target(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, TargetStatus status) {
        super();
