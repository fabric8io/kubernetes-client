...
public class EventPolicyFromReference implements Editable<EventPolicyFromReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EventPolicyFromReference)) {
            return false;
        }
        EventPolicyFromReference other = (EventPolicyFromReference) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EventPolicyFromReference;
    }
    ...
    public String toString() {
        return "EventPolicyFromReference(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
