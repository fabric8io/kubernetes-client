...
public class Sequence implements Editable<SequenceBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Sequence(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
