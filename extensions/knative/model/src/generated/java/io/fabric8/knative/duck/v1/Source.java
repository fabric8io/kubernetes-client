...
public class Source implements Editable<SourceBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Source(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
