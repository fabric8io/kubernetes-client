...
public class BrokerSpec implements Editable<BrokerSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BrokerSpec)) {
            return false;
        }
        BrokerSpec other = (BrokerSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof BrokerSpec;
    }
    ...
    public String toString() {
        return "BrokerSpec(" + "config=" + this.getConfig() + ", delivery=" + this.getDelivery() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
