...
public class KafkaSource implements Editable<KafkaSourceBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "KafkaSource(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
