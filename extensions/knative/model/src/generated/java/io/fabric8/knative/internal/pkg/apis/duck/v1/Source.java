...
public class Source implements Editable<SourceBuilder> , HasMetadata
{
    ...
    public Source(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, SourceSpec spec, SourceStatus status) {
        super();
