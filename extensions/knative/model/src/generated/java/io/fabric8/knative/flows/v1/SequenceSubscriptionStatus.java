...
public class SequenceSubscriptionStatus implements KubernetesResource
{
     ...
     * @param subscription
     */
    public SequenceSubscriptionStatus(Condition ready, io.fabric8.kubernetes.api.model.ObjectReference subscription) {
        super();
        this.ready = ready;
