...
public class KafkaBinding implements Editable<KafkaBindingBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KafkaBinding)) {
            return false;
        }
        KafkaBinding other = (KafkaBinding) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof KafkaBinding;
    }
    ...
    public String toString() {
        return "KafkaBinding(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
