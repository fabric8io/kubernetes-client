...
public class Channelable implements Editable<ChannelableBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Channelable)) {
            return false;
        }
        Channelable other = (Channelable) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Channelable;
    }
    ...
    public String toString() {
        return "Channelable(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
