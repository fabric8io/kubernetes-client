...
public class Target implements Editable<TargetBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Target(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
