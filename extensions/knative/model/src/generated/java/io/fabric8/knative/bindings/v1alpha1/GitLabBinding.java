...
public class GitLabBinding implements Editable<GitLabBindingBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GitLabBinding)) {
            return false;
        }
        GitLabBinding other = (GitLabBinding) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GitLabBinding;
    }
    ...
    public String toString() {
        return "GitLabBinding(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
