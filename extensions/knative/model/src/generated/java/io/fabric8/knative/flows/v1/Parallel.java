...
public class Parallel implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public Parallel(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, ParallelSpec spec, ParallelStatus status) {
        super();
