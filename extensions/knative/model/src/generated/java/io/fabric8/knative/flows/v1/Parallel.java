...
public class Parallel implements Editable<ParallelBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Parallel(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
