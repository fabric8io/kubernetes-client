...
public class ClusterDomainClaimSpec implements Editable<ClusterDomainClaimSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterDomainClaimSpec)) {
            return false;
        }
        ClusterDomainClaimSpec other = (ClusterDomainClaimSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClusterDomainClaimSpec;
    }
    ...
    public String toString() {
        return "ClusterDomainClaimSpec(" + "namespace=" + this.getNamespace() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
