...
public class ApiServerSource implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public ApiServerSource(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, ApiServerSourceSpec spec, ApiServerSourceStatus status) {
        super();
