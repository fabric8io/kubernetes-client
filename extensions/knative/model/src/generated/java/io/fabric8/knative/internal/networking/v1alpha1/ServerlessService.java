...
public class ServerlessService implements Editable<ServerlessServiceBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ServerlessService)) {
            return false;
        }
        ServerlessService other = (ServerlessService) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ServerlessService;
    }
    ...
    public String toString() {
        return "ServerlessService(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
