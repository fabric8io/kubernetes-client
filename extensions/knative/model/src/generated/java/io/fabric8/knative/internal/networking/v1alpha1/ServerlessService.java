...
public class ServerlessService implements HasMetadata, Namespaced
{
    ...
    public ServerlessService(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, ServerlessServiceSpec spec, ServerlessServiceStatus status) {
        super();
