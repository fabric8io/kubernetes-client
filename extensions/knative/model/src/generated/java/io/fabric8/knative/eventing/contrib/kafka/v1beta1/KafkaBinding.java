...
public class KafkaBinding implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public KafkaBinding(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, KafkaBindingSpec spec, KafkaBindingStatus status) {
        super();
