...
public class ParallelSubscriptionStatus implements Editable<ParallelSubscriptionStatusBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ParallelSubscriptionStatus)) {
            return false;
        }
        ParallelSubscriptionStatus other = (ParallelSubscriptionStatus) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ParallelSubscriptionStatus;
    }
    ...
    public String toString() {
        return "ParallelSubscriptionStatus(" + "ready=" + this.getReady() + ", subscription=" + this.getSubscription() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
