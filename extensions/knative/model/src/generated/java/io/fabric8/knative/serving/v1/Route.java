...
public class Route implements Editable<RouteBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Route(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
