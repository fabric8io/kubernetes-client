...
public class EventAttributeDefinition implements Editable<EventAttributeDefinitionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EventAttributeDefinition)) {
            return false;
        }
        EventAttributeDefinition other = (EventAttributeDefinition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EventAttributeDefinition;
    }
    ...
    public String toString() {
        return "EventAttributeDefinition(" + "name=" + this.getName() + ", required=" + this.getRequired() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
