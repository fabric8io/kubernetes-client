...
public class LegacyTarget implements Editable<LegacyTargetBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LegacyTarget)) {
            return false;
        }
        LegacyTarget other = (LegacyTarget) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LegacyTarget;
    }
    ...
    public String toString() {
        return "LegacyTarget(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
