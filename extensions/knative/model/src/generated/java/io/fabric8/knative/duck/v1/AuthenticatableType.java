...
public class AuthenticatableType implements Editable<AuthenticatableTypeBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AuthenticatableType)) {
            return false;
        }
        AuthenticatableType other = (AuthenticatableType) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AuthenticatableType;
    }
    ...
    public String toString() {
        return "AuthenticatableType(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
