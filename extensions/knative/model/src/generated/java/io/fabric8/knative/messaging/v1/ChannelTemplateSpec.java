...
public class ChannelTemplateSpec implements Editable<ChannelTemplateSpecBuilder>, KubernetesResource, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChannelTemplateSpec)) {
            return false;
        }
        ChannelTemplateSpec other = (ChannelTemplateSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ChannelTemplateSpec;
    }
    ...
    public String toString() {
        return "ChannelTemplateSpec(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
