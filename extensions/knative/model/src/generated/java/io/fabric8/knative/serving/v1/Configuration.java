...
public class Configuration implements Editable<ConfigurationBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Configuration(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
