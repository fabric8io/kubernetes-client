...
public class Configuration implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public Configuration(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, ConfigurationSpec spec, ConfigurationStatus status) {
        super();
