...
public class Revision implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public Revision(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, RevisionSpec spec, RevisionStatus status) {
        super();
