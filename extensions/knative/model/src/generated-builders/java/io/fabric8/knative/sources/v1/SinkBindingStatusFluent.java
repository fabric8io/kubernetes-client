...
public class SinkBindingStatusFluent<A extends io.fabric8.knative.sources.v1.SinkBindingStatusFluent<A>> extends BaseFluent<A>{
  ...
  public SinkBindingStatusFluent() {
  }
  
  public SinkBindingStatusFluent(SinkBindingStatus instance) {
  ...
  protected void copyInstance(SinkBindingStatus instance) {
    ...
    if (instance != null) {
        ...
        this.withOidcTokenSecretName(instance.getOidcTokenSecretName());
  ...
  public boolean equals(Object o) {
    ...
    SinkBindingStatusFluent that = (SinkBindingStatusFluent) o;
    ...
    if (!(Objects.equals(oidcTokenSecretName, that.oidcTokenSecretName))) {
      return false;
    }
  ...
  public String getOidcTokenSecretName() {
    return this.oidcTokenSecretName;
  }
  ...
  public boolean hasOidcTokenSecretName() {
    return this.oidcTokenSecretName != null;
  }
  ...
  public int hashCode() {
    return Objects.hash(annotations, auth, ceAttributes, conditions, observedGeneration, oidcTokenSecretName, sinkAudience, sinkCACerts, sinkUri, additionalProperties);
  }
  ...
  public String toString() {
    ...
    if (!(oidcTokenSecretName == null)) {
        sb.append("oidcTokenSecretName:");
        sb.append(oidcTokenSecretName);
        sb.append(",");
    }
  ...
  public A withOidcTokenSecretName(String oidcTokenSecretName) {
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SinkBindingStatusFluent.this.withAuth(builder.build());
    }
  ...
  public class CeAttributesNested<N> extends CloudEventAttributesFluent<CeAttributesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SinkBindingStatusFluent.this.setToCeAttributes(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SinkBindingStatusFluent.this.setToConditions(index, builder.build());
    }
