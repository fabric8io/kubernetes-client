...
public class ContainerSourceListFluent<A extends io.fabric8.knative.sources.v1.ContainerSourceListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ContainerSourceBuilder> items = new ArrayList<ContainerSourceBuilder>();
  private String kind;
  ...
  public ContainerSource buildMatchingItem(Predicate<ContainerSourceBuilder> predicate) {
      for (ContainerSourceBuilder item : items) {
  ...
  protected void copyInstance(ContainerSourceList instance) {
    instance = instance != null ? instance : new ContainerSourceList();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ContainerSourceListFluent that = (ContainerSourceListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ContainerSourceBuilder> predicate) {
    ...
    Iterator<ContainerSourceBuilder> each = items.iterator();
  ...
  public class ItemsNested<N> extends ContainerSourceFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainerSourceListFluent.this.setToItems(index, builder.build());
    }
