...
public class ChannelableStatusBuilder extends ChannelableStatusFluent<ChannelableStatusBuilder> implements VisitableBuilder<ChannelableStatus,ChannelableStatusBuilder>{
  ...
  public ChannelableStatus build() {
    ChannelableStatus buildable = new ChannelableStatus(fluent.buildAddress(), fluent.buildAddresses(), fluent.getAnnotations(), fluent.buildConditions(), fluent.buildDeadLetterChannel(), fluent.getObservedGeneration(), fluent.buildSubscribers());
