...
public class IntegrationSourceStatusFluent<A extends io.fabric8.knative.sources.v1alpha1.IntegrationSourceStatusFluent<A>> extends BaseFluent<A>{
  ...
  public IntegrationSourceStatusFluent() {
  }
  
  public IntegrationSourceStatusFluent(IntegrationSourceStatus instance) {
  ...
  protected void copyInstance(IntegrationSourceStatus instance) {
    instance = instance != null ? instance : new IntegrationSourceStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    IntegrationSourceStatusFluent that = (IntegrationSourceStatusFluent) o;
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IntegrationSourceStatusFluent.this.withAuth(builder.build());
    }
  ...
  public class CeAttributesNested<N> extends CloudEventAttributesFluent<CeAttributesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IntegrationSourceStatusFluent.this.setToCeAttributes(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IntegrationSourceStatusFluent.this.setToConditions(index, builder.build());
    }
