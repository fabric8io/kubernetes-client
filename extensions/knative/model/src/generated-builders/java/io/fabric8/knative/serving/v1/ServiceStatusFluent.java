...
public class ServiceStatusFluent<A extends io.fabric8.knative.serving.v1.ServiceStatusFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(address, annotations, conditions, latestCreatedRevisionName, latestReadyRevisionName, observedGeneration, traffic, url, additionalProperties);
  }
  ...
  public class AddressNested<N> extends AddressableFluent<AddressNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceStatusFluent.this.withAddress(builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class TrafficNested<N> extends TrafficTargetFluent<TrafficNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceStatusFluent.this.setToTraffic(index, builder.build());
    }
