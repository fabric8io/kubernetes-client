...
public class ContainerStatusFluent<A extends io.fabric8.knative.serving.v1.ContainerStatusFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(imageDigest, name, additionalProperties);
  }
