...
public class MetricStatusFluent<A extends io.fabric8.knative.internal.autoscaling.v1alpha1.MetricStatusFluent<A>> extends BaseFluent<A>{
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) MetricStatusFluent.this.setToConditions(index, builder.build());
    }
