...
public class AWSCommonFluent<A extends io.fabric8.knative.eventing.pkg.apis.common.integration.v1alpha1.AWSCommonFluent<A>> extends BaseFluent<A>{
  ...
  public AWSCommonFluent() {
  }
  
  public AWSCommonFluent(AWSCommon instance) {
  ...
  protected void copyInstance(AWSCommon instance) {
    instance = instance != null ? instance : new AWSCommon();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    AWSCommonFluent that = (AWSCommonFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(overrideEndpoint, region, uriEndpointOverride, additionalProperties);
  }
