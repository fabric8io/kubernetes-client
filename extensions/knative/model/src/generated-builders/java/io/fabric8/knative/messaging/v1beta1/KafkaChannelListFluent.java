...
public class KafkaChannelListFluent<A extends io.fabric8.knative.messaging.v1beta1.KafkaChannelListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<KafkaChannelBuilder> items = new ArrayList<KafkaChannelBuilder>();
  private String kind;
  private ListMeta metadata;

  public KafkaChannelListFluent() {
  }
  
  public KafkaChannelListFluent(KafkaChannelList instance) {
  ...
  public A addAllToItems(Collection<KafkaChannel> items) {
    ...
    for (KafkaChannel item : items) {
        KafkaChannelBuilder builder = new KafkaChannelBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(KafkaChannel item) {
  ...
  public KafkaChannel buildMatchingItem(Predicate<KafkaChannelBuilder> predicate) {
      for (KafkaChannelBuilder item : items) {
  ...
  protected void copyInstance(KafkaChannelList instance) {
    instance = instance != null ? instance : new KafkaChannelList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<KafkaChannelBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    KafkaChannelListFluent that = (KafkaChannelListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<KafkaChannelBuilder> predicate) {
    ...
    Iterator<KafkaChannelBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        KafkaChannelBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,KafkaChannel item) {
  ...
  public class ItemsNested<N> extends KafkaChannelFluent<ItemsNested<N>> implements Nested<N>{
  
    KafkaChannelBuilder builder;
    int index;
  
    ItemsNested(int index,KafkaChannel item) {
      this.index = index;
      this.builder = new KafkaChannelBuilder(this, item);
    }
  
    public N and() {
      return (N) KafkaChannelListFluent.this.setToItems(index, builder.build());
    }
