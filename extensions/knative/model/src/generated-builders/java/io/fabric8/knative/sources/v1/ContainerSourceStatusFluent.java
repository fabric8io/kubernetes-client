...
public class ContainerSourceStatusFluent<A extends io.fabric8.knative.sources.v1.ContainerSourceStatusFluent<A>> extends BaseFluent<A>{
  ...
  public ContainerSourceStatusFluent() {
  }
  
  public ContainerSourceStatusFluent(ContainerSourceStatus instance) {
  ...
  protected void copyInstance(ContainerSourceStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    ContainerSourceStatusFluent that = (ContainerSourceStatusFluent) o;
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainerSourceStatusFluent.this.withAuth(builder.build());
    }
  ...
  public class CeAttributesNested<N> extends CloudEventAttributesFluent<CeAttributesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainerSourceStatusFluent.this.setToCeAttributes(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainerSourceStatusFluent.this.setToConditions(index, builder.build());
    }
