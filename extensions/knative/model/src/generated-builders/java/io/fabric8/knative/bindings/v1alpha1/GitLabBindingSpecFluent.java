...
public class GitLabBindingSpecFluent<A extends io.fabric8.knative.bindings.v1alpha1.GitLabBindingSpecFluent<A>> extends BaseFluent<A>{

  private SecretValueFromSourceBuilder accessToken;
  private Map<String,Object> additionalProperties;
  private ReferenceBuilder subject;

  public GitLabBindingSpecFluent() {
  }
  
  public GitLabBindingSpecFluent(GitLabBindingSpec instance) {
  ...
  protected void copyInstance(GitLabBindingSpec instance) {
    instance = instance != null ? instance : new GitLabBindingSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    GitLabBindingSpecFluent that = (GitLabBindingSpecFluent) o;
  ...
  public class AccessTokenNested<N> extends SecretValueFromSourceFluent<AccessTokenNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitLabBindingSpecFluent.this.withAccessToken(builder.build());
    }
  ...
  public class SubjectNested<N> extends ReferenceFluent<SubjectNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitLabBindingSpecFluent.this.withSubject(builder.build());
    }
