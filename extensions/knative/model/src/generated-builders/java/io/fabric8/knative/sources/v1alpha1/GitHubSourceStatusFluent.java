...
public class GitHubSourceStatusFluent<A extends io.fabric8.knative.sources.v1alpha1.GitHubSourceStatusFluent<A>> extends BaseFluent<A>{
  ...
  public GitHubSourceStatusFluent() {
  }
  
  public GitHubSourceStatusFluent(GitHubSourceStatus instance) {
  ...
  protected void copyInstance(GitHubSourceStatus instance) {
    instance = instance != null ? instance : new GitHubSourceStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    GitHubSourceStatusFluent that = (GitHubSourceStatusFluent) o;
    ...
    if (!(Objects.equals(webhookIDKey, that.webhookIDKey))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(annotations, auth, ceAttributes, conditions, observedGeneration, sinkAudience, sinkCACerts, sinkUri, webhookIDKey, additionalProperties);
  }
  ...
  public String toString() {
    ...
    if (!(webhookIDKey == null)) {
        sb.append("webhookIDKey:");
        sb.append(webhookIDKey);
        sb.append(",");
    }
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitHubSourceStatusFluent.this.withAuth(builder.build());
    }
  ...
  public class CeAttributesNested<N> extends CloudEventAttributesFluent<CeAttributesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitHubSourceStatusFluent.this.setToCeAttributes(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitHubSourceStatusFluent.this.setToConditions(index, builder.build());
    }
