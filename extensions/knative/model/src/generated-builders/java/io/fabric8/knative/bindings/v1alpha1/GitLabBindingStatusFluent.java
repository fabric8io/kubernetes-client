...
public class GitLabBindingStatusFluent<A extends io.fabric8.knative.bindings.v1alpha1.GitLabBindingStatusFluent<A>> extends BaseFluent<A>{
  ...
  public GitLabBindingStatusFluent() {
  }
  
  public GitLabBindingStatusFluent(GitLabBindingStatus instance) {
  ...
  protected void copyInstance(GitLabBindingStatus instance) {
    instance = instance != null ? instance : new GitLabBindingStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    GitLabBindingStatusFluent that = (GitLabBindingStatusFluent) o;
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitLabBindingStatusFluent.this.withAuth(builder.build());
    }
  ...
  public class CeAttributesNested<N> extends CloudEventAttributesFluent<CeAttributesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitLabBindingStatusFluent.this.setToCeAttributes(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitLabBindingStatusFluent.this.setToConditions(index, builder.build());
    }
