...
public class ChannelableStatusFluent<A extends io.fabric8.knative.duck.v1.ChannelableStatusFluent<A>> extends BaseFluent<A>{
  ...
  public class PoliciesNested<N> extends AppliedEventPolicyRefFluent<PoliciesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChannelableStatusFluent.this.setToPolicies(index, builder.build());
    }
