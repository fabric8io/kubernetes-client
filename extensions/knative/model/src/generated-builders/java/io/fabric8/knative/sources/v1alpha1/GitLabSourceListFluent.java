...
public class GitLabSourceListFluent<A extends io.fabric8.knative.sources.v1alpha1.GitLabSourceListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<GitLabSourceBuilder> items = new ArrayList<GitLabSourceBuilder>();
  private String kind;
  private ListMeta metadata;

  public GitLabSourceListFluent() {
  }
  
  public GitLabSourceListFluent(GitLabSourceList instance) {
  ...
  public A addAllToItems(Collection<GitLabSource> items) {
    ...
    for (GitLabSource item : items) {
        GitLabSourceBuilder builder = new GitLabSourceBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(GitLabSource item) {
  ...
  public GitLabSource buildMatchingItem(Predicate<GitLabSourceBuilder> predicate) {
      for (GitLabSourceBuilder item : items) {
  ...
  protected void copyInstance(GitLabSourceList instance) {
    instance = instance != null ? instance : new GitLabSourceList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<GitLabSourceBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    GitLabSourceListFluent that = (GitLabSourceListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<GitLabSourceBuilder> predicate) {
    ...
    Iterator<GitLabSourceBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        GitLabSourceBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,GitLabSource item) {
  ...
  public class ItemsNested<N> extends GitLabSourceFluent<ItemsNested<N>> implements Nested<N>{
  
    GitLabSourceBuilder builder;
    int index;
  
    ItemsNested(int index,GitLabSource item) {
      this.index = index;
      this.builder = new GitLabSourceBuilder(this, item);
    }
  
    public N and() {
      return (N) GitLabSourceListFluent.this.setToItems(index, builder.build());
    }
