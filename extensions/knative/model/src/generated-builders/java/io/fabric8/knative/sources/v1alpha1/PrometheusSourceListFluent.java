...
public class PrometheusSourceListFluent<A extends io.fabric8.knative.sources.v1alpha1.PrometheusSourceListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<PrometheusSourceBuilder> items = new ArrayList<PrometheusSourceBuilder>();
  private String kind;
  private ListMeta metadata;

  public PrometheusSourceListFluent() {
  }
  
  public PrometheusSourceListFluent(PrometheusSourceList instance) {
  ...
  public A addAllToItems(Collection<PrometheusSource> items) {
    ...
    for (PrometheusSource item : items) {
        PrometheusSourceBuilder builder = new PrometheusSourceBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(PrometheusSource item) {
  ...
  public PrometheusSource buildMatchingItem(Predicate<PrometheusSourceBuilder> predicate) {
      for (PrometheusSourceBuilder item : items) {
  ...
  protected void copyInstance(PrometheusSourceList instance) {
    instance = instance != null ? instance : new PrometheusSourceList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<PrometheusSourceBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    PrometheusSourceListFluent that = (PrometheusSourceListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<PrometheusSourceBuilder> predicate) {
    ...
    Iterator<PrometheusSourceBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        PrometheusSourceBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,PrometheusSource item) {
  ...
  public class ItemsNested<N> extends PrometheusSourceFluent<ItemsNested<N>> implements Nested<N>{
  
    PrometheusSourceBuilder builder;
    int index;
  
    ItemsNested(int index,PrometheusSource item) {
      this.index = index;
      this.builder = new PrometheusSourceBuilder(this, item);
    }
  
    public N and() {
      return (N) PrometheusSourceListFluent.this.setToItems(index, builder.build());
    }
