...
public class ConfigurationListFluent<A extends io.fabric8.knative.serving.v1.ConfigurationListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ConfigurationBuilder> items = new ArrayList<ConfigurationBuilder>();
  private String kind;
  private ListMeta metadata;

  public ConfigurationListFluent() {
  }
  
  public ConfigurationListFluent(ConfigurationList instance) {
  ...
  public ItemsNested<A> addNewItemLike(Configuration item) {
  ...
  public Configuration buildMatchingItem(Predicate<ConfigurationBuilder> predicate) {
      for (ConfigurationBuilder item : items) {
  ...
  protected void copyInstance(ConfigurationList instance) {
    instance = instance != null ? instance : new ConfigurationList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ConfigurationBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ConfigurationListFluent that = (ConfigurationListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ConfigurationBuilder> predicate) {
    ...
    Iterator<ConfigurationBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,Configuration item) {
  ...
  public class ItemsNested<N> extends ConfigurationFluent<ItemsNested<N>> implements Nested<N>{
  
    ConfigurationBuilder builder;
    int index;
  
    ItemsNested(int index,Configuration item) {
      this.index = index;
      this.builder = new ConfigurationBuilder(this, item);
    }
  
    public N and() {
      return (N) ConfigurationListFluent.this.setToItems(index, builder.build());
    }
