...
public class ImageStatusFluent<A extends io.fabric8.knative.internal.caching.v1alpha1.ImageStatusFluent<A>> extends BaseFluent<A>{
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ImageStatusFluent.this.setToConditions(index, builder.build());
    }
