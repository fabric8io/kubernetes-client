...
public class SequenceSubscriptionStatusFluent<A extends io.fabric8.knative.flows.v1.SequenceSubscriptionStatusFluent<A>> extends BaseFluent<A>{
  ...
  public SequenceSubscriptionStatusFluent(SequenceSubscriptionStatus instance) {
  ...
  protected void copyInstance(SequenceSubscriptionStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    SequenceSubscriptionStatusFluent that = (SequenceSubscriptionStatusFluent) o;
  ...
  public class ReadyNested<N> extends ConditionFluent<ReadyNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SequenceSubscriptionStatusFluent.this.withReady(builder.build());
    }
  ...
  public class SubscriptionNested<N> extends ObjectReferenceFluent<SubscriptionNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SequenceSubscriptionStatusFluent.this.withSubscription(builder.build());
    }
