...
public class PingSourceListFluent<A extends io.fabric8.knative.sources.v1beta2.PingSourceListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<PingSourceBuilder> items = new ArrayList<PingSourceBuilder>();
  private String kind;
  private ListMeta metadata;

  public PingSourceListFluent() {
  }
  
  public PingSourceListFluent(PingSourceList instance) {
  ...
  public A addAllToItems(Collection<PingSource> items) {
    ...
    for (PingSource item : items) {
        PingSourceBuilder builder = new PingSourceBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(PingSource item) {
  ...
  public PingSource buildMatchingItem(Predicate<PingSourceBuilder> predicate) {
      for (PingSourceBuilder item : items) {
  ...
  protected void copyInstance(PingSourceList instance) {
    instance = instance != null ? instance : new PingSourceList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<PingSourceBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    PingSourceListFluent that = (PingSourceListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<PingSourceBuilder> predicate) {
    ...
    Iterator<PingSourceBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        PingSourceBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,PingSource item) {
  ...
  public class ItemsNested<N> extends PingSourceFluent<ItemsNested<N>> implements Nested<N>{
  
    PingSourceBuilder builder;
    int index;
  
    ItemsNested(int index,PingSource item) {
      this.index = index;
      this.builder = new PingSourceBuilder(this, item);
    }
  
    public N and() {
      return (N) PingSourceListFluent.this.setToItems(index, builder.build());
    }
