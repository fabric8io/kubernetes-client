...
public class SourceStatusFluent<A extends io.fabric8.knative.duck.v1beta1.SourceStatusFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(annotations, conditions, observedGeneration, sinkUri, additionalProperties);
  }
