...
public class DeliverySpecFluent<A extends io.fabric8.knative.duck.v1.DeliverySpecFluent<A>> extends BaseFluent<A>{
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(retryAfterMax, that.retryAfterMax))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(backoffDelay, backoffPolicy, deadLetterSink, format, retry, retryAfterMax, timeout, additionalProperties);
  }
  ...
  public A withRetryAfterMax(String retryAfterMax) {
