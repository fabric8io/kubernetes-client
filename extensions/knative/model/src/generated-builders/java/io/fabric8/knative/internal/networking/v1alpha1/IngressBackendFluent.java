...
public class IngressBackendFluent<A extends io.fabric8.knative.internal.networking.v1alpha1.IngressBackendFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(serviceName, serviceNamespace, servicePort, additionalProperties);
  }
