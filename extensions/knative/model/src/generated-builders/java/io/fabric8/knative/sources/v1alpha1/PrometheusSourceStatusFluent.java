...
public class PrometheusSourceStatusFluent<A extends io.fabric8.knative.sources.v1alpha1.PrometheusSourceStatusFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(PrometheusSourceStatus instance) {
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PrometheusSourceStatusFluent.this.withAuth(builder.build());
    }
