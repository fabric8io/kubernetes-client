...
public class AwsSqsSourceListFluent<A extends io.fabric8.knative.sources.v1alpha1.AwsSqsSourceListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<AwsSqsSourceBuilder> items = new ArrayList<AwsSqsSourceBuilder>();
  private String kind;
  private ListMeta metadata;

  public AwsSqsSourceListFluent() {
  }
  
  public AwsSqsSourceListFluent(AwsSqsSourceList instance) {
  ...
  public A addAllToItems(Collection<AwsSqsSource> items) {
    ...
    for (AwsSqsSource item : items) {
        AwsSqsSourceBuilder builder = new AwsSqsSourceBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(AwsSqsSource item) {
  ...
  public AwsSqsSource buildMatchingItem(Predicate<AwsSqsSourceBuilder> predicate) {
      for (AwsSqsSourceBuilder item : items) {
  ...
  protected void copyInstance(AwsSqsSourceList instance) {
    instance = instance != null ? instance : new AwsSqsSourceList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<AwsSqsSourceBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    AwsSqsSourceListFluent that = (AwsSqsSourceListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<AwsSqsSourceBuilder> predicate) {
    ...
    Iterator<AwsSqsSourceBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        AwsSqsSourceBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,AwsSqsSource item) {
  ...
  public class ItemsNested<N> extends AwsSqsSourceFluent<ItemsNested<N>> implements Nested<N>{
  
    AwsSqsSourceBuilder builder;
    int index;
  
    ItemsNested(int index,AwsSqsSource item) {
      this.index = index;
      this.builder = new AwsSqsSourceBuilder(this, item);
    }
  
    public N and() {
      return (N) AwsSqsSourceListFluent.this.setToItems(index, builder.build());
    }
