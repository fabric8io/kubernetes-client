...
public class InMemoryChannelSpecFluent<A extends io.fabric8.knative.messaging.v1.InMemoryChannelSpecFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private DeliverySpecBuilder delivery;
  private ArrayList<SubscriberSpecBuilder> subscribers = new ArrayList<SubscriberSpecBuilder>();

  public InMemoryChannelSpecFluent() {
  }
  
  public InMemoryChannelSpecFluent(InMemoryChannelSpec instance) {
  ...
  protected void copyInstance(InMemoryChannelSpec instance) {
  ...
  public boolean equals(Object o) {
    ...
    InMemoryChannelSpecFluent that = (InMemoryChannelSpecFluent) o;
  ...
  public class DeliveryNested<N> extends DeliverySpecFluent<DeliveryNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) InMemoryChannelSpecFluent.this.withDelivery(builder.build());
    }
  ...
  public class SubscribersNested<N> extends SubscriberSpecFluent<SubscribersNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) InMemoryChannelSpecFluent.this.setToSubscribers(index, builder.build());
    }
