...
public class PingSourceStatusFluent<A extends io.fabric8.knative.sources.v1beta2.PingSourceStatusFluent<A>> extends BaseFluent<A>{
  ...
  public PingSourceStatusFluent() {
  }
  
  public PingSourceStatusFluent(PingSourceStatus instance) {
  ...
  protected void copyInstance(PingSourceStatus instance) {
    instance = instance != null ? instance : new PingSourceStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    PingSourceStatusFluent that = (PingSourceStatusFluent) o;
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PingSourceStatusFluent.this.withAuth(builder.build());
    }
  ...
  public class CeAttributesNested<N> extends CloudEventAttributesFluent<CeAttributesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PingSourceStatusFluent.this.setToCeAttributes(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PingSourceStatusFluent.this.setToConditions(index, builder.build());
    }
