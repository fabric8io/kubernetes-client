...
public class RequestReplyStatusFluent<A extends io.fabric8.knative.eventing.v1alpha1.RequestReplyStatusFluent<A>> extends BaseFluent<A>{
  ...
  public RequestReplyStatusFluent() {
  }
  
  public RequestReplyStatusFluent(RequestReplyStatus instance) {
  ...
  protected void copyInstance(RequestReplyStatus instance) {
    instance = instance != null ? instance : new RequestReplyStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    RequestReplyStatusFluent that = (RequestReplyStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(address, addresses, annotations, conditions, desiredReplicas, observedGeneration, policies, readyReplicas, additionalProperties);
  }
  ...
  public class AddressNested<N> extends AddressableFluent<AddressNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RequestReplyStatusFluent.this.withAddress(builder.build());
    }
  ...
  public class AddressesNested<N> extends AddressableFluent<AddressesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RequestReplyStatusFluent.this.setToAddresses(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RequestReplyStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class PoliciesNested<N> extends AppliedEventPolicyRefFluent<PoliciesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RequestReplyStatusFluent.this.setToPolicies(index, builder.build());
    }
