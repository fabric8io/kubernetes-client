...
public class MetricListFluent<A extends io.fabric8.knative.internal.autoscaling.v1alpha1.MetricListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<MetricBuilder> items = new ArrayList<MetricBuilder>();
  private String kind;
  private ListMeta metadata;

  public MetricListFluent() {
  }
  
  public MetricListFluent(MetricList instance) {
  ...
  public ItemsNested<A> addNewItemLike(Metric item) {
  ...
  protected void copyInstance(MetricList instance) {
    instance = instance != null ? instance : new MetricList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<MetricBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    MetricListFluent that = (MetricListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<MetricBuilder> predicate) {
    ...
    Iterator<MetricBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        MetricBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Metric item) {
  ...
  public class ItemsNested<N> extends MetricFluent<ItemsNested<N>> implements Nested<N>{
  
    MetricBuilder builder;
    int index;
  
    ItemsNested(int index,Metric item) {
      this.index = index;
      this.builder = new MetricBuilder(this, item);
    }
  
    public N and() {
      return (N) MetricListFluent.this.setToItems(index, builder.build());
    }
