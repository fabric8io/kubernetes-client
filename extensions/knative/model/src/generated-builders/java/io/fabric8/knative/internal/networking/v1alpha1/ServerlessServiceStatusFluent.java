...
public class ServerlessServiceStatusFluent<A extends io.fabric8.knative.internal.networking.v1alpha1.ServerlessServiceStatusFluent<A>> extends BaseFluent<A>{
  ...
  public ServerlessServiceStatusFluent() {
  }
  
  public ServerlessServiceStatusFluent(ServerlessServiceStatus instance) {
  ...
  protected void copyInstance(ServerlessServiceStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    ServerlessServiceStatusFluent that = (ServerlessServiceStatusFluent) o;
    ...
    if (!(Objects.equals(privateServiceName, that.privateServiceName))) {
      return false;
    }
  ...
  public boolean hasPrivateServiceName() {
    return this.privateServiceName != null;
  }
  ...
  public int hashCode() {
    return Objects.hash(annotations, conditions, observedGeneration, privateServiceName, serviceName, additionalProperties);
  }
  ...
  public String toString() {
    ...
    if (!(privateServiceName == null)) {
        sb.append("privateServiceName:");
        sb.append(privateServiceName);
        sb.append(",");
    }
    if (!(serviceName == null)) {
  ...
  public A withPrivateServiceName(String privateServiceName) {
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServerlessServiceStatusFluent.this.setToConditions(index, builder.build());
    }
