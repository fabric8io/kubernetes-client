...
public class ParallelStatusFluent<A extends io.fabric8.knative.flows.v1.ParallelStatusFluent<A>> extends BaseFluent<A>{
  ...
  public A addAllToBranchStatuses(Collection<ParallelBranchStatus> items) {
    ...
    for (ParallelBranchStatus item : items) {
        ...
        _visitables.get("branchStatuses").add(builder);
  ...
  public A addToBranchStatuses(int index,ParallelBranchStatus item) {
    ...
    ParallelBranchStatusBuilder builder = new ParallelBranchStatusBuilder(item);
    if (index < 0 || index >= branchStatuses.size()) {
        _visitables.get("branchStatuses").add(builder);
        branchStatuses.add(builder);
    } else {
        _visitables.get("branchStatuses").add(builder);
        branchStatuses.add(index, builder);
    }
    return (A) this;
  }
  ...
  public List<ParallelBranchStatus> buildBranchStatuses() {
    return this.branchStatuses != null ? build(branchStatuses) : null;
  }
  ...
  public ParallelBranchStatus buildMatchingBranchStatus(Predicate<ParallelBranchStatusBuilder> predicate) {
      for (ParallelBranchStatusBuilder item : branchStatuses) {
        if (predicate.test(item)) {
          return item.build();
        }
      }
  ...
  protected void copyInstance(ParallelStatus instance) {
    instance = instance != null ? instance : new ParallelStatus();
    if (instance != null) {
  ...
  public BranchStatusesNested<A> editBranchStatus(int index) {
    if (branchStatuses.size() <= index) {
      throw new RuntimeException(String.format("Can't edit %s. Index exceeds size.", "branchStatuses"));
    }
  ...
  public BranchStatusesNested<A> editFirstBranchStatus() {
    if (branchStatuses.size() == 0) {
      throw new RuntimeException(String.format("Can't edit first %s. The list is empty.", "branchStatuses"));
    }
  ...
  public BranchStatusesNested<A> editLastBranchStatus() {
    ...
    if (index < 0) {
      throw new RuntimeException(String.format("Can't edit last %s. The list is empty.", "branchStatuses"));
    }
    return this.setNewBranchStatusLike(index, this.buildBranchStatus(index));
  }
  ...
  public BranchStatusesNested<A> editMatchingBranchStatus(Predicate<ParallelBranchStatusBuilder> predicate) {
    ...
    for (int i = 0;i < branchStatuses.size();i++) {
      if (predicate.test(branchStatuses.get(i))) {
          index = i;
          break;
      }
    }
    if (index < 0) {
      throw new RuntimeException(String.format("Can't edit matching %s. No match found.", "branchStatuses"));
    }
    return this.setNewBranchStatusLike(index, this.buildBranchStatus(index));
  }
  ...
  public boolean equals(Object o) {
    ...
    ParallelStatusFluent that = (ParallelStatusFluent) o;
    ...
    if (!(Objects.equals(branchStatuses, that.branchStatuses))) {
      return false;
    }
    if (!(Objects.equals(conditions, that.conditions))) {
      return false;
    }
    if (!(Objects.equals(ingressChannelStatus, that.ingressChannelStatus))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(address, addresses, annotations, auth, branchStatuses, conditions, ingressChannelStatus, observedGeneration, policies, additionalProperties);
  }
  ...
  public A removeAllFromBranchStatuses(Collection<ParallelBranchStatus> items) {
    ...
    for (ParallelBranchStatus item : items) {
        ParallelBranchStatusBuilder builder = new ParallelBranchStatusBuilder(item);
        _visitables.get("branchStatuses").remove(builder);
  ...
  public A removeMatchingFromBranchStatuses(Predicate<ParallelBranchStatusBuilder> predicate) {
    ...
    Iterator<ParallelBranchStatusBuilder> each = branchStatuses.iterator();
    List visitables = _visitables.get("branchStatuses");
    while (each.hasNext()) {
  ...
  public A setToBranchStatuses(int index,ParallelBranchStatus item) {
    ...
    if (index < 0 || index >= branchStatuses.size()) {
        ...
        _visitables.get("branchStatuses").add(builder);
        branchStatuses.set(index, builder);
    }
    return (A) this;
  }
  ...
  public String toString() {
    ...
    if (!(branchStatuses == null) && !(branchStatuses.isEmpty())) {
  ...
  public A withBranchStatuses(List<ParallelBranchStatus> branchStatuses) {
    if (this.branchStatuses != null) {
      this._visitables.get("branchStatuses").clear();
    }
    if (branchStatuses != null) {
        this.branchStatuses = new ArrayList();
  ...
  public A withBranchStatuses(ParallelBranchStatus... branchStatuses) {
    if (this.branchStatuses != null) {
        ...
        _visitables.remove("branchStatuses");
    }
    if (branchStatuses != null) {
      for (ParallelBranchStatus item : branchStatuses) {
        this.addToBranchStatuses(item);
  ...
  public A withIngressChannelStatus(ParallelChannelStatus ingressChannelStatus) {
    this._visitables.remove("ingressChannelStatus");
    if (ingressChannelStatus != null) {
        this.ingressChannelStatus = new ParallelChannelStatusBuilder(ingressChannelStatus);
        this._visitables.get("ingressChannelStatus").add(this.ingressChannelStatus);
    } else {
        this.ingressChannelStatus = null;
        this._visitables.get("ingressChannelStatus").remove(this.ingressChannelStatus);
    }
    return (A) this;
  }
  ...
  public class AddressNested<N> extends AddressableFluent<AddressNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ParallelStatusFluent.this.withAddress(builder.build());
    }
  ...
  public class AddressesNested<N> extends AddressableFluent<AddressesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ParallelStatusFluent.this.setToAddresses(index, builder.build());
    }
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ParallelStatusFluent.this.withAuth(builder.build());
    }
  ...
  public class BranchStatusesNested<N> extends ParallelBranchStatusFluent<BranchStatusesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ParallelStatusFluent.this.setToBranchStatuses(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ParallelStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class IngressChannelStatusNested<N> extends ParallelChannelStatusFluent<IngressChannelStatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ParallelStatusFluent.this.withIngressChannelStatus(builder.build());
    }
  ...
  public class PoliciesNested<N> extends AppliedEventPolicyRefFluent<PoliciesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ParallelStatusFluent.this.setToPolicies(index, builder.build());
    }
