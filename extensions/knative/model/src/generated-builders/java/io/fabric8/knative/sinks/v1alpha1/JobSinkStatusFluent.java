...
public class JobSinkStatusFluent<A extends io.fabric8.knative.sinks.v1alpha1.JobSinkStatusFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(JobSinkStatus instance) {
    instance = instance != null ? instance : new JobSinkStatus();
    if (instance != null) {
  ...
  public JobNested<A> editOrNewJob() {
    return this.withNewJobLike(Optional.ofNullable(this.buildJob()).orElse(new JobStatusBuilder().build()));
  }
  
  public JobNested<A> editOrNewJobLike(JobStatus item) {
  ...
  public boolean equals(Object o) {
    ...
    JobSinkStatusFluent that = (JobSinkStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(address, addresses, annotations, conditions, job, observedGeneration, policies, additionalProperties);
  }
  ...
  public A withJob(JobStatus job) {
    this._visitables.remove("job");
    if (job != null) {
        this.job = new JobStatusBuilder(job);
  ...
  public A withNewJob(String selector) {
    return (A) this.withJob(new JobStatus(selector));
  }
  
  public JobNested<A> withNewJobLike(JobStatus item) {
  ...
  public class AddressNested<N> extends AddressableFluent<AddressNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) JobSinkStatusFluent.this.withAddress(builder.build());
    }
  ...
  public class AddressesNested<N> extends AddressableFluent<AddressesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) JobSinkStatusFluent.this.setToAddresses(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) JobSinkStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class JobNested<N> extends JobStatusFluent<JobNested<N>> implements Nested<N>{
  
    JobStatusBuilder builder;
  
    JobNested(JobStatus item) {
      this.builder = new JobStatusBuilder(this, item);
    }
  
    public N and() {
      return (N) JobSinkStatusFluent.this.withJob(builder.build());
    }
  ...
  public class PoliciesNested<N> extends AppliedEventPolicyRefFluent<PoliciesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) JobSinkStatusFluent.this.setToPolicies(index, builder.build());
    }
