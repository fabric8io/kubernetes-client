...
public class GitHubBindingStatusFluent<A extends io.fabric8.knative.bindings.v1alpha1.GitHubBindingStatusFluent<A>> extends BaseFluent<A>{
  ...
  public GitHubBindingStatusFluent() {
  }
  
  public GitHubBindingStatusFluent(GitHubBindingStatus instance) {
  ...
  protected void copyInstance(GitHubBindingStatus instance) {
    instance = instance != null ? instance : new GitHubBindingStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    GitHubBindingStatusFluent that = (GitHubBindingStatusFluent) o;
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitHubBindingStatusFluent.this.withAuth(builder.build());
    }
  ...
  public class CeAttributesNested<N> extends CloudEventAttributesFluent<CeAttributesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitHubBindingStatusFluent.this.setToCeAttributes(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitHubBindingStatusFluent.this.setToConditions(index, builder.build());
    }
