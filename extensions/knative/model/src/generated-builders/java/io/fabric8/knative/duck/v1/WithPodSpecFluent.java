...
public class WithPodSpecFluent<A extends io.fabric8.knative.duck.v1.WithPodSpecFluent<A>> extends BaseFluent<A>{
  ...
  public TemplateNested<A> editOrNewTemplate() {
    return this.withNewTemplateLike(Optional.ofNullable(this.buildTemplate()).orElse(new PodSpecableBuilder().build()));
  }
  
  public TemplateNested<A> editOrNewTemplateLike(PodSpecable item) {
  ...
  public TemplateNested<A> withNewTemplateLike(PodSpecable item) {
  ...
  public A withTemplate(PodSpecable template) {
    ...
    if (template != null) {
        this.template = new PodSpecableBuilder(template);
  ...
  public class TemplateNested<N> extends PodSpecableFluent<TemplateNested<N>> implements Nested<N>{
