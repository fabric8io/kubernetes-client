...
public class SecretTLSFluent<A extends io.fabric8.knative.serving.v1beta1.SecretTLSFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(SecretTLS instance) {
  ...
  public int hashCode() {
    return Objects.hash(secretName, additionalProperties);
  }
