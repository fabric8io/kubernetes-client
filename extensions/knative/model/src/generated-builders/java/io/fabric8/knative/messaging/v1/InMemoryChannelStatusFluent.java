...
public class InMemoryChannelStatusFluent<A extends io.fabric8.knative.messaging.v1.InMemoryChannelStatusFluent<A>> extends BaseFluent<A>{
  ...
  public InMemoryChannelStatusFluent() {
  }
  
  public InMemoryChannelStatusFluent(InMemoryChannelStatus instance) {
  ...
  protected void copyInstance(InMemoryChannelStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    InMemoryChannelStatusFluent that = (InMemoryChannelStatusFluent) o;
  ...
  public class AddressNested<N> extends AddressableFluent<AddressNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) InMemoryChannelStatusFluent.this.withAddress(builder.build());
    }
  ...
  public class AddressesNested<N> extends AddressableFluent<AddressesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) InMemoryChannelStatusFluent.this.setToAddresses(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) InMemoryChannelStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class PoliciesNested<N> extends AppliedEventPolicyRefFluent<PoliciesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) InMemoryChannelStatusFluent.this.setToPolicies(index, builder.build());
    }
  ...
  public class SubscribersNested<N> extends SubscriberStatusFluent<SubscribersNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) InMemoryChannelStatusFluent.this.setToSubscribers(index, builder.build());
    }
