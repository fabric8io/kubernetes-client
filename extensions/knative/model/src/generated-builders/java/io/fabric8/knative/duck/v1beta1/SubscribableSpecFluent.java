...
public class SubscribableSpecFluent<A extends io.fabric8.knative.duck.v1beta1.SubscribableSpecFluent<A>> extends BaseFluent<A>{
  ...
  public SubscribableSpecFluent(SubscribableSpec instance) {
  ...
  protected void copyInstance(SubscribableSpec instance) {
    instance = instance != null ? instance : new SubscribableSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    SubscribableSpecFluent that = (SubscribableSpecFluent) o;
  ...
  public class SubscribersNested<N> extends SubscriberSpecFluent<SubscribersNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SubscribableSpecFluent.this.setToSubscribers(index, builder.build());
    }
