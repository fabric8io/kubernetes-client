...
public class EventPolicyStatusFluent<A extends io.fabric8.knative.eventing.v1alpha1.EventPolicyStatusFluent<A>> extends BaseFluent<A>{
  ...
  public EventPolicyStatusFluent() {
  }
  
  public EventPolicyStatusFluent(EventPolicyStatus instance) {
  ...
  protected void copyInstance(EventPolicyStatus instance) {
    instance = instance != null ? instance : new EventPolicyStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    EventPolicyStatusFluent that = (EventPolicyStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(annotations, conditions, from, observedGeneration, additionalProperties);
  }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EventPolicyStatusFluent.this.setToConditions(index, builder.build());
    }
