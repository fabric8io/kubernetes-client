...
public class BrokerListFluent<A extends io.fabric8.knative.eventing.v1.BrokerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<BrokerBuilder> items = new ArrayList<BrokerBuilder>();
  private String kind;
  private ListMeta metadata;

  public BrokerListFluent() {
  }
  
  public BrokerListFluent(BrokerList instance) {
  ...
  public A addAllToItems(Collection<Broker> items) {
    ...
    for (Broker item : items) {
        BrokerBuilder builder = new BrokerBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(Broker item) {
  ...
  protected void copyInstance(BrokerList instance) {
    instance = instance != null ? instance : new BrokerList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<BrokerBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    BrokerListFluent that = (BrokerListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<BrokerBuilder> predicate) {
    ...
    Iterator<BrokerBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        BrokerBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Broker item) {
  ...
  public class ItemsNested<N> extends BrokerFluent<ItemsNested<N>> implements Nested<N>{
  
    BrokerBuilder builder;
    int index;
  
    ItemsNested(int index,Broker item) {
      this.index = index;
      this.builder = new BrokerBuilder(this, item);
    }
  
    public N and() {
      return (N) BrokerListFluent.this.setToItems(index, builder.build());
    }
