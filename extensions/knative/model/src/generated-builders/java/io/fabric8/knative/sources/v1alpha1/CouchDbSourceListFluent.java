...
public class CouchDbSourceListFluent<A extends io.fabric8.knative.sources.v1alpha1.CouchDbSourceListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<CouchDbSourceBuilder> items = new ArrayList<CouchDbSourceBuilder>();
  private String kind;
  private ListMeta metadata;

  public CouchDbSourceListFluent() {
  }
  
  public CouchDbSourceListFluent(CouchDbSourceList instance) {
  ...
  public A addAllToItems(Collection<CouchDbSource> items) {
    ...
    for (CouchDbSource item : items) {
        CouchDbSourceBuilder builder = new CouchDbSourceBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(CouchDbSource item) {
  ...
  public CouchDbSource buildMatchingItem(Predicate<CouchDbSourceBuilder> predicate) {
      for (CouchDbSourceBuilder item : items) {
  ...
  protected void copyInstance(CouchDbSourceList instance) {
    instance = instance != null ? instance : new CouchDbSourceList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<CouchDbSourceBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    CouchDbSourceListFluent that = (CouchDbSourceListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<CouchDbSourceBuilder> predicate) {
    ...
    Iterator<CouchDbSourceBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        CouchDbSourceBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,CouchDbSource item) {
  ...
  public class ItemsNested<N> extends CouchDbSourceFluent<ItemsNested<N>> implements Nested<N>{
  
    CouchDbSourceBuilder builder;
    int index;
  
    ItemsNested(int index,CouchDbSource item) {
      this.index = index;
      this.builder = new CouchDbSourceBuilder(this, item);
    }
  
    public N and() {
      return (N) CouchDbSourceListFluent.this.setToItems(index, builder.build());
    }
