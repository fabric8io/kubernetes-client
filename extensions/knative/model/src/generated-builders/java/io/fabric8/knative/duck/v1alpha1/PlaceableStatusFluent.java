...
public class PlaceableStatusFluent<A extends io.fabric8.knative.duck.v1alpha1.PlaceableStatusFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private Integer maxAllowedVReplicas;
  private ArrayList<PlacementBuilder> placements = new ArrayList<PlacementBuilder>();

  public PlaceableStatusFluent() {
  }
  
  public PlaceableStatusFluent(PlaceableStatus instance) {
  ...
  protected void copyInstance(PlaceableStatus instance) {
    instance = instance != null ? instance : new PlaceableStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    PlaceableStatusFluent that = (PlaceableStatusFluent) o;
  ...
  public class PlacementsNested<N> extends PlacementFluent<PlacementsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PlaceableStatusFluent.this.setToPlacements(index, builder.build());
    }
