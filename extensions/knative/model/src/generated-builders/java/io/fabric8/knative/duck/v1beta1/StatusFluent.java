...
public class StatusFluent<A extends io.fabric8.knative.duck.v1beta1.StatusFluent<A>> extends BaseFluent<A>{
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StatusFluent.this.setToConditions(index, builder.build());
    }
