...
public class ChannelStatusFluent<A extends io.fabric8.knative.messaging.v1.ChannelStatusFluent<A>> extends BaseFluent<A>{
  ...
  public ChannelStatusFluent(ChannelStatus instance) {
  ...
  protected void copyInstance(ChannelStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    ChannelStatusFluent that = (ChannelStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(address, addresses, annotations, channel, conditions, deadLetterSinkAudience, deadLetterSinkCACerts, deadLetterSinkUri, observedGeneration, policies, subscribers, additionalProperties);
  }
  ...
  public class AddressNested<N> extends AddressableFluent<AddressNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChannelStatusFluent.this.withAddress(builder.build());
    }
  ...
  public class AddressesNested<N> extends AddressableFluent<AddressesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChannelStatusFluent.this.setToAddresses(index, builder.build());
    }
  ...
  public class ChannelNested<N> extends KReferenceFluent<ChannelNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChannelStatusFluent.this.withChannel(builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChannelStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class PoliciesNested<N> extends AppliedEventPolicyRefFluent<PoliciesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChannelStatusFluent.this.setToPolicies(index, builder.build());
    }
  ...
  public class SubscribersNested<N> extends SubscriberStatusFluent<SubscribersNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChannelStatusFluent.this.setToSubscribers(index, builder.build());
    }
