...
public class GitLabSourceStatusFluent<A extends io.fabric8.knative.sources.v1alpha1.GitLabSourceStatusFluent<A>> extends BaseFluent<A>{
  ...
  public GitLabSourceStatusFluent(GitLabSourceStatus instance) {
  ...
  protected void copyInstance(GitLabSourceStatus instance) {
    instance = instance != null ? instance : new GitLabSourceStatus();
    if (instance != null) {
        ...
        this.withWebhookID(instance.getWebhookID());
  ...
  public boolean equals(Object o) {
    ...
    GitLabSourceStatusFluent that = (GitLabSourceStatusFluent) o;
    ...
    if (!(Objects.equals(webhookID, that.webhookID))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(annotations, auth, ceAttributes, conditions, observedGeneration, sinkAudience, sinkCACerts, sinkUri, webhookID, additionalProperties);
  }
  ...
  public A withWebhookID(Integer webhookID) {
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitLabSourceStatusFluent.this.withAuth(builder.build());
    }
  ...
  public class CeAttributesNested<N> extends CloudEventAttributesFluent<CeAttributesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitLabSourceStatusFluent.this.setToCeAttributes(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitLabSourceStatusFluent.this.setToConditions(index, builder.build());
    }
