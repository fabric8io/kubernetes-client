...
public class IngressStatusFluent<A extends io.fabric8.knative.internal.networking.v1alpha1.IngressStatusFluent<A>> extends BaseFluent<A>{
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(privateLoadBalancer, that.privateLoadBalancer))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(annotations, conditions, observedGeneration, privateLoadBalancer, publicLoadBalancer, additionalProperties);
  }
  ...
  public A withPrivateLoadBalancer(LoadBalancerStatus privateLoadBalancer) {
    this._visitables.remove("privateLoadBalancer");
    if (privateLoadBalancer != null) {
        this.privateLoadBalancer = new LoadBalancerStatusBuilder(privateLoadBalancer);
        this._visitables.get("privateLoadBalancer").add(this.privateLoadBalancer);
    } else {
        this.privateLoadBalancer = null;
        this._visitables.get("privateLoadBalancer").remove(this.privateLoadBalancer);
    }
    return (A) this;
  }
  
  public A withPublicLoadBalancer(LoadBalancerStatus publicLoadBalancer) {
    this._visitables.remove("publicLoadBalancer");
    if (publicLoadBalancer != null) {
        this.publicLoadBalancer = new LoadBalancerStatusBuilder(publicLoadBalancer);
        this._visitables.get("publicLoadBalancer").add(this.publicLoadBalancer);
    } else {
        this.publicLoadBalancer = null;
        this._visitables.get("publicLoadBalancer").remove(this.publicLoadBalancer);
    }
    return (A) this;
  }
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IngressStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class PrivateLoadBalancerNested<N> extends LoadBalancerStatusFluent<PrivateLoadBalancerNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IngressStatusFluent.this.withPrivateLoadBalancer(builder.build());
    }
  ...
  public class PublicLoadBalancerNested<N> extends LoadBalancerStatusFluent<PublicLoadBalancerNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IngressStatusFluent.this.withPublicLoadBalancer(builder.build());
    }
