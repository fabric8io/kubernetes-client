...
public class KafkaBindingListFluent<A extends io.fabric8.knative.bindings.v1beta1.KafkaBindingListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<KafkaBindingBuilder> items = new ArrayList<KafkaBindingBuilder>();
  private String kind;
  private ListMeta metadata;

  public KafkaBindingListFluent() {
  }
  
  public KafkaBindingListFluent(KafkaBindingList instance) {
  ...
  public ItemsNested<A> addNewItemLike(KafkaBinding item) {
  ...
  public KafkaBinding buildMatchingItem(Predicate<KafkaBindingBuilder> predicate) {
      for (KafkaBindingBuilder item : items) {
  ...
  protected void copyInstance(KafkaBindingList instance) {
    instance = instance != null ? instance : new KafkaBindingList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<KafkaBindingBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    KafkaBindingListFluent that = (KafkaBindingListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<KafkaBindingBuilder> predicate) {
    ...
    Iterator<KafkaBindingBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,KafkaBinding item) {
  ...
  public class ItemsNested<N> extends KafkaBindingFluent<ItemsNested<N>> implements Nested<N>{
  
    KafkaBindingBuilder builder;
    int index;
  
    ItemsNested(int index,KafkaBinding item) {
      this.index = index;
      this.builder = new KafkaBindingBuilder(this, item);
    }
  
    public N and() {
      return (N) KafkaBindingListFluent.this.setToItems(index, builder.build());
    }
