...
public class IntegrationSinkStatusFluent<A extends io.fabric8.knative.sinks.v1alpha1.IntegrationSinkStatusFluent<A>> extends BaseFluent<A>{
  ...
  public IntegrationSinkStatusFluent() {
  }
  
  public IntegrationSinkStatusFluent(IntegrationSinkStatus instance) {
  ...
  protected void copyInstance(IntegrationSinkStatus instance) {
    instance = instance != null ? instance : new IntegrationSinkStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    IntegrationSinkStatusFluent that = (IntegrationSinkStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(address, addresses, annotations, conditions, observedGeneration, policies, additionalProperties);
  }
  ...
  public class AddressNested<N> extends AddressableFluent<AddressNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IntegrationSinkStatusFluent.this.withAddress(builder.build());
    }
  ...
  public class AddressesNested<N> extends AddressableFluent<AddressesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IntegrationSinkStatusFluent.this.setToAddresses(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IntegrationSinkStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class PoliciesNested<N> extends AppliedEventPolicyRefFluent<PoliciesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IntegrationSinkStatusFluent.this.setToPolicies(index, builder.build());
    }
