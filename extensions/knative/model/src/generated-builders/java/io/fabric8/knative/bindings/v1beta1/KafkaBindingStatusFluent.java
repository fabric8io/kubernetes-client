...
public class KafkaBindingStatusFluent<A extends io.fabric8.knative.bindings.v1beta1.KafkaBindingStatusFluent<A>> extends BaseFluent<A>{
  ...
  public KafkaBindingStatusFluent() {
  }
  
  public KafkaBindingStatusFluent(KafkaBindingStatus instance) {
  ...
  protected void copyInstance(KafkaBindingStatus instance) {
    instance = instance != null ? instance : new KafkaBindingStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    KafkaBindingStatusFluent that = (KafkaBindingStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(annotations, conditions, observedGeneration, additionalProperties);
  }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KafkaBindingStatusFluent.this.setToConditions(index, builder.build());
    }
