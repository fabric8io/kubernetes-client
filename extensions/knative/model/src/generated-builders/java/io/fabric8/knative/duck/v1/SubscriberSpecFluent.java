...
public class SubscriberSpecFluent<A extends io.fabric8.knative.duck.v1.SubscriberSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(auth, delivery, generation, name, replyAudience, replyCACerts, replyUri, subscriberAudience, subscriberCACerts, subscriberUri, uid, additionalProperties);
  }
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SubscriberSpecFluent.this.withAuth(builder.build());
    }
