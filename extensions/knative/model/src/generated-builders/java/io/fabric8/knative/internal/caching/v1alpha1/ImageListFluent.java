...
public class ImageListFluent<A extends io.fabric8.knative.internal.caching.v1alpha1.ImageListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ImageBuilder> items = new ArrayList<ImageBuilder>();
  private String kind;
  private ListMeta metadata;

  public ImageListFluent() {
  }
  
  public ImageListFluent(ImageList instance) {
  ...
  public ItemsNested<A> addNewItemLike(Image item) {
  ...
  protected void copyInstance(ImageList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ImageBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ImageListFluent that = (ImageListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ImageBuilder> predicate) {
    ...
    Iterator<ImageBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,Image item) {
  ...
  public class ItemsNested<N> extends ImageFluent<ItemsNested<N>> implements Nested<N>{
  
    ImageBuilder builder;
    int index;
  
    ItemsNested(int index,Image item) {
      this.index = index;
      this.builder = new ImageBuilder(this, item);
    }
  
    public N and() {
      return (N) ImageListFluent.this.setToItems(index, builder.build());
    }
