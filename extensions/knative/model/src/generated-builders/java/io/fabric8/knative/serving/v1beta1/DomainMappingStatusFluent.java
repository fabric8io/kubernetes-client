...
public class DomainMappingStatusFluent<A extends io.fabric8.knative.serving.v1beta1.DomainMappingStatusFluent<A>> extends BaseFluent<A>{
  ...
  public DomainMappingStatusFluent() {
  }
  
  public DomainMappingStatusFluent(DomainMappingStatus instance) {
  ...
  protected void copyInstance(DomainMappingStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    DomainMappingStatusFluent that = (DomainMappingStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(address, annotations, conditions, observedGeneration, url, additionalProperties);
  }
  ...
  public class AddressNested<N> extends AddressableFluent<AddressNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DomainMappingStatusFluent.this.withAddress(builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DomainMappingStatusFluent.this.setToConditions(index, builder.build());
    }
