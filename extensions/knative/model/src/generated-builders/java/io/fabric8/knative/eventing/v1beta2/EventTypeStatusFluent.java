...
public class EventTypeStatusFluent<A extends io.fabric8.knative.eventing.v1beta2.EventTypeStatusFluent<A>> extends BaseFluent<A>{
  ...
  public EventTypeStatusFluent() {
  }
  
  public EventTypeStatusFluent(EventTypeStatus instance) {
  ...
  protected void copyInstance(EventTypeStatus instance) {
    instance = instance != null ? instance : new EventTypeStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    EventTypeStatusFluent that = (EventTypeStatusFluent) o;
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EventTypeStatusFluent.this.setToConditions(index, builder.build());
    }
