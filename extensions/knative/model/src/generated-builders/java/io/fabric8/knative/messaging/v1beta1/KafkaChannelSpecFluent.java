...
public class KafkaChannelSpecFluent<A extends io.fabric8.knative.messaging.v1beta1.KafkaChannelSpecFluent<A>> extends BaseFluent<A>{
  ...
  public boolean equals(Object o) {
    ...
    KafkaChannelSpecFluent that = (KafkaChannelSpecFluent) o;
    ...
    if (!(Objects.equals(retentionDuration, that.retentionDuration))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(delivery, numPartitions, replicationFactor, retentionDuration, subscribers, additionalProperties);
  }
  ...
  public class DeliveryNested<N> extends DeliverySpecFluent<DeliveryNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KafkaChannelSpecFluent.this.withDelivery(builder.build());
    }
  ...
  public class SubscribersNested<N> extends SubscriberSpecFluent<SubscribersNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KafkaChannelSpecFluent.this.setToSubscribers(index, builder.build());
    }
