...
public class AwsSqsSourceStatusFluent<A extends io.fabric8.knative.sources.v1alpha1.AwsSqsSourceStatusFluent<A>> extends BaseFluent<A>{
  ...
  public AwsSqsSourceStatusFluent() {
  }
  
  public AwsSqsSourceStatusFluent(AwsSqsSourceStatus instance) {
  ...
  protected void copyInstance(AwsSqsSourceStatus instance) {
    instance = instance != null ? instance : new AwsSqsSourceStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    AwsSqsSourceStatusFluent that = (AwsSqsSourceStatusFluent) o;
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AwsSqsSourceStatusFluent.this.withAuth(builder.build());
    }
  ...
  public class CeAttributesNested<N> extends CloudEventAttributesFluent<CeAttributesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AwsSqsSourceStatusFluent.this.setToCeAttributes(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AwsSqsSourceStatusFluent.this.setToConditions(index, builder.build());
    }
