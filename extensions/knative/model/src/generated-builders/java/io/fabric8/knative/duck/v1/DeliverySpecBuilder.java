...
public class DeliverySpecBuilder extends DeliverySpecFluent<DeliverySpecBuilder> implements VisitableBuilder<DeliverySpec,DeliverySpecBuilder>{
  ...
  public DeliverySpec build() {
    DeliverySpec buildable = new DeliverySpec(fluent.getBackoffDelay(), fluent.getBackoffPolicy(), fluent.buildDeadLetterSink(), fluent.getFormat(), fluent.getRetry(), fluent.getRetryAfterMax(), fluent.getTimeout());
