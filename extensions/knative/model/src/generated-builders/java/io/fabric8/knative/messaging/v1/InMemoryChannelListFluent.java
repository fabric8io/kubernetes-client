...
public class InMemoryChannelListFluent<A extends io.fabric8.knative.messaging.v1.InMemoryChannelListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<InMemoryChannelBuilder> items = new ArrayList<InMemoryChannelBuilder>();
  private String kind;
  private ListMeta metadata;

  public InMemoryChannelListFluent() {
  }
  
  public InMemoryChannelListFluent(InMemoryChannelList instance) {
  ...
  public ItemsNested<A> addNewItemLike(InMemoryChannel item) {
  ...
  public InMemoryChannel buildMatchingItem(Predicate<InMemoryChannelBuilder> predicate) {
      for (InMemoryChannelBuilder item : items) {
  ...
  protected void copyInstance(InMemoryChannelList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<InMemoryChannelBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    InMemoryChannelListFluent that = (InMemoryChannelListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<InMemoryChannelBuilder> predicate) {
    ...
    Iterator<InMemoryChannelBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,InMemoryChannel item) {
  ...
  public class ItemsNested<N> extends InMemoryChannelFluent<ItemsNested<N>> implements Nested<N>{
  
    InMemoryChannelBuilder builder;
    int index;
  
    ItemsNested(int index,InMemoryChannel item) {
      this.index = index;
      this.builder = new InMemoryChannelBuilder(this, item);
    }
  
    public N and() {
      return (N) InMemoryChannelListFluent.this.setToItems(index, builder.build());
    }
