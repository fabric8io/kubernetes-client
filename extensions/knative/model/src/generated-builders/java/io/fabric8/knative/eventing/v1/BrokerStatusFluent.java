...
public class BrokerStatusFluent<A extends io.fabric8.knative.eventing.v1.BrokerStatusFluent<A>> extends BaseFluent<A>{
  ...
  public boolean equals(Object o) {
    ...
    BrokerStatusFluent that = (BrokerStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(address, addresses, annotations, conditions, deadLetterSinkAudience, deadLetterSinkCACerts, deadLetterSinkUri, observedGeneration, policies, additionalProperties);
  }
  ...
  public class AddressNested<N> extends AddressableFluent<AddressNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BrokerStatusFluent.this.withAddress(builder.build());
    }
  ...
  public class AddressesNested<N> extends AddressableFluent<AddressesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BrokerStatusFluent.this.setToAddresses(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BrokerStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class PoliciesNested<N> extends AppliedEventPolicyRefFluent<PoliciesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BrokerStatusFluent.this.setToPolicies(index, builder.build());
    }
