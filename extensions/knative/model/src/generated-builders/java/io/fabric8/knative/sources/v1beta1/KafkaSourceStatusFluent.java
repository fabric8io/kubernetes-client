...
public class KafkaSourceStatusFluent<A extends io.fabric8.knative.sources.v1beta1.KafkaSourceStatusFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(KafkaSourceStatus instance) {
  ...
  public int hashCode() {
    return Objects.hash(annotations, auth, ceAttributes, claims, conditions, consumers, maxAllowedVReplicas, observedGeneration, placements, selector, sinkAudience, sinkCACerts, sinkUri, additionalProperties);
  }
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KafkaSourceStatusFluent.this.withAuth(builder.build());
    }
