...
public class ApiServerSourceListFluent<A extends io.fabric8.knative.sources.v1.ApiServerSourceListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ApiServerSourceBuilder> items = new ArrayList<ApiServerSourceBuilder>();
  private String kind;
  private ListMeta metadata;

  public ApiServerSourceListFluent() {
  }
  
  public ApiServerSourceListFluent(ApiServerSourceList instance) {
  ...
  public ItemsNested<A> addNewItemLike(ApiServerSource item) {
  ...
  public ApiServerSource buildMatchingItem(Predicate<ApiServerSourceBuilder> predicate) {
      for (ApiServerSourceBuilder item : items) {
  ...
  protected void copyInstance(ApiServerSourceList instance) {
    instance = instance != null ? instance : new ApiServerSourceList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ApiServerSourceBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ApiServerSourceListFluent that = (ApiServerSourceListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ApiServerSourceBuilder> predicate) {
    ...
    Iterator<ApiServerSourceBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,ApiServerSource item) {
  ...
  public class ItemsNested<N> extends ApiServerSourceFluent<ItemsNested<N>> implements Nested<N>{
  
    ApiServerSourceBuilder builder;
    int index;
  
    ItemsNested(int index,ApiServerSource item) {
      this.index = index;
      this.builder = new ApiServerSourceBuilder(this, item);
    }
  
    public N and() {
      return (N) ApiServerSourceListFluent.this.setToItems(index, builder.build());
    }
