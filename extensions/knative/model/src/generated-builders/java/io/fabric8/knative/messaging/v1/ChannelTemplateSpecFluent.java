...
public class ChannelTemplateSpecFluent<A extends io.fabric8.knative.messaging.v1.ChannelTemplateSpecFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(ChannelTemplateSpec instance) {
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, kind, spec, additionalProperties);
  }
