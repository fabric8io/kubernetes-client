...
public class GitLabBindingListFluent<A extends io.fabric8.knative.bindings.v1alpha1.GitLabBindingListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<GitLabBindingBuilder> items = new ArrayList<GitLabBindingBuilder>();
  private String kind;
  private ListMeta metadata;

  public GitLabBindingListFluent() {
  }
  
  public GitLabBindingListFluent(GitLabBindingList instance) {
  ...
  public A addAllToItems(Collection<GitLabBinding> items) {
    ...
    for (GitLabBinding item : items) {
        GitLabBindingBuilder builder = new GitLabBindingBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(GitLabBinding item) {
  ...
  public GitLabBinding buildMatchingItem(Predicate<GitLabBindingBuilder> predicate) {
      for (GitLabBindingBuilder item : items) {
  ...
  protected void copyInstance(GitLabBindingList instance) {
    instance = instance != null ? instance : new GitLabBindingList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<GitLabBindingBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    GitLabBindingListFluent that = (GitLabBindingListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<GitLabBindingBuilder> predicate) {
    ...
    Iterator<GitLabBindingBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        GitLabBindingBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,GitLabBinding item) {
  ...
  public class ItemsNested<N> extends GitLabBindingFluent<ItemsNested<N>> implements Nested<N>{
  
    GitLabBindingBuilder builder;
    int index;
  
    ItemsNested(int index,GitLabBinding item) {
      this.index = index;
      this.builder = new GitLabBindingBuilder(this, item);
    }
  
    public N and() {
      return (N) GitLabBindingListFluent.this.setToItems(index, builder.build());
    }
