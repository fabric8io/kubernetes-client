...
public class RevisionListFluent<A extends io.fabric8.knative.serving.v1.RevisionListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<RevisionBuilder> items = new ArrayList<RevisionBuilder>();
  private String kind;
  private ListMeta metadata;

  public RevisionListFluent() {
  }
  
  public RevisionListFluent(RevisionList instance) {
  ...
  public A addAllToItems(Collection<Revision> items) {
    ...
    for (Revision item : items) {
        RevisionBuilder builder = new RevisionBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(Revision item) {
  ...
  public Revision buildMatchingItem(Predicate<RevisionBuilder> predicate) {
      for (RevisionBuilder item : items) {
  ...
  protected void copyInstance(RevisionList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<RevisionBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    RevisionListFluent that = (RevisionListFluent) o;
  ...
  public boolean hasMatchingItem(Predicate<RevisionBuilder> predicate) {
      for (RevisionBuilder item : items) {
        if (predicate.test(item)) {
          return true;
        }
  ...
  public A removeMatchingFromItems(Predicate<RevisionBuilder> predicate) {
    if (items == null) {
      return (A) this;
    }
    Iterator<RevisionBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        RevisionBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Revision item) {
  ...
  public class ItemsNested<N> extends RevisionFluent<ItemsNested<N>> implements Nested<N>{
  
    RevisionBuilder builder;
    int index;
  
    ItemsNested(int index,Revision item) {
      this.index = index;
      this.builder = new RevisionBuilder(this, item);
    }
  
    public N and() {
      return (N) RevisionListFluent.this.setToItems(index, builder.build());
    }
