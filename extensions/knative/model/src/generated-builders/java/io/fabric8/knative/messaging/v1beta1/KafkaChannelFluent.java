...
public class KafkaChannelFluent<A extends io.fabric8.knative.messaging.v1beta1.KafkaChannelFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(KafkaChannel instance) {
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new KafkaChannelSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(KafkaChannelSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new KafkaChannelStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(KafkaChannelStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(KafkaChannelSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(KafkaChannelStatus item) {
  ...
  public A withSpec(KafkaChannelSpec spec) {
    ...
    if (spec != null) {
        this.spec = new KafkaChannelSpecBuilder(spec);
  ...
  public A withStatus(KafkaChannelStatus status) {
    ...
    if (status != null) {
        this.status = new KafkaChannelStatusBuilder(status);
  ...
  public class SpecNested<N> extends KafkaChannelSpecFluent<SpecNested<N>> implements Nested<N>{
  ...
  public class StatusNested<N> extends KafkaChannelStatusFluent<StatusNested<N>> implements Nested<N>{
