...
public class ConfigurationStatusFluent<A extends io.fabric8.knative.serving.v1.ConfigurationStatusFluent<A>> extends BaseFluent<A>{
  ...
  public ConfigurationStatusFluent() {
  }
  
  public ConfigurationStatusFluent(ConfigurationStatus instance) {
  ...
  protected void copyInstance(ConfigurationStatus instance) {
    instance = instance != null ? instance : new ConfigurationStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ConfigurationStatusFluent that = (ConfigurationStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(annotations, conditions, latestCreatedRevisionName, latestReadyRevisionName, observedGeneration, additionalProperties);
  }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ConfigurationStatusFluent.this.setToConditions(index, builder.build());
    }
