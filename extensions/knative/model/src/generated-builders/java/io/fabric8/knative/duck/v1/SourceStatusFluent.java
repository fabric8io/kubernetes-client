...
public class SourceStatusFluent<A extends io.fabric8.knative.duck.v1.SourceStatusFluent<A>> extends BaseFluent<A>{
  ...
  public SourceStatusFluent() {
  }
  
  public SourceStatusFluent(SourceStatus instance) {
  ...
  protected void copyInstance(SourceStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    SourceStatusFluent that = (SourceStatusFluent) o;
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SourceStatusFluent.this.withAuth(builder.build());
    }
  ...
  public class CeAttributesNested<N> extends CloudEventAttributesFluent<CeAttributesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SourceStatusFluent.this.setToCeAttributes(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SourceStatusFluent.this.setToConditions(index, builder.build());
    }
