...
public class ReferenceFluent<A extends io.fabric8.knative.pkg.tracker.ReferenceFluent<A>> extends BaseFluent<A>{
  ...
  public ReferenceFluent() {
  }
  
  public ReferenceFluent(Reference instance) {
  ...
  protected void copyInstance(Reference instance) {
  ...
  public boolean equals(Object o) {
    ...
    ReferenceFluent that = (ReferenceFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, kind, name, namespace, selector, additionalProperties);
  }
  ...
  public class SelectorNested<N> extends LabelSelectorFluent<SelectorNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ReferenceFluent.this.withSelector(builder.build());
    }
