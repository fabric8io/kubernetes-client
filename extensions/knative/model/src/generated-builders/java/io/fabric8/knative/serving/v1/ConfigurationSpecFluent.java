...
public class ConfigurationSpecFluent<A extends io.fabric8.knative.serving.v1.ConfigurationSpecFluent<A>> extends BaseFluent<A>{
  ...
  public ConfigurationSpecFluent(ConfigurationSpec instance) {
  ...
  protected void copyInstance(ConfigurationSpec instance) {
    instance = instance != null ? instance : new ConfigurationSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ConfigurationSpecFluent that = (ConfigurationSpecFluent) o;
  ...
  public class TemplateNested<N> extends RevisionTemplateSpecFluent<TemplateNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ConfigurationSpecFluent.this.withTemplate(builder.build());
    }
