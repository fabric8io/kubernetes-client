...
public class ApiServerSourceStatusFluent<A extends io.fabric8.knative.sources.v1.ApiServerSourceStatusFluent<A>> extends BaseFluent<A>{
  ...
  public boolean equals(Object o) {
    ...
    ApiServerSourceStatusFluent that = (ApiServerSourceStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(annotations, auth, ceAttributes, conditions, namespaces, observedGeneration, sinkAudience, sinkCACerts, sinkUri, additionalProperties);
  }
  ...
  public class AuthNested<N> extends AuthStatusFluent<AuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ApiServerSourceStatusFluent.this.withAuth(builder.build());
    }
  ...
  public class CeAttributesNested<N> extends CloudEventAttributesFluent<CeAttributesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ApiServerSourceStatusFluent.this.setToCeAttributes(index, builder.build());
    }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ApiServerSourceStatusFluent.this.setToConditions(index, builder.build());
    }
