...
public class ReplySpecFluent<A extends io.fabric8.knative.eventing.v1alpha1.ReplySpecFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private Boolean discard;
  private JsonataEventTransformationSpecBuilder jsonata;

  public ReplySpecFluent() {
  }
  
  public ReplySpecFluent(ReplySpec instance) {
  ...
  protected void copyInstance(ReplySpec instance) {
    instance = instance != null ? instance : new ReplySpec();
    if (instance != null) {
        this.withDiscard(instance.getDiscard());
  ...
  public boolean equals(Object o) {
    ...
    ReplySpecFluent that = (ReplySpecFluent) o;
    if (!(Objects.equals(discard, that.discard))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(discard, jsonata, additionalProperties);
  }
  ...
  public A withDiscard() {
    return withDiscard(true);
  }
  
  public A withDiscard(Boolean discard) {
  ...
  public class JsonataNested<N> extends JsonataEventTransformationSpecFluent<JsonataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ReplySpecFluent.this.withJsonata(builder.build());
    }
