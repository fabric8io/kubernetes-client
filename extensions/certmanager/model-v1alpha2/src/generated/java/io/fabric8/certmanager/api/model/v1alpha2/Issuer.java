...
public class Issuer implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public Issuer(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, IssuerSpec spec, IssuerStatus status) {
        super();
