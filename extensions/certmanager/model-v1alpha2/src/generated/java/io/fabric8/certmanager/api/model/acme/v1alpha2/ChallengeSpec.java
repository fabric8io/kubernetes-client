...
public class ChallengeSpec implements KubernetesResource
{
     ...
     * @param wildcard
     */
    public ChallengeSpec(String authzURL, String dnsName, io.fabric8.certmanager.api.model.meta.v1.ObjectReference issuerRef, String key, ACMEChallengeSolver solver, String token, String type, String url, Boolean wildcard) {
        super();
