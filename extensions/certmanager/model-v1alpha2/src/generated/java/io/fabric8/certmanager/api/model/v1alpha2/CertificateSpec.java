...
public class CertificateSpec implements KubernetesResource
{
     ...
     * @param usages
     */
    public CertificateSpec(String commonName, List<String> dnsNames, io.fabric8.kubernetes.api.model.Duration duration, List<String> emailSANs, Boolean encodeUsagesInRequest, List<String> ipAddresses, java.lang.Boolean isCA, io.fabric8.certmanager.api.model.meta.v1.ObjectReference issuerRef, String keyAlgorithm, String keyEncoding, Integer keySize, CertificateKeystores keystores, List<String> organization, CertificatePrivateKey privateKey, io.fabric8.kubernetes.api.model.Duration renewBefore, String secretName, X509Subject subject, List<String> uriSANs, List<String> usages) {
        super();
