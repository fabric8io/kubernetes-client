...
public class VenafiTPP implements KubernetesResource
{
    ...
    private io.fabric8.certmanager.api.model.meta.v1.LocalObjectReference credentialsRef;
    @JsonProperty("url")
    private String url;
    @JsonIgnore
    ...
    @JsonProperty("credentialsRef")
    public io.fabric8.certmanager.api.model.meta.v1.LocalObjectReference getCredentialsRef() {
        return credentialsRef;
    }

    @JsonProperty("credentialsRef")
    public void setCredentialsRef(io.fabric8.certmanager.api.model.meta.v1.LocalObjectReference credentialsRef) {
        this.credentialsRef = credentialsRef;
    }
