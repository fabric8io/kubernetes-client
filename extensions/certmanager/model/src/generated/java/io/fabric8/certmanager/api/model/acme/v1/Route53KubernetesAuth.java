...
public class Route53KubernetesAuth implements Editable<Route53KubernetesAuthBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Route53KubernetesAuth)) {
            return false;
        }
        Route53KubernetesAuth other = (Route53KubernetesAuth) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Route53KubernetesAuth;
    }
    ...
    public String toString() {
        return "Route53KubernetesAuth(" + "serviceAccountRef=" + this.getServiceAccountRef() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
