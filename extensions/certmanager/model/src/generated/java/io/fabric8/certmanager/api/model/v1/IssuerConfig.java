...
public class IssuerConfig implements Editable<IssuerConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IssuerConfig)) {
            return false;
        }
        IssuerConfig other = (IssuerConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IssuerConfig;
    }
    ...
    public String toString() {
        return "IssuerConfig(" + "acme=" + this.getAcme() + ", ca=" + this.getCa() + ", selfSigned=" + this.getSelfSigned() + ", vault=" + this.getVault() + ", venafi=" + this.getVenafi() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
