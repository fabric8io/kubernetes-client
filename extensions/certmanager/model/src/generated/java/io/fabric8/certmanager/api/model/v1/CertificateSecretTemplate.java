...
public class CertificateSecretTemplate implements Editable<CertificateSecretTemplateBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CertificateSecretTemplate)) {
            return false;
        }
        CertificateSecretTemplate other = (CertificateSecretTemplate) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CertificateSecretTemplate;
    }
    ...
    public String toString() {
        return "CertificateSecretTemplate(" + "annotations=" + this.getAnnotations() + ", labels=" + this.getLabels() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
