...
public class ClusterIssuer implements Editable<ClusterIssuerBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterIssuer)) {
            return false;
        }
        ClusterIssuer other = (ClusterIssuer) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClusterIssuer;
    }
    ...
    public String toString() {
        return "ClusterIssuer(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
