...
public class Certificate implements Editable<CertificateBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Certificate(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
