...
public class ACMEChallengeSolverHTTP01IngressObjectMeta implements Editable<ACMEChallengeSolverHTTP01IngressObjectMetaBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ACMEChallengeSolverHTTP01IngressObjectMeta)) {
            return false;
        }
        ACMEChallengeSolverHTTP01IngressObjectMeta other = (ACMEChallengeSolverHTTP01IngressObjectMeta) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ACMEChallengeSolverHTTP01IngressObjectMeta;
    }
    ...
    public String toString() {
        return "ACMEChallengeSolverHTTP01IngressObjectMeta(" + "annotations=" + this.getAnnotations() + ", labels=" + this.getLabels() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
