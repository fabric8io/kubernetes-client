...
public class CertificateRequest implements Editable<CertificateRequestBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "CertificateRequest(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
