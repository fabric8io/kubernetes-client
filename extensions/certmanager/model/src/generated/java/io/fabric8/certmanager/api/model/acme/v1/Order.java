...
public class Order implements Editable<OrderBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Order(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
