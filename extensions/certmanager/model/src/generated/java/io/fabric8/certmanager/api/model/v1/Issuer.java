...
public class Issuer implements Editable<IssuerBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Issuer(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
