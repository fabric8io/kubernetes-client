...
public class CertificateCondition implements Editable<CertificateConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CertificateCondition)) {
            return false;
        }
        CertificateCondition other = (CertificateCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CertificateCondition;
    }
    ...
    public String toString() {
        return "CertificateCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", observedGeneration=" + this.getObservedGeneration() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
