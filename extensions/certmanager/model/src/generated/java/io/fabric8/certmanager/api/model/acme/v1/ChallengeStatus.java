...
public class ChallengeStatus implements Editable<ChallengeStatusBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "ChallengeStatus(" + "presented=" + this.getPresented() + ", processing=" + this.getProcessing() + ", reason=" + this.getReason() + ", state=" + this.getState() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
