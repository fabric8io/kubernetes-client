...
public class Route53Auth implements Editable<Route53AuthBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Route53Auth)) {
            return false;
        }
        Route53Auth other = (Route53Auth) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Route53Auth;
    }
    ...
    public String toString() {
        return "Route53Auth(" + "kubernetes=" + this.getKubernetes() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
