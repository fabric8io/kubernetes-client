...
public class ACMEChallengeSolverHTTP01IngressPodObjectMeta implements Editable<ACMEChallengeSolverHTTP01IngressPodObjectMetaBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ACMEChallengeSolverHTTP01IngressPodObjectMeta)) {
            return false;
        }
        ACMEChallengeSolverHTTP01IngressPodObjectMeta other = (ACMEChallengeSolverHTTP01IngressPodObjectMeta) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ACMEChallengeSolverHTTP01IngressPodObjectMeta;
    }
    ...
    public String toString() {
        return "ACMEChallengeSolverHTTP01IngressPodObjectMeta(" + "annotations=" + this.getAnnotations() + ", labels=" + this.getLabels() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
