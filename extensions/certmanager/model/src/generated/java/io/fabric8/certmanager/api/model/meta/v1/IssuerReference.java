...
public class IssuerReference implements Editable<IssuerReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IssuerReference)) {
            return false;
        }
        IssuerReference other = (IssuerReference) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IssuerReference;
    }
    ...
    public String toString() {
        return "IssuerReference(" + "group=" + this.getGroup() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
