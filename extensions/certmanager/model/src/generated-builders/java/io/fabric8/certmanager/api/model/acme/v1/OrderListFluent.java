...
public class OrderListFluent<A extends io.fabric8.certmanager.api.model.acme.v1.OrderListFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(Order... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (Order item : items) {
  ...
  public A removeFromItems(Order... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (Order item : items) {
  ...
  public A removeMatchingFromItems(Predicate<OrderBuilder> predicate) {
    ...
    Iterator<OrderBuilder> each = items.iterator();
  ...
  public A withItems(Order... items) {
    if (this.items != null) {
        this.items.clear();
