...
public class ACMEChallengeSolverHTTP01IngressPodResourcesFluent<A extends io.fabric8.certmanager.api.model.acme.v1.ACMEChallengeSolverHTTP01IngressPodResourcesFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private Map<String,Quantity> limits;
  private Map<String,Quantity> requests;

  public ACMEChallengeSolverHTTP01IngressPodResourcesFluent() {
  }
  
  public ACMEChallengeSolverHTTP01IngressPodResourcesFluent(ACMEChallengeSolverHTTP01IngressPodResources instance) {
  ...
  protected void copyInstance(ACMEChallengeSolverHTTP01IngressPodResources instance) {
    instance = instance != null ? instance : new ACMEChallengeSolverHTTP01IngressPodResources();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ACMEChallengeSolverHTTP01IngressPodResourcesFluent that = (ACMEChallengeSolverHTTP01IngressPodResourcesFluent) o;
