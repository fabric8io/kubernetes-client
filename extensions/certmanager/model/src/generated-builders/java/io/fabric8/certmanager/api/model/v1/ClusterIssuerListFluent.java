...
public class ClusterIssuerListFluent<A extends io.fabric8.certmanager.api.model.v1.ClusterIssuerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ClusterIssuerBuilder> items = new ArrayList<ClusterIssuerBuilder>();
  private String kind;
  ...
  public ClusterIssuer buildMatchingItem(Predicate<ClusterIssuerBuilder> predicate) {
      for (ClusterIssuerBuilder item : items) {
  ...
  protected void copyInstance(ClusterIssuerList instance) {
    instance = instance != null ? instance : new ClusterIssuerList();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ClusterIssuerListFluent that = (ClusterIssuerListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ClusterIssuerBuilder> predicate) {
    ...
    Iterator<ClusterIssuerBuilder> each = items.iterator();
  ...
  public class ItemsNested<N> extends ClusterIssuerFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ClusterIssuerListFluent.this.setToItems(index, builder.build());
    }
