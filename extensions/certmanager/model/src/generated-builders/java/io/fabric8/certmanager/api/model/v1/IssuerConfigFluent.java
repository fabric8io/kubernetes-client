...
public class IssuerConfigFluent<A extends io.fabric8.certmanager.api.model.v1.IssuerConfigFluent<A>> extends BaseFluent<A>{
  ...
  public IssuerConfigFluent() {
  }
  
  public IssuerConfigFluent(IssuerConfig instance) {
  ...
  protected void copyInstance(IssuerConfig instance) {
    instance = instance != null ? instance : new IssuerConfig();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    IssuerConfigFluent that = (IssuerConfigFluent) o;
  ...
  public class AcmeNested<N> extends ACMEIssuerFluent<AcmeNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IssuerConfigFluent.this.withAcme(builder.build());
    }
  ...
  public class CaNested<N> extends CAIssuerFluent<CaNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IssuerConfigFluent.this.withCa(builder.build());
    }
  ...
  public class SelfSignedNested<N> extends SelfSignedIssuerFluent<SelfSignedNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IssuerConfigFluent.this.withSelfSigned(builder.build());
    }
  ...
  public class VaultNested<N> extends VaultIssuerFluent<VaultNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IssuerConfigFluent.this.withVault(builder.build());
    }
  ...
  public class VenafiNested<N> extends VenafiIssuerFluent<VenafiNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IssuerConfigFluent.this.withVenafi(builder.build());
    }
