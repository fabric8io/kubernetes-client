...
public class IssuerListFluent<A extends io.fabric8.certmanager.api.model.v1.IssuerListFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(IssuerList instance) {
  ...
  public A removeMatchingFromItems(Predicate<IssuerBuilder> predicate) {
    ...
    Iterator<IssuerBuilder> each = items.iterator();
