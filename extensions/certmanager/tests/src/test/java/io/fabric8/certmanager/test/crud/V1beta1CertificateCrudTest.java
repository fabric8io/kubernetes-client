...
class V1beta1CertificateCrudTest {
  ...
  void shouldDeleteACertificate() {
    ...
    boolean deleted = client.v1beta1().certificates().inNamespace("ns3").withName("cert3").delete().size() == 1;
    assertTrue(deleted);
  }
  ...
  void shouldLoadCertificate() {
    ...
    Certificate certificate = client.v1beta1().certificates().inNamespace("ns4")
