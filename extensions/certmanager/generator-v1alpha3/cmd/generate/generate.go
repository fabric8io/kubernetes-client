...
func main() {
	...
	packageMapping := map[string]schemagen.PackageInformation{
		"github.com/jetstack/cert-manager/pkg/apis/certmanager/v1alpha3": {JavaPackage: "io.fabric8.certmanager.api.model.v1alpha3", ApiGroup: "cert-manager.io", ApiVersion: "v1alpha3"},
		"github.com/jetstack/cert-manager/pkg/apis/acme/v1alpha3":        {JavaPackage: "io.fabric8.certmanager.api.model.acme.v1alpha3", ApiGroup: "cert-manager.io", ApiVersion: "v1alpha3"},
