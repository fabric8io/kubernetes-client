...
import (
	...
	certmanageracme "github.com/jetstack/cert-manager/pkg/apis/acme/v1beta1"
...
func main() {
	...
	packageMapping := map[string]schemagen.PackageInformation{
		"github.com/jetstack/cert-manager/pkg/apis/certmanager/v1beta1": {JavaPackage: "io.fabric8.certmanager.api.model.v1beta1", ApiGroup: "cert-manager.io", ApiVersion: "v1beta1"},
		"github.com/jetstack/cert-manager/pkg/apis/acme/v1beta1":        {JavaPackage: "io.fabric8.certmanager.api.model.acme.v1beta1", ApiGroup: "cert-manager.io", ApiVersion: "v1beta1"},
