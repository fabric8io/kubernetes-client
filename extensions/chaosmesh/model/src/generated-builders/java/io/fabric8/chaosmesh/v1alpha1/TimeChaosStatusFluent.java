...
public class TimeChaosStatusFluent<A extends io.fabric8.chaosmesh.v1alpha1.TimeChaosStatusFluent<A>> extends BaseFluent<A>{
  ...
  public TimeChaosStatusFluent() {
  }
  
  public TimeChaosStatusFluent(TimeChaosStatus instance) {
  ...
  protected void copyInstance(TimeChaosStatus instance) {
    instance = instance != null ? instance : new TimeChaosStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    TimeChaosStatusFluent that = (TimeChaosStatusFluent) o;
  ...
  public class ConditionsNested<N> extends ChaosConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TimeChaosStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class ExperimentNested<N> extends ExperimentStatusFluent<ExperimentNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TimeChaosStatusFluent.this.withExperiment(builder.build());
    }
