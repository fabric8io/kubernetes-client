...
public class AWSChaosStatusFluent<A extends io.fabric8.chaosmesh.v1alpha1.AWSChaosStatusFluent<A>> extends BaseFluent<A>{
  ...
  public AWSChaosStatusFluent(AWSChaosStatus instance) {
  ...
  protected void copyInstance(AWSChaosStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    AWSChaosStatusFluent that = (AWSChaosStatusFluent) o;
  ...
  public class ConditionsNested<N> extends ChaosConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AWSChaosStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class ExperimentNested<N> extends ExperimentStatusFluent<ExperimentNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AWSChaosStatusFluent.this.withExperiment(builder.build());
    }
