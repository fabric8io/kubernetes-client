...
public class PodChaosStatusFluent<A extends io.fabric8.chaosmesh.v1alpha1.PodChaosStatusFluent<A>> extends BaseFluent<A>{
  ...
  public PodChaosStatusFluent() {
  }
  
  public PodChaosStatusFluent(PodChaosStatus instance) {
  ...
  protected void copyInstance(PodChaosStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    PodChaosStatusFluent that = (PodChaosStatusFluent) o;
  ...
  public class ConditionsNested<N> extends ChaosConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodChaosStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class ExperimentNested<N> extends ExperimentStatusFluent<ExperimentNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodChaosStatusFluent.this.withExperiment(builder.build());
    }
