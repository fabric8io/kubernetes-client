...
public class WorkflowNodeSpecFluent<A extends io.fabric8.chaosmesh.v1alpha1.WorkflowNodeSpecFluent<A>> extends BaseFluent<A>{
  ...
  public WorkflowNodeSpecFluent(WorkflowNodeSpec instance) {
  ...
  protected void copyInstance(WorkflowNodeSpec instance) {
    instance = instance != null ? instance : new WorkflowNodeSpec();
    if (instance != null) {
        ...
        this.withWorkflowName(instance.getWorkflowName());
  ...
  public ScheduleNested<A> editOrNewSchedule() {
    return this.withNewScheduleLike(Optional.ofNullable(this.buildSchedule()).orElse(new ScheduleSpecBuilder().build()));
  }
  
  public ScheduleNested<A> editOrNewScheduleLike(ScheduleSpec item) {
  ...
  public boolean equals(Object o) {
    ...
    WorkflowNodeSpecFluent that = (WorkflowNodeSpecFluent) o;
    ...
    if (!(Objects.equals(workflowName, that.workflowName))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(abortWithStatusCheck, awsChaos, azureChaos, blockChaos, children, conditionalBranches, deadline, dnsChaos, gcpChaos, httpChaos, ioChaos, jvmChaos, kernelChaos, networkChaos, physicalmachineChaos, podChaos, schedule, startTime, statusCheck, stressChaos, task, templateName, timeChaos, type, workflowName, additionalProperties);
  }
  ...
  public ScheduleNested<A> withNewScheduleLike(ScheduleSpec item) {
  ...
  public A withSchedule(ScheduleSpec schedule) {
    this._visitables.remove("schedule");
    if (schedule != null) {
        this.schedule = new ScheduleSpecBuilder(schedule);
  ...
  public A withWorkflowName(String workflowName) {
  ...
  public class AwsChaosNested<N> extends AWSChaosSpecFluent<AwsChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withAwsChaos(builder.build());
    }
  ...
  public class AzureChaosNested<N> extends AzureChaosSpecFluent<AzureChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withAzureChaos(builder.build());
    }
  ...
  public class BlockChaosNested<N> extends BlockChaosSpecFluent<BlockChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withBlockChaos(builder.build());
    }
  ...
  public class ConditionalBranchesNested<N> extends ConditionalBranchFluent<ConditionalBranchesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.setToConditionalBranches(index, builder.build());
    }
  ...
  public class DnsChaosNested<N> extends DNSChaosSpecFluent<DnsChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withDnsChaos(builder.build());
    }
  ...
  public class GcpChaosNested<N> extends GCPChaosSpecFluent<GcpChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withGcpChaos(builder.build());
    }
  ...
  public class HttpChaosNested<N> extends HTTPChaosSpecFluent<HttpChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withHttpChaos(builder.build());
    }
  ...
  public class IoChaosNested<N> extends IOChaosSpecFluent<IoChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withIoChaos(builder.build());
    }
  ...
  public class JvmChaosNested<N> extends JVMChaosSpecFluent<JvmChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withJvmChaos(builder.build());
    }
  ...
  public class KernelChaosNested<N> extends KernelChaosSpecFluent<KernelChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withKernelChaos(builder.build());
    }
  ...
  public class NetworkChaosNested<N> extends NetworkChaosSpecFluent<NetworkChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withNetworkChaos(builder.build());
    }
  ...
  public class PhysicalmachineChaosNested<N> extends PhysicalMachineChaosSpecFluent<PhysicalmachineChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withPhysicalmachineChaos(builder.build());
    }
  ...
  public class PodChaosNested<N> extends PodChaosSpecFluent<PodChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withPodChaos(builder.build());
    }
  ...
  public class ScheduleNested<N> extends ScheduleSpecFluent<ScheduleNested<N>> implements Nested<N>{
  
    ScheduleSpecBuilder builder;
  
    ScheduleNested(ScheduleSpec item) {
      this.builder = new ScheduleSpecBuilder(this, item);
    }
  
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withSchedule(builder.build());
    }
  ...
  public class StatusCheckNested<N> extends StatusCheckSpecFluent<StatusCheckNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withStatusCheck(builder.build());
    }
  ...
  public class StressChaosNested<N> extends StressChaosSpecFluent<StressChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withStressChaos(builder.build());
    }
  ...
  public class TaskNested<N> extends TaskFluent<TaskNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withTask(builder.build());
    }
  ...
  public class TimeChaosNested<N> extends TimeChaosSpecFluent<TimeChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkflowNodeSpecFluent.this.withTimeChaos(builder.build());
    }
