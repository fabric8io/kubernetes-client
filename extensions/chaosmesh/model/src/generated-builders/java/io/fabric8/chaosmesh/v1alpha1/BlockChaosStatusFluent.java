...
public class BlockChaosStatusFluent<A extends io.fabric8.chaosmesh.v1alpha1.BlockChaosStatusFluent<A>> extends BaseFluent<A>{
  ...
  public BlockChaosStatusFluent() {
  }
  
  public BlockChaosStatusFluent(BlockChaosStatus instance) {
  ...
  public A addToIds(Map<String,Integer> map) {
    if (this.ids == null && map != null) {
  ...
  public A addToIds(String key,Integer value) {
    if (this.ids == null && key != null && value != null) {
      this.ids = new LinkedHashMap();
    }
    if (key != null && value != null) {
  ...
  protected void copyInstance(BlockChaosStatus instance) {
    instance = instance != null ? instance : new BlockChaosStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    BlockChaosStatusFluent that = (BlockChaosStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(conditions, experiment, ids, additionalProperties);
  }
  ...
  public A removeFromIds(String key) {
    if (this.ids == null) {
      return (A) this;
    }
    if (key != null && this.ids != null) {
      this.ids.remove(key);
    }
    return (A) this;
  }
  
  public A removeFromIds(Map<String,Integer> map) {
    if (this.ids == null) {
      return (A) this;
    }
    if (map != null) {
  ...
  public <K,V>A withIds(Map<String,Integer> ids) {
    if (ids == null) {
      this.ids = null;
    } else {
      this.ids = new LinkedHashMap(ids);
    }
    return (A) this;
  }
  ...
  public class ConditionsNested<N> extends ChaosConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BlockChaosStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class ExperimentNested<N> extends ExperimentStatusFluent<ExperimentNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BlockChaosStatusFluent.this.withExperiment(builder.build());
    }
