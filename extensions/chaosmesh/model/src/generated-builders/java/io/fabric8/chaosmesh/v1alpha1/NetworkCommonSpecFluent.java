...
public class NetworkCommonSpecFluent<A extends io.fabric8.chaosmesh.v1alpha1.NetworkCommonSpecFluent<A>> extends BaseFluent<A>{
  ...
  public NetworkCommonSpecFluent() {
  }
  
  public NetworkCommonSpecFluent(NetworkCommonSpec instance) {
  ...
  protected void copyInstance(NetworkCommonSpec instance) {
    instance = instance != null ? instance : new NetworkCommonSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkCommonSpecFluent that = (NetworkCommonSpecFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(correlation, device, egressPort, hostname, ipAddress, ipProtocol, sourcePort, additionalProperties);
  }
