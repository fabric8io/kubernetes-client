...
public class PhysicalMachineChaosStatusFluent<A extends io.fabric8.chaosmesh.v1alpha1.PhysicalMachineChaosStatusFluent<A>> extends BaseFluent<A>{
  ...
  public PhysicalMachineChaosStatusFluent() {
  }
  
  public PhysicalMachineChaosStatusFluent(PhysicalMachineChaosStatus instance) {
  ...
  protected void copyInstance(PhysicalMachineChaosStatus instance) {
    instance = instance != null ? instance : new PhysicalMachineChaosStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    PhysicalMachineChaosStatusFluent that = (PhysicalMachineChaosStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(conditions, experiment, additionalProperties);
  }
  ...
  public class ConditionsNested<N> extends ChaosConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PhysicalMachineChaosStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class ExperimentNested<N> extends ExperimentStatusFluent<ExperimentNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PhysicalMachineChaosStatusFluent.this.withExperiment(builder.build());
    }
