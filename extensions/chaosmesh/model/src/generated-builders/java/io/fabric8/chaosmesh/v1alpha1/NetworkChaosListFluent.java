...
public class NetworkChaosListFluent<A extends io.fabric8.chaosmesh.v1alpha1.NetworkChaosListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<NetworkChaosBuilder> items = new ArrayList<NetworkChaosBuilder>();
  private String kind;
  private ListMeta metadata;

  public NetworkChaosListFluent() {
  }
  
  public NetworkChaosListFluent(NetworkChaosList instance) {
  ...
  public A addAllToItems(Collection<NetworkChaos> items) {
    ...
    for (NetworkChaos item : items) {
        NetworkChaosBuilder builder = new NetworkChaosBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(NetworkChaos item) {
  ...
  public NetworkChaos buildMatchingItem(Predicate<NetworkChaosBuilder> predicate) {
      for (NetworkChaosBuilder item : items) {
  ...
  protected void copyInstance(NetworkChaosList instance) {
    instance = instance != null ? instance : new NetworkChaosList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<NetworkChaosBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    NetworkChaosListFluent that = (NetworkChaosListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<NetworkChaosBuilder> predicate) {
    ...
    Iterator<NetworkChaosBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        NetworkChaosBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,NetworkChaos item) {
  ...
  public class ItemsNested<N> extends NetworkChaosFluent<ItemsNested<N>> implements Nested<N>{
  
    NetworkChaosBuilder builder;
    int index;
  
    ItemsNested(int index,NetworkChaos item) {
      this.index = index;
      this.builder = new NetworkChaosBuilder(this, item);
    }
  
    public N and() {
      return (N) NetworkChaosListFluent.this.setToItems(index, builder.build());
    }
