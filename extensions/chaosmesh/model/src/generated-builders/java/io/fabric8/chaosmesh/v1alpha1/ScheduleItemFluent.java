...
public class ScheduleItemFluent<A extends io.fabric8.chaosmesh.v1alpha1.ScheduleItemFluent<A>> extends BaseFluent<A>{
  ...
  public ScheduleItemFluent() {
  }
  
  public ScheduleItemFluent(ScheduleItem instance) {
  ...
  protected void copyInstance(ScheduleItem instance) {
    instance = instance != null ? instance : new ScheduleItem();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ScheduleItemFluent that = (ScheduleItemFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(awsChaos, azureChaos, blockChaos, dnsChaos, gcpChaos, httpChaos, ioChaos, jvmChaos, kernelChaos, networkChaos, physicalmachineChaos, podChaos, stressChaos, timeChaos, workflow, additionalProperties);
  }
  ...
  public class AwsChaosNested<N> extends AWSChaosSpecFluent<AwsChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withAwsChaos(builder.build());
    }
  ...
  public class AzureChaosNested<N> extends AzureChaosSpecFluent<AzureChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withAzureChaos(builder.build());
    }
  ...
  public class BlockChaosNested<N> extends BlockChaosSpecFluent<BlockChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withBlockChaos(builder.build());
    }
  ...
  public class DnsChaosNested<N> extends DNSChaosSpecFluent<DnsChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withDnsChaos(builder.build());
    }
  ...
  public class GcpChaosNested<N> extends GCPChaosSpecFluent<GcpChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withGcpChaos(builder.build());
    }
  ...
  public class HttpChaosNested<N> extends HTTPChaosSpecFluent<HttpChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withHttpChaos(builder.build());
    }
  ...
  public class IoChaosNested<N> extends IOChaosSpecFluent<IoChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withIoChaos(builder.build());
    }
  ...
  public class JvmChaosNested<N> extends JVMChaosSpecFluent<JvmChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withJvmChaos(builder.build());
    }
  ...
  public class KernelChaosNested<N> extends KernelChaosSpecFluent<KernelChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withKernelChaos(builder.build());
    }
  ...
  public class NetworkChaosNested<N> extends NetworkChaosSpecFluent<NetworkChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withNetworkChaos(builder.build());
    }
  ...
  public class PhysicalmachineChaosNested<N> extends PhysicalMachineChaosSpecFluent<PhysicalmachineChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withPhysicalmachineChaos(builder.build());
    }
  ...
  public class PodChaosNested<N> extends PodChaosSpecFluent<PodChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withPodChaos(builder.build());
    }
  ...
  public class StressChaosNested<N> extends StressChaosSpecFluent<StressChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withStressChaos(builder.build());
    }
  ...
  public class TimeChaosNested<N> extends TimeChaosSpecFluent<TimeChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withTimeChaos(builder.build());
    }
  ...
  public class WorkflowNested<N> extends WorkflowSpecFluent<WorkflowNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ScheduleItemFluent.this.withWorkflow(builder.build());
    }
