...
public class TcParameterFluent<A extends io.fabric8.chaosmesh.v1alpha1.TcParameterFluent<A>> extends BaseFluent<A>{
  ...
  public TcParameterFluent() {
  }
  
  public TcParameterFluent(TcParameter instance) {
  ...
  protected void copyInstance(TcParameter instance) {
    instance = instance != null ? instance : new TcParameter();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    TcParameterFluent that = (TcParameterFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(bandwidth, corrupt, delay, duplicate, loss, rate, additionalProperties);
  }
  ...
  public class BandwidthNested<N> extends BandwidthSpecFluent<BandwidthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TcParameterFluent.this.withBandwidth(builder.build());
    }
  ...
  public class CorruptNested<N> extends CorruptSpecFluent<CorruptNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TcParameterFluent.this.withCorrupt(builder.build());
    }
  ...
  public class DelayNested<N> extends DelaySpecFluent<DelayNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TcParameterFluent.this.withDelay(builder.build());
    }
  ...
  public class DuplicateNested<N> extends DuplicateSpecFluent<DuplicateNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TcParameterFluent.this.withDuplicate(builder.build());
    }
  ...
  public class LossNested<N> extends LossSpecFluent<LossNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TcParameterFluent.this.withLoss(builder.build());
    }
  ...
  public class RateNested<N> extends RateSpecFluent<RateNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TcParameterFluent.this.withRate(builder.build());
    }
