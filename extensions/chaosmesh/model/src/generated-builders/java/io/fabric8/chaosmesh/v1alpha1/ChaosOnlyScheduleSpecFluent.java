...
public class ChaosOnlyScheduleSpecFluent<A extends io.fabric8.chaosmesh.v1alpha1.ChaosOnlyScheduleSpecFluent<A>> extends BaseFluent<A>{
  ...
  public ChaosOnlyScheduleSpecFluent(ChaosOnlyScheduleSpec instance) {
  ...
  protected void copyInstance(ChaosOnlyScheduleSpec instance) {
    instance = instance != null ? instance : new ChaosOnlyScheduleSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ChaosOnlyScheduleSpecFluent that = (ChaosOnlyScheduleSpecFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(awsChaos, azureChaos, blockChaos, concurrencyPolicy, dnsChaos, gcpChaos, historyLimit, httpChaos, ioChaos, jvmChaos, kernelChaos, networkChaos, physicalmachineChaos, podChaos, schedule, startingDeadlineSeconds, stressChaos, timeChaos, type, additionalProperties);
  }
  ...
  public class AwsChaosNested<N> extends AWSChaosSpecFluent<AwsChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosOnlyScheduleSpecFluent.this.withAwsChaos(builder.build());
    }
  ...
  public class AzureChaosNested<N> extends AzureChaosSpecFluent<AzureChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosOnlyScheduleSpecFluent.this.withAzureChaos(builder.build());
    }
  ...
  public class BlockChaosNested<N> extends BlockChaosSpecFluent<BlockChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosOnlyScheduleSpecFluent.this.withBlockChaos(builder.build());
    }
  ...
  public class DnsChaosNested<N> extends DNSChaosSpecFluent<DnsChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosOnlyScheduleSpecFluent.this.withDnsChaos(builder.build());
    }
  ...
  public class GcpChaosNested<N> extends GCPChaosSpecFluent<GcpChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosOnlyScheduleSpecFluent.this.withGcpChaos(builder.build());
    }
  ...
  public class HttpChaosNested<N> extends HTTPChaosSpecFluent<HttpChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosOnlyScheduleSpecFluent.this.withHttpChaos(builder.build());
    }
  ...
  public class IoChaosNested<N> extends IOChaosSpecFluent<IoChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosOnlyScheduleSpecFluent.this.withIoChaos(builder.build());
    }
  ...
  public class JvmChaosNested<N> extends JVMChaosSpecFluent<JvmChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosOnlyScheduleSpecFluent.this.withJvmChaos(builder.build());
    }
  ...
  public class KernelChaosNested<N> extends KernelChaosSpecFluent<KernelChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosOnlyScheduleSpecFluent.this.withKernelChaos(builder.build());
    }
  ...
  public class NetworkChaosNested<N> extends NetworkChaosSpecFluent<NetworkChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosOnlyScheduleSpecFluent.this.withNetworkChaos(builder.build());
    }
  ...
  public class PhysicalmachineChaosNested<N> extends PhysicalMachineChaosSpecFluent<PhysicalmachineChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosOnlyScheduleSpecFluent.this.withPhysicalmachineChaos(builder.build());
    }
  ...
  public class PodChaosNested<N> extends PodChaosSpecFluent<PodChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosOnlyScheduleSpecFluent.this.withPodChaos(builder.build());
    }
  ...
  public class StressChaosNested<N> extends StressChaosSpecFluent<StressChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosOnlyScheduleSpecFluent.this.withStressChaos(builder.build());
    }
  ...
  public class TimeChaosNested<N> extends TimeChaosSpecFluent<TimeChaosNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosOnlyScheduleSpecFluent.this.withTimeChaos(builder.build());
    }
