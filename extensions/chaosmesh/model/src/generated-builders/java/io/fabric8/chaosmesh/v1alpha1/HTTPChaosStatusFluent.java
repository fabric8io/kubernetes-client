...
public class HTTPChaosStatusFluent<A extends io.fabric8.chaosmesh.v1alpha1.HTTPChaosStatusFluent<A>> extends BaseFluent<A>{
  ...
  public HTTPChaosStatusFluent() {
  }
  
  public HTTPChaosStatusFluent(HTTPChaosStatus instance) {
  ...
  protected void copyInstance(HTTPChaosStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    HTTPChaosStatusFluent that = (HTTPChaosStatusFluent) o;
  ...
  public class ConditionsNested<N> extends ChaosConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPChaosStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class ExperimentNested<N> extends ExperimentStatusFluent<ExperimentNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPChaosStatusFluent.this.withExperiment(builder.build());
    }
