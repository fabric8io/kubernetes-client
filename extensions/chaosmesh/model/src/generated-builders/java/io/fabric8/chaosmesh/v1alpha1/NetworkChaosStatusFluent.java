...
public class NetworkChaosStatusFluent<A extends io.fabric8.chaosmesh.v1alpha1.NetworkChaosStatusFluent<A>> extends BaseFluent<A>{
  ...
  public NetworkChaosStatusFluent() {
  }
  
  public NetworkChaosStatusFluent(NetworkChaosStatus instance) {
  ...
  protected void copyInstance(NetworkChaosStatus instance) {
    instance = instance != null ? instance : new NetworkChaosStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkChaosStatusFluent that = (NetworkChaosStatusFluent) o;
  ...
  public class ConditionsNested<N> extends ChaosConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NetworkChaosStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class ExperimentNested<N> extends ExperimentStatusFluent<ExperimentNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NetworkChaosStatusFluent.this.withExperiment(builder.build());
    }
