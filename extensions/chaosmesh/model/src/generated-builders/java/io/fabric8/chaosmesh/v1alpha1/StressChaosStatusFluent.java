...
public class StressChaosStatusFluent<A extends io.fabric8.chaosmesh.v1alpha1.StressChaosStatusFluent<A>> extends BaseFluent<A>{
  ...
  public StressChaosStatusFluent() {
  }
  
  public StressChaosStatusFluent(StressChaosStatus instance) {
  ...
  protected void copyInstance(StressChaosStatus instance) {
    instance = instance != null ? instance : new StressChaosStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    StressChaosStatusFluent that = (StressChaosStatusFluent) o;
  ...
  public <K,V>A withInstances(Map<String,StressInstance> instances) {
    if (instances == null) {
      this.instances = null;
    } else {
  ...
  public class ConditionsNested<N> extends ChaosConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StressChaosStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class ExperimentNested<N> extends ExperimentStatusFluent<ExperimentNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StressChaosStatusFluent.this.withExperiment(builder.build());
    }
