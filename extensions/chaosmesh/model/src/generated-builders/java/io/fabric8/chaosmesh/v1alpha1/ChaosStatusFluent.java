...
public class ChaosStatusFluent<A extends io.fabric8.chaosmesh.v1alpha1.ChaosStatusFluent<A>> extends BaseFluent<A>{
  ...
  public ChaosStatusFluent() {
  }
  
  public ChaosStatusFluent(ChaosStatus instance) {
  ...
  protected void copyInstance(ChaosStatus instance) {
    instance = instance != null ? instance : new ChaosStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ChaosStatusFluent that = (ChaosStatusFluent) o;
  ...
  public class ConditionsNested<N> extends ChaosConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class ExperimentNested<N> extends ExperimentStatusFluent<ExperimentNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ChaosStatusFluent.this.withExperiment(builder.build());
    }
