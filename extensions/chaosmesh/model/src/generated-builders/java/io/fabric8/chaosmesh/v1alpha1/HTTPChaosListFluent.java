...
public class HTTPChaosListFluent<A extends io.fabric8.chaosmesh.v1alpha1.HTTPChaosListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<HTTPChaosBuilder> items = new ArrayList<HTTPChaosBuilder>();
  private String kind;
  private ListMeta metadata;

  public HTTPChaosListFluent() {
  }
  ...
  public A addAllToItems(Collection<HTTPChaos> items) {
    ...
    for (HTTPChaos item : items) {
        HTTPChaosBuilder builder = new HTTPChaosBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(HTTPChaos item) {
  ...
  public HTTPChaos buildMatchingItem(Predicate<HTTPChaosBuilder> predicate) {
      for (HTTPChaosBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<HTTPChaosBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    HTTPChaosListFluent that = (HTTPChaosListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<HTTPChaosBuilder> predicate) {
    ...
    Iterator<HTTPChaosBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        HTTPChaosBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,HTTPChaos item) {
  ...
  public class ItemsNested<N> extends HTTPChaosFluent<ItemsNested<N>> implements Nested<N>{
  
    HTTPChaosBuilder builder;
    int index;
  
    ItemsNested(int index,HTTPChaos item) {
      this.index = index;
      this.builder = new HTTPChaosBuilder(this, item);
    }
  
    public N and() {
      return (N) HTTPChaosListFluent.this.setToItems(index, builder.build());
    }
