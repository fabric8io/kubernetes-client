...
public class KernelChaosListFluent<A extends io.fabric8.chaosmesh.v1alpha1.KernelChaosListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<KernelChaosBuilder> items = new ArrayList<KernelChaosBuilder>();
  private String kind;
  private ListMeta metadata;

  public KernelChaosListFluent() {
  }
  
  public KernelChaosListFluent(KernelChaosList instance) {
  ...
  public A addAllToItems(Collection<KernelChaos> items) {
    ...
    for (KernelChaos item : items) {
        KernelChaosBuilder builder = new KernelChaosBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(KernelChaos item) {
  ...
  public KernelChaos buildMatchingItem(Predicate<KernelChaosBuilder> predicate) {
      for (KernelChaosBuilder item : items) {
  ...
  protected void copyInstance(KernelChaosList instance) {
    instance = instance != null ? instance : new KernelChaosList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<KernelChaosBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    KernelChaosListFluent that = (KernelChaosListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<KernelChaosBuilder> predicate) {
    ...
    Iterator<KernelChaosBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        KernelChaosBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,KernelChaos item) {
  ...
  public class ItemsNested<N> extends KernelChaosFluent<ItemsNested<N>> implements Nested<N>{
  
    KernelChaosBuilder builder;
    int index;
  
    ItemsNested(int index,KernelChaos item) {
      this.index = index;
      this.builder = new KernelChaosBuilder(this, item);
    }
  
    public N and() {
      return (N) KernelChaosListFluent.this.setToItems(index, builder.build());
    }
