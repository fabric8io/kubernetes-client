...
public class JVMExceptionSpecFluent<A extends io.fabric8.chaosmesh.v1alpha1.JVMExceptionSpecFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(JVMExceptionSpec instance) {
    instance = instance != null ? instance : new JVMExceptionSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    JVMExceptionSpecFluent that = (JVMExceptionSpecFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(className, exception, method, pid, port, additionalProperties);
  }
