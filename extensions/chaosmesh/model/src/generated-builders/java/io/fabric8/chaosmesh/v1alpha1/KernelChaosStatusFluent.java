...
public class KernelChaosStatusFluent<A extends io.fabric8.chaosmesh.v1alpha1.KernelChaosStatusFluent<A>> extends BaseFluent<A>{
  ...
  public KernelChaosStatusFluent() {
  }
  
  public KernelChaosStatusFluent(KernelChaosStatus instance) {
  ...
  protected void copyInstance(KernelChaosStatus instance) {
    instance = instance != null ? instance : new KernelChaosStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    KernelChaosStatusFluent that = (KernelChaosStatusFluent) o;
  ...
  public class ConditionsNested<N> extends ChaosConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KernelChaosStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class ExperimentNested<N> extends ExperimentStatusFluent<ExperimentNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KernelChaosStatusFluent.this.withExperiment(builder.build());
    }
