...
public class AzureChaosStatusFluent<A extends io.fabric8.chaosmesh.v1alpha1.AzureChaosStatusFluent<A>> extends BaseFluent<A>{
  ...
  public AzureChaosStatusFluent() {
  }
  
  public AzureChaosStatusFluent(AzureChaosStatus instance) {
  ...
  protected void copyInstance(AzureChaosStatus instance) {
    instance = instance != null ? instance : new AzureChaosStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    AzureChaosStatusFluent that = (AzureChaosStatusFluent) o;
  ...
  public class ConditionsNested<N> extends ChaosConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AzureChaosStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class ExperimentNested<N> extends ExperimentStatusFluent<ExperimentNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AzureChaosStatusFluent.this.withExperiment(builder.build());
    }
