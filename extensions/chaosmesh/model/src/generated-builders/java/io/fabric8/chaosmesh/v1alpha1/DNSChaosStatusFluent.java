...
public class DNSChaosStatusFluent<A extends io.fabric8.chaosmesh.v1alpha1.DNSChaosStatusFluent<A>> extends BaseFluent<A>{
  ...
  public DNSChaosStatusFluent() {
  }
  
  public DNSChaosStatusFluent(DNSChaosStatus instance) {
  ...
  protected void copyInstance(DNSChaosStatus instance) {
    instance = instance != null ? instance : new DNSChaosStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    DNSChaosStatusFluent that = (DNSChaosStatusFluent) o;
  ...
  public class ConditionsNested<N> extends ChaosConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DNSChaosStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class ExperimentNested<N> extends ExperimentStatusFluent<ExperimentNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DNSChaosStatusFluent.this.withExperiment(builder.build());
    }
