...
public class PodHttpChaosRuleFluent<A extends io.fabric8.chaosmesh.v1alpha1.PodHttpChaosRuleFluent<A>> extends BaseFluent<A>{
  ...
  public PodHttpChaosRuleFluent(PodHttpChaosRule instance) {
  ...
  protected void copyInstance(PodHttpChaosRule instance) {
    instance = instance != null ? instance : new PodHttpChaosRule();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    PodHttpChaosRuleFluent that = (PodHttpChaosRuleFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(actions, port, selector, source, target, additionalProperties);
  }
  ...
  public class ActionsNested<N> extends PodHttpChaosActionsFluent<ActionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodHttpChaosRuleFluent.this.withActions(builder.build());
    }
  ...
  public class SelectorNested<N> extends PodHttpChaosSelectorFluent<SelectorNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodHttpChaosRuleFluent.this.withSelector(builder.build());
    }
