...
public class PodSelectorFluent<A extends io.fabric8.chaosmesh.v1alpha1.PodSelectorFluent<A>> extends BaseFluent<A>{
  ...
  public PodSelectorFluent() {
  }
  
  public PodSelectorFluent(PodSelector instance) {
  ...
  protected void copyInstance(PodSelector instance) {
  ...
  public boolean equals(Object o) {
    ...
    PodSelectorFluent that = (PodSelectorFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(mode, selector, value, additionalProperties);
  }
  ...
  public class SelectorNested<N> extends PodSelectorSpecFluent<SelectorNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodSelectorFluent.this.withSelector(builder.build());
    }
