...
public class Workflow implements Editable<WorkflowBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Workflow(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
