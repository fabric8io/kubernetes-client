...
public class PodNetworkChaosStatus implements Editable<PodNetworkChaosStatusBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodNetworkChaosStatus)) {
            return false;
        }
        PodNetworkChaosStatus other = (PodNetworkChaosStatus) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PodNetworkChaosStatus;
    }
    ...
    public String toString() {
        return "PodNetworkChaosStatus(" + "failedMessage=" + this.getFailedMessage() + ", observedGeneration=" + this.getObservedGeneration() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
