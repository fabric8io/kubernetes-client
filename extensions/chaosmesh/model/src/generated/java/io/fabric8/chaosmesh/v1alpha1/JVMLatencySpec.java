...
public class JVMLatencySpec implements Editable<JVMLatencySpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JVMLatencySpec)) {
            return false;
        }
        JVMLatencySpec other = (JVMLatencySpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof JVMLatencySpec;
    }
    ...
    public String toString() {
        return "JVMLatencySpec(" + "className=" + this.getClassName() + ", latency=" + this.getLatency() + ", method=" + this.getMethod() + ", pid=" + this.getPid() + ", port=" + this.getPort() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
