...
public class DiskPayloadSpec implements Editable<DiskPayloadSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DiskPayloadSpec)) {
            return false;
        }
        DiskPayloadSpec other = (DiskPayloadSpec) o;
        ...
        Object this$payloadProcessNum = this.getPayloadProcessNum();
        Object other$payloadProcessNum = other.getPayloadProcessNum();
        if (this$payloadProcessNum == null ? other$payloadProcessNum != null : !this$payloadProcessNum.equals(other$payloadProcessNum)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DiskPayloadSpec;
    }
    ...
    public int hashCode() {
        ...
        Object $payloadProcessNum = this.getPayloadProcessNum();
        result = result * prime + ($payloadProcessNum == null ? 43 : $payloadProcessNum.hashCode());
    ...
    public String toString() {
        return "DiskPayloadSpec(" + "path=" + this.getPath() + ", payloadProcessNum=" + this.getPayloadProcessNum() + ", size=" + this.getSize() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
