...
public class TimeChaosStatus implements KubernetesResource
{
     ...
     * @param failedMessage
     */
    public TimeChaosStatus(ExperimentStatus experiment, String failedMessage, ScheduleStatus scheduler) {
        super();
