...
public class EmbedStatusCheck implements Editable<EmbedStatusCheckBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmbedStatusCheck)) {
            return false;
        }
        EmbedStatusCheck other = (EmbedStatusCheck) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EmbedStatusCheck;
    }
    ...
    public String toString() {
        return "EmbedStatusCheck(" + "http=" + this.getHttp() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
