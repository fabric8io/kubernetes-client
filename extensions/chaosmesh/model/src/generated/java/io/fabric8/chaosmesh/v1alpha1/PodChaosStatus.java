...
public class PodChaosStatus implements KubernetesResource
{
     ...
     * @param failedMessage
     */
    public PodChaosStatus(ExperimentStatus experiment, String failedMessage, ScheduleStatus scheduler) {
        super();
