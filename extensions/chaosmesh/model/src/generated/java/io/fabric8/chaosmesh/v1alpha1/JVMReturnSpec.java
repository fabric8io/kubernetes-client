...
public class JVMReturnSpec implements Editable<JVMReturnSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JVMReturnSpec)) {
            return false;
        }
        JVMReturnSpec other = (JVMReturnSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof JVMReturnSpec;
    }
    ...
    public String toString() {
        return "JVMReturnSpec(" + "className=" + this.getClassName() + ", method=" + this.getMethod() + ", pid=" + this.getPid() + ", port=" + this.getPort() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
