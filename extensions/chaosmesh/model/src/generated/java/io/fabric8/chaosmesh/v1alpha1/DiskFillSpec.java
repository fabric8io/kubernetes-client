...
public class DiskFillSpec implements Editable<DiskFillSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DiskFillSpec)) {
            return false;
        }
        DiskFillSpec other = (DiskFillSpec) o;
        if (!other.canEqual(this)) {
            return false;
        }
        Object this$fillByFallocate = this.getFillByFallocate();
        Object other$fillByFallocate = other.getFillByFallocate();
        if (this$fillByFallocate == null ? other$fillByFallocate != null : !this$fillByFallocate.equals(other$fillByFallocate)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DiskFillSpec;
    }
    ...
    public int hashCode() {
        final int prime = 59;
        int result = 1;
        Object $fillByFallocate = this.getFillByFallocate();
        result = result * prime + ($fillByFallocate == null ? 43 : $fillByFallocate.hashCode());
    ...
    public String toString() {
        return "DiskFillSpec(" + "fillByFallocate=" + this.getFillByFallocate() + ", path=" + this.getPath() + ", size=" + this.getSize() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
