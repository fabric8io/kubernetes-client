...
public class EmbedChaos implements Editable<EmbedChaosBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmbedChaos)) {
            return false;
        }
        EmbedChaos other = (EmbedChaos) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EmbedChaos;
    }
    ...
    public String toString() {
        return "EmbedChaos(" + "awsChaos=" + this.getAwsChaos() + ", azureChaos=" + this.getAzureChaos() + ", blockChaos=" + this.getBlockChaos() + ", dnsChaos=" + this.getDnsChaos() + ", gcpChaos=" + this.getGcpChaos() + ", httpChaos=" + this.getHttpChaos() + ", ioChaos=" + this.getIoChaos() + ", jvmChaos=" + this.getJvmChaos() + ", kernelChaos=" + this.getKernelChaos() + ", networkChaos=" + this.getNetworkChaos() + ", physicalmachineChaos=" + this.getPhysicalmachineChaos() + ", podChaos=" + this.getPodChaos() + ", stressChaos=" + this.getStressChaos() + ", timeChaos=" + this.getTimeChaos() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
