...
public class Schedule implements Editable<ScheduleBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Schedule(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
