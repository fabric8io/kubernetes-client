...
public class ScheduleStatus implements KubernetesResource
{
     ...
     * @param nextStart
     */
    public ScheduleStatus(String nextRecover, String nextStart) {
        super();
    ...
    @JsonProperty("nextRecover")
    public void setNextRecover(String nextRecover) {
        this.nextRecover = nextRecover;
    }
