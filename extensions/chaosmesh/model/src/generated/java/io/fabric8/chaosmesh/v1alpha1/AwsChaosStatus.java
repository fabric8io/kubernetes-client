...
public class AwsChaosStatus implements KubernetesResource
{
     ...
     * @param failedMessage
     */
    public AwsChaosStatus(ExperimentStatus experiment, String failedMessage, ScheduleStatus scheduler) {
        super();
