...
public class ScheduleSpec implements Editable<ScheduleSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScheduleSpec)) {
            return false;
        }
        ScheduleSpec other = (ScheduleSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ScheduleSpec;
    }
    ...
    public String toString() {
        return "ScheduleSpec(" + "awsChaos=" + this.getAwsChaos() + ", azureChaos=" + this.getAzureChaos() + ", blockChaos=" + this.getBlockChaos() + ", concurrencyPolicy=" + this.getConcurrencyPolicy() + ", dnsChaos=" + this.getDnsChaos() + ", gcpChaos=" + this.getGcpChaos() + ", historyLimit=" + this.getHistoryLimit() + ", httpChaos=" + this.getHttpChaos() + ", ioChaos=" + this.getIoChaos() + ", jvmChaos=" + this.getJvmChaos() + ", kernelChaos=" + this.getKernelChaos() + ", networkChaos=" + this.getNetworkChaos() + ", physicalmachineChaos=" + this.getPhysicalmachineChaos() + ", podChaos=" + this.getPodChaos() + ", schedule=" + this.getSchedule() + ", startingDeadlineSeconds=" + this.getStartingDeadlineSeconds() + ", stressChaos=" + this.getStressChaos() + ", timeChaos=" + this.getTimeChaos() + ", type=" + this.getType() + ", workflow=" + this.getWorkflow() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
