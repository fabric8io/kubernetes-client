...
public class NetworkPartitionSpec implements Editable<NetworkPartitionSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkPartitionSpec)) {
            return false;
        }
        NetworkPartitionSpec other = (NetworkPartitionSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof NetworkPartitionSpec;
    }
    ...
    public String toString() {
        return "NetworkPartitionSpec(" + "acceptTcpFlags=" + this.getAcceptTcpFlags() + ", device=" + this.getDevice() + ", direction=" + this.getDirection() + ", hostname=" + this.getHostname() + ", ipAddress=" + this.getIpAddress() + ", ipProtocol=" + this.getIpProtocol() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
