...
public class PodHttpChaosRule implements Editable<PodHttpChaosRuleBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodHttpChaosRule)) {
            return false;
        }
        PodHttpChaosRule other = (PodHttpChaosRule) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PodHttpChaosRule;
    }
    ...
    public String toString() {
        return "PodHttpChaosRule(" + "actions=" + this.getActions() + ", port=" + this.getPort() + ", selector=" + this.getSelector() + ", source=" + this.getSource() + ", target=" + this.getTarget() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
