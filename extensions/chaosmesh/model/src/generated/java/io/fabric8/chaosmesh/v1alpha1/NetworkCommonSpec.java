...
public class NetworkCommonSpec implements Editable<NetworkCommonSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkCommonSpec)) {
            return false;
        }
        NetworkCommonSpec other = (NetworkCommonSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof NetworkCommonSpec;
    }
    ...
    public String toString() {
        return "NetworkCommonSpec(" + "correlation=" + this.getCorrelation() + ", device=" + this.getDevice() + ", egressPort=" + this.getEgressPort() + ", hostname=" + this.getHostname() + ", ipAddress=" + this.getIpAddress() + ", ipProtocol=" + this.getIpProtocol() + ", sourcePort=" + this.getSourcePort() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
