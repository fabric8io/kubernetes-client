...
public class PodIOChaos implements HasMetadata, Namespaced
{
    ...
    public PodIOChaos(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, PodIOChaosSpec spec, PodIOChaosStatus status) {
        super();
