...
public class PodIOChaos implements Editable<PodIOChaosBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodIOChaos)) {
            return false;
        }
        PodIOChaos other = (PodIOChaos) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PodIOChaos;
    }
    ...
    public String toString() {
        return "PodIOChaos(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
