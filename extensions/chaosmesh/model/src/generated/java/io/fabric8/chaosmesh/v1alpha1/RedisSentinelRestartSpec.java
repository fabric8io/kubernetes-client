...
public class RedisSentinelRestartSpec implements Editable<RedisSentinelRestartSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RedisSentinelRestartSpec)) {
            return false;
        }
        RedisSentinelRestartSpec other = (RedisSentinelRestartSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RedisSentinelRestartSpec;
    }
    ...
    public String toString() {
        return "RedisSentinelRestartSpec(" + "addr=" + this.getAddr() + ", conf=" + this.getConf() + ", flushConfig=" + this.getFlushConfig() + ", password=" + this.getPassword() + ", redisPath=" + this.getRedisPath() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
