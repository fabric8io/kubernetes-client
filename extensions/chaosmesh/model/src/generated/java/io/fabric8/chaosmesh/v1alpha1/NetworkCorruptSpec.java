...
public class NetworkCorruptSpec implements Editable<NetworkCorruptSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkCorruptSpec)) {
            return false;
        }
        NetworkCorruptSpec other = (NetworkCorruptSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof NetworkCorruptSpec;
    }
    ...
    public String toString() {
        return "NetworkCorruptSpec(" + "correlation=" + this.getCorrelation() + ", device=" + this.getDevice() + ", egressPort=" + this.getEgressPort() + ", hostname=" + this.getHostname() + ", ipAddress=" + this.getIpAddress() + ", ipProtocol=" + this.getIpProtocol() + ", percent=" + this.getPercent() + ", sourcePort=" + this.getSourcePort() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
