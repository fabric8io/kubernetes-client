...
public class ArgoServerSpec implements KubernetesResource
{
     ...
     * @param cluster
     */
    public ArgoServerSpec(String argoNamespace, String cluster) {
        super();
    ...
    @JsonProperty("argoNamespace")
    public void setArgoNamespace(String argoNamespace) {
        this.argoNamespace = argoNamespace;
    }
