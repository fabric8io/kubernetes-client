...
public class ClusterManager implements HasMetadata
{
     ...
     * @param status
     */
    public ClusterManager(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, ClusterManagerSpec spec, ClusterManagerStatus status) {
        super();
