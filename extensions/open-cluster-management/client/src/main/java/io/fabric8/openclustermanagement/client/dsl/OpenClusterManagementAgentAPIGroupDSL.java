...
public interface OpenClusterManagementAgentAPIGroupDSL extends Client {
  MixedOperation<KlusterletAddonConfig, KlusterletAddonConfigList, Resource<KlusterletAddonConfig>> klusterletAddonConfigs();
}
