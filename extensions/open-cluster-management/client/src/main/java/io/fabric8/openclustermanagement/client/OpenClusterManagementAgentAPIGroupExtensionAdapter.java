...
public class OpenClusterManagementAgentAPIGroupExtensionAdapter implements ExtensionAdapter<OpenClusterManagementAgentAPIGroupClient> {

  @Override
  public Class<OpenClusterManagementAgentAPIGroupClient> getExtensionType() {
    return OpenClusterManagementAgentAPIGroupClient.class;
  }
