...
func main() {
	...
	crdLists := map[reflect.Type]schemagen.CrdScope{
		reflect.TypeOf(cluster.ManagedClusterList{}):                  schemagen.Cluster,
		reflect.TypeOf(clusterv1beta1.ManagedClusterSetList{}):        schemagen.Cluster,
		reflect.TypeOf(clusterv1beta1.ManagedClusterSetBindingList{}): schemagen.Namespaced,
		reflect.TypeOf(clusterv1alpha1.PlacementList{}):               schemagen.Namespaced,
		reflect.TypeOf(clusterv1alpha1.PlacementDecisionList{}):       schemagen.Namespaced,
	}
	...
	packageMapping := map[string]schemagen.PackageInformation{
		"open-cluster-management.io/api/cluster/v1":       {JavaPackage: "io.fabric8.openclustermanagement.api.model.cluster.v1", ApiGroup: "cluster.open-cluster-management.io", ApiVersion: "v1"},
		"open-cluster-management.io/api/cluster/v1beta1":  {JavaPackage: "io.fabric8.openclustermanagement.api.model.cluster.v1beta1", ApiGroup: "cluster.open-cluster-management.io", ApiVersion: "v1beta1"},
		"open-cluster-management.io/api/cluster/v1alpha1": {JavaPackage: "io.fabric8.openclustermanagement.api.model.cluster.v1alpha1", ApiGroup: "cluster.open-cluster-management.io", ApiVersion: "v1alpha1"},
	}
	...
	json := schemagen.GenerateSchemaWithAllOptions("http://fabric8.io/OpenClusterManagement#", crdLists, typesDescriptors, providedPackages, manualTypeMap, packageMapping, mappingSchema, providedTypes, constraints, interfacesMapping, javaNameStrategyMapping, enumMapping, "io.fabric8")
