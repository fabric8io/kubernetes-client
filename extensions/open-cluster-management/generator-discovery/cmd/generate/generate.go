...
func main() {
	...
	crdLists := map[reflect.Type]schemagen.CrdScope{
		reflect.TypeOf(discoveryv1alpha1.DiscoveredClusterList{}): schemagen.Namespaced,
		reflect.TypeOf(discoveryv1alpha1.DiscoveryConfigList{}):   schemagen.Namespaced,
	}
	...
	packageMapping := map[string]schemagen.PackageInformation{
		"github.com/open-cluster-management/discovery/api/v1alpha1": {JavaPackage: "io.fabric8.openclustermanagement.api.model.discovery.v1alpha1", ApiGroup: "discovery.open-cluster-management.io", ApiVersion: "v1alpha1"},
	}
	...
	json := schemagen.GenerateSchemaWithAllOptions("http://fabric8.io/OpenClusterManagement#Discovery", crdLists, typesDescriptors, providedPackages, manualTypeMap, packageMapping, mappingSchema, providedTypes, constraints, interfacesMapping, javaNameStrategyMapping, enumMapping, "io.fabric8")
