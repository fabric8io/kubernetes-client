...
public class DiscoveryConfig implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public DiscoveryConfig(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, DiscoveryConfigSpec spec, DiscoveryConfigStatus status) {
        super();
