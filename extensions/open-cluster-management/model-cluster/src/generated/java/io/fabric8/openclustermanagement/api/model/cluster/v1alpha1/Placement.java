...
public class Placement implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public Placement(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, PlacementSpec spec, PlacementStatus status) {
        super();
