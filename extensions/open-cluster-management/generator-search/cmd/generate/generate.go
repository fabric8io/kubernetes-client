...
func main() {
	...
	crdLists := map[reflect.Type]schemagen.CrdScope{
		reflect.TypeOf(searchv1alpha1.SearchCustomizationList{}): schemagen.Namespaced,
		reflect.TypeOf(searchv1alpha1.SearchOperatorList{}):      schemagen.Namespaced,
	}
	...
	packageMapping := map[string]schemagen.PackageInformation{
		"github.com/open-cluster-management/search-operator/api/v1alpha1": {JavaPackage: "io.fabric8.openclustermanagement.api.model.searchoperator.v1alpha1", ApiGroup: "search.open-cluster-management.io", ApiVersion: "v1alpha1"},
	}
