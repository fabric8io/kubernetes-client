...
public class StorageSpecFluent<A extends io.fabric8.openclustermanagement.api.model.search.v1alpha1.StorageSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(size, storageClassName, additionalProperties);
  }
  ...
  public A withNewSize(String amount) {
    return (A) this.withSize(new Quantity(amount));
  }
  
  public A withNewSize(String amount,String format) {
    return (A) this.withSize(new Quantity(amount, format));
  }
