...
public class RuleSpecFluent<A extends io.fabric8.openclustermanagement.api.model.observability.v1beta2.RuleSpecFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(RuleSpec instance) {
    instance = instance != null ? instance : new RuleSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    RuleSpecFluent that = (RuleSpecFluent) o;
    if (!(Objects.equals(containers, that.containers))) {
      return false;
    }
    if (!(Objects.equals(evalInterval, that.evalInterval))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(containers, evalInterval, replicas, resources, serviceAccountAnnotations, additionalProperties);
  }
  ...
  public A withEvalInterval(String evalInterval) {
  ...
  public class ContainersNested<N> extends ContainerFluent<ContainersNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RuleSpecFluent.this.setToContainers(index, builder.build());
    }
  ...
  public class ResourcesNested<N> extends ResourceRequirementsFluent<ResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RuleSpecFluent.this.withResources(builder.build());
    }
