...
public class PlacementBindingListFluent<A extends io.fabric8.openclustermanagement.api.model.policy.v1.PlacementBindingListFluent<A>> extends BaseFluent<A>{
  ...
  public PlacementBindingListFluent() {
  }
  
  public PlacementBindingListFluent(PlacementBindingList instance) {
  ...
  public A addAllToItems(Collection<PlacementBinding> items) {
    ...
    for (PlacementBinding item : items) {
  ...
  public ItemsNested<A> addNewItemLike(PlacementBinding item) {
  ...
  public A addToItems(PlacementBinding... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (PlacementBinding item : items) {
  ...
  public PlacementBinding buildMatchingItem(Predicate<PlacementBindingBuilder> predicate) {
      for (PlacementBindingBuilder item : items) {
  ...
  protected void copyInstance(PlacementBindingList instance) {
    instance = instance != null ? instance : new PlacementBindingList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<PlacementBindingBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    PlacementBindingListFluent that = (PlacementBindingListFluent) o;
  ...
  public A removeFromItems(PlacementBinding... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (PlacementBinding item : items) {
  ...
  public A removeMatchingFromItems(Predicate<PlacementBindingBuilder> predicate) {
    ...
    Iterator<PlacementBindingBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,PlacementBinding item) {
  ...
  public A withItems(PlacementBinding... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends PlacementBindingFluent<ItemsNested<N>> implements Nested<N>{
  
    PlacementBindingBuilder builder;
    int index;
  
    ItemsNested(int index,PlacementBinding item) {
      this.index = index;
      this.builder = new PlacementBindingBuilder(this, item);
    }
  
    public N and() {
      return (N) PlacementBindingListFluent.this.setToItems(index, builder.build());
    }
