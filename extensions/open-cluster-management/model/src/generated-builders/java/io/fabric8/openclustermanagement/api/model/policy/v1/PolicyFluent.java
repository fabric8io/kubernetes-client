...
public class PolicyFluent<A extends io.fabric8.openclustermanagement.api.model.policy.v1.PolicyFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new PolicySpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(PolicySpec item) {
  ...
  public SpecNested<A> withNewSpecLike(PolicySpec item) {
  ...
  public A withSpec(PolicySpec spec) {
    ...
    if (spec != null) {
        this.spec = new PolicySpecBuilder(spec);
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PolicyFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends PolicySpecFluent<SpecNested<N>> implements Nested<N>{
  
    PolicySpecBuilder builder;
  
    SpecNested(PolicySpec item) {
      this.builder = new PolicySpecBuilder(this, item);
    }
  
    public N and() {
      return (N) PolicyFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends PolicyStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PolicyFluent.this.withStatus(builder.build());
    }
