...
public class CapabilitiesSpecFluent<A extends io.fabric8.openclustermanagement.api.model.observability.v1beta2.CapabilitiesSpecFluent<A>> extends BaseFluent<A>{
  ...
  public PlatformNested<A> editOrNewPlatform() {
    return this.withNewPlatformLike(Optional.ofNullable(this.buildPlatform()).orElse(new PlatformCapabilitiesSpecBuilder().build()));
  }
  ...
  public UserWorkloadsNested<A> editOrNewUserWorkloads() {
    return this.withNewUserWorkloadsLike(Optional.ofNullable(this.buildUserWorkloads()).orElse(new UserWorkloadCapabilitiesSpecBuilder().build()));
  }
  
  public UserWorkloadsNested<A> editOrNewUserWorkloadsLike(UserWorkloadCapabilitiesSpec item) {
    return this.withNewUserWorkloadsLike(Optional.ofNullable(this.buildUserWorkloads()).orElse(item));
  }
  ...
  public UserWorkloadsNested<A> editUserWorkloads() {
    return this.withNewUserWorkloadsLike(Optional.ofNullable(this.buildUserWorkloads()).orElse(null));
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(userWorkloads, that.userWorkloads))) {
      return false;
    }
