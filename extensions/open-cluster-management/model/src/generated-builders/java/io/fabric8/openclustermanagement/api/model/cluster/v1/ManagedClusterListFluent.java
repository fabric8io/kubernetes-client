...
public class ManagedClusterListFluent<A extends io.fabric8.openclustermanagement.api.model.cluster.v1.ManagedClusterListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ManagedClusterBuilder> items = new ArrayList<ManagedClusterBuilder>();
  private String kind;
  private ListMeta metadata;

  public ManagedClusterListFluent() {
  }
  
  public ManagedClusterListFluent(ManagedClusterList instance) {
  ...
  public A addAllToItems(Collection<ManagedCluster> items) {
    ...
    for (ManagedCluster item : items) {
        ManagedClusterBuilder builder = new ManagedClusterBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(ManagedCluster item) {
  ...
  public A addToItems(ManagedCluster... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (ManagedCluster item : items) {
  ...
  public ManagedCluster buildMatchingItem(Predicate<ManagedClusterBuilder> predicate) {
      for (ManagedClusterBuilder item : items) {
  ...
  protected void copyInstance(ManagedClusterList instance) {
    instance = instance != null ? instance : new ManagedClusterList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ManagedClusterBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ManagedClusterListFluent that = (ManagedClusterListFluent) o;
  ...
  public A removeFromItems(ManagedCluster... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (ManagedCluster item : items) {
  ...
  public A removeMatchingFromItems(Predicate<ManagedClusterBuilder> predicate) {
    ...
    Iterator<ManagedClusterBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ManagedClusterBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ManagedCluster item) {
  ...
  public A withItems(ManagedCluster... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends ManagedClusterFluent<ItemsNested<N>> implements Nested<N>{
  
    ManagedClusterBuilder builder;
    int index;
  
    ItemsNested(int index,ManagedCluster item) {
      this.index = index;
      this.builder = new ManagedClusterBuilder(this, item);
    }
  
    public N and() {
      return (N) ManagedClusterListFluent.this.setToItems(index, builder.build());
    }
