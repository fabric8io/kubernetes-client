...
public class AddOnManagerConfigurationFluent<A extends io.fabric8.openclustermanagement.api.model.operator.v1.AddOnManagerConfigurationFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private ArrayList<FeatureGateBuilder> featureGates = new ArrayList<FeatureGateBuilder>();

  public AddOnManagerConfigurationFluent() {
  }
  
  public AddOnManagerConfigurationFluent(AddOnManagerConfiguration instance) {
  ...
  protected void copyInstance(AddOnManagerConfiguration instance) {
    instance = instance != null ? instance : new AddOnManagerConfiguration();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    AddOnManagerConfigurationFluent that = (AddOnManagerConfigurationFluent) o;
  ...
  public class FeatureGatesNested<N> extends FeatureGateFluent<FeatureGatesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AddOnManagerConfigurationFluent.this.setToFeatureGates(index, builder.build());
    }
