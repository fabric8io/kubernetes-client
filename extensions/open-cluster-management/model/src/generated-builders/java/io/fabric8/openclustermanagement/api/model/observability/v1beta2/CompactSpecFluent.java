...
public class CompactSpecFluent<A extends io.fabric8.openclustermanagement.api.model.observability.v1beta2.CompactSpecFluent<A>> extends BaseFluent<A>{
  ...
  public class ContainersNested<N> extends ContainerFluent<ContainersNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CompactSpecFluent.this.setToContainers(index, builder.build());
    }
  ...
  public class ResourcesNested<N> extends ResourceRequirementsFluent<ResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CompactSpecFluent.this.withResources(builder.build());
    }
