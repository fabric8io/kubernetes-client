...
public class StoreSpecFluent<A extends io.fabric8.openclustermanagement.api.model.observability.v1beta2.StoreSpecFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(StoreSpec instance) {
    instance = instance != null ? instance : new StoreSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    StoreSpecFluent that = (StoreSpecFluent) o;
  ...
  public class ContainersNested<N> extends ContainerFluent<ContainersNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StoreSpecFluent.this.setToContainers(index, builder.build());
    }
  ...
  public class ResourcesNested<N> extends ResourceRequirementsFluent<ResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StoreSpecFluent.this.withResources(builder.build());
    }
