...
public class RolloutProgressiveFluent<A extends io.fabric8.openclustermanagement.api.model.cluster.v1alpha1.RolloutProgressiveFluent<A>> extends BaseFluent<A>{
  ...
  public RolloutProgressiveFluent(RolloutProgressive instance) {
  ...
  public IntOrString buildMaxConcurrency() {
    return this.maxConcurrency != null ? this.maxConcurrency.build() : null;
  }
  ...
  protected void copyInstance(RolloutProgressive instance) {
    instance = instance != null ? instance : new RolloutProgressive();
    if (instance != null) {
  ...
  public MaxConcurrencyNested<A> editMaxConcurrency() {
    return this.withNewMaxConcurrencyLike(Optional.ofNullable(this.buildMaxConcurrency()).orElse(null));
  }
  ...
  public MaxConcurrencyNested<A> editOrNewMaxConcurrency() {
    return this.withNewMaxConcurrencyLike(Optional.ofNullable(this.buildMaxConcurrency()).orElse(new IntOrStringBuilder().build()));
  }
  
  public MaxConcurrencyNested<A> editOrNewMaxConcurrencyLike(IntOrString item) {
    return this.withNewMaxConcurrencyLike(Optional.ofNullable(this.buildMaxConcurrency()).orElse(item));
  }
  ...
  public boolean equals(Object o) {
    ...
    RolloutProgressiveFluent that = (RolloutProgressiveFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(mandatoryDecisionGroups, maxConcurrency, maxFailures, minSuccessTime, progressDeadline, additionalProperties);
  }
  ...
  public A withMaxConcurrency(IntOrString maxConcurrency) {
    this._visitables.remove("maxConcurrency");
    if (maxConcurrency != null) {
        this.maxConcurrency = new IntOrStringBuilder(maxConcurrency);
  ...
  public MaxConcurrencyNested<A> withNewMaxConcurrency() {
    return new MaxConcurrencyNested(null);
  }
  
  public A withNewMaxConcurrency(Object value) {
    return (A) this.withMaxConcurrency(new IntOrString(value));
  }
  
  public MaxConcurrencyNested<A> withNewMaxConcurrencyLike(IntOrString item) {
    return new MaxConcurrencyNested(item);
  }
  ...
  public class MandatoryDecisionGroupsNested<N> extends MandatoryDecisionGroupFluent<MandatoryDecisionGroupsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RolloutProgressiveFluent.this.setToMandatoryDecisionGroups(index, builder.build());
    }
  ...
  public class MaxConcurrencyNested<N> extends IntOrStringFluent<MaxConcurrencyNested<N>> implements Nested<N>{
  
    IntOrStringBuilder builder;
  
    MaxConcurrencyNested(IntOrString item) {
      this.builder = new IntOrStringBuilder(this, item);
    }
  
    public N and() {
      return (N) RolloutProgressiveFluent.this.withMaxConcurrency(builder.build());
    }
  ...
  public class MaxFailuresNested<N> extends IntOrStringFluent<MaxFailuresNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RolloutProgressiveFluent.this.withMaxFailures(builder.build());
    }
