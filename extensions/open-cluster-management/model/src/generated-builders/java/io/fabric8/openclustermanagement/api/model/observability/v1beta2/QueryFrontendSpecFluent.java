...
public class QueryFrontendSpecFluent<A extends io.fabric8.openclustermanagement.api.model.observability.v1beta2.QueryFrontendSpecFluent<A>> extends BaseFluent<A>{
  ...
  public QueryFrontendSpecFluent() {
  }
  
  public QueryFrontendSpecFluent(QueryFrontendSpec instance) {
  ...
  protected void copyInstance(QueryFrontendSpec instance) {
    instance = instance != null ? instance : new QueryFrontendSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    QueryFrontendSpecFluent that = (QueryFrontendSpecFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(containers, replicas, resources, additionalProperties);
  }
  ...
  public class ContainersNested<N> extends ContainerFluent<ContainersNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) QueryFrontendSpecFluent.this.setToContainers(index, builder.build());
    }
  ...
  public class ResourcesNested<N> extends ResourceRequirementsFluent<ResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) QueryFrontendSpecFluent.this.withResources(builder.build());
    }
