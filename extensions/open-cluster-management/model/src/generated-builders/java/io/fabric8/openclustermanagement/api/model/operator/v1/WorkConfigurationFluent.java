...
public class WorkConfigurationFluent<A extends io.fabric8.openclustermanagement.api.model.operator.v1.WorkConfigurationFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(WorkConfiguration instance) {
    instance = instance != null ? instance : new WorkConfiguration();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    WorkConfigurationFluent that = (WorkConfigurationFluent) o;
    if (!(Objects.equals(featureGates, that.featureGates))) {
      return false;
    }
    if (!(Objects.equals(workDriver, that.workDriver))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(featureGates, workDriver, additionalProperties);
  }
  ...
  public class FeatureGatesNested<N> extends FeatureGateFluent<FeatureGatesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkConfigurationFluent.this.setToFeatureGates(index, builder.build());
    }
