...
public class ReceiveSpecFluent<A extends io.fabric8.openclustermanagement.api.model.observability.v1beta2.ReceiveSpecFluent<A>> extends BaseFluent<A>{
  ...
  public ReceiveSpecFluent() {
  }
  
  public ReceiveSpecFluent(ReceiveSpec instance) {
  ...
  protected void copyInstance(ReceiveSpec instance) {
  ...
  public class ContainersNested<N> extends ContainerFluent<ContainersNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ReceiveSpecFluent.this.setToContainers(index, builder.build());
    }
  ...
  public class ResourcesNested<N> extends ResourceRequirementsFluent<ResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ReceiveSpecFluent.this.withResources(builder.build());
    }
