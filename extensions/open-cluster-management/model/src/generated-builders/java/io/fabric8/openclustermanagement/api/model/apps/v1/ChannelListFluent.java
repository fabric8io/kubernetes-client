...
public class ChannelListFluent<A extends io.fabric8.openclustermanagement.api.model.apps.v1.ChannelListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ChannelBuilder> items = new ArrayList<ChannelBuilder>();
  private String kind;
  private ListMeta metadata;

  public ChannelListFluent() {
  }
  
  public ChannelListFluent(ChannelList instance) {
  ...
  public A addAllToItems(Collection<Channel> items) {
    ...
    for (Channel item : items) {
        ChannelBuilder builder = new ChannelBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(Channel item) {
  ...
  protected void copyInstance(ChannelList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ChannelBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ChannelListFluent that = (ChannelListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ChannelBuilder> predicate) {
    ...
    Iterator<ChannelBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ChannelBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Channel item) {
  ...
  public class ItemsNested<N> extends ChannelFluent<ItemsNested<N>> implements Nested<N>{
  
    ChannelBuilder builder;
    int index;
  
    ItemsNested(int index,Channel item) {
      this.index = index;
      this.builder = new ChannelBuilder(this, item);
    }
  
    public N and() {
      return (N) ChannelListFluent.this.setToItems(index, builder.build());
    }
