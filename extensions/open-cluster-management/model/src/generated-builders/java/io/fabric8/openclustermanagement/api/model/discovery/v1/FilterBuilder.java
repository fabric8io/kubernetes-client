...
public class FilterBuilder extends FilterFluent<FilterBuilder> implements VisitableBuilder<Filter,FilterBuilder>{
  ...
  public Filter build() {
    Filter buildable = new Filter(fluent.getClusterTypes(), fluent.getInfrastructureProviders(), fluent.getLastActive(), fluent.getOpenShiftVersions(), fluent.getRegions());
