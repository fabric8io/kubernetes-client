...
public class KlusterletStatusFluent<A extends io.fabric8.openclustermanagement.api.model.operator.v1.KlusterletStatusFluent<A>> extends BaseFluent<A>{
  ...
  public KlusterletStatusFluent() {
  }
  
  public KlusterletStatusFluent(KlusterletStatus instance) {
  ...
  protected void copyInstance(KlusterletStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    KlusterletStatusFluent that = (KlusterletStatusFluent) o;
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KlusterletStatusFluent.this.setToGenerations(index, builder.build());
    }
  ...
  public class RelatedResourcesNested<N> extends RelatedResourceMetaFluent<RelatedResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KlusterletStatusFluent.this.setToRelatedResources(index, builder.build());
    }
