...
public class WorkAgentConfigurationFluent<A extends io.fabric8.openclustermanagement.api.model.operator.v1.WorkAgentConfigurationFluent<A>> extends BaseFluent<A>{
  ...
  public WorkAgentConfigurationFluent() {
  }
  
  public WorkAgentConfigurationFluent(WorkAgentConfiguration instance) {
  ...
  protected void copyInstance(WorkAgentConfiguration instance) {
    instance = instance != null ? instance : new WorkAgentConfiguration();
    if (instance != null) {
        this.withAppliedManifestWorkEvictionGracePeriod(instance.getAppliedManifestWorkEvictionGracePeriod());
        this.withFeatureGates(instance.getFeatureGates());
        this.withHubKubeAPIBurst(instance.getHubKubeAPIBurst());
        this.withHubKubeAPIQPS(instance.getHubKubeAPIQPS());
        this.withKubeAPIBurst(instance.getKubeAPIBurst());
        this.withKubeAPIQPS(instance.getKubeAPIQPS());
        this.withStatusSyncInterval(instance.getStatusSyncInterval());
  ...
  public boolean equals(Object o) {
    ...
    WorkAgentConfigurationFluent that = (WorkAgentConfigurationFluent) o;
    if (!(Objects.equals(appliedManifestWorkEvictionGracePeriod, that.appliedManifestWorkEvictionGracePeriod))) {
      return false;
    }
    if (!(Objects.equals(featureGates, that.featureGates))) {
      return false;
    }
    if (!(Objects.equals(hubKubeAPIBurst, that.hubKubeAPIBurst))) {
      return false;
    }
    if (!(Objects.equals(hubKubeAPIQPS, that.hubKubeAPIQPS))) {
      return false;
    }
    ...
    if (!(Objects.equals(statusSyncInterval, that.statusSyncInterval))) {
      return false;
    }
  ...
  public Duration getAppliedManifestWorkEvictionGracePeriod() {
    return this.appliedManifestWorkEvictionGracePeriod;
  }
  
  public Integer getHubKubeAPIBurst() {
    return this.hubKubeAPIBurst;
  }
  
  public Integer getHubKubeAPIQPS() {
    return this.hubKubeAPIQPS;
  }
  ...
  public Duration getStatusSyncInterval() {
    return this.statusSyncInterval;
  }
  ...
  public boolean hasAppliedManifestWorkEvictionGracePeriod() {
    return this.appliedManifestWorkEvictionGracePeriod != null;
  }
  ...
  public boolean hasHubKubeAPIBurst() {
    return this.hubKubeAPIBurst != null;
  }
  
  public boolean hasHubKubeAPIQPS() {
    return this.hubKubeAPIQPS != null;
  }
  ...
  public boolean hasStatusSyncInterval() {
    return this.statusSyncInterval != null;
  }
  
  public int hashCode() {
    return Objects.hash(appliedManifestWorkEvictionGracePeriod, featureGates, hubKubeAPIBurst, hubKubeAPIQPS, kubeAPIBurst, kubeAPIQPS, statusSyncInterval, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("{");
    if (!(appliedManifestWorkEvictionGracePeriod == null)) {
        sb.append("appliedManifestWorkEvictionGracePeriod:");
        sb.append(appliedManifestWorkEvictionGracePeriod);
        sb.append(",");
    }
    ...
    if (!(hubKubeAPIBurst == null)) {
        sb.append("hubKubeAPIBurst:");
        sb.append(hubKubeAPIBurst);
        sb.append(",");
    }
    if (!(hubKubeAPIQPS == null)) {
        sb.append("hubKubeAPIQPS:");
        sb.append(hubKubeAPIQPS);
        sb.append(",");
    }
    ...
    if (!(statusSyncInterval == null)) {
        sb.append("statusSyncInterval:");
        sb.append(statusSyncInterval);
        sb.append(",");
    }
  ...
  public A withAppliedManifestWorkEvictionGracePeriod(Duration appliedManifestWorkEvictionGracePeriod) {
  ...
  public A withHubKubeAPIBurst(Integer hubKubeAPIBurst) {
    this.hubKubeAPIBurst = hubKubeAPIBurst;
    return (A) this;
  }
  
  public A withHubKubeAPIQPS(Integer hubKubeAPIQPS) {
  ...
  public A withStatusSyncInterval(Duration statusSyncInterval) {
  ...
  public class FeatureGatesNested<N> extends FeatureGateFluent<FeatureGatesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkAgentConfigurationFluent.this.setToFeatureGates(index, builder.build());
    }
