...
public class HostedWebhookConfigurationFluent<A extends io.fabric8.openclustermanagement.api.model.operator.v1.HostedWebhookConfigurationFluent<A>> extends BaseFluent<A>{
  ...
  public HostedWebhookConfigurationFluent() {
  }
  
  public HostedWebhookConfigurationFluent(HostedWebhookConfiguration instance) {
  ...
  protected void copyInstance(HostedWebhookConfiguration instance) {
    instance = instance != null ? instance : new HostedWebhookConfiguration();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    HostedWebhookConfigurationFluent that = (HostedWebhookConfigurationFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(address, bindConfiguration, port, additionalProperties);
  }
  ...
  public class BindConfigurationNested<N> extends BindConfigurationFluent<BindConfigurationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HostedWebhookConfigurationFluent.this.withBindConfiguration(builder.build());
    }
