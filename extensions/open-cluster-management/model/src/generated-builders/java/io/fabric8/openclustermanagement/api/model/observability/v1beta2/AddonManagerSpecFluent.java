...
public class AddonManagerSpecFluent<A extends io.fabric8.openclustermanagement.api.model.observability.v1beta2.AddonManagerSpecFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private Integer logVerbosity;
  private ResourceRequirementsBuilder resources;

  public AddonManagerSpecFluent() {
  }
  
  public AddonManagerSpecFluent(AddonManagerSpec instance) {
  ...
  protected void copyInstance(AddonManagerSpec instance) {
    instance = instance != null ? instance : new AddonManagerSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    AddonManagerSpecFluent that = (AddonManagerSpecFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(logVerbosity, resources, additionalProperties);
  }
  ...
  public class ResourcesNested<N> extends ResourceRequirementsFluent<ResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AddonManagerSpecFluent.this.withResources(builder.build());
    }
