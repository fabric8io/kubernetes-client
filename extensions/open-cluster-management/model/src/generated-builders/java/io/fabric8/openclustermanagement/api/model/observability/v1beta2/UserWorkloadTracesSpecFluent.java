...
public class UserWorkloadTracesSpecFluent<A extends io.fabric8.openclustermanagement.api.model.observability.v1beta2.UserWorkloadTracesSpecFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(UserWorkloadTracesSpec instance) {
    instance = instance != null ? instance : new UserWorkloadTracesSpec();
    if (instance != null) {
  ...
  public CollectionNested<A> editOrNewCollection() {
    return this.withNewCollectionLike(Optional.ofNullable(this.buildCollection()).orElse(new OpenTelemetryCollectionSpecBuilder().build()));
  }
  
  public CollectionNested<A> editOrNewCollectionLike(OpenTelemetryCollectionSpec item) {
  ...
  public boolean equals(Object o) {
    ...
    UserWorkloadTracesSpecFluent that = (UserWorkloadTracesSpecFluent) o;
  ...
  public A withCollection(OpenTelemetryCollectionSpec collection) {
    ...
    if (collection != null) {
        this.collection = new OpenTelemetryCollectionSpecBuilder(collection);
  ...
  public CollectionNested<A> withNewCollectionLike(OpenTelemetryCollectionSpec item) {
    return new CollectionNested(item);
  }
  public class CollectionNested<N> extends OpenTelemetryCollectionSpecFluent<CollectionNested<N>> implements Nested<N>{
  
    OpenTelemetryCollectionSpecBuilder builder;
  
    CollectionNested(OpenTelemetryCollectionSpec item) {
      this.builder = new OpenTelemetryCollectionSpecBuilder(this, item);
    }
  
    public N and() {
      return (N) UserWorkloadTracesSpecFluent.this.withCollection(builder.build());
    }
