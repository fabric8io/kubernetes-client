...
public class RolloutAllFluent<A extends io.fabric8.openclustermanagement.api.model.cluster.v1alpha1.RolloutAllFluent<A>> extends BaseFluent<A>{
  ...
  public RolloutAllFluent(RolloutAll instance) {
  ...
  protected void copyInstance(RolloutAll instance) {
    instance = instance != null ? instance : new RolloutAll();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    RolloutAllFluent that = (RolloutAllFluent) o;
  ...
  public class MaxFailuresNested<N> extends IntOrStringFluent<MaxFailuresNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RolloutAllFluent.this.withMaxFailures(builder.build());
    }
