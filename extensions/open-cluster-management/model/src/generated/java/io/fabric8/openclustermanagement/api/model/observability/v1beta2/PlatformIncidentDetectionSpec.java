...
public class PlatformIncidentDetectionSpec implements Editable<PlatformIncidentDetectionSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PlatformIncidentDetectionSpec)) {
            return false;
        }
        PlatformIncidentDetectionSpec other = (PlatformIncidentDetectionSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PlatformIncidentDetectionSpec;
    }
    ...
    public String toString() {
        return "PlatformIncidentDetectionSpec(" + "enabled=" + this.getEnabled() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
