...
public class RolloutAll implements Editable<RolloutAllBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RolloutAll)) {
            return false;
        }
        RolloutAll other = (RolloutAll) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RolloutAll;
    }
    ...
    public String toString() {
        return "RolloutAll(" + "maxFailures=" + this.getMaxFailures() + ", minSuccessTime=" + this.getMinSuccessTime() + ", progressDeadline=" + this.getProgressDeadline() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
