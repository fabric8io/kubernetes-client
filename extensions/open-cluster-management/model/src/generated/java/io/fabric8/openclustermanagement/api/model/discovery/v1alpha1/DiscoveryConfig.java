...
public class DiscoveryConfig implements Editable<DiscoveryConfigBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "DiscoveryConfig(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
