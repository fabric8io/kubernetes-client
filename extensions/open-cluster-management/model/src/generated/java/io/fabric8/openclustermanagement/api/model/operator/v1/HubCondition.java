...
public class HubCondition implements Editable<HubConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HubCondition)) {
            return false;
        }
        HubCondition other = (HubCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HubCondition;
    }
    ...
    public String toString() {
        return "HubCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", lastUpdateTime=" + this.getLastUpdateTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
