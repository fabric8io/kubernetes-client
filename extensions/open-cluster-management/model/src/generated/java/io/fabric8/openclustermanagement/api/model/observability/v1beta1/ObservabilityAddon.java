...
public class ObservabilityAddon implements Editable<ObservabilityAddonBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ObservabilityAddon)) {
            return false;
        }
        ObservabilityAddon other = (ObservabilityAddon) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ObservabilityAddon;
    }
    ...
    public String toString() {
        return "ObservabilityAddon(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
