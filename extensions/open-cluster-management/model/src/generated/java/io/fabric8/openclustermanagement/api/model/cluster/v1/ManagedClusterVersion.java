...
public class ManagedClusterVersion implements Editable<ManagedClusterVersionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagedClusterVersion)) {
            return false;
        }
        ManagedClusterVersion other = (ManagedClusterVersion) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ManagedClusterVersion;
    }
    ...
    public String toString() {
        return "ManagedClusterVersion(" + "kubernetes=" + this.getKubernetes() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
