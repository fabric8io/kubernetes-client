...
public class DiscoveryConfigSpec implements Editable<DiscoveryConfigSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DiscoveryConfigSpec)) {
            return false;
        }
        DiscoveryConfigSpec other = (DiscoveryConfigSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DiscoveryConfigSpec;
    }
    ...
    public String toString() {
        return "DiscoveryConfigSpec(" + "credential=" + this.getCredential() + ", filters=" + this.getFilters() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
