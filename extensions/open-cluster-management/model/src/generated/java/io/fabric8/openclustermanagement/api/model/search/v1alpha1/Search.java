...
public class Search implements Editable<SearchBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Search(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
