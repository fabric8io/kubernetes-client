...
public class ClusterClaim implements Editable<ClusterClaimBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "ClusterClaim(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
