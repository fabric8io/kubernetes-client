...
public class HostnameConfig implements Editable<HostnameConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostnameConfig)) {
            return false;
        }
        HostnameConfig other = (HostnameConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HostnameConfig;
    }
    ...
    public String toString() {
        return "HostnameConfig(" + "caBundle=" + this.getCaBundle() + ", host=" + this.getHost() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
