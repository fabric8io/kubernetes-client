...
public class MultiClusterObservability implements Editable<MultiClusterObservabilityBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MultiClusterObservability)) {
            return false;
        }
        MultiClusterObservability other = (MultiClusterObservability) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MultiClusterObservability;
    }
    ...
    public String toString() {
        return "MultiClusterObservability(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
