...
public class AddOnPlacementScoreItem implements Editable<AddOnPlacementScoreItemBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddOnPlacementScoreItem)) {
            return false;
        }
        AddOnPlacementScoreItem other = (AddOnPlacementScoreItem) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AddOnPlacementScoreItem;
    }
    ...
    public String toString() {
        return "AddOnPlacementScoreItem(" + "name=" + this.getName() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
