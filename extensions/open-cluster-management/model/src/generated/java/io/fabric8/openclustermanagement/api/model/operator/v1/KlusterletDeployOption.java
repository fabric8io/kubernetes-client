...
public class KlusterletDeployOption implements Editable<KlusterletDeployOptionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KlusterletDeployOption)) {
            return false;
        }
        KlusterletDeployOption other = (KlusterletDeployOption) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof KlusterletDeployOption;
    }
    ...
    public String toString() {
        return "KlusterletDeployOption(" + "mode=" + this.getMode() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
