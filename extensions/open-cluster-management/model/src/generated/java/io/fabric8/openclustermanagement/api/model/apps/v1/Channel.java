...
public class Channel implements Editable<ChannelBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Channel(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
