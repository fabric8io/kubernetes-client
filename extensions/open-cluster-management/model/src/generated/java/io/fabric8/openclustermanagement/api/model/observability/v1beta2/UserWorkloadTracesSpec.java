...
public class UserWorkloadTracesSpec implements Editable<UserWorkloadTracesSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserWorkloadTracesSpec)) {
            return false;
        }
        UserWorkloadTracesSpec other = (UserWorkloadTracesSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof UserWorkloadTracesSpec;
    }
    ...
    public String toString() {
        return "UserWorkloadTracesSpec(" + "collection=" + this.getCollection() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
