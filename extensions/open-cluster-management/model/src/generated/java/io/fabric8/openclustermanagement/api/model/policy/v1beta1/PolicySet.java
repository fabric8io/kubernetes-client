...
public class PolicySet implements Editable<PolicySetBuilder>, HasMetadata, Namespaced
{
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PolicySet;
    }
    ...
    public String toString() {
        return "PolicySet(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
