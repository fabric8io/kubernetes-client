...
public class Policy implements Editable<PolicyBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Policy(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
