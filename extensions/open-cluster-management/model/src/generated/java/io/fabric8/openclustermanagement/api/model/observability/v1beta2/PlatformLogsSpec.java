...
public class PlatformLogsSpec implements Editable<PlatformLogsSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PlatformLogsSpec)) {
            return false;
        }
        PlatformLogsSpec other = (PlatformLogsSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PlatformLogsSpec;
    }
    ...
    public String toString() {
        return "PlatformLogsSpec(" + "collection=" + this.getCollection() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
