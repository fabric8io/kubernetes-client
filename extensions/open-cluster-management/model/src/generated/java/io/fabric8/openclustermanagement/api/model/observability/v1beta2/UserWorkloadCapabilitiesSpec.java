...
public class UserWorkloadCapabilitiesSpec implements Editable<UserWorkloadCapabilitiesSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserWorkloadCapabilitiesSpec)) {
            return false;
        }
        UserWorkloadCapabilitiesSpec other = (UserWorkloadCapabilitiesSpec) o;
        ...
        if (this$traces == null ? other$traces != null : !this$traces.equals(other$traces)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof UserWorkloadCapabilitiesSpec;
    }
    ...
    public int hashCode() {
        ...
        result = result * prime + ($traces == null ? 43 : $traces.hashCode());
    ...
    public String toString() {
        return "UserWorkloadCapabilitiesSpec(" + "logs=" + this.getLogs() + ", metrics=" + this.getMetrics() + ", traces=" + this.getTraces() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
