...
public class StatusCondition implements Editable<StatusConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StatusCondition)) {
            return false;
        }
        StatusCondition other = (StatusCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof StatusCondition;
    }
    ...
    public String toString() {
        return "StatusCondition(" + "kind=" + this.getKind() + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", name=" + this.getName() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
