...
public class ManagedNamespaceConfig implements Editable<ManagedNamespaceConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagedNamespaceConfig)) {
            return false;
        }
        ManagedNamespaceConfig other = (ManagedNamespaceConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ManagedNamespaceConfig;
    }
    ...
    public String toString() {
        return "ManagedNamespaceConfig(" + "name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
