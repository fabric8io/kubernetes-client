...
public class ClusterManager implements Editable<ClusterManagerBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterManager)) {
            return false;
        }
        ClusterManager other = (ClusterManager) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClusterManager;
    }
    ...
    public String toString() {
        return "ClusterManager(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
