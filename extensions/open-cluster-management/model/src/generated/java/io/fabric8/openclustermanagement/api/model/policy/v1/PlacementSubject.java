...
public class PlacementSubject implements Editable<PlacementSubjectBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PlacementSubject)) {
            return false;
        }
        PlacementSubject other = (PlacementSubject) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PlacementSubject;
    }
    ...
    public String toString() {
        return "PlacementSubject(" + "apiGroup=" + this.getApiGroup() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
