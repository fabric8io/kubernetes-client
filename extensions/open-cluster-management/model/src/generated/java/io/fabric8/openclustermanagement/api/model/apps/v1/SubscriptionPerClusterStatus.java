...
public class SubscriptionPerClusterStatus implements Editable<SubscriptionPerClusterStatusBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SubscriptionPerClusterStatus)) {
            return false;
        }
        SubscriptionPerClusterStatus other = (SubscriptionPerClusterStatus) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SubscriptionPerClusterStatus;
    }
    ...
    public String toString() {
        return "SubscriptionPerClusterStatus(" + "packages=" + this.getPackages() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
