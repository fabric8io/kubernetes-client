...
public class PolicyAutomation implements Editable<PolicyAutomationBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PolicyAutomation)) {
            return false;
        }
        PolicyAutomation other = (PolicyAutomation) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PolicyAutomation;
    }
    ...
    public String toString() {
        return "PolicyAutomation(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
