...
public class HubTemplateOptions implements Editable<HubTemplateOptionsBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HubTemplateOptions)) {
            return false;
        }
        HubTemplateOptions other = (HubTemplateOptions) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HubTemplateOptions;
    }
    ...
    public String toString() {
        return "HubTemplateOptions(" + "serviceAccountName=" + this.getServiceAccountName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
