...
public class ManagedClusterSetBinding implements Editable<ManagedClusterSetBindingBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagedClusterSetBinding)) {
            return false;
        }
        ManagedClusterSetBinding other = (ManagedClusterSetBinding) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ManagedClusterSetBinding;
    }
    ...
    public String toString() {
        return "ManagedClusterSetBinding(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
