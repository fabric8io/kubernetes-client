...
public class PlacementDecision implements Editable<PlacementDecisionBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PlacementDecision)) {
            return false;
        }
        PlacementDecision other = (PlacementDecision) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PlacementDecision;
    }
    ...
    public String toString() {
        return "PlacementDecision(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
