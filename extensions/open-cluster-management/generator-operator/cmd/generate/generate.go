...
func main() {
	...
	crdLists := map[reflect.Type]schemagen.CrdScope{
		reflect.TypeOf(multiclusterhuboperator.MultiClusterHubList{}): schemagen.Namespaced,
		reflect.TypeOf(operatorv1.KlusterletList{}):                   schemagen.Cluster,
		reflect.TypeOf(operatorv1.ClusterManagerList{}):               schemagen.Cluster,
	}
	...
	packageMapping := map[string]schemagen.PackageInformation{
		"github.com/open-cluster-management/multiclusterhub-operator/api/v1": {JavaPackage: "io.fabric8.openclustermanagement.api.model.multiclusterhub.operator.v1", ApiGroup: "operator.open-cluster-management.io", ApiVersion: "v1"},
		"open-cluster-management.io/api/operator/v1":                         {JavaPackage: "io.fabric8.openclustermanagement.api.model.operator.v1", ApiGroup: "operator.open-cluster-management.io", ApiVersion: "v1"},
	}
