...
public class InfoItemSource implements Editable<InfoItemSourceBuilder> , KubernetesResource
{
    ...
    @JsonIgnore
    public InfoItemSourceBuilder edit() {
        return new InfoItemSourceBuilder(this);
    }

    @JsonIgnore
    public InfoItemSourceBuilder toBuilder() {
        return edit();
    }
