...
public class HelmReleaseRepo implements Editable<HelmReleaseRepoBuilder> , KubernetesResource
{
    ...
    @JsonIgnore
    public HelmReleaseRepoBuilder edit() {
        return new HelmReleaseRepoBuilder(this);
    }

    @JsonIgnore
    public HelmReleaseRepoBuilder toBuilder() {
        return edit();
    }
