...
public class InfoItem implements Editable<InfoItemBuilder> , KubernetesResource
{
    ...
    @JsonIgnore
    public InfoItemBuilder edit() {
        return new InfoItemBuilder(this);
    }

    @JsonIgnore
    public InfoItemBuilder toBuilder() {
        return edit();
    }
