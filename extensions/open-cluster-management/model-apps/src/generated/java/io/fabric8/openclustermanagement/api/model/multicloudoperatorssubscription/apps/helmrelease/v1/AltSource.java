...
public class AltSource implements Editable<AltSourceBuilder> , KubernetesResource
{
    ...
    @JsonIgnore
    public AltSourceBuilder edit() {
        return new AltSourceBuilder(this);
    }

    @JsonIgnore
    public AltSourceBuilder toBuilder() {
        return edit();
    }
