...
func main() {
	...
	crdLists := map[reflect.Type]schemagen.CrdScope{
		reflect.TypeOf(observabilityv1beta2.MultiClusterObservabilityList{}): schemagen.Cluster,
		reflect.TypeOf(observabilityv1beta1.ObservabilityAddonList{}):        schemagen.Namespaced,
	}
	...
	packageMapping := map[string]schemagen.PackageInformation{
		"github.com/open-cluster-management/multicluster-observability-operator/operators/multiclusterobservability/api/v1beta2": {JavaPackage: "io.fabric8.openclustermanagement.api.model.multiclusterobservabilityoperator.apps.v1beta2", ApiGroup: "observability.open-cluster-management.io", ApiVersion: "v1beta2"},
		"github.com/open-cluster-management/multicluster-observability-operator/operators/multiclusterobservability/api/v1beta1": {JavaPackage: "io.fabric8.openclustermanagement.api.model.multiclusterobservabilityoperator.apps.v1beta1", ApiGroup: "observability.open-cluster-management.io", ApiVersion: "v1beta1"},
		"github.com/open-cluster-management/multicluster-observability-operator/operators/multiclusterobservability/api/shared":  {JavaPackage: "io.fabric8.openclustermanagement.api.model.multiclusterobservabilityoperator.shared", ApiGroup: "apps.open-cluster-management.io", ApiVersion: "v1"},
	}
