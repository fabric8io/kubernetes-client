...
public class ObservabilityAddon implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public ObservabilityAddon(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, ObservabilityAddonSpec spec, ObservabilityAddonStatus status) {
        super();
