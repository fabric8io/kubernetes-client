...
func main() {
	...
	crdLists := map[reflect.Type]schemagen.CrdScope{
		reflect.TypeOf(governancepolicypropogatorv1.PolicyList{}):                schemagen.Namespaced,
		reflect.TypeOf(governancepolicypropogatorv1.PlacementBindingList{}):      schemagen.Namespaced,
		reflect.TypeOf(governancepolicypropogatorv1beta1.PolicyAutomationList{}): schemagen.Namespaced,
	}
	...
	packageMapping := map[string]schemagen.PackageInformation{
		"github.com/open-cluster-management/governance-policy-propagator/api/v1":                 {JavaPackage: "io.fabric8.openclustermanagement.api.model.governancepolicypropagator.policy.v1", ApiGroup: "policy.open-cluster-management.io", ApiVersion: "v1"},
		"github.com/open-cluster-management/governance-policy-propagator/api/v1beta1":            {JavaPackage: "io.fabric8.openclustermanagement.api.model.governancepolicypropagator.policy.v1beta1", ApiGroup: "policy.open-cluster-management.io", ApiVersion: "v1beta1"},
	...
	json := schemagen.GenerateSchemaWithAllOptions("http://fabric8.io/OpenClusterManagement#Policy", crdLists, typesDescriptors, providedPackages, manualTypeMap, packageMapping, mappingSchema, providedTypes, constraints, interfacesMapping, javaNameStrategyMapping, enumMapping, "io.fabric8")
