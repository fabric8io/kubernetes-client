...
public class ServiceClassStatus implements Editable<ServiceClassStatusBuilder> , KubernetesResource
{
     ...
     * 
     */
    public ServiceClassStatus() {
    }

    public ServiceClassStatus(Boolean removedFromBrokerCatalog) {
        super();
    ...
    @JsonIgnore
    public ServiceClassStatusBuilder edit() {
        return new ServiceClassStatusBuilder(this);
    }

    @JsonIgnore
    public ServiceClassStatusBuilder toBuilder() {
        return edit();
    }
