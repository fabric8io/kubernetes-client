...
public class CatalogRestrictions implements KubernetesResource
{
     ...
     * @param serviceClass
     */
    public CatalogRestrictions(List<String> serviceClass, List<String> servicePlan) {
        super();
    ...
    @JsonProperty("serviceClass")
    public void setServiceClass(List<String> serviceClass) {
        this.serviceClass = serviceClass;
    }
