...
public class ClusterServiceClass implements Editable<ClusterServiceClassBuilder> , HasMetadata
{
     ...
     */
    @JsonProperty("kind")
    private String kind = "ClusterServiceClass";
    ...
    @JsonIgnore
    public ClusterServiceClassBuilder edit() {
        return new ClusterServiceClassBuilder(this);
    }

    @JsonIgnore
    public ClusterServiceClassBuilder toBuilder() {
        return edit();
    }
