...
public class ServiceInstance implements Editable<ServiceInstanceBuilder> , HasMetadata, Namespaced
{
    ...
    public ServiceInstance(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, ServiceInstanceSpec spec, ServiceInstanceStatus status) {
        super();
    ...
    @JsonIgnore
    public ServiceInstanceBuilder edit() {
        return new ServiceInstanceBuilder(this);
    }
