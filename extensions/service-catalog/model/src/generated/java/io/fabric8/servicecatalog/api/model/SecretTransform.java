...
public class SecretTransform implements Editable<SecretTransformBuilder> , KubernetesResource
{
    ...
    @JsonIgnore
    public SecretTransformBuilder edit() {
        return new SecretTransformBuilder(this);
    }

    @JsonIgnore
    public SecretTransformBuilder toBuilder() {
        return edit();
    }
