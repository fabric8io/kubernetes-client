...
public class ServiceBinding implements Editable<ServiceBindingBuilder> , HasMetadata, Namespaced
{
    ...
    public ServiceBinding(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, ServiceBindingSpec spec, ServiceBindingStatus status) {
        super();
    ...
    @JsonIgnore
    public ServiceBindingBuilder edit() {
        return new ServiceBindingBuilder(this);
    }

    @JsonIgnore
    public ServiceBindingBuilder toBuilder() {
        return edit();
    }
