...
public class AddKeyTransform implements Editable<AddKeyTransformBuilder> , KubernetesResource
{
    ...
    @JsonIgnore
    public AddKeyTransformBuilder edit() {
        return new AddKeyTransformBuilder(this);
    }

    @JsonIgnore
    public AddKeyTransformBuilder toBuilder() {
        return edit();
    }
