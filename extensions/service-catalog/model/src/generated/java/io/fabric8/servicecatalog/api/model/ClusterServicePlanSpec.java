...
public class ClusterServicePlanSpec implements Editable<ClusterServicePlanSpecBuilder> , KubernetesResource
{
    ...
    @JsonIgnore
    public ClusterServicePlanSpecBuilder edit() {
        return new ClusterServicePlanSpecBuilder(this);
    }

    @JsonIgnore
    public ClusterServicePlanSpecBuilder toBuilder() {
        return edit();
    }
