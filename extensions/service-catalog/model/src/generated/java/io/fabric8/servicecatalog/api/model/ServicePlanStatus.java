...
public class ServicePlanStatus implements Editable<ServicePlanStatusBuilder> , KubernetesResource
{
    ...
    @JsonIgnore
    public ServicePlanStatusBuilder edit() {
        return new ServicePlanStatusBuilder(this);
    }

    @JsonIgnore
    public ServicePlanStatusBuilder toBuilder() {
        return edit();
    }
