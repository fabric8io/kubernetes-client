...
public class IntegrationCondition implements KubernetesResource
{
    ...
    @JsonProperty("firstTruthyTime")
    private String firstTruthyTime;
    ...
    @JsonProperty("firstTruthyTime")
    public String getFirstTruthyTime() {
        return firstTruthyTime;
    }

    @JsonProperty("firstTruthyTime")
    public void setFirstTruthyTime(String firstTruthyTime) {
        this.firstTruthyTime = firstTruthyTime;
    }
