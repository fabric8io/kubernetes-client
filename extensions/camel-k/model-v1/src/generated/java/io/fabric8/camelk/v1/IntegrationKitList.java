...
public class IntegrationKitList implements KubernetesResource, KubernetesResourceList<io.fabric8.camelk.v1.IntegrationKit>
{
     ...
     * @param items
     */
    public IntegrationKitList(String apiVersion, List<io.fabric8.camelk.v1.IntegrationKit> items, String kind, ListMeta metadata) {
        super();
    ...
    @JsonProperty("items")
    public List<io.fabric8.camelk.v1.IntegrationKit> getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(List<io.fabric8.camelk.v1.IntegrationKit> items) {
        this.items = items;
    }
