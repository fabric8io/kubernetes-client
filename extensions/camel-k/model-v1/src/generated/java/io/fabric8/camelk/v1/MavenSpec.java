...
public class MavenSpec implements KubernetesResource
{
     ...
     */
    public MavenSpec(SecretKeySelector caSecret, List<SecretKeySelector> caSecrets, List<java.lang.String> cliOptions, List<MavenArtifact> extension, java.lang.String localRepository, Map<String, String> properties, ValueSource settings) {
        super();
