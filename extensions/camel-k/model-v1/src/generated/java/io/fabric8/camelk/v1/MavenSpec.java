...
public class MavenSpec implements KubernetesResource
{
     ...
     */
    public MavenSpec(SecretKeySelector caSecret, List<java.lang.String> cliOptions, List<MavenArtifact> extension, java.lang.String localRepository, Map<String, String> properties, ValueSource settings, Duration timeout) {
        super();
