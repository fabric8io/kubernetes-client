...
public class IntegrationList implements KubernetesResource, KubernetesResourceList<io.fabric8.camelk.v1.Integration>
{
     ...
     * @param items
     */
    public IntegrationList(String apiVersion, List<io.fabric8.camelk.v1.Integration> items, String kind, ListMeta metadata) {
        super();
    ...
    @JsonProperty("items")
    public List<io.fabric8.camelk.v1.Integration> getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(List<io.fabric8.camelk.v1.Integration> items) {
        this.items = items;
    }
