...
public class EgressFirewall implements Editable<EgressFirewallBuilder> , HasMetadata, Namespaced
{
    ...
    public EgressFirewall(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, EgressFirewallSpec spec, EgressFirewallStatus status) {
        super();
