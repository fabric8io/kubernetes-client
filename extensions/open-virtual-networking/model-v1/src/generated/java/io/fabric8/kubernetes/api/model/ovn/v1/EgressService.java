...
public class EgressService implements Editable<EgressServiceBuilder> , HasMetadata, Namespaced
{
    ...
    public EgressService(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, EgressServiceSpec spec, EgressServiceStatus status) {
        super();
