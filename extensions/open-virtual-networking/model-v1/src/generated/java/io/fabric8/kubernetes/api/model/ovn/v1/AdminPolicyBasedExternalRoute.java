...
public class AdminPolicyBasedExternalRoute implements Editable<AdminPolicyBasedExternalRouteBuilder> , HasMetadata
{
    ...
    public AdminPolicyBasedExternalRoute(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, AdminPolicyBasedExternalRouteSpec spec, AdminPolicyBasedRouteStatus status) {
        super();
