...
import io.fabric8.kubernetes.api.model.flowcontrol.v1beta3.PriorityLevelConfigurationBuilder;
import io.fabric8.kubernetes.api.model.flowcontrol.v1beta3.PriorityLevelConfigurationList;
import io.fabric8.kubernetes.api.model.flowcontrol.v1beta3.PriorityLevelConfigurationListBuilder;
...
class V1beta3PriorityLevelConfigurationTest {
  ...
  @Test
  void load() {
    List<HasMetadata> items = client.load(getClass().getResourceAsStream("/v1beta3-prioritylevelconfiguration.yml")).items();
    ...
    AssertionsForClassTypes.assertThat(items.get(0))
        ...
        .hasFieldOrPropertyWithValue("metadata.name", "global-default");
  }

  @Test
  void get() {
    // Given
    server.expect().get().withPath("/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations/plc1")
        .andReturn(HttpURLConnection.HTTP_OK, createPriorityLevelConfiguration("plc1"))
        .once();

    // When
    PriorityLevelConfiguration priorityLevelConfiguration = client.flowControl().v1beta3().priorityLevelConfigurations()
        .withName("plc1").get();
  ...
  void list() {
    // Given
    server.expect().get().withPath("/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations")
    ...
    // When
    PriorityLevelConfigurationList priorityLevelConfigurations = client.flowControl().v1beta3().priorityLevelConfigurations()
        .list();
  ...
  void create() {
    ...
    server.expect().post().withPath("/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations")
        .andReturn(HttpURLConnection.HTTP_OK, priorityLevelConfiguration)
        .once();

    // When
    PriorityLevelConfiguration createdPriorityLevelConfiguration = client.flowControl().v1beta3().priorityLevelConfigurations()
  ...
  void delete() {
    ...
    server.expect().delete()
        .withPath("/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations/prioritylevelconfiguration1")
        .andReturn(HttpURLConnection.HTTP_OK, priorityLevelConfiguration)
        .once();
