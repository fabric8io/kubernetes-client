...
class V1PriorityLevelConfigurationTest {
  ...
  @Test
  void load() {
    List<HasMetadata> items = client.load(getClass().getResourceAsStream("/v1-prioritylevelconfiguration.yaml")).items();
  ...
  void get() {
    // Given
    server.expect().get().withPath("/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/plc1")
        .andReturn(HttpURLConnection.HTTP_OK, createPriorityLevelConfiguration("plc1"))
        .once();

    // When
    PriorityLevelConfiguration priorityLevelConfiguration = client.flowControl().v1().priorityLevelConfigurations()
        .withName("plc1").get();
  ...
  void list() {
    // Given
    server.expect().get().withPath("/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations")
    ...
    // When
    PriorityLevelConfigurationList priorityLevelConfigurations = client.flowControl().v1().priorityLevelConfigurations()
        .list();
  ...
  void create() {
    ...
    server.expect().post().withPath("/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations")
        .andReturn(HttpURLConnection.HTTP_OK, priorityLevelConfiguration)
        .once();

    // When
    PriorityLevelConfiguration createdPriorityLevelConfiguration = client.flowControl().v1().priorityLevelConfigurations()
        .resource(priorityLevelConfiguration).create();
  ...
  void delete() {
    ...
    server.expect().delete()
        .withPath("/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/prioritylevelconfiguration1")
        .andReturn(HttpURLConnection.HTTP_OK, priorityLevelConfiguration)
        .once();
