...
@Deprecated
public class CloudStorageBinaryBinaryDownloader implements BinaryDownloader {

  private static final Logger log = LoggerFactory.getLogger(CloudStorageBinaryBinaryDownloader.class);
  ...
  public CloudStorageBinaryBinaryDownloader(String kubeAPITestDir, OSInfo osInfoProvider) {
    this.kubeAPITestDir = kubeAPITestDir;
    this.osInfoProvider = osInfoProvider;
    this.binaryRepo = new BinaryRepo(osInfoProvider);
  }

  CloudStorageBinaryBinaryDownloader(String kubeAPITestDir, BinaryRepo binaryRepo, OSInfo osInfoProvider) {
    this.kubeAPITestDir = kubeAPITestDir;
