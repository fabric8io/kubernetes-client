...
@DisplayName("Vertx5WebSocket")
class Vertx5WebSocketTest {
  ...
  private Vertx5WebSocket webSocket;
  ...
  void setUp() {
    ...
    webSocket = new Vertx5WebSocket(vertxWebSocket, listener);
  }
  ...
  void request_shouldCallFetchOnVertx5WebSocket() {
    webSocket.request();
