...
public class Vertx5HttpResponse extends StandardHttpHeaders implements HttpResponse<AsyncBody> {
  ...
  /**
   * Constructs a Vertx5HttpResponse bridging Vert.x 5 and Fabric8 client APIs.
   ...
   */
  Vertx5HttpResponse(AsyncBody result, HttpClientResponse resp, HttpRequest request) {
