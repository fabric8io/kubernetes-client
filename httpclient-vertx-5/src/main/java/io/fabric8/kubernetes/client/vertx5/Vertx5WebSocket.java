 ...
 * </ul>
 */
class Vertx5WebSocket implements WebSocket {

  private static final Logger logger = LoggerFactory.getLogger(Vertx5WebSocket.class);
   ...
   */
  Vertx5WebSocket(final io.vertx.core.http.WebSocket webSocket, final Listener eventListener) {
