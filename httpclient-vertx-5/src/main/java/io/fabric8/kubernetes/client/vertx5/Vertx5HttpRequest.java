...
class Vertx5HttpRequest {
   ...
   */
  public Vertx5HttpRequest(Vertx vertx, RequestOptions options, StandardHttpRequest request) {
    this.vertx = vertx;
  ...
  private HttpResponse<AsyncBody> toFabricResponse(HttpClientResponse resp,
      AsyncBody.Consumer<List<ByteBuffer>> consumer) {
    Vertx5AsyncBody asyncBody = new Vertx5AsyncBody(resp, consumer);
    return new Vertx5HttpResponse(asyncBody, resp, request);
  }
