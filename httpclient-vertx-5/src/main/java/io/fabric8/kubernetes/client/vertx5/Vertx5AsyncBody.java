 ...
 */
final class Vertx5AsyncBody implements AsyncBody {
  ...
  /**
   * Creates a new Vertx5AsyncBody bridging Vert.x streaming to Fabric8's AsyncBody interface.
   ...
   */
  Vertx5AsyncBody(final HttpClientResponse resp, final AsyncBody.Consumer<List<ByteBuffer>> consumer) {
    this.resp = resp;
