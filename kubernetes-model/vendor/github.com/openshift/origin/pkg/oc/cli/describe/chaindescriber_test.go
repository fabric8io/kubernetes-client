...
func TestChainDescriber(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			name:             "ruby-22-centos7",
			tag:              "latest",
			path:             "../../../../pkg/oc/experimental/buildchain/test/single-namespace-bcs.yaml",
			humanReadable: map[string]int{
		...
		},
		{
			...
			name:             "ruby-22-centos7",
			tag:              "latest",
			path:             "../../../../pkg/oc/experimental/buildchain/test/multiple-namespaces-bcs.yaml",
			humanReadable: map[string]int{
		...
		},
		{
			...
			defaultNamespace: "test",
			tag:              "latest",
			path:             "../../../../pkg/oc/experimental/buildchain/test/multiple-trigger-bcs.yaml",
			namespaces:       sets.NewString("test"),
			humanReadable: map[string]int{
				"istag/ruby-22-centos7:latest":   1,
				"\tbc/parent1":                   1,
