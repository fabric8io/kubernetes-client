...
func (g *schemaGenerator) isClusterScopedResource(t reflect.Type) bool {
	clusterScopedResourcesList := []string{
		...
		"k8s.io/api/networking/v1alpha1/ServiceCIDR",
		"k8s.io/api/networking/v1alpha1/IPAddress",
		...
		"k8s.io/api/storagemigration/v1alpha1/StorageVersionMigration",
		...
		"k8s.io/api/resource/v1alpha2/ResourceSlice",
