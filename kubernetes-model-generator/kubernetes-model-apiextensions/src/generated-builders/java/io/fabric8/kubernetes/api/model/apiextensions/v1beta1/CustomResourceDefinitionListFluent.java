...
public class CustomResourceDefinitionListFluent<A extends io.fabric8.kubernetes.api.model.apiextensions.v1beta1.CustomResourceDefinitionListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<CustomResourceDefinitionBuilder> items = new ArrayList<CustomResourceDefinitionBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(CustomResourceDefinition item) {
  ...
  public CustomResourceDefinition buildMatchingItem(Predicate<CustomResourceDefinitionBuilder> predicate) {
      for (CustomResourceDefinitionBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<CustomResourceDefinitionBuilder> predicate) {
    int index = -1;
  ...
  public boolean hasMatchingItem(Predicate<CustomResourceDefinitionBuilder> predicate) {
      for (CustomResourceDefinitionBuilder item : items) {
        if (predicate.test(item)) {
          return true;
        }
  ...
  public A removeMatchingFromItems(Predicate<CustomResourceDefinitionBuilder> predicate) {
    if (items == null) {
      return (A) this;
    }
    Iterator<CustomResourceDefinitionBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        CustomResourceDefinitionBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,CustomResourceDefinition item) {
  ...
  public class ItemsNested<N> extends CustomResourceDefinitionFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CustomResourceDefinitionListFluent.this.setToItems(index, builder.build());
    }
