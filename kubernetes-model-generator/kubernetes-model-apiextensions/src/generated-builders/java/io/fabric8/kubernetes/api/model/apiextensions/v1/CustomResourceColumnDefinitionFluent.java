...
public class CustomResourceColumnDefinitionFluent<A extends io.fabric8.kubernetes.api.model.apiextensions.v1.CustomResourceColumnDefinitionFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(description, format, jsonPath, name, priority, type, additionalProperties);
  }
