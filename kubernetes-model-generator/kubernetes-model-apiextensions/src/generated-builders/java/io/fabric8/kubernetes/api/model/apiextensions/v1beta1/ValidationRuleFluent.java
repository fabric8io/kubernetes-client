...
public class ValidationRuleFluent<A extends io.fabric8.kubernetes.api.model.apiextensions.v1beta1.ValidationRuleFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(fieldPath, message, messageExpression, optionalOldSelf, reason, rule, additionalProperties);
  }
