...
public class CustomResourceDefinitionSpecBuilder extends CustomResourceDefinitionSpecFluent<CustomResourceDefinitionSpecBuilder> implements VisitableBuilder<CustomResourceDefinitionSpec,CustomResourceDefinitionSpecBuilder>{
  ...
  public CustomResourceDefinitionSpec build() {
    CustomResourceDefinitionSpec buildable = new CustomResourceDefinitionSpec(fluent.buildAdditionalPrinterColumns(), fluent.buildConversion(), fluent.getGroup(), fluent.buildNames(), fluent.getPreserveUnknownFields(), fluent.getScope(), fluent.buildSubresources(), fluent.buildValidation(), fluent.getVersion(), fluent.buildVersions());
