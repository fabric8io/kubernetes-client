...
public class ExternalDocumentation implements Editable<ExternalDocumentationBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalDocumentation)) {
            return false;
        }
    ...
    public String toString() {
        return "ExternalDocumentation(" + "description=" + this.getDescription() + ", url=" + this.getUrl() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
