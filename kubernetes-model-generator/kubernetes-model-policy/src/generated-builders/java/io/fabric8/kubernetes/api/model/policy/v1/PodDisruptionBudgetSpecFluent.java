...
public class PodDisruptionBudgetSpecFluent<A extends io.fabric8.kubernetes.api.model.policy.v1.PodDisruptionBudgetSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(maxUnavailable, minAvailable, selector, unhealthyPodEvictionPolicy, additionalProperties);
  }
