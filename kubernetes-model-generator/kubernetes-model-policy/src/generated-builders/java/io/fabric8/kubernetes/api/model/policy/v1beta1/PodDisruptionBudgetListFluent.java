...
public class PodDisruptionBudgetListFluent<A extends io.fabric8.kubernetes.api.model.policy.v1beta1.PodDisruptionBudgetListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<PodDisruptionBudgetBuilder> items = new ArrayList<PodDisruptionBudgetBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(PodDisruptionBudget item) {
  ...
  public PodDisruptionBudget buildMatchingItem(Predicate<PodDisruptionBudgetBuilder> predicate) {
      for (PodDisruptionBudgetBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<PodDisruptionBudgetBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<PodDisruptionBudgetBuilder> predicate) {
    ...
    Iterator<PodDisruptionBudgetBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,PodDisruptionBudget item) {
  ...
  public class ItemsNested<N> extends PodDisruptionBudgetFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodDisruptionBudgetListFluent.this.setToItems(index, builder.build());
    }
