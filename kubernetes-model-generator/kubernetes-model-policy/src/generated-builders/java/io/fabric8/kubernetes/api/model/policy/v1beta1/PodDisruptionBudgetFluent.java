...
public class PodDisruptionBudgetFluent<A extends io.fabric8.kubernetes.api.model.policy.v1beta1.PodDisruptionBudgetFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new PodDisruptionBudgetSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(PodDisruptionBudgetSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new PodDisruptionBudgetStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(PodDisruptionBudgetStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(PodDisruptionBudgetSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(PodDisruptionBudgetStatus item) {
  ...
  public class SpecNested<N> extends PodDisruptionBudgetSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodDisruptionBudgetFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends PodDisruptionBudgetStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodDisruptionBudgetFluent.this.withStatus(builder.build());
    }
