...
public class SupplementalGroupsStrategyOptionsFluent<A extends io.fabric8.kubernetes.api.model.policy.v1beta1.SupplementalGroupsStrategyOptionsFluent<A>> extends BaseFluent<A>{
  ...
  public class RangesNested<N> extends IDRangeFluent<RangesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SupplementalGroupsStrategyOptionsFluent.this.setToRanges(index, builder.build());
    }
