...
public class PodSecurityPolicyListFluent<A extends io.fabric8.kubernetes.api.model.policy.v1beta1.PodSecurityPolicyListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<PodSecurityPolicyBuilder> items = new ArrayList<PodSecurityPolicyBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(PodSecurityPolicy item) {
  ...
  public PodSecurityPolicy buildMatchingItem(Predicate<PodSecurityPolicyBuilder> predicate) {
      for (PodSecurityPolicyBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<PodSecurityPolicyBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<PodSecurityPolicyBuilder> predicate) {
    ...
    Iterator<PodSecurityPolicyBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        PodSecurityPolicyBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,PodSecurityPolicy item) {
  ...
  public class ItemsNested<N> extends PodSecurityPolicyFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodSecurityPolicyListFluent.this.setToItems(index, builder.build());
    }
