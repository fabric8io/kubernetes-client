...
public class AllowedFlexVolumeFluent<A extends io.fabric8.kubernetes.api.model.policy.v1beta1.AllowedFlexVolumeFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(driver, additionalProperties);
  }
