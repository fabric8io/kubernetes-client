...
public class PodDisruptionBudget implements Editable<PodDisruptionBudgetBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodDisruptionBudget)) {
            return false;
        }
    ...
    public String toString() {
        return "PodDisruptionBudget(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
