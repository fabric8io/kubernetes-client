...
public class EvictionPodReference implements Editable<EvictionPodReferenceBuilder>, KubernetesResource
{
     ...
     */
    public EvictionPodReference() {
    }

    public EvictionPodReference(String name, String uid) {
        super();
        this.name = name;
        this.uid = uid;
    }
    ...
    @JsonIgnore
    public EvictionPodReferenceBuilder edit() {
        return new EvictionPodReferenceBuilder(this);
    }

    @JsonIgnore
    public EvictionPodReferenceBuilder toBuilder() {
        return edit();
    }
