...
public class DataGatherStatusBuilder extends DataGatherStatusFluent<DataGatherStatusBuilder> implements VisitableBuilder<DataGatherStatus,DataGatherStatusBuilder>{
  ...
  public DataGatherStatus build() {
    DataGatherStatus buildable = new DataGatherStatus(fluent.getConditions(), fluent.getFinishTime(), fluent.buildGatherers(), fluent.buildInsightsReport(), fluent.getInsightsRequestID(), fluent.buildRelatedObjects(), fluent.getStartTime());
