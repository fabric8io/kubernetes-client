...
public class ObjectReferenceFluent<A extends io.fabric8.openshift.api.model.insights.v1.ObjectReferenceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(group, name, namespace, resource, additionalProperties);
  }
