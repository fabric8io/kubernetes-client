...
public class DataGatherStatusFluent<A extends io.fabric8.openshift.api.model.insights.v1alpha1.DataGatherStatusFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(DataGatherStatus instance) {
    ...
    if (instance != null) {
        ...
        this.withDataGatherState(instance.getDataGatherState());
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(dataGatherState, that.dataGatherState))) {
      return false;
    }
  ...
  public boolean hasDataGatherState() {
    return this.dataGatherState != null;
  }
  ...
  public int hashCode() {
    return Objects.hash(conditions, dataGatherState, finishTime, gatherers, insightsReport, insightsRequestID, relatedObjects, startTime, additionalProperties);
  }
  ...
  public String toString() {
    ...
    if (!(dataGatherState == null)) {
        sb.append("dataGatherState:");
        sb.append(dataGatherState);
        sb.append(",");
    }
    if (!(finishTime == null)) {
  ...
  public A withDataGatherState(String dataGatherState) {
