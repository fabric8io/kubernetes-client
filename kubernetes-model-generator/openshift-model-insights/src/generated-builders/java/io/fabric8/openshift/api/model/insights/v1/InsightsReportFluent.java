...
public class InsightsReportFluent<A extends io.fabric8.openshift.api.model.insights.v1.InsightsReportFluent<A>> extends BaseFluent<A>{
  ...
  public A addNewHealthCheck(String advisorURI,String description,String totalRisk) {
    return (A) this.addToHealthChecks(new HealthCheck(advisorURI, description, totalRisk));
  }
  ...
  protected void copyInstance(InsightsReport instance) {
    ...
    if (instance != null) {
        this.withDownloadedTime(instance.getDownloadedTime());
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(downloadedTime, that.downloadedTime))) {
      return false;
    }
  ...
  public boolean hasDownloadedTime() {
    return this.downloadedTime != null;
  }
  ...
  public int hashCode() {
    return Objects.hash(downloadedTime, healthChecks, uri, additionalProperties);
  }
  ...
  public A withDownloadedTime(String downloadedTime) {
