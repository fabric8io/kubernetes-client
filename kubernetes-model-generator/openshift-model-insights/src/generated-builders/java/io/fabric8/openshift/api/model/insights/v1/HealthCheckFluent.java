...
public class HealthCheckFluent<A extends io.fabric8.openshift.api.model.insights.v1.HealthCheckFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(advisorURI, description, totalRisk, additionalProperties);
  }
  ...
  public A withTotalRisk(String totalRisk) {
