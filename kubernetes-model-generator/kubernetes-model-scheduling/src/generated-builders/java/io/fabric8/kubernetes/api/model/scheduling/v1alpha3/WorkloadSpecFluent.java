...
public class WorkloadSpecFluent<A extends io.fabric8.kubernetes.api.model.scheduling.v1alpha3.WorkloadSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(compositePodGroupTemplates, controllerRef, podGroupTemplates, additionalProperties);
  }
  ...
  public class CompositePodGroupTemplatesNested<N> extends CompositePodGroupTemplateFluent<CompositePodGroupTemplatesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkloadSpecFluent.this.setToCompositePodGroupTemplates(index, builder.build());
    }
