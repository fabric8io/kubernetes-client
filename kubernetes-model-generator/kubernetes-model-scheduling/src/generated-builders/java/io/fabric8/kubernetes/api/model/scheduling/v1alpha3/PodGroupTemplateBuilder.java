...
public class PodGroupTemplateBuilder extends PodGroupTemplateFluent<PodGroupTemplateBuilder> implements VisitableBuilder<PodGroupTemplate,PodGroupTemplateBuilder>{
  ...
  public PodGroupTemplate build() {
    PodGroupTemplate buildable = new PodGroupTemplate(fluent.buildDisruptionMode(), fluent.getName(), fluent.getPreemptionPolicy(), fluent.getPriority(), fluent.getPriorityClassName(), fluent.buildResourceClaims(), fluent.buildSchedulingConstraints(), fluent.buildSchedulingPolicy());
