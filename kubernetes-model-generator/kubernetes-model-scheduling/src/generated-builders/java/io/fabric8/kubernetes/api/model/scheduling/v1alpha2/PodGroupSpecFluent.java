...
public class PodGroupSpecFluent<A extends io.fabric8.kubernetes.api.model.scheduling.v1alpha2.PodGroupSpecFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String disruptionMode;
  private PodGroupTemplateReferenceBuilder podGroupTemplateRef;
  ...
  public PodGroupTemplateReference buildPodGroupTemplateRef() {
  ...
  public PodGroupTemplateRefNested<A> editOrNewPodGroupTemplateRef() {
    return this.withNewPodGroupTemplateRefLike(Optional.ofNullable(this.buildPodGroupTemplateRef()).orElse(new PodGroupTemplateReferenceBuilder().build()));
  }
  
  public PodGroupTemplateRefNested<A> editOrNewPodGroupTemplateRefLike(PodGroupTemplateReference item) {
  ...
  public int hashCode() {
    return Objects.hash(disruptionMode, podGroupTemplateRef, priority, priorityClassName, resourceClaims, schedulingConstraints, schedulingPolicy, additionalProperties);
  }
  ...
  public PodGroupTemplateRefNested<A> withNewPodGroupTemplateRefLike(PodGroupTemplateReference item) {
  ...
  public A withPodGroupTemplateRef(PodGroupTemplateReference podGroupTemplateRef) {
    this._visitables.remove("podGroupTemplateRef");
    if (podGroupTemplateRef != null) {
        this.podGroupTemplateRef = new PodGroupTemplateReferenceBuilder(podGroupTemplateRef);
  ...
  public class PodGroupTemplateRefNested<N> extends PodGroupTemplateReferenceFluent<PodGroupTemplateRefNested<N>> implements Nested<N>{
  
    PodGroupTemplateReferenceBuilder builder;
  
    PodGroupTemplateRefNested(PodGroupTemplateReference item) {
      this.builder = new PodGroupTemplateReferenceBuilder(this, item);
    }
  
    public N and() {
      return (N) PodGroupSpecFluent.this.withPodGroupTemplateRef(builder.build());
    }
  ...
  public class ResourceClaimsNested<N> extends PodGroupResourceClaimFluent<ResourceClaimsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodGroupSpecFluent.this.setToResourceClaims(index, builder.build());
    }
  ...
  public class SchedulingConstraintsNested<N> extends PodGroupSchedulingConstraintsFluent<SchedulingConstraintsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodGroupSpecFluent.this.withSchedulingConstraints(builder.build());
    }
  ...
  public class SchedulingPolicyNested<N> extends PodGroupSchedulingPolicyFluent<SchedulingPolicyNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodGroupSpecFluent.this.withSchedulingPolicy(builder.build());
    }
