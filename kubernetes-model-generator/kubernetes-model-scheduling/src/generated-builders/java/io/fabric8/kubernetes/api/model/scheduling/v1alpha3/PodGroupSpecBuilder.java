...
public class PodGroupSpecBuilder extends PodGroupSpecFluent<PodGroupSpecBuilder> implements VisitableBuilder<PodGroupSpec,PodGroupSpecBuilder>{
  ...
  public PodGroupSpec build() {
    PodGroupSpec buildable = new PodGroupSpec(fluent.buildDisruptionMode(), fluent.getParentCompositePodGroupName(), fluent.getPreemptionPolicy(), fluent.getPriority(), fluent.getPriorityClassName(), fluent.buildResourceClaims(), fluent.buildSchedulingConstraints(), fluent.buildSchedulingPolicy(), fluent.buildWorkloadRef());
