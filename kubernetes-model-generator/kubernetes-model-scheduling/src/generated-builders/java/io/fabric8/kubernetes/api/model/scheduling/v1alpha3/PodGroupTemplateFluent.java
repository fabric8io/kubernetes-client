...
public class PodGroupTemplateFluent<A extends io.fabric8.kubernetes.api.model.scheduling.v1alpha3.PodGroupTemplateFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(disruptionMode, name, preemptionPolicy, priority, priorityClassName, resourceClaims, schedulingConstraints, schedulingPolicy, additionalProperties);
  }
  ...
  public class DisruptionModeNested<N> extends DisruptionModeFluent<DisruptionModeNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodGroupTemplateFluent.this.withDisruptionMode(builder.build());
    }
