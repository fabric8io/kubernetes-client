...
public class CompositePodGroupSchedulingConstraintsFluent<A extends io.fabric8.kubernetes.api.model.scheduling.v1alpha3.CompositePodGroupSchedulingConstraintsFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private ArrayList<TopologyConstraintBuilder> topology = new ArrayList<TopologyConstraintBuilder>();

  public CompositePodGroupSchedulingConstraintsFluent() {
  }
  
  public CompositePodGroupSchedulingConstraintsFluent(CompositePodGroupSchedulingConstraints instance) {
  ...
  protected void copyInstance(CompositePodGroupSchedulingConstraints instance) {
    instance = instance != null ? instance : new CompositePodGroupSchedulingConstraints();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    CompositePodGroupSchedulingConstraintsFluent that = (CompositePodGroupSchedulingConstraintsFluent) o;
  ...
  public class TopologyNested<N> extends TopologyConstraintFluent<TopologyNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CompositePodGroupSchedulingConstraintsFluent.this.setToTopology(index, builder.build());
    }
