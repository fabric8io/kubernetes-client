...
public class WorkloadPodGroupSchedulingConstraintsFluent<A extends io.fabric8.kubernetes.api.model.scheduling.v1alpha3.WorkloadPodGroupSchedulingConstraintsFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private ArrayList<TopologyConstraintBuilder> topology = new ArrayList<TopologyConstraintBuilder>();

  public WorkloadPodGroupSchedulingConstraintsFluent() {
  }
  
  public WorkloadPodGroupSchedulingConstraintsFluent(WorkloadPodGroupSchedulingConstraints instance) {
  ...
  protected void copyInstance(WorkloadPodGroupSchedulingConstraints instance) {
    instance = instance != null ? instance : new WorkloadPodGroupSchedulingConstraints();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    WorkloadPodGroupSchedulingConstraintsFluent that = (WorkloadPodGroupSchedulingConstraintsFluent) o;
  ...
  public class TopologyNested<N> extends TopologyConstraintFluent<TopologyNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WorkloadPodGroupSchedulingConstraintsFluent.this.setToTopology(index, builder.build());
    }
