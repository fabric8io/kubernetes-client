...
public class PodGroupSpecFluent<A extends io.fabric8.kubernetes.api.model.scheduling.v1alpha3.PodGroupSpecFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private DisruptionModeBuilder disruptionMode;
  ...
  public DisruptionMode buildDisruptionMode() {
  ...
  public DisruptionModeNested<A> editOrNewDisruptionMode() {
    return this.withNewDisruptionModeLike(Optional.ofNullable(this.buildDisruptionMode()).orElse(new DisruptionModeBuilder().build()));
  }
  
  public DisruptionModeNested<A> editOrNewDisruptionModeLike(DisruptionMode item) {
  ...
  public int hashCode() {
    return Objects.hash(disruptionMode, parentCompositePodGroupName, preemptionPolicy, priority, priorityClassName, resourceClaims, schedulingConstraints, schedulingPolicy, workloadRef, additionalProperties);
  }
  ...
  public A withDisruptionMode(DisruptionMode disruptionMode) {
    this._visitables.remove("disruptionMode");
    if (disruptionMode != null) {
        this.disruptionMode = new DisruptionModeBuilder(disruptionMode);
  ...
  public DisruptionModeNested<A> withNewDisruptionModeLike(DisruptionMode item) {
  ...
  public class DisruptionModeNested<N> extends DisruptionModeFluent<DisruptionModeNested<N>> implements Nested<N>{
  
    DisruptionModeBuilder builder;
  
    DisruptionModeNested(DisruptionMode item) {
      this.builder = new DisruptionModeBuilder(this, item);
    }
  
    public N and() {
      return (N) PodGroupSpecFluent.this.withDisruptionMode(builder.build());
    }
  ...
  public class WorkloadRefNested<N> extends WorkloadReferenceFluent<WorkloadRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodGroupSpecFluent.this.withWorkloadRef(builder.build());
    }
