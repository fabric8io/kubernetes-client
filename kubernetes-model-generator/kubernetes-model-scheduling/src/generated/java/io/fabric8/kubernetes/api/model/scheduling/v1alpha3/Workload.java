...
public class Workload implements Editable<WorkloadBuilder>, HasMetadata, Namespaced
{
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Workload;
    }
    ...
    public String toString() {
        return "Workload(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
