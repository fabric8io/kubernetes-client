...
public class TopologyConstraint implements Editable<TopologyConstraintBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TopologyConstraint)) {
            return false;
        }
        TopologyConstraint other = (TopologyConstraint) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof TopologyConstraint;
    }
    ...
    public String toString() {
        return "TopologyConstraint(" + "key=" + this.getKey() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
