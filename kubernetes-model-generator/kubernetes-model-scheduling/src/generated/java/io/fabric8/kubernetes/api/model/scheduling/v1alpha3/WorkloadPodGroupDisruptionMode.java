...
public class WorkloadPodGroupDisruptionMode implements Editable<WorkloadPodGroupDisruptionModeBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WorkloadPodGroupDisruptionMode)) {
            return false;
        }
        WorkloadPodGroupDisruptionMode other = (WorkloadPodGroupDisruptionMode) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof WorkloadPodGroupDisruptionMode;
    }
    ...
    public String toString() {
        return "WorkloadPodGroupDisruptionMode(" + "all=" + this.getAll() + ", single=" + this.getSingle() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
