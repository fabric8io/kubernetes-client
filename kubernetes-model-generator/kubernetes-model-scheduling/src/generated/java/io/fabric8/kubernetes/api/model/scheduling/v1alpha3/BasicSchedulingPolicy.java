...
public class BasicSchedulingPolicy implements Editable<BasicSchedulingPolicyBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BasicSchedulingPolicy)) {
            return false;
        }
        BasicSchedulingPolicy other = (BasicSchedulingPolicy) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof BasicSchedulingPolicy;
    }
    ...
    public String toString() {
        return "BasicSchedulingPolicy(" + "additionalProperties=" + this.getAdditionalProperties() + ")";
    }
