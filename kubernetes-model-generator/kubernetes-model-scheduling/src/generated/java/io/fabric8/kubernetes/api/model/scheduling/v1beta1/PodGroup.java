...
public class PodGroup implements Editable<PodGroupBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodGroup)) {
            return false;
        }
        PodGroup other = (PodGroup) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PodGroup;
    }
    ...
    public String toString() {
        return "PodGroup(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
