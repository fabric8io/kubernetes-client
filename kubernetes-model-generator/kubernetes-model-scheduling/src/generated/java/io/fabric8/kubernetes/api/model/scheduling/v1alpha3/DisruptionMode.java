...
public class DisruptionMode implements Editable<DisruptionModeBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisruptionMode)) {
            return false;
        }
        DisruptionMode other = (DisruptionMode) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DisruptionMode;
    }
    ...
    public String toString() {
        return "DisruptionMode(" + "all=" + this.getAll() + ", single=" + this.getSingle() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
