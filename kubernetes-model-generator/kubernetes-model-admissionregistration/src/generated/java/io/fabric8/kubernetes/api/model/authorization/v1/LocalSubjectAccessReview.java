...
public class LocalSubjectAccessReview implements Editable<LocalSubjectAccessReviewBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LocalSubjectAccessReview)) {
            return false;
        }
    ...
    public String toString() {
        return "LocalSubjectAccessReview(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
