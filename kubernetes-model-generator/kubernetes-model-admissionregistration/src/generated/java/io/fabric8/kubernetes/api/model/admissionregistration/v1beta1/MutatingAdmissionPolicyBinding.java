...
public class MutatingAdmissionPolicyBinding implements Editable<MutatingAdmissionPolicyBindingBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MutatingAdmissionPolicyBinding)) {
            return false;
        }
    ...
    public String toString() {
        return "MutatingAdmissionPolicyBinding(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
