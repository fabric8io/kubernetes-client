...
public class MutatingAdmissionPolicy implements Editable<MutatingAdmissionPolicyBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MutatingAdmissionPolicy)) {
            return false;
        }
    ...
    public String toString() {
        return "MutatingAdmissionPolicy(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
