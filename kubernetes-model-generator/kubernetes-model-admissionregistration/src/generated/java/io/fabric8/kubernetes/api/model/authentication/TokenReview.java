...
public class TokenReview implements Editable<TokenReviewBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "TokenReview(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
