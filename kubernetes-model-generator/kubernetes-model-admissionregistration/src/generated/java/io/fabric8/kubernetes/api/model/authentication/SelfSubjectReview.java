...
public class SelfSubjectReview implements Editable<SelfSubjectReviewBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SelfSubjectReview)) {
            return false;
        }
    ...
    public String toString() {
        return "SelfSubjectReview(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
