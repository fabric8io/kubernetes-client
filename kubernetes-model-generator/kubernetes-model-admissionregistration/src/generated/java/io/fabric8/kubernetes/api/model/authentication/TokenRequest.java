...
public class TokenRequest implements Editable<TokenRequestBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "TokenRequest(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
