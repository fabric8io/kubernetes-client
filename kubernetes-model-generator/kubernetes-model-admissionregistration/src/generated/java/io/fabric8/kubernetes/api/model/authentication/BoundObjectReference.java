...
public class BoundObjectReference implements Editable<BoundObjectReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BoundObjectReference)) {
            return false;
        }
    ...
    public String toString() {
        return "BoundObjectReference(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", uid=" + this.getUid() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
