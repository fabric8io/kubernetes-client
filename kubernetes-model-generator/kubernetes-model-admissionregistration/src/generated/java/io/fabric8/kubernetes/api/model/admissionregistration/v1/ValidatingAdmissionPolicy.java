...
public class ValidatingAdmissionPolicy implements Editable<ValidatingAdmissionPolicyBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ValidatingAdmissionPolicy)) {
            return false;
        }
    ...
    public String toString() {
        return "ValidatingAdmissionPolicy(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
