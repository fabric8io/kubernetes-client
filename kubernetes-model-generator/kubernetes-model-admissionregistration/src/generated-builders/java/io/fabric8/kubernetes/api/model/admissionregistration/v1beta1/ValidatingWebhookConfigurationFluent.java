...
public class ValidatingWebhookConfigurationFluent<A extends io.fabric8.kubernetes.api.model.admissionregistration.v1beta1.ValidatingWebhookConfigurationFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private String kind;
  private ObjectMetaBuilder metadata;
  private ArrayList<ValidatingWebhookBuilder> webhooks = new ArrayList<ValidatingWebhookBuilder>();
  ...
  public WebhooksNested<A> addNewWebhookLike(ValidatingWebhook item) {
  ...
  public ValidatingWebhook buildMatchingWebhook(Predicate<ValidatingWebhookBuilder> predicate) {
      for (ValidatingWebhookBuilder item : webhooks) {
  ...
  public WebhooksNested<A> editMatchingWebhook(Predicate<ValidatingWebhookBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromWebhooks(Predicate<ValidatingWebhookBuilder> predicate) {
    ...
    Iterator<ValidatingWebhookBuilder> each = webhooks.iterator();
  ...
  public WebhooksNested<A> setNewWebhookLike(int index,ValidatingWebhook item) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ValidatingWebhookConfigurationFluent.this.withMetadata(builder.build());
    }
  ...
  public class WebhooksNested<N> extends ValidatingWebhookFluent<WebhooksNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ValidatingWebhookConfigurationFluent.this.setToWebhooks(index, builder.build());
    }
