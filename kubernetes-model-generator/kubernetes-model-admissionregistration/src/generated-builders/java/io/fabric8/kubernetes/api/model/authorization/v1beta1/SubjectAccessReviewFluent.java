...
public class SubjectAccessReviewFluent<A extends io.fabric8.kubernetes.api.model.authorization.v1beta1.SubjectAccessReviewFluent<A>> extends BaseFluent<A>{
  ...
  public class SpecNested<N> extends SubjectAccessReviewSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SubjectAccessReviewFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends SubjectAccessReviewStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SubjectAccessReviewFluent.this.withStatus(builder.build());
    }
