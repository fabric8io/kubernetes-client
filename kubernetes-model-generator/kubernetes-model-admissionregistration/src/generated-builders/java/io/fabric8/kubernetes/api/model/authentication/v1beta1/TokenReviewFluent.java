...
public class TokenReviewFluent<A extends io.fabric8.kubernetes.api.model.authentication.v1beta1.TokenReviewFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new TokenReviewSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(TokenReviewSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new TokenReviewStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(TokenReviewStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(TokenReviewSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(TokenReviewStatus item) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TokenReviewFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends TokenReviewSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TokenReviewFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends TokenReviewStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TokenReviewFluent.this.withStatus(builder.build());
    }
