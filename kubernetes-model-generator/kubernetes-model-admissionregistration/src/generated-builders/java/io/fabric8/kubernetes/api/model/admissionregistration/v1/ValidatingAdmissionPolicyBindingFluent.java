...
public class ValidatingAdmissionPolicyBindingFluent<A extends io.fabric8.kubernetes.api.model.admissionregistration.v1.ValidatingAdmissionPolicyBindingFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new ValidatingAdmissionPolicyBindingSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(ValidatingAdmissionPolicyBindingSpec item) {
  ...
  public SpecNested<A> withNewSpecLike(ValidatingAdmissionPolicyBindingSpec item) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ValidatingAdmissionPolicyBindingFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends ValidatingAdmissionPolicyBindingSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ValidatingAdmissionPolicyBindingFluent.this.withSpec(builder.build());
    }
