...
public class ServiceReferenceFluent<A extends io.fabric8.kubernetes.api.model.admissionregistration.v1.ServiceReferenceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(name, namespace, path, port, additionalProperties);
  }
