...
public class NonResourceAttributesFluent<A extends io.fabric8.kubernetes.api.model.authorization.v1beta1.NonResourceAttributesFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(path, verb, additionalProperties);
  }
