...
public class ValidatingWebhookFluent<A extends io.fabric8.kubernetes.api.model.admissionregistration.v1beta1.ValidatingWebhookFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(admissionReviewVersions, clientConfig, failurePolicy, matchPolicy, name, namespaceSelector, objectSelector, rules, sideEffects, timeoutSeconds, additionalProperties);
  }
