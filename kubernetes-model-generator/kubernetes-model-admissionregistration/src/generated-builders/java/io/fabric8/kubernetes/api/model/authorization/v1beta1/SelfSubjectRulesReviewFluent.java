...
public class SelfSubjectRulesReviewFluent<A extends io.fabric8.kubernetes.api.model.authorization.v1beta1.SelfSubjectRulesReviewFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new SelfSubjectRulesReviewSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(SelfSubjectRulesReviewSpec item) {
  ...
  public A withNewSpec(String namespace) {
    return (A) this.withSpec(new SelfSubjectRulesReviewSpec(namespace));
  }
  
  public SpecNested<A> withNewSpecLike(SelfSubjectRulesReviewSpec item) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SelfSubjectRulesReviewFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends SelfSubjectRulesReviewSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SelfSubjectRulesReviewFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends SubjectRulesReviewStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SelfSubjectRulesReviewFluent.this.withStatus(builder.build());
    }
