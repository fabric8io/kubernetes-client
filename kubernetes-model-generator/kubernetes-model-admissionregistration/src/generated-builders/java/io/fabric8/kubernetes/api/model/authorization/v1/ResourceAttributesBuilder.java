...
public class ResourceAttributesBuilder extends ResourceAttributesFluent<ResourceAttributesBuilder> implements VisitableBuilder<ResourceAttributes,ResourceAttributesBuilder>{
  ...
  public ResourceAttributes build() {
    ResourceAttributes buildable = new ResourceAttributes(fluent.buildFieldSelector(), fluent.getGroup(), fluent.buildLabelSelector(), fluent.getName(), fluent.getNamespace(), fluent.getResource(), fluent.getSubresource(), fluent.getVerb(), fluent.getVersion());
