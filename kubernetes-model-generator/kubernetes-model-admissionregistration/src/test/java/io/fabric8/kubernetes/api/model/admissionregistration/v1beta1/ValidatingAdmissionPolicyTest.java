...
class ValidatingAdmissionPolicyTest {
  ...
  void deserializationAndSerializationShouldWorkAsExpected() throws IOException {
    // Given
    String originalJson = new Scanner(getClass().getResourceAsStream("/test-validatingadmissionpolicy-v1beta1.json"))
        .useDelimiter("\\A")
        .next();
    ...
    assertThat(validatingAdmissionPolicy)
        ...
        .hasFieldOrPropertyWithValue("spec.matchConstraints.resourceRules",
            Collections.singletonList(new NamedRuleWithOperationsBuilder()
                .addToApiGroups("apiGroupsValue")
                .addToApiVersions("apiVersionsValue")
                .addToOperations("operationsValue")
                .addToResources("resourcesValue")
        ...
        .hasFieldOrPropertyWithValue("spec.validations", Collections.singletonList(new ValidationBuilder()
            ...
            .withMessage("messageValue")
            .withReason("reasonValue")
            .withMessageExpression("messageExpressionValue")
            .build()));
  }
