...
public class VolumeAttachment implements Editable<VolumeAttachmentBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "VolumeAttachment(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
