...
public class CSINodeListFluent<A extends io.fabric8.kubernetes.api.model.storage.v1beta1.CSINodeListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<CSINodeBuilder> items = new ArrayList<CSINodeBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(CSINode item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<CSINodeBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<CSINodeBuilder> predicate) {
    ...
    Iterator<CSINodeBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        CSINodeBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,CSINode item) {
  ...
  public class ItemsNested<N> extends CSINodeFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CSINodeListFluent.this.setToItems(index, builder.build());
    }
