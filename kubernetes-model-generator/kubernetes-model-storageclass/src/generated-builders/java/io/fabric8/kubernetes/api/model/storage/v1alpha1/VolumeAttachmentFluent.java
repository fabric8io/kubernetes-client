...
public class VolumeAttachmentFluent<A extends io.fabric8.kubernetes.api.model.storage.v1alpha1.VolumeAttachmentFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new VolumeAttachmentSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(VolumeAttachmentSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new VolumeAttachmentStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(VolumeAttachmentStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(VolumeAttachmentSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(VolumeAttachmentStatus item) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) VolumeAttachmentFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends VolumeAttachmentSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) VolumeAttachmentFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends VolumeAttachmentStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) VolumeAttachmentFluent.this.withStatus(builder.build());
    }
