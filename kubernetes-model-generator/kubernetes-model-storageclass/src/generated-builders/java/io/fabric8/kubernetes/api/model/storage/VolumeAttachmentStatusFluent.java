...
public class VolumeAttachmentStatusFluent<A extends io.fabric8.kubernetes.api.model.storage.VolumeAttachmentStatusFluent<A>> extends BaseFluent<A>{
  ...
  public A withNewAttachError(Integer errorCode,String message,String time) {
    return (A) this.withAttachError(new VolumeError(errorCode, message, time));
  }
  ...
  public A withNewDetachError(Integer errorCode,String message,String time) {
    return (A) this.withDetachError(new VolumeError(errorCode, message, time));
  }
