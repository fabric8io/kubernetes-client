...
public class VolumeAttachmentSourceFluent<A extends io.fabric8.kubernetes.api.model.storage.v1alpha1.VolumeAttachmentSourceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(inlineVolumeSpec, persistentVolumeName, additionalProperties);
  }
