...
public class CSIDriverSpecFluent<A extends io.fabric8.kubernetes.api.model.storage.v1beta1.CSIDriverSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(attachRequired, fsGroupPolicy, podInfoOnMount, requiresRepublish, storageCapacity, tokenRequests, volumeLifecycleModes, additionalProperties);
  }
