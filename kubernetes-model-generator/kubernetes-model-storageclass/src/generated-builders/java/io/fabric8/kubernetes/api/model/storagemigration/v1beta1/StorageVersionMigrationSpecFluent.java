...
public class StorageVersionMigrationSpecFluent<A extends io.fabric8.kubernetes.api.model.storagemigration.v1beta1.StorageVersionMigrationSpecFluent<A>> extends BaseFluent<A>{
  ...
  public A withNewResource(String group,String resource) {
    return (A) this.withResource(new GroupResource(group, resource));
  }
