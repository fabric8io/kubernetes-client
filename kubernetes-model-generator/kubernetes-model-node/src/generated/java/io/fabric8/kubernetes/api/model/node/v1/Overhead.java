...
public class Overhead implements Editable<OverheadBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (this$podFixed == null ? other$podFixed != null : !this$podFixed.equals(other$podFixed)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = result * prime + ($podFixed == null ? 43 : $podFixed.hashCode());
    ...
    public String toString() {
        return "Overhead(" + "podFixed=" + this.getPodFixed() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
