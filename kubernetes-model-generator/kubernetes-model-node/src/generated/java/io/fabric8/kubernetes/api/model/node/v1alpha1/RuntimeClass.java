...
public class RuntimeClass implements Editable<RuntimeClassBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "RuntimeClass(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
