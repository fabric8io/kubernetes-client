...
public class RuntimeClassFluent<A extends io.fabric8.kubernetes.api.model.node.v1alpha1.RuntimeClassFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new RuntimeClassSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(RuntimeClassSpec item) {
  ...
  public SpecNested<A> withNewSpecLike(RuntimeClassSpec item) {
    return new SpecNested(item);
  }
  
  public A withSpec(RuntimeClassSpec spec) {
  ...
  public class SpecNested<N> extends RuntimeClassSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RuntimeClassFluent.this.withSpec(builder.build());
    }
