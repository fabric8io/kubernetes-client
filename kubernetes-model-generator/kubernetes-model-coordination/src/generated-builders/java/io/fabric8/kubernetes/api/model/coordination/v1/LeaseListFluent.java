...
public class LeaseListFluent<A extends io.fabric8.kubernetes.api.model.coordination.v1.LeaseListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<LeaseBuilder> items = new ArrayList<LeaseBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(Lease item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<LeaseBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<LeaseBuilder> predicate) {
    ...
    Iterator<LeaseBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        LeaseBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Lease item) {
  ...
  public class ItemsNested<N> extends LeaseFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) LeaseListFluent.this.setToItems(index, builder.build());
    }
