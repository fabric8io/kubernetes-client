...
public class MachineConfigListFluent<A extends io.fabric8.openshift.api.model.machineconfiguration.v1.MachineConfigListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<MachineConfigBuilder> items = new ArrayList<MachineConfigBuilder>();
  private String kind;
  private ListMeta metadata;

  public MachineConfigListFluent() {
  }
  
  public MachineConfigListFluent(MachineConfigList instance) {
  ...
  public ItemsNested<A> addNewItemLike(MachineConfig item) {
  ...
  public MachineConfig buildMatchingItem(Predicate<MachineConfigBuilder> predicate) {
      for (MachineConfigBuilder item : items) {
  ...
  protected void copyInstance(MachineConfigList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<MachineConfigBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    MachineConfigListFluent that = (MachineConfigListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<MachineConfigBuilder> predicate) {
    ...
    Iterator<MachineConfigBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,MachineConfig item) {
  ...
  public class ItemsNested<N> extends MachineConfigFluent<ItemsNested<N>> implements Nested<N>{
  
    MachineConfigBuilder builder;
    int index;
  
    ItemsNested(int index,MachineConfig item) {
      this.index = index;
      this.builder = new MachineConfigBuilder(this, item);
    }
  
    public N and() {
      return (N) MachineConfigListFluent.this.setToItems(index, builder.build());
    }
