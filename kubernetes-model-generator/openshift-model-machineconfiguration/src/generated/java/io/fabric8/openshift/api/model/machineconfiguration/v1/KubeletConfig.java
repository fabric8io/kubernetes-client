...
public class KubeletConfig implements Editable<KubeletConfigBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KubeletConfig)) {
            return false;
        }
        KubeletConfig other = (KubeletConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof KubeletConfig;
    }
    ...
    public String toString() {
        return "KubeletConfig(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
