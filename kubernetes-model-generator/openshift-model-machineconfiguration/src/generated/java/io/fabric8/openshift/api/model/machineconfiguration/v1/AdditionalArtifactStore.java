...
public class AdditionalArtifactStore implements Editable<AdditionalArtifactStoreBuilder>, KubernetesResource
{
     ...
     */
    public AdditionalArtifactStore() {
    }

    public AdditionalArtifactStore(String path) {
        super();
        this.path = path;
    }
    ...
    @JsonIgnore
    public AdditionalArtifactStoreBuilder edit() {
        return new AdditionalArtifactStoreBuilder(this);
    }

    @JsonIgnore
    public AdditionalArtifactStoreBuilder toBuilder() {
        return edit();
    }
