...
public class MachineConfigReference implements Editable<MachineConfigReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MachineConfigReference)) {
            return false;
        }
        MachineConfigReference other = (MachineConfigReference) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MachineConfigReference;
    }
    ...
    public String toString() {
        return "MachineConfigReference(" + "name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
