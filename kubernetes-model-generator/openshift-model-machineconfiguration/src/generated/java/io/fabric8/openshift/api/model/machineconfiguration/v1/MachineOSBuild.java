...
public class MachineOSBuild implements Editable<MachineOSBuildBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MachineOSBuild)) {
            return false;
        }
        MachineOSBuild other = (MachineOSBuild) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MachineOSBuild;
    }
    ...
    public String toString() {
        return "MachineOSBuild(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
