...
public class ImageSecretObjectReference implements Editable<ImageSecretObjectReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImageSecretObjectReference)) {
            return false;
        }
        ImageSecretObjectReference other = (ImageSecretObjectReference) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ImageSecretObjectReference;
    }
    ...
    public String toString() {
        return "ImageSecretObjectReference(" + "name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
