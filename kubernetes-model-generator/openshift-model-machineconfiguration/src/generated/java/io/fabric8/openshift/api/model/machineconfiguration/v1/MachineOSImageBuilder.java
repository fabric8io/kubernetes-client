...
public class MachineOSImageBuilder implements Editable<MachineOSImageBuilderBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MachineOSImageBuilder)) {
            return false;
        }
        MachineOSImageBuilder other = (MachineOSImageBuilder) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MachineOSImageBuilder;
    }
    ...
    public String toString() {
        return "MachineOSImageBuilder(" + "imageBuilderType=" + this.getImageBuilderType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
