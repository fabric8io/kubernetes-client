...
public class AdditionalLayerStore implements Editable<AdditionalLayerStoreBuilder>, KubernetesResource
{
     ...
     */
    public AdditionalLayerStore() {
    }

    public AdditionalLayerStore(String path) {
        super();
        this.path = path;
    }
    ...
    @JsonIgnore
    public AdditionalLayerStoreBuilder edit() {
        return new AdditionalLayerStoreBuilder(this);
    }

    @JsonIgnore
    public AdditionalLayerStoreBuilder toBuilder() {
        return edit();
    }
