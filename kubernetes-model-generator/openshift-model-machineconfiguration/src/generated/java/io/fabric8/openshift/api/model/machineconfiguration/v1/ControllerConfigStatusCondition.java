...
public class ControllerConfigStatusCondition implements Editable<ControllerConfigStatusConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ControllerConfigStatusCondition)) {
            return false;
        }
        ControllerConfigStatusCondition other = (ControllerConfigStatusCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ControllerConfigStatusCondition;
    }
    ...
    public String toString() {
        return "ControllerConfigStatusCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
