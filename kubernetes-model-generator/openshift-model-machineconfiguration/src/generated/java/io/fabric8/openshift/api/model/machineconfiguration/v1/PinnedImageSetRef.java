...
public class PinnedImageSetRef implements Editable<PinnedImageSetRefBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PinnedImageSetRef)) {
            return false;
        }
        PinnedImageSetRef other = (PinnedImageSetRef) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PinnedImageSetRef;
    }
    ...
    public String toString() {
        return "PinnedImageSetRef(" + "name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
