...
public class MachineOSConfigReference implements Editable<MachineOSConfigReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MachineOSConfigReference)) {
            return false;
        }
        MachineOSConfigReference other = (MachineOSConfigReference) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MachineOSConfigReference;
    }
    ...
    public String toString() {
        return "MachineOSConfigReference(" + "name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
