...
public class PinnedImageSet implements Editable<PinnedImageSetBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PinnedImageSet)) {
            return false;
        }
        PinnedImageSet other = (PinnedImageSet) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PinnedImageSet;
    }
    ...
    public String toString() {
        return "PinnedImageSet(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
