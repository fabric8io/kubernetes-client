...
public class ControllerConfig implements Editable<ControllerConfigBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "ControllerConfig(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
