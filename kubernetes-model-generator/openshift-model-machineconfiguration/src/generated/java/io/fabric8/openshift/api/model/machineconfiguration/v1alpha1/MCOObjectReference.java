...
public class MCOObjectReference implements Editable<MCOObjectReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MCOObjectReference)) {
            return false;
        }
        MCOObjectReference other = (MCOObjectReference) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MCOObjectReference;
    }
    ...
    public String toString() {
        return "MCOObjectReference(" + "name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
