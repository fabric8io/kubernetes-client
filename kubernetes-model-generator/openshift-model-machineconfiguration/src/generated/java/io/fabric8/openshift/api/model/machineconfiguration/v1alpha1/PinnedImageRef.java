...
public class PinnedImageRef implements Editable<PinnedImageRefBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PinnedImageRef)) {
            return false;
        }
        PinnedImageRef other = (PinnedImageRef) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PinnedImageRef;
    }
    ...
    public String toString() {
        return "PinnedImageRef(" + "name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
