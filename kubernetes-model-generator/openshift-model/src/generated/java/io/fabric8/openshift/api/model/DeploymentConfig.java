...
public class DeploymentConfig implements Editable<DeploymentConfigBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "DeploymentConfig(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
