...
public class BuildCondition implements Editable<BuildConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        BuildCondition other = (BuildCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof BuildCondition;
    }
    ...
    public String toString() {
        return "BuildCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", lastUpdateTime=" + this.getLastUpdateTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
