...
public class ImageStreamLayers implements Editable<ImageStreamLayersBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImageStreamLayers)) {
            return false;
        }
        ImageStreamLayers other = (ImageStreamLayers) o;
        ...
        Object this$blobs = this.getBlobs();
        Object other$blobs = other.getBlobs();
        if (this$blobs == null ? other$blobs != null : !this$blobs.equals(other$blobs)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ImageStreamLayers;
    }
    ...
    public int hashCode() {
        ...
        Object $blobs = this.getBlobs();
        result = result * prime + ($blobs == null ? 43 : $blobs.hashCode());
    ...
    public String toString() {
        return "ImageStreamLayers(" + "apiVersion=" + this.getApiVersion() + ", blobs=" + this.getBlobs() + ", images=" + this.getImages() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
