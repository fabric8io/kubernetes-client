...
public class PodSecurityPolicySubjectReviewStatus implements Editable<PodSecurityPolicySubjectReviewStatusBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodSecurityPolicySubjectReviewStatus)) {
            return false;
        }
        PodSecurityPolicySubjectReviewStatus other = (PodSecurityPolicySubjectReviewStatus) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PodSecurityPolicySubjectReviewStatus;
    }
    ...
    public String toString() {
        return "PodSecurityPolicySubjectReviewStatus(" + "allowedBy=" + this.getAllowedBy() + ", reason=" + this.getReason() + ", template=" + this.getTemplate() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
