...
public class SignatureCondition implements Editable<SignatureConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SignatureCondition)) {
            return false;
        }
        SignatureCondition other = (SignatureCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SignatureCondition;
    }
    ...
    public String toString() {
        return "SignatureCondition(" + "lastProbeTime=" + this.getLastProbeTime() + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
