...
public class GenericWebHookCause implements Editable<GenericWebHookCauseBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenericWebHookCause)) {
            return false;
        }
        GenericWebHookCause other = (GenericWebHookCause) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GenericWebHookCause;
    }
    ...
    public String toString() {
        return "GenericWebHookCause(" + "revision=" + this.getRevision() + ", secret=" + this.getSecret() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
