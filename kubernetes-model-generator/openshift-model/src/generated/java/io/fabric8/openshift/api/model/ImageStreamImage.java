...
public class ImageStreamImage implements Editable<ImageStreamImageBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImageStreamImage)) {
            return false;
        }
        ImageStreamImage other = (ImageStreamImage) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ImageStreamImage;
    }
    ...
    public String toString() {
        return "ImageStreamImage(" + "apiVersion=" + this.getApiVersion() + ", image=" + this.getImage() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
