...
public class RouteIngressCondition implements Editable<RouteIngressConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RouteIngressCondition)) {
            return false;
        }
        RouteIngressCondition other = (RouteIngressCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RouteIngressCondition;
    }
    ...
    public String toString() {
        return "RouteIngressCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
