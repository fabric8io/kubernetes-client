...
public class Condition implements Editable<ConditionBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "Condition(" + "lastHeartbeatTime=" + this.getLastHeartbeatTime() + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
