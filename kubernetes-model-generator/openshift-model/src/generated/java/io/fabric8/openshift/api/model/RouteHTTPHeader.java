...
public class RouteHTTPHeader implements Editable<RouteHTTPHeaderBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RouteHTTPHeader)) {
            return false;
        }
        RouteHTTPHeader other = (RouteHTTPHeader) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RouteHTTPHeader;
    }
    ...
    public String toString() {
        return "RouteHTTPHeader(" + "action=" + this.getAction() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
