...
public class BuildLogOptions implements Editable<BuildLogOptionsBuilder>, KubernetesResource, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BuildLogOptions)) {
            return false;
        }
        BuildLogOptions other = (BuildLogOptions) o;
        ...
        Object this$insecureSkipTLSVerifyBackend = this.getInsecureSkipTLSVerifyBackend();
        Object other$insecureSkipTLSVerifyBackend = other.getInsecureSkipTLSVerifyBackend();
        if (this$insecureSkipTLSVerifyBackend == null ? other$insecureSkipTLSVerifyBackend != null : !this$insecureSkipTLSVerifyBackend.equals(other$insecureSkipTLSVerifyBackend)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof BuildLogOptions;
    }
    ...
    public int hashCode() {
        ...
        Object $insecureSkipTLSVerifyBackend = this.getInsecureSkipTLSVerifyBackend();
        result = result * prime + ($insecureSkipTLSVerifyBackend == null ? 43 : $insecureSkipTLSVerifyBackend.hashCode());
