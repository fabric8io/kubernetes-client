...
public class ImageLayerData implements Editable<ImageLayerDataBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImageLayerData)) {
            return false;
        }
        ImageLayerData other = (ImageLayerData) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ImageLayerData;
    }
    ...
    public String toString() {
        return "ImageLayerData(" + "mediaType=" + this.getMediaType() + ", size=" + this.getSize() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
