...
public class RedirectReference implements Editable<RedirectReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RedirectReference)) {
            return false;
        }
        RedirectReference other = (RedirectReference) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RedirectReference;
    }
    ...
    public String toString() {
        return "RedirectReference(" + "group=" + this.getGroup() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
