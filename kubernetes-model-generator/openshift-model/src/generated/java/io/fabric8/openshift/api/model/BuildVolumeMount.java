...
public class BuildVolumeMount implements Editable<BuildVolumeMountBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BuildVolumeMount)) {
            return false;
        }
        BuildVolumeMount other = (BuildVolumeMount) o;
        if (!other.canEqual(this)) {
            return false;
        }
        Object this$destinationPath = this.getDestinationPath();
        Object other$destinationPath = other.getDestinationPath();
        if (this$destinationPath == null ? other$destinationPath != null : !this$destinationPath.equals(other$destinationPath)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof BuildVolumeMount;
    }
    ...
    public int hashCode() {
        ...
        result = result * prime + ($destinationPath == null ? 43 : $destinationPath.hashCode());
    ...
    public String toString() {
        return "BuildVolumeMount(" + "destinationPath=" + this.getDestinationPath() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
