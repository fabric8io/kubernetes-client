...
public class ImageTag implements Editable<ImageTagBuilder>, HasMetadata, Namespaced
{
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ImageTag;
    }
    ...
    public String toString() {
        return "ImageTag(" + "apiVersion=" + this.getApiVersion() + ", image=" + this.getImage() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
