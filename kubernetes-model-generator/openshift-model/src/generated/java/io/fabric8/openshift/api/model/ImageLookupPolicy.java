...
public class ImageLookupPolicy implements Editable<ImageLookupPolicyBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImageLookupPolicy)) {
            return false;
        }
        ImageLookupPolicy other = (ImageLookupPolicy) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ImageLookupPolicy;
    }
    ...
    public String toString() {
        return "ImageLookupPolicy(" + "local=" + this.getLocal() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
