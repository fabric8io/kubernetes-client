...
public class TemplateInstanceSpec implements Editable<TemplateInstanceSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TemplateInstanceSpec)) {
            return false;
        }
        TemplateInstanceSpec other = (TemplateInstanceSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof TemplateInstanceSpec;
    }
    ...
    public String toString() {
        return "TemplateInstanceSpec(" + "requester=" + this.getRequester() + ", secret=" + this.getSecret() + ", template=" + this.getTemplate() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
