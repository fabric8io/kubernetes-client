...
public class ProjectRequest implements Editable<ProjectRequestBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "ProjectRequest(" + "apiVersion=" + this.getApiVersion() + ", description=" + this.getDescription() + ", displayName=" + this.getDisplayName() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
