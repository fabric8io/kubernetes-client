...
public class CommonWebHookCause implements Editable<CommonWebHookCauseBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CommonWebHookCause)) {
            return false;
        }
        CommonWebHookCause other = (CommonWebHookCause) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CommonWebHookCause;
    }
    ...
    public String toString() {
        return "CommonWebHookCause(" + "revision=" + this.getRevision() + ", secret=" + this.getSecret() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
