...
public class RouteSetHTTPHeader implements Editable<RouteSetHTTPHeaderBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RouteSetHTTPHeader)) {
            return false;
        }
        RouteSetHTTPHeader other = (RouteSetHTTPHeader) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RouteSetHTTPHeader;
    }
    ...
    public String toString() {
        return "RouteSetHTTPHeader(" + "value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
