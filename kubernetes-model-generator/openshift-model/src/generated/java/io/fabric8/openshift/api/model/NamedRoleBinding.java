...
public class NamedRoleBinding implements Editable<NamedRoleBindingBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NamedRoleBinding)) {
            return false;
        }
        NamedRoleBinding other = (NamedRoleBinding) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof NamedRoleBinding;
    }
    ...
    public String toString() {
        return "NamedRoleBinding(" + "name=" + this.getName() + ", roleBinding=" + this.getRoleBinding() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
