...
public class PodSecurityPolicySubjectReview implements Editable<PodSecurityPolicySubjectReviewBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodSecurityPolicySubjectReview)) {
            return false;
        }
        PodSecurityPolicySubjectReview other = (PodSecurityPolicySubjectReview) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PodSecurityPolicySubjectReview;
    }
    ...
    public String toString() {
        return "PodSecurityPolicySubjectReview(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
