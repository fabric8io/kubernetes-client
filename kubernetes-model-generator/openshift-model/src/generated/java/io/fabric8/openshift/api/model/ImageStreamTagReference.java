...
public class ImageStreamTagReference implements Editable<ImageStreamTagReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImageStreamTagReference)) {
            return false;
        }
        ImageStreamTagReference other = (ImageStreamTagReference) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ImageStreamTagReference;
    }
    ...
    public String toString() {
        return "ImageStreamTagReference(" + "name=" + this.getName() + ", namespace=" + this.getNamespace() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
