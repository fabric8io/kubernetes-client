...
public class SecretBuildSource implements Editable<SecretBuildSourceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecretBuildSource)) {
            return false;
        }
        SecretBuildSource other = (SecretBuildSource) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SecretBuildSource;
    }
    ...
    public String toString() {
        return "SecretBuildSource(" + "destinationDir=" + this.getDestinationDir() + ", secret=" + this.getSecret() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
