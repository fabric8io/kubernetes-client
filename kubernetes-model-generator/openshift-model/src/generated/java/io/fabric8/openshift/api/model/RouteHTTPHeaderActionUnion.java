...
public class RouteHTTPHeaderActionUnion implements Editable<RouteHTTPHeaderActionUnionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RouteHTTPHeaderActionUnion)) {
            return false;
        }
        RouteHTTPHeaderActionUnion other = (RouteHTTPHeaderActionUnion) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RouteHTTPHeaderActionUnion;
    }
    ...
    public String toString() {
        return "RouteHTTPHeaderActionUnion(" + "set=" + this.getSet() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
