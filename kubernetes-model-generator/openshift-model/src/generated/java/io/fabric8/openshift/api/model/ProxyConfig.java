...
public class ProxyConfig implements Editable<ProxyConfigBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "ProxyConfig(" + "httpProxy=" + this.getHttpProxy() + ", httpsProxy=" + this.getHttpsProxy() + ", noProxy=" + this.getNoProxy() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
