...
public class PodSecurityPolicySelfSubjectReviewSpec implements Editable<PodSecurityPolicySelfSubjectReviewSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodSecurityPolicySelfSubjectReviewSpec)) {
            return false;
        }
        PodSecurityPolicySelfSubjectReviewSpec other = (PodSecurityPolicySelfSubjectReviewSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PodSecurityPolicySelfSubjectReviewSpec;
    }
    ...
    public String toString() {
        return "PodSecurityPolicySelfSubjectReviewSpec(" + "template=" + this.getTemplate() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
