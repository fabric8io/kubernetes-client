...
public class GitLabWebHookCause implements Editable<GitLabWebHookCauseBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GitLabWebHookCause)) {
            return false;
        }
        GitLabWebHookCause other = (GitLabWebHookCause) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GitLabWebHookCause;
    }
    ...
    public String toString() {
        return "GitLabWebHookCause(" + "revision=" + this.getRevision() + ", secret=" + this.getSecret() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
