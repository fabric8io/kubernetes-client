...
public class GitHubWebHookCause implements Editable<GitHubWebHookCauseBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GitHubWebHookCause)) {
            return false;
        }
        GitHubWebHookCause other = (GitHubWebHookCause) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GitHubWebHookCause;
    }
    ...
    public String toString() {
        return "GitHubWebHookCause(" + "revision=" + this.getRevision() + ", secret=" + this.getSecret() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
