...
public class NamedClusterRole implements Editable<NamedClusterRoleBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NamedClusterRole)) {
            return false;
        }
        NamedClusterRole other = (NamedClusterRole) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof NamedClusterRole;
    }
    ...
    public String toString() {
        return "NamedClusterRole(" + "name=" + this.getName() + ", role=" + this.getRole() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
