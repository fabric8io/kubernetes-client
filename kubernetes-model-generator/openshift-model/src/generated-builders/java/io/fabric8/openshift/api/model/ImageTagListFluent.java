...
public class ImageTagListFluent<A extends io.fabric8.openshift.api.model.ImageTagListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ImageTagBuilder> items = new ArrayList<ImageTagBuilder>();
  private String kind;
  private ListMeta metadata;

  public ImageTagListFluent() {
  }
  
  public ImageTagListFluent(ImageTagList instance) {
  ...
  public ItemsNested<A> addNewItemLike(ImageTag item) {
  ...
  public ImageTag buildMatchingItem(Predicate<ImageTagBuilder> predicate) {
      for (ImageTagBuilder item : items) {
  ...
  protected void copyInstance(ImageTagList instance) {
    instance = instance != null ? instance : new ImageTagList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ImageTagBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ImageTagListFluent that = (ImageTagListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ImageTagBuilder> predicate) {
    ...
    Iterator<ImageTagBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ImageTagBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ImageTag item) {
  ...
  public class ItemsNested<N> extends ImageTagFluent<ItemsNested<N>> implements Nested<N>{
  
    ImageTagBuilder builder;
    int index;
  
    ItemsNested(int index,ImageTag item) {
      this.index = index;
      this.builder = new ImageTagBuilder(this, item);
    }
  
    public N and() {
      return (N) ImageTagListFluent.this.setToItems(index, builder.build());
    }
