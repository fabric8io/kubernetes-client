...
public class BuildConfigFluent<A extends io.fabric8.openshift.api.model.BuildConfigFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new BuildConfigSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(BuildConfigSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new BuildConfigStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(BuildConfigStatus item) {
