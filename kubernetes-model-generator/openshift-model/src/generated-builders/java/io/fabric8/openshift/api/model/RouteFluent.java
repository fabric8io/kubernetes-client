...
public class RouteFluent<A extends io.fabric8.openshift.api.model.RouteFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new RouteSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(RouteSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new RouteStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(RouteStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(RouteSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(RouteStatus item) {
