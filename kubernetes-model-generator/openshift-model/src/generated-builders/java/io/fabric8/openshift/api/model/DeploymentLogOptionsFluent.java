...
public class DeploymentLogOptionsFluent<A extends io.fabric8.openshift.api.model.DeploymentLogOptionsFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(DeploymentLogOptions instance) {
    instance = instance != null ? instance : new DeploymentLogOptions();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    DeploymentLogOptionsFluent that = (DeploymentLogOptionsFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, container, follow, kind, limitBytes, nowait, previous, sinceSeconds, sinceTime, tailLines, timestamps, version, additionalProperties);
  }
