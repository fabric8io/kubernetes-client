...
public class GroupRestrictionFluent<A extends io.fabric8.openshift.api.model.GroupRestrictionFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(groups, labels, additionalProperties);
  }
