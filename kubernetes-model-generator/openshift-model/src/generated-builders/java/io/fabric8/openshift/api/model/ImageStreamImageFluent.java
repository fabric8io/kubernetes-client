...
public class ImageStreamImageFluent<A extends io.fabric8.openshift.api.model.ImageStreamImageFluent<A>> extends BaseFluent<A>{
  ...
  public ImageStreamImageFluent() {
  }
  
  public ImageStreamImageFluent(ImageStreamImage instance) {
  ...
  protected void copyInstance(ImageStreamImage instance) {
    instance = instance != null ? instance : new ImageStreamImage();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ImageStreamImageFluent that = (ImageStreamImageFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, image, kind, metadata, additionalProperties);
  }
  ...
  public class ImageNested<N> extends ImageFluent<ImageNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ImageStreamImageFluent.this.withImage(builder.build());
    }
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ImageStreamImageFluent.this.withMetadata(builder.build());
    }
