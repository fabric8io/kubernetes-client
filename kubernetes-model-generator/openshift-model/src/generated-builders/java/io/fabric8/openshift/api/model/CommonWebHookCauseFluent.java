...
public class CommonWebHookCauseFluent<A extends io.fabric8.openshift.api.model.CommonWebHookCauseFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private SourceRevisionBuilder revision;
  private String secret;

  public CommonWebHookCauseFluent() {
  }
  
  public CommonWebHookCauseFluent(CommonWebHookCause instance) {
  ...
  protected void copyInstance(CommonWebHookCause instance) {
    instance = instance != null ? instance : new CommonWebHookCause();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    CommonWebHookCauseFluent that = (CommonWebHookCauseFluent) o;
  ...
  public class RevisionNested<N> extends SourceRevisionFluent<RevisionNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CommonWebHookCauseFluent.this.withRevision(builder.build());
    }
