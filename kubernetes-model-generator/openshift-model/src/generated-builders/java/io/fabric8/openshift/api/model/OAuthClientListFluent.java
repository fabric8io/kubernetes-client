...
public class OAuthClientListFluent<A extends io.fabric8.openshift.api.model.OAuthClientListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<OAuthClientBuilder> items = new ArrayList<OAuthClientBuilder>();
  private String kind;
  private ListMeta metadata;

  public OAuthClientListFluent() {
  }
  
  public OAuthClientListFluent(OAuthClientList instance) {
  ...
  public OAuthClient buildMatchingItem(Predicate<OAuthClientBuilder> predicate) {
      for (OAuthClientBuilder item : items) {
  ...
  protected void copyInstance(OAuthClientList instance) {
    instance = instance != null ? instance : new OAuthClientList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<OAuthClientBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    OAuthClientListFluent that = (OAuthClientListFluent) o;
  ...
  public boolean hasMatchingItem(Predicate<OAuthClientBuilder> predicate) {
      for (OAuthClientBuilder item : items) {
        if (predicate.test(item)) {
          return true;
        }
  ...
  public A removeMatchingFromItems(Predicate<OAuthClientBuilder> predicate) {
    if (items == null) {
      return (A) this;
    }
    Iterator<OAuthClientBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        OAuthClientBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,OAuthClient item) {
  ...
  public class ItemsNested<N> extends OAuthClientFluent<ItemsNested<N>> implements Nested<N>{
  
    OAuthClientBuilder builder;
    int index;
  
    ItemsNested(int index,OAuthClient item) {
      this.index = index;
      this.builder = new OAuthClientBuilder(this, item);
    }
  
    public N and() {
      return (N) OAuthClientListFluent.this.setToItems(index, builder.build());
    }
