...
public class ImageTagFluent<A extends io.fabric8.openshift.api.model.ImageTagFluent<A>> extends BaseFluent<A>{
  ...
  public ImageTagFluent() {
  }
  
  public ImageTagFluent(ImageTag instance) {
  ...
  protected void copyInstance(ImageTag instance) {
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new TagReferenceBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(TagReference item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new NamedTagEventListBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(NamedTagEventList item) {
  ...
  public boolean equals(Object o) {
    ...
    ImageTagFluent that = (ImageTagFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, image, kind, metadata, spec, status, additionalProperties);
  }
  ...
  public SpecNested<A> withNewSpecLike(TagReference item) {
  ...
  public StatusNested<A> withNewStatusLike(NamedTagEventList item) {
  ...
  public class ImageNested<N> extends ImageFluent<ImageNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ImageTagFluent.this.withImage(builder.build());
    }
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ImageTagFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends TagReferenceFluent<SpecNested<N>> implements Nested<N>{
  
    TagReferenceBuilder builder;
  
    SpecNested(TagReference item) {
      this.builder = new TagReferenceBuilder(this, item);
    }
  
    public N and() {
      return (N) ImageTagFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends NamedTagEventListFluent<StatusNested<N>> implements Nested<N>{
  
    NamedTagEventListBuilder builder;
  
    StatusNested(NamedTagEventList item) {
      this.builder = new NamedTagEventListBuilder(this, item);
    }
  
    public N and() {
      return (N) ImageTagFluent.this.withStatus(builder.build());
    }
