...
public class RoleBindingBuilder extends RoleBindingFluent<RoleBindingBuilder> implements VisitableBuilder<RoleBinding,RoleBindingBuilder>{
  ...
  public RoleBinding build() {
    RoleBinding buildable = new RoleBinding(fluent.getApiVersion(), fluent.getGroupNames(), fluent.getKind(), fluent.buildMetadata(), fluent.buildRoleRef(), fluent.buildSubjects(), fluent.getUserNames());
