...
public class ImageStreamTagListFluent<A extends io.fabric8.openshift.api.model.ImageStreamTagListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ImageStreamTagBuilder> items = new ArrayList<ImageStreamTagBuilder>();
  private String kind;
  private ListMeta metadata;

  public ImageStreamTagListFluent() {
  }
  
  public ImageStreamTagListFluent(ImageStreamTagList instance) {
  ...
  public ItemsNested<A> addNewItemLike(ImageStreamTag item) {
  ...
  public ImageStreamTag buildMatchingItem(Predicate<ImageStreamTagBuilder> predicate) {
      for (ImageStreamTagBuilder item : items) {
  ...
  protected void copyInstance(ImageStreamTagList instance) {
    instance = instance != null ? instance : new ImageStreamTagList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ImageStreamTagBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ImageStreamTagListFluent that = (ImageStreamTagListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ImageStreamTagBuilder> predicate) {
    ...
    Iterator<ImageStreamTagBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ImageStreamTagBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ImageStreamTag item) {
  ...
  public class ItemsNested<N> extends ImageStreamTagFluent<ItemsNested<N>> implements Nested<N>{
  
    ImageStreamTagBuilder builder;
    int index;
  
    ItemsNested(int index,ImageStreamTag item) {
      this.index = index;
      this.builder = new ImageStreamTagBuilder(this, item);
    }
  
    public N and() {
      return (N) ImageStreamTagListFluent.this.setToItems(index, builder.build());
    }
