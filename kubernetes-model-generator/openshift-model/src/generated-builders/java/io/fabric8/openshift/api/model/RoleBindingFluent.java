...
public class RoleBindingFluent<A extends io.fabric8.openshift.api.model.RoleBindingFluent<A>> extends BaseFluent<A>{
  ...
  public class SubjectsNested<N> extends ObjectReferenceFluent<SubjectsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RoleBindingFluent.this.setToSubjects(index, builder.build());
    }
