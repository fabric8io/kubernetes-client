...
public class JenkinsPipelineBuildStrategyFluent<A extends io.fabric8.openshift.api.model.JenkinsPipelineBuildStrategyFluent<A>> extends BaseFluent<A>{
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(jenkinsfile, that.jenkinsfile))) {
      return false;
    }
    if (!(Objects.equals(jenkinsfilePath, that.jenkinsfilePath))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(env, jenkinsfile, jenkinsfilePath, additionalProperties);
  }
  ...
  public String toString() {
    ...
    if (!(jenkinsfile == null)) {
        sb.append("jenkinsfile:");
        sb.append(jenkinsfile);
        sb.append(",");
    }
    if (!(jenkinsfilePath == null)) {
        sb.append("jenkinsfilePath:");
        sb.append(jenkinsfilePath);
        sb.append(",");
    }
