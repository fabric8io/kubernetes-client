...
public class PodSecurityPolicySubjectReviewStatusFluent<A extends io.fabric8.openshift.api.model.PodSecurityPolicySubjectReviewStatusFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(allowedBy, reason, template, additionalProperties);
  }
