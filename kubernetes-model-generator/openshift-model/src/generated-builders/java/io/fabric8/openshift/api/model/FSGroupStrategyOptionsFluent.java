...
public class FSGroupStrategyOptionsFluent<A extends io.fabric8.openshift.api.model.FSGroupStrategyOptionsFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(ranges, type, additionalProperties);
  }
