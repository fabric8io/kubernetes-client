...
public class GitLabWebHookCauseFluent<A extends io.fabric8.openshift.api.model.GitLabWebHookCauseFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private SourceRevisionBuilder revision;
  private String secret;

  public GitLabWebHookCauseFluent() {
  }
  
  public GitLabWebHookCauseFluent(GitLabWebHookCause instance) {
  ...
  protected void copyInstance(GitLabWebHookCause instance) {
  ...
  public boolean equals(Object o) {
    ...
    GitLabWebHookCauseFluent that = (GitLabWebHookCauseFluent) o;
  ...
  public class RevisionNested<N> extends SourceRevisionFluent<RevisionNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitLabWebHookCauseFluent.this.withRevision(builder.build());
    }
