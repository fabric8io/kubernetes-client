...
public class GroupListFluent<A extends io.fabric8.openshift.api.model.GroupListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<GroupBuilder> items = new ArrayList<GroupBuilder>();
  private String kind;
  private ListMeta metadata;

  public GroupListFluent() {
  }
  
  public GroupListFluent(GroupList instance) {
  ...
  public ItemsNested<A> addNewItemLike(Group item) {
  ...
  protected void copyInstance(GroupList instance) {
    instance = instance != null ? instance : new GroupList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<GroupBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    GroupListFluent that = (GroupListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<GroupBuilder> predicate) {
    ...
    Iterator<GroupBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        GroupBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Group item) {
  ...
  public class ItemsNested<N> extends GroupFluent<ItemsNested<N>> implements Nested<N>{
  
    GroupBuilder builder;
    int index;
  
    ItemsNested(int index,Group item) {
      this.index = index;
      this.builder = new GroupBuilder(this, item);
    }
  
    public N and() {
      return (N) GroupListFluent.this.setToItems(index, builder.build());
    }
