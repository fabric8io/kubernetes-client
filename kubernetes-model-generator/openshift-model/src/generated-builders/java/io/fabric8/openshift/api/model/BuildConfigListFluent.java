...
public class BuildConfigListFluent<A extends io.fabric8.openshift.api.model.BuildConfigListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<BuildConfigBuilder> items = new ArrayList<BuildConfigBuilder>();
  private String kind;
  private ListMeta metadata;

  public BuildConfigListFluent() {
  }
  
  public BuildConfigListFluent(BuildConfigList instance) {
  ...
  public ItemsNested<A> addNewItemLike(BuildConfig item) {
  ...
  public BuildConfig buildMatchingItem(Predicate<BuildConfigBuilder> predicate) {
      for (BuildConfigBuilder item : items) {
  ...
  protected void copyInstance(BuildConfigList instance) {
    instance = instance != null ? instance : new BuildConfigList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<BuildConfigBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    BuildConfigListFluent that = (BuildConfigListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<BuildConfigBuilder> predicate) {
    ...
    Iterator<BuildConfigBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,BuildConfig item) {
  ...
  public class ItemsNested<N> extends BuildConfigFluent<ItemsNested<N>> implements Nested<N>{
  
    BuildConfigBuilder builder;
    int index;
  
    ItemsNested(int index,BuildConfig item) {
      this.index = index;
      this.builder = new BuildConfigBuilder(this, item);
    }
  
    public N and() {
      return (N) BuildConfigListFluent.this.setToItems(index, builder.build());
    }
