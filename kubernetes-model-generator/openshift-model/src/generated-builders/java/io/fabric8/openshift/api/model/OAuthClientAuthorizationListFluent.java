...
public class OAuthClientAuthorizationListFluent<A extends io.fabric8.openshift.api.model.OAuthClientAuthorizationListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<OAuthClientAuthorizationBuilder> items = new ArrayList<OAuthClientAuthorizationBuilder>();
  private String kind;
  private ListMeta metadata;

  public OAuthClientAuthorizationListFluent() {
  }
  
  public OAuthClientAuthorizationListFluent(OAuthClientAuthorizationList instance) {
  ...
  public ItemsNested<A> addNewItemLike(OAuthClientAuthorization item) {
  ...
  public OAuthClientAuthorization buildMatchingItem(Predicate<OAuthClientAuthorizationBuilder> predicate) {
      for (OAuthClientAuthorizationBuilder item : items) {
  ...
  protected void copyInstance(OAuthClientAuthorizationList instance) {
    instance = instance != null ? instance : new OAuthClientAuthorizationList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<OAuthClientAuthorizationBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    OAuthClientAuthorizationListFluent that = (OAuthClientAuthorizationListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<OAuthClientAuthorizationBuilder> predicate) {
    ...
    Iterator<OAuthClientAuthorizationBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,OAuthClientAuthorization item) {
  ...
  public class ItemsNested<N> extends OAuthClientAuthorizationFluent<ItemsNested<N>> implements Nested<N>{
  
    OAuthClientAuthorizationBuilder builder;
    int index;
  
    ItemsNested(int index,OAuthClientAuthorization item) {
      this.index = index;
      this.builder = new OAuthClientAuthorizationBuilder(this, item);
    }
  
    public N and() {
      return (N) OAuthClientAuthorizationListFluent.this.setToItems(index, builder.build());
    }
