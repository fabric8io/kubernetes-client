...
public class BuildSpecFluent<A extends io.fabric8.openshift.api.model.BuildSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(completionDeadlineSeconds, mountTrustedCA, nodeSelector, output, postCommit, resources, revision, serviceAccount, source, strategy, triggeredBy, additionalProperties);
  }
  ...
  public class PostCommitNested<N> extends BuildPostCommitSpecFluent<PostCommitNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BuildSpecFluent.this.withPostCommit(builder.build());
    }
  ...
  public class TriggeredByNested<N> extends BuildTriggerCauseFluent<TriggeredByNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BuildSpecFluent.this.setToTriggeredBy(index, builder.build());
    }
