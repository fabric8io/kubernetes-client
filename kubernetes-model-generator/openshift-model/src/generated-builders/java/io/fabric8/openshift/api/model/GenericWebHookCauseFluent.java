...
public class GenericWebHookCauseFluent<A extends io.fabric8.openshift.api.model.GenericWebHookCauseFluent<A>> extends BaseFluent<A>{
  ...
  public GenericWebHookCauseFluent(GenericWebHookCause instance) {
  ...
  protected void copyInstance(GenericWebHookCause instance) {
    instance = instance != null ? instance : new GenericWebHookCause();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    GenericWebHookCauseFluent that = (GenericWebHookCauseFluent) o;
  ...
  public class RevisionNested<N> extends SourceRevisionFluent<RevisionNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GenericWebHookCauseFluent.this.withRevision(builder.build());
    }
