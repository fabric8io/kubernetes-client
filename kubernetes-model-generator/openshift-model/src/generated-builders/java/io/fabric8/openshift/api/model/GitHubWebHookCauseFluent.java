...
public class GitHubWebHookCauseFluent<A extends io.fabric8.openshift.api.model.GitHubWebHookCauseFluent<A>> extends BaseFluent<A>{
  ...
  public GitHubWebHookCauseFluent(GitHubWebHookCause instance) {
  ...
  protected void copyInstance(GitHubWebHookCause instance) {
  ...
  public boolean equals(Object o) {
    ...
    GitHubWebHookCauseFluent that = (GitHubWebHookCauseFluent) o;
  ...
  public class RevisionNested<N> extends SourceRevisionFluent<RevisionNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GitHubWebHookCauseFluent.this.withRevision(builder.build());
    }
