...
public class DeploymentConfigListFluent<A extends io.fabric8.openshift.api.model.DeploymentConfigListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<DeploymentConfigBuilder> items = new ArrayList<DeploymentConfigBuilder>();
  private String kind;
  private ListMeta metadata;

  public DeploymentConfigListFluent() {
  }
  
  public DeploymentConfigListFluent(DeploymentConfigList instance) {
  ...
  public ItemsNested<A> addNewItemLike(DeploymentConfig item) {
  ...
  public DeploymentConfig buildMatchingItem(Predicate<DeploymentConfigBuilder> predicate) {
      for (DeploymentConfigBuilder item : items) {
  ...
  protected void copyInstance(DeploymentConfigList instance) {
    instance = instance != null ? instance : new DeploymentConfigList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<DeploymentConfigBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    DeploymentConfigListFluent that = (DeploymentConfigListFluent) o;
  ...
  public boolean hasMatchingItem(Predicate<DeploymentConfigBuilder> predicate) {
      for (DeploymentConfigBuilder item : items) {
        if (predicate.test(item)) {
          return true;
        }
  ...
  public A removeMatchingFromItems(Predicate<DeploymentConfigBuilder> predicate) {
    if (items == null) {
      return (A) this;
    }
    Iterator<DeploymentConfigBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,DeploymentConfig item) {
  ...
  public class ItemsNested<N> extends DeploymentConfigFluent<ItemsNested<N>> implements Nested<N>{
  
    DeploymentConfigBuilder builder;
    int index;
  
    ItemsNested(int index,DeploymentConfig item) {
      this.index = index;
      this.builder = new DeploymentConfigBuilder(this, item);
    }
  
    public N and() {
      return (N) DeploymentConfigListFluent.this.setToItems(index, builder.build());
    }
