...
public class SecurityContextConstraintsListFluent<A extends io.fabric8.openshift.api.model.SecurityContextConstraintsListFluent<A>> extends BaseFluent<A>{
  ...
  public SecurityContextConstraintsListFluent() {
  }
  
  public SecurityContextConstraintsListFluent(SecurityContextConstraintsList instance) {
  ...
  public A addAllToItems(Collection<SecurityContextConstraints> items) {
    ...
    for (SecurityContextConstraints item : items) {
  ...
  public ItemsNested<A> addNewItemLike(SecurityContextConstraints item) {
  ...
  public SecurityContextConstraints buildMatchingItem(Predicate<SecurityContextConstraintsBuilder> predicate) {
      for (SecurityContextConstraintsBuilder item : items) {
  ...
  protected void copyInstance(SecurityContextConstraintsList instance) {
    instance = instance != null ? instance : new SecurityContextConstraintsList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<SecurityContextConstraintsBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    SecurityContextConstraintsListFluent that = (SecurityContextConstraintsListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<SecurityContextConstraintsBuilder> predicate) {
    ...
    Iterator<SecurityContextConstraintsBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,SecurityContextConstraints item) {
  ...
  public class ItemsNested<N> extends SecurityContextConstraintsFluent<ItemsNested<N>> implements Nested<N>{
  
    SecurityContextConstraintsBuilder builder;
    int index;
  
    ItemsNested(int index,SecurityContextConstraints item) {
      this.index = index;
      this.builder = new SecurityContextConstraintsBuilder(this, item);
    }
  
    public N and() {
      return (N) SecurityContextConstraintsListFluent.this.setToItems(index, builder.build());
    }
