...
public class TemplateInstanceListFluent<A extends io.fabric8.openshift.api.model.TemplateInstanceListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<TemplateInstanceBuilder> items = new ArrayList<TemplateInstanceBuilder>();
  private String kind;
  private ListMeta metadata;

  public TemplateInstanceListFluent() {
  }
  
  public TemplateInstanceListFluent(TemplateInstanceList instance) {
  ...
  public A addAllToItems(Collection<TemplateInstance> items) {
    ...
    for (TemplateInstance item : items) {
  ...
  public ItemsNested<A> addNewItemLike(TemplateInstance item) {
  ...
  public A addToItems(TemplateInstance... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (TemplateInstance item : items) {
  ...
  public TemplateInstance buildMatchingItem(Predicate<TemplateInstanceBuilder> predicate) {
      for (TemplateInstanceBuilder item : items) {
  ...
  protected void copyInstance(TemplateInstanceList instance) {
    instance = instance != null ? instance : new TemplateInstanceList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<TemplateInstanceBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    TemplateInstanceListFluent that = (TemplateInstanceListFluent) o;
  ...
  public A removeFromItems(TemplateInstance... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (TemplateInstance item : items) {
  ...
  public A removeMatchingFromItems(Predicate<TemplateInstanceBuilder> predicate) {
    ...
    Iterator<TemplateInstanceBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        TemplateInstanceBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,TemplateInstance item) {
  ...
  public A withItems(TemplateInstance... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends TemplateInstanceFluent<ItemsNested<N>> implements Nested<N>{
  
    TemplateInstanceBuilder builder;
    int index;
  
    ItemsNested(int index,TemplateInstance item) {
      this.index = index;
      this.builder = new TemplateInstanceBuilder(this, item);
    }
  
    public N and() {
      return (N) TemplateInstanceListFluent.this.setToItems(index, builder.build());
    }
