...
public class RoleBindingListFluent<A extends io.fabric8.openshift.api.model.RoleBindingListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<RoleBindingBuilder> items = new ArrayList<RoleBindingBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(RoleBinding item) {
  ...
  public RoleBinding buildMatchingItem(Predicate<RoleBindingBuilder> predicate) {
      for (RoleBindingBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<RoleBindingBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<RoleBindingBuilder> predicate) {
    ...
    Iterator<RoleBindingBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,RoleBinding item) {
  ...
  public class ItemsNested<N> extends RoleBindingFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RoleBindingListFluent.this.setToItems(index, builder.build());
    }
