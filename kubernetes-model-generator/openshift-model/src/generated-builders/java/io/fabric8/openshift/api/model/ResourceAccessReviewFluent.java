...
public class ResourceAccessReviewFluent<A extends io.fabric8.openshift.api.model.ResourceAccessReviewFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(ResourceAccessReview instance) {
    instance = instance != null ? instance : new ResourceAccessReview();
    if (instance != null) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ResourceAccessReviewFluent.this.withMetadata(builder.build());
    }
