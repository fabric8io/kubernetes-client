...
public class OAuthAccessTokenListFluent<A extends io.fabric8.openshift.api.model.OAuthAccessTokenListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<OAuthAccessTokenBuilder> items = new ArrayList<OAuthAccessTokenBuilder>();
  private String kind;
  private ListMeta metadata;

  public OAuthAccessTokenListFluent() {
  }
  
  public OAuthAccessTokenListFluent(OAuthAccessTokenList instance) {
  ...
  public A addAllToItems(Collection<OAuthAccessToken> items) {
    ...
    for (OAuthAccessToken item : items) {
  ...
  public ItemsNested<A> addNewItemLike(OAuthAccessToken item) {
  ...
  public OAuthAccessToken buildMatchingItem(Predicate<OAuthAccessTokenBuilder> predicate) {
      for (OAuthAccessTokenBuilder item : items) {
  ...
  protected void copyInstance(OAuthAccessTokenList instance) {
    instance = instance != null ? instance : new OAuthAccessTokenList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<OAuthAccessTokenBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    OAuthAccessTokenListFluent that = (OAuthAccessTokenListFluent) o;
  ...
  public boolean hasMatchingItem(Predicate<OAuthAccessTokenBuilder> predicate) {
      for (OAuthAccessTokenBuilder item : items) {
        if (predicate.test(item)) {
          return true;
        }
  ...
  public A removeMatchingFromItems(Predicate<OAuthAccessTokenBuilder> predicate) {
    if (items == null) {
      return (A) this;
    }
    Iterator<OAuthAccessTokenBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        OAuthAccessTokenBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,OAuthAccessToken item) {
  ...
  public class ItemsNested<N> extends OAuthAccessTokenFluent<ItemsNested<N>> implements Nested<N>{
    ...
    ItemsNested(int index,OAuthAccessToken item) {
      this.index = index;
      this.builder = new OAuthAccessTokenBuilder(this, item);
    }
  
    public N and() {
      return (N) OAuthAccessTokenListFluent.this.setToItems(index, builder.build());
    }
