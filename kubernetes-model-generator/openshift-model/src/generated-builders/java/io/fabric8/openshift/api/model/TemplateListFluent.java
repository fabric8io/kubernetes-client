...
public class TemplateListFluent<A extends io.fabric8.openshift.api.model.TemplateListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<TemplateBuilder> items = new ArrayList<TemplateBuilder>();
  private String kind;
  private ListMeta metadata;

  public TemplateListFluent() {
  }
  
  public TemplateListFluent(TemplateList instance) {
  ...
  public ItemsNested<A> addNewItemLike(Template item) {
  ...
  public Template buildMatchingItem(Predicate<TemplateBuilder> predicate) {
      for (TemplateBuilder item : items) {
  ...
  protected void copyInstance(TemplateList instance) {
    instance = instance != null ? instance : new TemplateList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<TemplateBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    TemplateListFluent that = (TemplateListFluent) o;
  ...
  public boolean hasMatchingItem(Predicate<TemplateBuilder> predicate) {
      for (TemplateBuilder item : items) {
        if (predicate.test(item)) {
          return true;
        }
  ...
  public A removeMatchingFromItems(Predicate<TemplateBuilder> predicate) {
    if (items == null) {
      return (A) this;
    }
    Iterator<TemplateBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,Template item) {
  ...
  public class ItemsNested<N> extends TemplateFluent<ItemsNested<N>> implements Nested<N>{
  
    TemplateBuilder builder;
    int index;
  
    ItemsNested(int index,Template item) {
      this.index = index;
      this.builder = new TemplateBuilder(this, item);
    }
  
    public N and() {
      return (N) TemplateListFluent.this.setToItems(index, builder.build());
    }
