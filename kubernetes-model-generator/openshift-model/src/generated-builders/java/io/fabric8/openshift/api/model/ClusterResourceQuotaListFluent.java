...
public class ClusterResourceQuotaListFluent<A extends io.fabric8.openshift.api.model.ClusterResourceQuotaListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ClusterResourceQuotaBuilder> items = new ArrayList<ClusterResourceQuotaBuilder>();
  private String kind;
  private ListMeta metadata;

  public ClusterResourceQuotaListFluent() {
  }
  
  public ClusterResourceQuotaListFluent(ClusterResourceQuotaList instance) {
  ...
  public A addAllToItems(Collection<ClusterResourceQuota> items) {
    ...
    for (ClusterResourceQuota item : items) {
  ...
  public ItemsNested<A> addNewItemLike(ClusterResourceQuota item) {
  ...
  public ClusterResourceQuota buildMatchingItem(Predicate<ClusterResourceQuotaBuilder> predicate) {
      for (ClusterResourceQuotaBuilder item : items) {
  ...
  protected void copyInstance(ClusterResourceQuotaList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ClusterResourceQuotaBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ClusterResourceQuotaListFluent that = (ClusterResourceQuotaListFluent) o;
  ...
  public boolean hasMatchingItem(Predicate<ClusterResourceQuotaBuilder> predicate) {
      for (ClusterResourceQuotaBuilder item : items) {
        if (predicate.test(item)) {
          return true;
        }
  ...
  public A removeMatchingFromItems(Predicate<ClusterResourceQuotaBuilder> predicate) {
    if (items == null) {
      return (A) this;
    }
    Iterator<ClusterResourceQuotaBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ClusterResourceQuotaBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ClusterResourceQuota item) {
  ...
  public class ItemsNested<N> extends ClusterResourceQuotaFluent<ItemsNested<N>> implements Nested<N>{
  
    ClusterResourceQuotaBuilder builder;
    int index;
  
    ItemsNested(int index,ClusterResourceQuota item) {
      this.index = index;
      this.builder = new ClusterResourceQuotaBuilder(this, item);
    }
  
    public N and() {
      return (N) ClusterResourceQuotaListFluent.this.setToItems(index, builder.build());
    }
