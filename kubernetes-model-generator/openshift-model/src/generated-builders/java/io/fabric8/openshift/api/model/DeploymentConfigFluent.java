...
public class DeploymentConfigFluent<A extends io.fabric8.openshift.api.model.DeploymentConfigFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new DeploymentConfigSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(DeploymentConfigSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new DeploymentConfigStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(DeploymentConfigStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(DeploymentConfigSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(DeploymentConfigStatus item) {
  ...
  public class SpecNested<N> extends DeploymentConfigSpecFluent<SpecNested<N>> implements Nested<N>{
  
    DeploymentConfigSpecBuilder builder;
  
    SpecNested(DeploymentConfigSpec item) {
  ...
  public class StatusNested<N> extends DeploymentConfigStatusFluent<StatusNested<N>> implements Nested<N>{
  
    DeploymentConfigStatusBuilder builder;
  
    StatusNested(DeploymentConfigStatus item) {
      this.builder = new DeploymentConfigStatusBuilder(this, item);
    }
  
    public N and() {
      return (N) DeploymentConfigFluent.this.withStatus(builder.build());
    }
