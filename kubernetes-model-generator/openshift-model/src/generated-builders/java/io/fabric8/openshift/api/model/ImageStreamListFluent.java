...
public class ImageStreamListFluent<A extends io.fabric8.openshift.api.model.ImageStreamListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ImageStreamBuilder> items = new ArrayList<ImageStreamBuilder>();
  private String kind;
  private ListMeta metadata;

  public ImageStreamListFluent() {
  }
  
  public ImageStreamListFluent(ImageStreamList instance) {
  ...
  public ItemsNested<A> addNewItemLike(ImageStream item) {
  ...
  public ImageStream buildMatchingItem(Predicate<ImageStreamBuilder> predicate) {
      for (ImageStreamBuilder item : items) {
  ...
  protected void copyInstance(ImageStreamList instance) {
    instance = instance != null ? instance : new ImageStreamList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ImageStreamBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ImageStreamListFluent that = (ImageStreamListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ImageStreamBuilder> predicate) {
    ...
    Iterator<ImageStreamBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,ImageStream item) {
  ...
  public class ItemsNested<N> extends ImageStreamFluent<ItemsNested<N>> implements Nested<N>{
  
    ImageStreamBuilder builder;
    int index;
  
    ItemsNested(int index,ImageStream item) {
      this.index = index;
      this.builder = new ImageStreamBuilder(this, item);
    }
  
    public N and() {
      return (N) ImageStreamListFluent.this.setToItems(index, builder.build());
    }
