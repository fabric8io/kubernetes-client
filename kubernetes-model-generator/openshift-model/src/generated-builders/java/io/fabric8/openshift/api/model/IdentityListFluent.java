...
public class IdentityListFluent<A extends io.fabric8.openshift.api.model.IdentityListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<IdentityBuilder> items = new ArrayList<IdentityBuilder>();
  private String kind;
  private ListMeta metadata;

  public IdentityListFluent() {
  }
  
  public IdentityListFluent(IdentityList instance) {
  ...
  public ItemsNested<A> addNewItemLike(Identity item) {
  ...
  public Identity buildMatchingItem(Predicate<IdentityBuilder> predicate) {
      for (IdentityBuilder item : items) {
  ...
  protected void copyInstance(IdentityList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<IdentityBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    IdentityListFluent that = (IdentityListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<IdentityBuilder> predicate) {
    ...
    Iterator<IdentityBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        IdentityBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Identity item) {
  ...
  public class ItemsNested<N> extends IdentityFluent<ItemsNested<N>> implements Nested<N>{
  
    IdentityBuilder builder;
    int index;
  
    ItemsNested(int index,Identity item) {
      this.index = index;
      this.builder = new IdentityBuilder(this, item);
    }
  
    public N and() {
      return (N) IdentityListFluent.this.setToItems(index, builder.build());
    }
