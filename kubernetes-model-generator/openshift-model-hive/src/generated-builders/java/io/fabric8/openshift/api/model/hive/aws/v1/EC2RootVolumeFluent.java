...
public class EC2RootVolumeFluent<A extends io.fabric8.openshift.api.model.hive.aws.v1.EC2RootVolumeFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(iops, kmsKeyARN, size, type, additionalProperties);
  }
