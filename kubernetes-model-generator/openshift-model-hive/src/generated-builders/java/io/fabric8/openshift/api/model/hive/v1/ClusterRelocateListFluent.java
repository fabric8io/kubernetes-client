...
public class ClusterRelocateListFluent<A extends io.fabric8.openshift.api.model.hive.v1.ClusterRelocateListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ClusterRelocateBuilder> items = new ArrayList<ClusterRelocateBuilder>();
  private String kind;
  ...
  public A addAllToItems(Collection<ClusterRelocate> items) {
    ...
    for (ClusterRelocate item : items) {
        ClusterRelocateBuilder builder = new ClusterRelocateBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(ClusterRelocate item) {
  ...
  public ClusterRelocate buildMatchingItem(Predicate<ClusterRelocateBuilder> predicate) {
      for (ClusterRelocateBuilder item : items) {
  ...
  protected void copyInstance(ClusterRelocateList instance) {
    instance = instance != null ? instance : new ClusterRelocateList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ClusterRelocateBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ClusterRelocateListFluent that = (ClusterRelocateListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ClusterRelocateBuilder> predicate) {
    ...
    Iterator<ClusterRelocateBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ClusterRelocateBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ClusterRelocate item) {
  ...
  public class ItemsNested<N> extends ClusterRelocateFluent<ItemsNested<N>> implements Nested<N>{
  
    ClusterRelocateBuilder builder;
    int index;
  
    ItemsNested(int index,ClusterRelocate item) {
      this.index = index;
      this.builder = new ClusterRelocateBuilder(this, item);
    }
  
    public N and() {
      return (N) ClusterRelocateListFluent.this.setToItems(index, builder.build());
    }
