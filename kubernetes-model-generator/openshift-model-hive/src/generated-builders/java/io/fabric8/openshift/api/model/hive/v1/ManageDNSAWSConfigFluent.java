...
public class ManageDNSAWSConfigFluent<A extends io.fabric8.openshift.api.model.hive.v1.ManageDNSAWSConfigFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private LocalObjectReferenceBuilder credentialsSecretRef;
  private String region;

  public ManageDNSAWSConfigFluent() {
  }
  
  public ManageDNSAWSConfigFluent(ManageDNSAWSConfig instance) {
  ...
  protected void copyInstance(ManageDNSAWSConfig instance) {
    instance = instance != null ? instance : new ManageDNSAWSConfig();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ManageDNSAWSConfigFluent that = (ManageDNSAWSConfigFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(credentialsSecretRef, region, additionalProperties);
  }
  ...
  public class CredentialsSecretRefNested<N> extends LocalObjectReferenceFluent<CredentialsSecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ManageDNSAWSConfigFluent.this.withCredentialsSecretRef(builder.build());
    }
