...
public class GCPDNSZoneSpecFluent<A extends io.fabric8.openshift.api.model.hive.v1.GCPDNSZoneSpecFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private LocalObjectReferenceBuilder credentialsSecretRef;

  public GCPDNSZoneSpecFluent() {
  }
  ...
  protected void copyInstance(GCPDNSZoneSpec instance) {
    instance = instance != null ? instance : new GCPDNSZoneSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    GCPDNSZoneSpecFluent that = (GCPDNSZoneSpecFluent) o;
  ...
  public class CredentialsSecretRefNested<N> extends LocalObjectReferenceFluent<CredentialsSecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GCPDNSZoneSpecFluent.this.withCredentialsSecretRef(builder.build());
    }
