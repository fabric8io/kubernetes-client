...
public class AWSServiceProviderCredentialsFluent<A extends io.fabric8.openshift.api.model.hive.v1.AWSServiceProviderCredentialsFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private LocalObjectReferenceBuilder credentialsSecretRef;

  public AWSServiceProviderCredentialsFluent() {
  }
  
  public AWSServiceProviderCredentialsFluent(AWSServiceProviderCredentials instance) {
  ...
  protected void copyInstance(AWSServiceProviderCredentials instance) {
  ...
  public boolean equals(Object o) {
    ...
    AWSServiceProviderCredentialsFluent that = (AWSServiceProviderCredentialsFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(credentialsSecretRef, additionalProperties);
  }
  ...
  public class CredentialsSecretRefNested<N> extends LocalObjectReferenceFluent<CredentialsSecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AWSServiceProviderCredentialsFluent.this.withCredentialsSecretRef(builder.build());
    }
