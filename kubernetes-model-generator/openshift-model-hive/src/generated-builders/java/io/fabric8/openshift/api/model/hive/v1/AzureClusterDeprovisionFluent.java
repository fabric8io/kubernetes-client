...
public class AzureClusterDeprovisionFluent<A extends io.fabric8.openshift.api.model.hive.v1.AzureClusterDeprovisionFluent<A>> extends BaseFluent<A>{
  ...
  public AzureClusterDeprovisionFluent() {
  }
  
  public AzureClusterDeprovisionFluent(AzureClusterDeprovision instance) {
  ...
  public class CredentialsSecretRefNested<N> extends LocalObjectReferenceFluent<CredentialsSecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AzureClusterDeprovisionFluent.this.withCredentialsSecretRef(builder.build());
    }
