...
public class PlatformBuilder extends PlatformFluent<PlatformBuilder> implements VisitableBuilder<Platform,PlatformBuilder>{
  ...
  public Platform build() {
    Platform buildable = new Platform(fluent.buildCredentialsAssumeRole(), fluent.buildCredentialsSecretRef(), fluent.buildPrivateLink(), fluent.getRegion(), fluent.getUserTags());
