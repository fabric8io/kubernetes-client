...
public class RootVolumeFluent<A extends io.fabric8.openshift.api.model.hive.openstack.v1.RootVolumeFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(size, type, additionalProperties);
  }
