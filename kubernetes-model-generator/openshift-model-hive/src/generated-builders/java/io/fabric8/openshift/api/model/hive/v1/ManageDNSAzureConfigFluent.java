...
public class ManageDNSAzureConfigFluent<A extends io.fabric8.openshift.api.model.hive.v1.ManageDNSAzureConfigFluent<A>> extends BaseFluent<A>{
  ...
  public ManageDNSAzureConfigFluent() {
  }
  
  public ManageDNSAzureConfigFluent(ManageDNSAzureConfig instance) {
  ...
  protected void copyInstance(ManageDNSAzureConfig instance) {
    instance = instance != null ? instance : new ManageDNSAzureConfig();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ManageDNSAzureConfigFluent that = (ManageDNSAzureConfigFluent) o;
  ...
  public class CredentialsSecretRefNested<N> extends LocalObjectReferenceFluent<CredentialsSecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ManageDNSAzureConfigFluent.this.withCredentialsSecretRef(builder.build());
    }
