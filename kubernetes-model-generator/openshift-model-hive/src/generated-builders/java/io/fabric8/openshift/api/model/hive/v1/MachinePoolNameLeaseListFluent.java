...
public class MachinePoolNameLeaseListFluent<A extends io.fabric8.openshift.api.model.hive.v1.MachinePoolNameLeaseListFluent<A>> extends BaseFluent<A>{
  ...
  public MachinePoolNameLeaseListFluent() {
  }
  
  public MachinePoolNameLeaseListFluent(MachinePoolNameLeaseList instance) {
  ...
  public A addAllToItems(Collection<MachinePoolNameLease> items) {
    ...
    for (MachinePoolNameLease item : items) {
  ...
  public ItemsNested<A> addNewItemLike(MachinePoolNameLease item) {
  ...
  public A addToItems(MachinePoolNameLease... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (MachinePoolNameLease item : items) {
  ...
  public A addToItems(int index,MachinePoolNameLease item) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    MachinePoolNameLeaseBuilder builder = new MachinePoolNameLeaseBuilder(item);
  ...
  public MachinePoolNameLease buildItem(int index) {
  ...
  public MachinePoolNameLease buildMatchingItem(Predicate<MachinePoolNameLeaseBuilder> predicate) {
      for (MachinePoolNameLeaseBuilder item : items) {
  ...
  protected void copyInstance(MachinePoolNameLeaseList instance) {
    instance = instance != null ? instance : new MachinePoolNameLeaseList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<MachinePoolNameLeaseBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    MachinePoolNameLeaseListFluent that = (MachinePoolNameLeaseListFluent) o;
  ...
  public A removeFromItems(MachinePoolNameLease... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (MachinePoolNameLease item : items) {
  ...
  public A removeMatchingFromItems(Predicate<MachinePoolNameLeaseBuilder> predicate) {
    ...
    Iterator<MachinePoolNameLeaseBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,MachinePoolNameLease item) {
    return new ItemsNested(index, item);
  }
  
  public A setToItems(int index,MachinePoolNameLease item) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    MachinePoolNameLeaseBuilder builder = new MachinePoolNameLeaseBuilder(item);
  ...
  public A withItems(MachinePoolNameLease... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends MachinePoolNameLeaseFluent<ItemsNested<N>> implements Nested<N>{
  
    MachinePoolNameLeaseBuilder builder;
    int index;
  
    ItemsNested(int index,MachinePoolNameLease item) {
      this.index = index;
      this.builder = new MachinePoolNameLeaseBuilder(this, item);
    }
  
    public N and() {
      return (N) MachinePoolNameLeaseListFluent.this.setToItems(index, builder.build());
    }
