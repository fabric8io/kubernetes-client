...
public class DiskFluent<A extends io.fabric8.openshift.api.model.hive.ovirt.v1.DiskFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(sizeGB, additionalProperties);
  }
