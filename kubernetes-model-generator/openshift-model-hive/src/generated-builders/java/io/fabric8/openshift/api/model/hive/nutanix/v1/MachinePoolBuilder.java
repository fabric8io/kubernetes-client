...
public class MachinePoolBuilder extends MachinePoolFluent<MachinePoolBuilder> implements VisitableBuilder<MachinePool,MachinePoolBuilder>{
  ...
  public MachinePool build() {
    MachinePool buildable = new MachinePool(fluent.getBootType(), fluent.getCategories(), fluent.getCoresPerSocket(), fluent.getCpus(), fluent.getDataDisks(), fluent.getFailureDomains(), fluent.getGpus(), fluent.getMemoryMiB(), fluent.buildOsDisk(), fluent.getProject());
