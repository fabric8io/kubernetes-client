...
public class VSphereClusterDeprovisionFluent<A extends io.fabric8.openshift.api.model.hive.v1.VSphereClusterDeprovisionFluent<A>> extends BaseFluent<A>{
  ...
  public VSphereClusterDeprovisionFluent(VSphereClusterDeprovision instance) {
  ...
  protected void copyInstance(VSphereClusterDeprovision instance) {
    instance = instance != null ? instance : new VSphereClusterDeprovision();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    VSphereClusterDeprovisionFluent that = (VSphereClusterDeprovisionFluent) o;
  ...
  public class CertificatesSecretRefNested<N> extends LocalObjectReferenceFluent<CertificatesSecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) VSphereClusterDeprovisionFluent.this.withCertificatesSecretRef(builder.build());
    }
  ...
  public class CredentialsSecretRefNested<N> extends LocalObjectReferenceFluent<CredentialsSecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) VSphereClusterDeprovisionFluent.this.withCredentialsSecretRef(builder.build());
    }
