...
public class PlatformBuilder extends PlatformFluent<PlatformBuilder> implements VisitableBuilder<Platform,PlatformBuilder>{
  ...
  public Platform build() {
    Platform buildable = new Platform(fluent.buildCertificatesSecretRef(), fluent.buildCredentialsSecretRef(), fluent.getOvirtClusterId(), fluent.getOvirtNetworkName(), fluent.getStorageDomainId());
