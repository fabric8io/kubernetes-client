...
public class FailedProvisionAWSConfigFluent<A extends io.fabric8.openshift.api.model.hive.v1.FailedProvisionAWSConfigFluent<A>> extends BaseFluent<A>{
  ...
  public FailedProvisionAWSConfigFluent() {
  }
  
  public FailedProvisionAWSConfigFluent(FailedProvisionAWSConfig instance) {
  ...
  protected void copyInstance(FailedProvisionAWSConfig instance) {
    instance = instance != null ? instance : new FailedProvisionAWSConfig();
    if (instance != null) {
        this.withBucket(instance.getBucket());
        this.withCredentialsSecretRef(instance.getCredentialsSecretRef());
        this.withRegion(instance.getRegion());
        this.withServiceEndpoint(instance.getServiceEndpoint());
  ...
  public boolean equals(Object o) {
    ...
    FailedProvisionAWSConfigFluent that = (FailedProvisionAWSConfigFluent) o;
    ...
    if (!(Objects.equals(serviceEndpoint, that.serviceEndpoint))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(bucket, credentialsSecretRef, region, serviceEndpoint, additionalProperties);
  }
  ...
  public A withServiceEndpoint(String serviceEndpoint) {
  ...
  public class CredentialsSecretRefNested<N> extends LocalObjectReferenceFluent<CredentialsSecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) FailedProvisionAWSConfigFluent.this.withCredentialsSecretRef(builder.build());
    }
