...
public class OvirtClusterDeprovisionFluent<A extends io.fabric8.openshift.api.model.hive.v1.OvirtClusterDeprovisionFluent<A>> extends BaseFluent<A>{
  ...
  public OvirtClusterDeprovisionFluent() {
  }
  
  public OvirtClusterDeprovisionFluent(OvirtClusterDeprovision instance) {
  ...
  protected void copyInstance(OvirtClusterDeprovision instance) {
    instance = instance != null ? instance : new OvirtClusterDeprovision();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    OvirtClusterDeprovisionFluent that = (OvirtClusterDeprovisionFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(certificatesSecretRef, clusterID, credentialsSecretRef, additionalProperties);
  }
  ...
  public class CertificatesSecretRefNested<N> extends LocalObjectReferenceFluent<CertificatesSecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) OvirtClusterDeprovisionFluent.this.withCertificatesSecretRef(builder.build());
    }
  ...
  public class CredentialsSecretRefNested<N> extends LocalObjectReferenceFluent<CredentialsSecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) OvirtClusterDeprovisionFluent.this.withCredentialsSecretRef(builder.build());
    }
