...
public class MetadataFluent<A extends io.fabric8.openshift.api.model.hive.aws.v1.MetadataFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(hostedZoneRole, additionalProperties);
  }
