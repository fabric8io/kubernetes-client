...
public class ManageDNSGCPConfigFluent<A extends io.fabric8.openshift.api.model.hive.v1.ManageDNSGCPConfigFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private LocalObjectReferenceBuilder credentialsSecretRef;

  public ManageDNSGCPConfigFluent() {
  }
  
  public ManageDNSGCPConfigFluent(ManageDNSGCPConfig instance) {
  ...
  protected void copyInstance(ManageDNSGCPConfig instance) {
  ...
  public boolean equals(Object o) {
    ...
    ManageDNSGCPConfigFluent that = (ManageDNSGCPConfigFluent) o;
  ...
  public class CredentialsSecretRefNested<N> extends LocalObjectReferenceFluent<CredentialsSecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ManageDNSGCPConfigFluent.this.withCredentialsSecretRef(builder.build());
    }
