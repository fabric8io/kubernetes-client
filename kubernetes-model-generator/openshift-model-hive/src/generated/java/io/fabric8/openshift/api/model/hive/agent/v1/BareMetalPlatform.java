...
public class BareMetalPlatform implements Editable<BareMetalPlatformBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BareMetalPlatform)) {
            return false;
        }
        BareMetalPlatform other = (BareMetalPlatform) o;
        if (!other.canEqual(this)) {
            return false;
        }
        Object this$agentSelector = this.getAgentSelector();
        Object other$agentSelector = other.getAgentSelector();
        if (this$agentSelector == null ? other$agentSelector != null : !this$agentSelector.equals(other$agentSelector)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof BareMetalPlatform;
    }
    ...
    public int hashCode() {
        final int prime = 59;
        int result = 1;
        Object $agentSelector = this.getAgentSelector();
        result = result * prime + ($agentSelector == null ? 43 : $agentSelector.hashCode());
    ...
    public String toString() {
        return "BareMetalPlatform(" + "agentSelector=" + this.getAgentSelector() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
