...
public class ClusterImageSetSpec implements Editable<ClusterImageSetSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterImageSetSpec)) {
            return false;
        }
        ClusterImageSetSpec other = (ClusterImageSetSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClusterImageSetSpec;
    }
    ...
    public String toString() {
        return "ClusterImageSetSpec(" + "releaseImage=" + this.getReleaseImage() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
