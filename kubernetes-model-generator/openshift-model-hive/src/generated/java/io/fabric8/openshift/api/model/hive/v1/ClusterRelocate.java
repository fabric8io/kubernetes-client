...
public class ClusterRelocate implements Editable<ClusterRelocateBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterRelocate)) {
            return false;
        }
        ClusterRelocate other = (ClusterRelocate) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClusterRelocate;
    }
    ...
    public String toString() {
        return "ClusterRelocate(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
