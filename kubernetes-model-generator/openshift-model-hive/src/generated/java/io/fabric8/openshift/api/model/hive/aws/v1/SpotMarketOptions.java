...
public class SpotMarketOptions implements Editable<SpotMarketOptionsBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SpotMarketOptions)) {
            return false;
        }
        SpotMarketOptions other = (SpotMarketOptions) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SpotMarketOptions;
    }
    ...
    public String toString() {
        return "SpotMarketOptions(" + "maxPrice=" + this.getMaxPrice() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
