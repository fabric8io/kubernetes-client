...
public class InventoryEntry implements Editable<InventoryEntryBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        InventoryEntry other = (InventoryEntry) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof InventoryEntry;
    }
    ...
    public String toString() {
        return "InventoryEntry(" + "kind=" + this.getKind() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
