...
public class AzureDNSZoneSpec implements Editable<AzureDNSZoneSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AzureDNSZoneSpec)) {
            return false;
        }
        AzureDNSZoneSpec other = (AzureDNSZoneSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AzureDNSZoneSpec;
    }
    ...
    public String toString() {
        return "AzureDNSZoneSpec(" + "cloudName=" + this.getCloudName() + ", credentialsSecretRef=" + this.getCredentialsSecretRef() + ", resourceGroupName=" + this.getResourceGroupName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
