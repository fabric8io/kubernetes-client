...
public class ServiceAttachmentSubnetExisting implements Editable<ServiceAttachmentSubnetExistingBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ServiceAttachmentSubnetExisting)) {
            return false;
        }
        ServiceAttachmentSubnetExisting other = (ServiceAttachmentSubnetExisting) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ServiceAttachmentSubnetExisting;
    }
    ...
    public String toString() {
        return "ServiceAttachmentSubnetExisting(" + "name=" + this.getName() + ", project=" + this.getProject() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
