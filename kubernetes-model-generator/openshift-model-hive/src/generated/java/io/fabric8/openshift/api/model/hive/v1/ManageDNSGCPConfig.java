...
public class ManageDNSGCPConfig implements Editable<ManageDNSGCPConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManageDNSGCPConfig)) {
            return false;
        }
        ManageDNSGCPConfig other = (ManageDNSGCPConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ManageDNSGCPConfig;
    }
    ...
    public String toString() {
        return "ManageDNSGCPConfig(" + "credentialsSecretRef=" + this.getCredentialsSecretRef() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
