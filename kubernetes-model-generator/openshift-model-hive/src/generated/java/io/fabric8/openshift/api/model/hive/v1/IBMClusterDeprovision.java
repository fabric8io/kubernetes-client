...
public class IBMClusterDeprovision implements Editable<IBMClusterDeprovisionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IBMClusterDeprovision)) {
            return false;
        }
        IBMClusterDeprovision other = (IBMClusterDeprovision) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IBMClusterDeprovision;
    }
    ...
    public String toString() {
        return "IBMClusterDeprovision(" + "baseDomain=" + this.getBaseDomain() + ", credentialsSecretRef=" + this.getCredentialsSecretRef() + ", region=" + this.getRegion() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
