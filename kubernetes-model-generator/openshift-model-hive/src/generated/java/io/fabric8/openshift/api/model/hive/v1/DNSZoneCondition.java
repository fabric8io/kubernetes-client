...
public class DNSZoneCondition implements Editable<DNSZoneConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DNSZoneCondition)) {
            return false;
        }
        DNSZoneCondition other = (DNSZoneCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DNSZoneCondition;
    }
    ...
    public String toString() {
        return "DNSZoneCondition(" + "lastProbeTime=" + this.getLastProbeTime() + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
