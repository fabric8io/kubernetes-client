...
public class MachinePoolNameLease implements Editable<MachinePoolNameLeaseBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MachinePoolNameLease)) {
            return false;
        }
        MachinePoolNameLease other = (MachinePoolNameLease) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MachinePoolNameLease;
    }
    ...
    public String toString() {
        return "MachinePoolNameLease(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
