...
public class ClusterInstallCondition implements Editable<ClusterInstallConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterInstallCondition)) {
            return false;
        }
        ClusterInstallCondition other = (ClusterInstallCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClusterInstallCondition;
    }
    ...
    public String toString() {
        return "ClusterInstallCondition(" + "lastProbeTime=" + this.getLastProbeTime() + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
