...
public class ClusterPoolCondition implements Editable<ClusterPoolConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterPoolCondition)) {
            return false;
        }
        ClusterPoolCondition other = (ClusterPoolCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClusterPoolCondition;
    }
    ...
    public String toString() {
        return "ClusterPoolCondition(" + "lastProbeTime=" + this.getLastProbeTime() + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
