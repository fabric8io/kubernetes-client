...
public class MachinePoolCondition implements Editable<MachinePoolConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MachinePoolCondition)) {
            return false;
        }
        MachinePoolCondition other = (MachinePoolCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MachinePoolCondition;
    }
    ...
    public String toString() {
        return "MachinePoolCondition(" + "lastProbeTime=" + this.getLastProbeTime() + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
