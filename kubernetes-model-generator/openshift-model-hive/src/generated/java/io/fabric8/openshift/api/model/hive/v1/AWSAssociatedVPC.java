...
public class AWSAssociatedVPC implements Editable<AWSAssociatedVPCBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AWSAssociatedVPC)) {
            return false;
        }
        AWSAssociatedVPC other = (AWSAssociatedVPC) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AWSAssociatedVPC;
    }
    ...
    public String toString() {
        return "AWSAssociatedVPC(" + "credentialsSecretRef=" + this.getCredentialsSecretRef() + ", region=" + this.getRegion() + ", vpcID=" + this.getVpcID() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
