...
public class OSDisk implements Editable<OSDiskBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "OSDisk(" + "diskEncryptionSet=" + this.getDiskEncryptionSet() + ", diskSizeGB=" + this.getDiskSizeGB() + ", diskType=" + this.getDiskType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
