...
public class MachinePoolPlatform implements Editable<MachinePoolPlatformBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "MachinePoolPlatform(" + "aws=" + this.getAws() + ", azure=" + this.getAzure() + ", gcp=" + this.getGcp() + ", ibmcloud=" + this.getIbmcloud() + ", openstack=" + this.getOpenstack() + ", ovirt=" + this.getOvirt() + ", vsphere=" + this.getVsphere() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
