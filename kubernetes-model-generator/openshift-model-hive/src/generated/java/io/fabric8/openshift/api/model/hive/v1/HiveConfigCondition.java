...
public class HiveConfigCondition implements Editable<HiveConfigConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HiveConfigCondition)) {
            return false;
        }
        HiveConfigCondition other = (HiveConfigCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HiveConfigCondition;
    }
    ...
    public String toString() {
        return "HiveConfigCondition(" + "lastProbeTime=" + this.getLastProbeTime() + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
