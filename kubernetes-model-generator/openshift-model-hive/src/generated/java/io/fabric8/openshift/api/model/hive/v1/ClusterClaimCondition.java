...
public class ClusterClaimCondition implements Editable<ClusterClaimConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterClaimCondition)) {
            return false;
        }
        ClusterClaimCondition other = (ClusterClaimCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClusterClaimCondition;
    }
    ...
    public String toString() {
        return "ClusterClaimCondition(" + "lastProbeTime=" + this.getLastProbeTime() + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
