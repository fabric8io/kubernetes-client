...
public class PrometheusAgent implements Editable<PrometheusAgentBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrometheusAgent)) {
            return false;
        }
        PrometheusAgent other = (PrometheusAgent) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PrometheusAgent;
    }
    ...
    public String toString() {
        return "PrometheusAgent(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
