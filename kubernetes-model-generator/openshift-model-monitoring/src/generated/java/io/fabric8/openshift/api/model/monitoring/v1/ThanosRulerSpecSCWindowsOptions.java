...
public class ThanosRulerSpecSCWindowsOptions implements Editable<ThanosRulerSpecSCWindowsOptionsBuilder> , KubernetesResource
{
    ...
    public ThanosRulerSpecSCWindowsOptions(String gmsaCredentialSpec, String gmsaCredentialSpecName, Boolean hostProcess, String runAsUserName) {
        super();
    ...
    @JsonIgnore
    public ThanosRulerSpecSCWindowsOptionsBuilder edit() {
        return new ThanosRulerSpecSCWindowsOptionsBuilder(this);
    }

    @JsonIgnore
    public ThanosRulerSpecSCWindowsOptionsBuilder toBuilder() {
        return edit();
    }
