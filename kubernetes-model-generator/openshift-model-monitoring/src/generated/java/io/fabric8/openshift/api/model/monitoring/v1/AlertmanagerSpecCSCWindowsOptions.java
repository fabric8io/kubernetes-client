...
public class AlertmanagerSpecCSCWindowsOptions implements Editable<AlertmanagerSpecCSCWindowsOptionsBuilder> , KubernetesResource
{
    ...
    public AlertmanagerSpecCSCWindowsOptions(String gmsaCredentialSpec, String gmsaCredentialSpecName, Boolean hostProcess, String runAsUserName) {
        super();
    ...
    @JsonIgnore
    public AlertmanagerSpecCSCWindowsOptionsBuilder edit() {
        return new AlertmanagerSpecCSCWindowsOptionsBuilder(this);
    }

    @JsonIgnore
    public AlertmanagerSpecCSCWindowsOptionsBuilder toBuilder() {
        return edit();
    }
