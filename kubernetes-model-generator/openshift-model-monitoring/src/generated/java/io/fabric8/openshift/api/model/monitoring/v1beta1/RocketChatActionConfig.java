...
public class RocketChatActionConfig implements Editable<RocketChatActionConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RocketChatActionConfig)) {
            return false;
        }
        RocketChatActionConfig other = (RocketChatActionConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RocketChatActionConfig;
    }
    ...
    public String toString() {
        return "RocketChatActionConfig(" + "msg=" + this.getMsg() + ", text=" + this.getText() + ", url=" + this.getUrl() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
