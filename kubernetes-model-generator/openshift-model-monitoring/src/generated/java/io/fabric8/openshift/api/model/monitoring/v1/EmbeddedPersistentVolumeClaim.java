...
public class EmbeddedPersistentVolumeClaim implements Editable<EmbeddedPersistentVolumeClaimBuilder>, KubernetesResource, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmbeddedPersistentVolumeClaim)) {
            return false;
        }
        EmbeddedPersistentVolumeClaim other = (EmbeddedPersistentVolumeClaim) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EmbeddedPersistentVolumeClaim;
    }
    ...
    public String toString() {
        return "EmbeddedPersistentVolumeClaim(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
