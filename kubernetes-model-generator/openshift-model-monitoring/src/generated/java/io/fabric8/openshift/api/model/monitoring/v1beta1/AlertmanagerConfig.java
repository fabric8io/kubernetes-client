...
public class AlertmanagerConfig implements Editable<AlertmanagerConfigBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlertmanagerConfig)) {
            return false;
        }
        AlertmanagerConfig other = (AlertmanagerConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AlertmanagerConfig;
    }
    ...
    public String toString() {
        return "AlertmanagerConfig(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
