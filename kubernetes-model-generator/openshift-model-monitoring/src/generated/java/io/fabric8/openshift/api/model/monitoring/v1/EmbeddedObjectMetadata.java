...
public class EmbeddedObjectMetadata implements Editable<EmbeddedObjectMetadataBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmbeddedObjectMetadata)) {
            return false;
        }
        EmbeddedObjectMetadata other = (EmbeddedObjectMetadata) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EmbeddedObjectMetadata;
    }
    ...
    public String toString() {
        return "EmbeddedObjectMetadata(" + "annotations=" + this.getAnnotations() + ", labels=" + this.getLabels() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
