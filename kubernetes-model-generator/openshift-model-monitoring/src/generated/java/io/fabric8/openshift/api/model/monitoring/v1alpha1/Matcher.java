...
public class Matcher implements Editable<MatcherBuilder>, KubernetesResource
{
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Matcher;
    }
    ...
    public String toString() {
        return "Matcher(" + "matchType=" + this.getMatchType() + ", name=" + this.getName() + ", regex=" + this.getRegex() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
