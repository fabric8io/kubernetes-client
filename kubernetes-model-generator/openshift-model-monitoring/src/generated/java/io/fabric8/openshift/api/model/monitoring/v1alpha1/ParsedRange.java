...
public class ParsedRange implements Editable<ParsedRangeBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ParsedRange)) {
            return false;
        }
        ParsedRange other = (ParsedRange) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ParsedRange;
    }
    ...
    public String toString() {
        return "ParsedRange(" + "end=" + this.getEnd() + ", start=" + this.getStart() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
