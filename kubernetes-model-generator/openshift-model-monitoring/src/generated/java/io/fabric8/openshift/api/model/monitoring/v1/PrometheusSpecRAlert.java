...
public class PrometheusSpecRAlert implements Editable<PrometheusSpecRAlertBuilder> , KubernetesResource
{
     ...
     * 
     */
    public PrometheusSpecRAlert() {
    }

    public PrometheusSpecRAlert(String forGracePeriod, String forOutageTolerance, String resendDelay) {
        super();
    ...
    @JsonIgnore
    public PrometheusSpecRAlertBuilder edit() {
        return new PrometheusSpecRAlertBuilder(this);
    }

    @JsonIgnore
    public PrometheusSpecRAlertBuilder toBuilder() {
        return edit();
    }
