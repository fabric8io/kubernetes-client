...
public class KumaSDConfig implements Editable<KumaSDConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KumaSDConfig)) {
            return false;
        }
        KumaSDConfig other = (KumaSDConfig) o;
        ...
        Object this$fetchTimeout = this.getFetchTimeout();
        Object other$fetchTimeout = other.getFetchTimeout();
        if (this$fetchTimeout == null ? other$fetchTimeout != null : !this$fetchTimeout.equals(other$fetchTimeout)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof KumaSDConfig;
    }
    ...
    public int hashCode() {
        ...
        Object $fetchTimeout = this.getFetchTimeout();
        result = result * prime + ($fetchTimeout == null ? 43 : $fetchTimeout.hashCode());
    ...
    public String toString() {
        return "KumaSDConfig(" + "authorization=" + this.getAuthorization() + ", basicAuth=" + this.getBasicAuth() + ", clientID=" + this.getClientID() + ", enableHTTP2=" + this.getEnableHTTP2() + ", fetchTimeout=" + this.getFetchTimeout() + ", followRedirects=" + this.getFollowRedirects() + ", noProxy=" + this.getNoProxy() + ", oauth2=" + this.getOauth2() + ", proxyConnectHeader=" + this.getProxyConnectHeader() + ", proxyFromEnvironment=" + this.getProxyFromEnvironment() + ", proxyUrl=" + this.getProxyUrl() + ", refreshInterval=" + this.getRefreshInterval() + ", server=" + this.getServer() + ", tlsConfig=" + this.getTlsConfig() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
