...
public class LinodeSDConfig implements Editable<LinodeSDConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LinodeSDConfig)) {
            return false;
        }
        LinodeSDConfig other = (LinodeSDConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LinodeSDConfig;
    }
    ...
    public String toString() {
        return "LinodeSDConfig(" + "authorization=" + this.getAuthorization() + ", enableHTTP2=" + this.getEnableHTTP2() + ", followRedirects=" + this.getFollowRedirects() + ", noProxy=" + this.getNoProxy() + ", oauth2=" + this.getOauth2() + ", port=" + this.getPort() + ", proxyConnectHeader=" + this.getProxyConnectHeader() + ", proxyFromEnvironment=" + this.getProxyFromEnvironment() + ", proxyUrl=" + this.getProxyUrl() + ", refreshInterval=" + this.getRefreshInterval() + ", region=" + this.getRegion() + ", tagSeparator=" + this.getTagSeparator() + ", tlsConfig=" + this.getTlsConfig() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
