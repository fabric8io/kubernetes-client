...
public class Probe implements Editable<ProbeBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Probe(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
