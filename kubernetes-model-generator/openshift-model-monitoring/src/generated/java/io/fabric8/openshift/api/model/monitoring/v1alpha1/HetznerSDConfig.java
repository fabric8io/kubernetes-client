...
public class HetznerSDConfig implements Editable<HetznerSDConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HetznerSDConfig)) {
            return false;
        }
        HetznerSDConfig other = (HetznerSDConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HetznerSDConfig;
    }
    ...
    public String toString() {
        return "HetznerSDConfig(" + "authorization=" + this.getAuthorization() + ", basicAuth=" + this.getBasicAuth() + ", enableHTTP2=" + this.getEnableHTTP2() + ", followRedirects=" + this.getFollowRedirects() + ", labelSelector=" + this.getLabelSelector() + ", noProxy=" + this.getNoProxy() + ", oauth2=" + this.getOauth2() + ", port=" + this.getPort() + ", proxyConnectHeader=" + this.getProxyConnectHeader() + ", proxyFromEnvironment=" + this.getProxyFromEnvironment() + ", proxyUrl=" + this.getProxyUrl() + ", refreshInterval=" + this.getRefreshInterval() + ", role=" + this.getRole() + ", tlsConfig=" + this.getTlsConfig() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
