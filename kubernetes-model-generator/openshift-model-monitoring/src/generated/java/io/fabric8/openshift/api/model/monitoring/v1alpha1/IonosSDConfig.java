...
public class IonosSDConfig implements Editable<IonosSDConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IonosSDConfig)) {
            return false;
        }
        IonosSDConfig other = (IonosSDConfig) o;
        ...
        Object this$datacenterID = this.getDatacenterID();
        Object other$datacenterID = other.getDatacenterID();
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IonosSDConfig;
    }
    ...
    public int hashCode() {
        ...
        Object $datacenterID = this.getDatacenterID();
        result = result * prime + ($datacenterID == null ? 43 : $datacenterID.hashCode());
    ...
    public String toString() {
        return "IonosSDConfig(" + "authorization=" + this.getAuthorization() + ", datacenterID=" + this.getDatacenterID() + ", enableHTTP2=" + this.getEnableHTTP2() + ", followRedirects=" + this.getFollowRedirects() + ", noProxy=" + this.getNoProxy() + ", oauth2=" + this.getOauth2() + ", port=" + this.getPort() + ", proxyConnectHeader=" + this.getProxyConnectHeader() + ", proxyFromEnvironment=" + this.getProxyFromEnvironment() + ", proxyUrl=" + this.getProxyUrl() + ", refreshInterval=" + this.getRefreshInterval() + ", tlsConfig=" + this.getTlsConfig() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
