...
public class DigitalOceanSDConfig implements Editable<DigitalOceanSDConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DigitalOceanSDConfig)) {
            return false;
        }
        DigitalOceanSDConfig other = (DigitalOceanSDConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DigitalOceanSDConfig;
    }
    ...
    public String toString() {
        return "DigitalOceanSDConfig(" + "authorization=" + this.getAuthorization() + ", enableHTTP2=" + this.getEnableHTTP2() + ", followRedirects=" + this.getFollowRedirects() + ", noProxy=" + this.getNoProxy() + ", oauth2=" + this.getOauth2() + ", port=" + this.getPort() + ", proxyConnectHeader=" + this.getProxyConnectHeader() + ", proxyFromEnvironment=" + this.getProxyFromEnvironment() + ", proxyUrl=" + this.getProxyUrl() + ", refreshInterval=" + this.getRefreshInterval() + ", tlsConfig=" + this.getTlsConfig() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
