...
public class ScrapeConfig implements Editable<ScrapeConfigBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScrapeConfig)) {
            return false;
        }
        ScrapeConfig other = (ScrapeConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ScrapeConfig;
    }
    ...
    public String toString() {
        return "ScrapeConfig(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
