...
public class PodMonitor implements Editable<PodMonitorBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodMonitor)) {
            return false;
        }
        PodMonitor other = (PodMonitor) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PodMonitor;
    }
    ...
    public String toString() {
        return "PodMonitor(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
