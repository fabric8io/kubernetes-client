...
public class HTTPConfigWithTLSFiles implements Editable<HTTPConfigWithTLSFilesBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HTTPConfigWithTLSFiles)) {
            return false;
        }
        HTTPConfigWithTLSFiles other = (HTTPConfigWithTLSFiles) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HTTPConfigWithTLSFiles;
    }
    ...
    public String toString() {
        return "HTTPConfigWithTLSFiles(" + "authorization=" + this.getAuthorization() + ", basicAuth=" + this.getBasicAuth() + ", bearerTokenSecret=" + this.getBearerTokenSecret() + ", enableHttp2=" + this.getEnableHttp2() + ", followRedirects=" + this.getFollowRedirects() + ", oauth2=" + this.getOauth2() + ", tlsConfig=" + this.getTlsConfig() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
