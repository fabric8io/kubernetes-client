...
public class ThanosRuler implements Editable<ThanosRulerBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ThanosRuler)) {
            return false;
        }
        ThanosRuler other = (ThanosRuler) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ThanosRuler;
    }
    ...
    public String toString() {
        return "ThanosRuler(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
