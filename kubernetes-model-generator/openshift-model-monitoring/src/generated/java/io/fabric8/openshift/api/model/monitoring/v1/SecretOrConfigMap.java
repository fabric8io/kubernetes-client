...
public class SecretOrConfigMap implements Editable<SecretOrConfigMapBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecretOrConfigMap)) {
            return false;
        }
        SecretOrConfigMap other = (SecretOrConfigMap) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SecretOrConfigMap;
    }
    ...
    public String toString() {
        return "SecretOrConfigMap(" + "configMap=" + this.getConfigMap() + ", secret=" + this.getSecret() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
