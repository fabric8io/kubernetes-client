...
public class PrometheusSpecRWQueueConfig implements Editable<PrometheusSpecRWQueueConfigBuilder> , KubernetesResource
{
     ...
     * 
     */
    public PrometheusSpecRWQueueConfig() {
    }

    public PrometheusSpecRWQueueConfig(String batchSendDeadline, Integer capacity, String maxBackoff, Integer maxRetries, Integer maxSamplesPerSend, Integer maxShards, String minBackoff, Integer minShards, Boolean retryOnRateLimit, String sampleAgeLimit) {
        super();
    ...
    @JsonIgnore
    public PrometheusSpecRWQueueConfigBuilder edit() {
        return new PrometheusSpecRWQueueConfigBuilder(this);
    }

    @JsonIgnore
    public PrometheusSpecRWQueueConfigBuilder toBuilder() {
        return edit();
    }
