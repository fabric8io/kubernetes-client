...
public class ServiceMonitor implements Editable<ServiceMonitorBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ServiceMonitor)) {
            return false;
        }
        ServiceMonitor other = (ServiceMonitor) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ServiceMonitor;
    }
    ...
    public String toString() {
        return "ServiceMonitor(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
