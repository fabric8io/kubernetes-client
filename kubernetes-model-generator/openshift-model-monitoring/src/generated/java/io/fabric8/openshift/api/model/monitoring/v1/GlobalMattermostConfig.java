...
public class GlobalMattermostConfig implements Editable<GlobalMattermostConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GlobalMattermostConfig)) {
            return false;
        }
        GlobalMattermostConfig other = (GlobalMattermostConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GlobalMattermostConfig;
    }
    ...
    public String toString() {
        return "GlobalMattermostConfig(" + "webhookURL=" + this.getWebhookURL() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
