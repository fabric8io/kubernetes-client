...
public class ThanosRulerWebSpec implements Editable<ThanosRulerWebSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ThanosRulerWebSpec)) {
            return false;
        }
        ThanosRulerWebSpec other = (ThanosRulerWebSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ThanosRulerWebSpec;
    }
    ...
    public String toString() {
        return "ThanosRulerWebSpec(" + "httpConfig=" + this.getHttpConfig() + ", tlsConfig=" + this.getTlsConfig() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
