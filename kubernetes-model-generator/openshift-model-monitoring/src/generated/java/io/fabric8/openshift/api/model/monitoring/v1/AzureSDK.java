...
public class AzureSDK implements Editable<AzureSDKBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AzureSDK)) {
            return false;
        }
        AzureSDK other = (AzureSDK) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AzureSDK;
    }
    ...
    public String toString() {
        return "AzureSDK(" + "tenantId=" + this.getTenantId() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
