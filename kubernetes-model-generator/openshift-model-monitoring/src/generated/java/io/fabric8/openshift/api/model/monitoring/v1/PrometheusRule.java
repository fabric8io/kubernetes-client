...
public class PrometheusRule implements Editable<PrometheusRuleBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrometheusRule)) {
            return false;
        }
        PrometheusRule other = (PrometheusRule) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PrometheusRule;
    }
    ...
    public String toString() {
        return "PrometheusRule(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
