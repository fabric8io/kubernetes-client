...
public class ConfigResourceCondition implements Editable<ConfigResourceConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigResourceCondition)) {
            return false;
        }
        ConfigResourceCondition other = (ConfigResourceCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ConfigResourceCondition;
    }
    ...
    public String toString() {
        return "ConfigResourceCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", observedGeneration=" + this.getObservedGeneration() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
