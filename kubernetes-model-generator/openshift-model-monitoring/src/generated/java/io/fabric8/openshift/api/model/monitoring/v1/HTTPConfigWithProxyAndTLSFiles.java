...
public class HTTPConfigWithProxyAndTLSFiles implements Editable<HTTPConfigWithProxyAndTLSFilesBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HTTPConfigWithProxyAndTLSFiles)) {
            return false;
        }
        HTTPConfigWithProxyAndTLSFiles other = (HTTPConfigWithProxyAndTLSFiles) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HTTPConfigWithProxyAndTLSFiles;
    }
    ...
    public String toString() {
        return "HTTPConfigWithProxyAndTLSFiles(" + "authorization=" + this.getAuthorization() + ", basicAuth=" + this.getBasicAuth() + ", bearerTokenSecret=" + this.getBearerTokenSecret() + ", enableHttp2=" + this.getEnableHttp2() + ", followRedirects=" + this.getFollowRedirects() + ", noProxy=" + this.getNoProxy() + ", oauth2=" + this.getOauth2() + ", proxyConnectHeader=" + this.getProxyConnectHeader() + ", proxyFromEnvironment=" + this.getProxyFromEnvironment() + ", proxyUrl=" + this.getProxyUrl() + ", tlsConfig=" + this.getTlsConfig() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
