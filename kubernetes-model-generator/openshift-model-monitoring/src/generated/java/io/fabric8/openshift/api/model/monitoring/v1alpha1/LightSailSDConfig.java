...
public class LightSailSDConfig implements Editable<LightSailSDConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LightSailSDConfig)) {
            return false;
        }
        LightSailSDConfig other = (LightSailSDConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LightSailSDConfig;
    }
    ...
    public String toString() {
        return "LightSailSDConfig(" + "accessKey=" + this.getAccessKey() + ", authorization=" + this.getAuthorization() + ", basicAuth=" + this.getBasicAuth() + ", enableHTTP2=" + this.getEnableHTTP2() + ", endpoint=" + this.getEndpoint() + ", followRedirects=" + this.getFollowRedirects() + ", noProxy=" + this.getNoProxy() + ", oauth2=" + this.getOauth2() + ", port=" + this.getPort() + ", proxyConnectHeader=" + this.getProxyConnectHeader() + ", proxyFromEnvironment=" + this.getProxyFromEnvironment() + ", proxyUrl=" + this.getProxyUrl() + ", refreshInterval=" + this.getRefreshInterval() + ", region=" + this.getRegion() + ", roleARN=" + this.getRoleARN() + ", secretKey=" + this.getSecretKey() + ", tlsConfig=" + this.getTlsConfig() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
