...
public class TelegramConfigFluent<A extends io.fabric8.openshift.api.model.monitoring.v1beta1.TelegramConfigFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiURL;
  private SecretKeySelectorBuilder botToken;
  ...
  public SecretKeySelector buildBotToken() {
    return this.botToken != null ? this.botToken.build() : null;
  }
  ...
  public BotTokenNested<A> editBotToken() {
    return this.withNewBotTokenLike(Optional.ofNullable(this.buildBotToken()).orElse(null));
  }
  ...
  public BotTokenNested<A> editOrNewBotToken() {
    return this.withNewBotTokenLike(Optional.ofNullable(this.buildBotToken()).orElse(new SecretKeySelectorBuilder().build()));
  }
  
  public BotTokenNested<A> editOrNewBotTokenLike(SecretKeySelector item) {
    return this.withNewBotTokenLike(Optional.ofNullable(this.buildBotToken()).orElse(item));
  }
  ...
  public A withBotToken(SecretKeySelector botToken) {
    this._visitables.remove("botToken");
    if (botToken != null) {
        this.botToken = new SecretKeySelectorBuilder(botToken);
        this._visitables.get("botToken").add(this.botToken);
    } else {
        this.botToken = null;
        this._visitables.get("botToken").remove(this.botToken);
    }
    return (A) this;
  }
  ...
  public BotTokenNested<A> withNewBotToken() {
    return new BotTokenNested(null);
  }
  
  public A withNewBotToken(String key,String name) {
    return (A) this.withBotToken(new SecretKeySelector(key, name));
  }
  
  public BotTokenNested<A> withNewBotTokenLike(SecretKeySelector item) {
    return new BotTokenNested(item);
  }
  ...
  public class BotTokenNested<N> extends SecretKeySelectorFluent<BotTokenNested<N>> implements Nested<N>{
  
    SecretKeySelectorBuilder builder;
  
    BotTokenNested(SecretKeySelector item) {
      this.builder = new SecretKeySelectorBuilder(this, item);
    }
  
    public N and() {
      return (N) TelegramConfigFluent.this.withBotToken(builder.build());
    }
    
    public N endBotToken() {
      return and();
    }
