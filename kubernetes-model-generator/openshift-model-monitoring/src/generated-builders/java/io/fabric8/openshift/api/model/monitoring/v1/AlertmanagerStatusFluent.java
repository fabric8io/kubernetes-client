...
public class AlertmanagerStatusFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.AlertmanagerStatusFluent<A>> extends BaseFluent<A>{
  ...
  public AlertmanagerStatusFluent() {
  }
  
  public AlertmanagerStatusFluent(AlertmanagerStatus instance) {
  ...
  protected void copyInstance(AlertmanagerStatus instance) {
    instance = instance != null ? instance : new AlertmanagerStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    AlertmanagerStatusFluent that = (AlertmanagerStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(availableReplicas, conditions, paused, replicas, selector, unavailableReplicas, updatedReplicas, additionalProperties);
  }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AlertmanagerStatusFluent.this.setToConditions(index, builder.build());
    }
