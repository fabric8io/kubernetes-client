...
public class PrometheusListFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.PrometheusListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<PrometheusBuilder> items = new ArrayList<PrometheusBuilder>();
  private String kind;
  private ListMeta metadata;

  public PrometheusListFluent() {
  }
  
  public PrometheusListFluent(PrometheusList instance) {
  ...
  public A addAllToItems(Collection<Prometheus> items) {
    ...
    for (Prometheus item : items) {
        PrometheusBuilder builder = new PrometheusBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(Prometheus item) {
  ...
  public Prometheus buildMatchingItem(Predicate<PrometheusBuilder> predicate) {
      for (PrometheusBuilder item : items) {
  ...
  protected void copyInstance(PrometheusList instance) {
    instance = instance != null ? instance : new PrometheusList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<PrometheusBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    PrometheusListFluent that = (PrometheusListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<PrometheusBuilder> predicate) {
    ...
    Iterator<PrometheusBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        PrometheusBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Prometheus item) {
  ...
  public class ItemsNested<N> extends PrometheusFluent<ItemsNested<N>> implements Nested<N>{
  
    PrometheusBuilder builder;
    int index;
  
    ItemsNested(int index,Prometheus item) {
      this.index = index;
      this.builder = new PrometheusBuilder(this, item);
    }
  
    public N and() {
      return (N) PrometheusListFluent.this.setToItems(index, builder.build());
    }
