...
public class HTTPSDConfigFluent<A extends io.fabric8.openshift.api.model.monitoring.v1alpha1.HTTPSDConfigFluent<A>> extends BaseFluent<A>{
  ...
  public HTTPSDConfigFluent(HTTPSDConfig instance) {
  ...
  protected void copyInstance(HTTPSDConfig instance) {
    instance = instance != null ? instance : new HTTPSDConfig();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    HTTPSDConfigFluent that = (HTTPSDConfigFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(authorization, basicAuth, enableHTTP2, followRedirects, noProxy, oauth2, proxyConnectHeader, proxyFromEnvironment, proxyUrl, refreshInterval, tlsConfig, url, additionalProperties);
  }
  ...
  public class AuthorizationNested<N> extends SafeAuthorizationFluent<AuthorizationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPSDConfigFluent.this.withAuthorization(builder.build());
    }
  ...
  public class BasicAuthNested<N> extends BasicAuthFluent<BasicAuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPSDConfigFluent.this.withBasicAuth(builder.build());
    }
  ...
  public class Oauth2Nested<N> extends OAuth2Fluent<Oauth2Nested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPSDConfigFluent.this.withOauth2(builder.build());
    }
  ...
  public class TlsConfigNested<N> extends SafeTLSConfigFluent<TlsConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPSDConfigFluent.this.withTlsConfig(builder.build());
    }
