...
public class LightSailSDConfigFluent<A extends io.fabric8.openshift.api.model.monitoring.v1alpha1.LightSailSDConfigFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(LightSailSDConfig instance) {
    instance = instance != null ? instance : new LightSailSDConfig();
    if (instance != null) {
  ...
  public int hashCode() {
    return Objects.hash(accessKey, authorization, basicAuth, enableHTTP2, endpoint, followRedirects, noProxy, oauth2, port, proxyConnectHeader, proxyFromEnvironment, proxyUrl, refreshInterval, region, roleARN, secretKey, tlsConfig, additionalProperties);
  }
  ...
  public class AuthorizationNested<N> extends SafeAuthorizationFluent<AuthorizationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) LightSailSDConfigFluent.this.withAuthorization(builder.build());
    }
  ...
  public class BasicAuthNested<N> extends BasicAuthFluent<BasicAuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) LightSailSDConfigFluent.this.withBasicAuth(builder.build());
    }
  ...
  public class Oauth2Nested<N> extends OAuth2Fluent<Oauth2Nested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) LightSailSDConfigFluent.this.withOauth2(builder.build());
    }
  ...
  public class TlsConfigNested<N> extends SafeTLSConfigFluent<TlsConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) LightSailSDConfigFluent.this.withTlsConfig(builder.build());
    }
