...
public class HTTPConfigWithoutTLSFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.HTTPConfigWithoutTLSFluent<A>> extends BaseFluent<A>{
  ...
  public HTTPConfigWithoutTLSFluent() {
  }
  
  public HTTPConfigWithoutTLSFluent(HTTPConfigWithoutTLS instance) {
  ...
  protected void copyInstance(HTTPConfigWithoutTLS instance) {
    instance = instance != null ? instance : new HTTPConfigWithoutTLS();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    HTTPConfigWithoutTLSFluent that = (HTTPConfigWithoutTLSFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(authorization, basicAuth, bearerTokenSecret, enableHttp2, followRedirects, oauth2, additionalProperties);
  }
  ...
  public class AuthorizationNested<N> extends SafeAuthorizationFluent<AuthorizationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithoutTLSFluent.this.withAuthorization(builder.build());
    }
  ...
  public class BasicAuthNested<N> extends BasicAuthFluent<BasicAuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithoutTLSFluent.this.withBasicAuth(builder.build());
    }
  ...
  public class Oauth2Nested<N> extends OAuth2Fluent<Oauth2Nested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithoutTLSFluent.this.withOauth2(builder.build());
    }
