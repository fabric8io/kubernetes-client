...
public class AlertmanagerWebSpecFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.AlertmanagerWebSpecFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(AlertmanagerWebSpec instance) {
    instance = instance != null ? instance : new AlertmanagerWebSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    AlertmanagerWebSpecFluent that = (AlertmanagerWebSpecFluent) o;
    if (!(Objects.equals(getConcurrency, that.getConcurrency))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(getConcurrency, httpConfig, timeout, tlsConfig, additionalProperties);
  }
  ...
  public class HttpConfigNested<N> extends WebHTTPConfigFluent<HttpConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AlertmanagerWebSpecFluent.this.withHttpConfig(builder.build());
    }
  ...
  public class TlsConfigNested<N> extends WebTLSConfigFluent<TlsConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AlertmanagerWebSpecFluent.this.withTlsConfig(builder.build());
    }
