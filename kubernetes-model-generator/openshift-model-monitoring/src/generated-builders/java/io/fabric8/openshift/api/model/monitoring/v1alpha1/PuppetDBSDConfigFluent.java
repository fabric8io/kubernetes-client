...
public class PuppetDBSDConfigFluent<A extends io.fabric8.openshift.api.model.monitoring.v1alpha1.PuppetDBSDConfigFluent<A>> extends BaseFluent<A>{
  ...
  public PuppetDBSDConfigFluent() {
  }
  
  public PuppetDBSDConfigFluent(PuppetDBSDConfig instance) {
  ...
  protected void copyInstance(PuppetDBSDConfig instance) {
    instance = instance != null ? instance : new PuppetDBSDConfig();
    if (instance != null) {
        this.withAuthorization(instance.getAuthorization());
        this.withBasicAuth(instance.getBasicAuth());
        this.withEnableHTTP2(instance.getEnableHTTP2());
        this.withFollowRedirects(instance.getFollowRedirects());
        this.withIncludeParameters(instance.getIncludeParameters());
  ...
  public boolean equals(Object o) {
    ...
    PuppetDBSDConfigFluent that = (PuppetDBSDConfigFluent) o;
    ...
    if (!(Objects.equals(includeParameters, that.includeParameters))) {
      return false;
    }
  ...
  public boolean hasIncludeParameters() {
    return this.includeParameters != null;
  }
  ...
  public int hashCode() {
    return Objects.hash(authorization, basicAuth, enableHTTP2, followRedirects, includeParameters, noProxy, oauth2, port, proxyConnectHeader, proxyFromEnvironment, proxyUrl, query, refreshInterval, tlsConfig, url, additionalProperties);
  }
  ...
  public A withIncludeParameters() {
    return withIncludeParameters(true);
  }
  
  public A withIncludeParameters(Boolean includeParameters) {
  ...
  public class AuthorizationNested<N> extends SafeAuthorizationFluent<AuthorizationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PuppetDBSDConfigFluent.this.withAuthorization(builder.build());
    }
  ...
  public class BasicAuthNested<N> extends BasicAuthFluent<BasicAuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PuppetDBSDConfigFluent.this.withBasicAuth(builder.build());
    }
  ...
  public class Oauth2Nested<N> extends OAuth2Fluent<Oauth2Nested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PuppetDBSDConfigFluent.this.withOauth2(builder.build());
    }
  ...
  public class TlsConfigNested<N> extends SafeTLSConfigFluent<TlsConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PuppetDBSDConfigFluent.this.withTlsConfig(builder.build());
    }
