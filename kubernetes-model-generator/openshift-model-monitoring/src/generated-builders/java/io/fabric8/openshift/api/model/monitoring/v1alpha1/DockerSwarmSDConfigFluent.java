...
public class DockerSwarmSDConfigFluent<A extends io.fabric8.openshift.api.model.monitoring.v1alpha1.DockerSwarmSDConfigFluent<A>> extends BaseFluent<A>{
  ...
  public DockerSwarmSDConfigFluent() {
  }
  
  public DockerSwarmSDConfigFluent(DockerSwarmSDConfig instance) {
  ...
  protected void copyInstance(DockerSwarmSDConfig instance) {
    instance = instance != null ? instance : new DockerSwarmSDConfig();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    DockerSwarmSDConfigFluent that = (DockerSwarmSDConfigFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(authorization, basicAuth, enableHTTP2, filters, followRedirects, host, noProxy, oauth2, port, proxyConnectHeader, proxyFromEnvironment, proxyUrl, refreshInterval, role, tlsConfig, additionalProperties);
  }
  ...
  public class AuthorizationNested<N> extends SafeAuthorizationFluent<AuthorizationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DockerSwarmSDConfigFluent.this.withAuthorization(builder.build());
    }
  ...
  public class BasicAuthNested<N> extends BasicAuthFluent<BasicAuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DockerSwarmSDConfigFluent.this.withBasicAuth(builder.build());
    }
  ...
  public class FiltersNested<N> extends FilterFluent<FiltersNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DockerSwarmSDConfigFluent.this.setToFilters(index, builder.build());
    }
  ...
  public class Oauth2Nested<N> extends OAuth2Fluent<Oauth2Nested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DockerSwarmSDConfigFluent.this.withOauth2(builder.build());
    }
  ...
  public class TlsConfigNested<N> extends SafeTLSConfigFluent<TlsConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DockerSwarmSDConfigFluent.this.withTlsConfig(builder.build());
    }
