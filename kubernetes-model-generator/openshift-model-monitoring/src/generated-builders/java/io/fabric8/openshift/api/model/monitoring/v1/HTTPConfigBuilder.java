...
public class HTTPConfigBuilder extends HTTPConfigFluent<HTTPConfigBuilder> implements VisitableBuilder<HTTPConfig,HTTPConfigBuilder>{
  ...
  public HTTPConfig build() {
    HTTPConfig buildable = new HTTPConfig(fluent.buildAuthorization(), fluent.buildBasicAuth(), fluent.getBearerTokenSecret(), fluent.getEnableHttp2(), fluent.getFollowRedirects(), fluent.buildOauth2(), fluent.buildTlsConfig());
