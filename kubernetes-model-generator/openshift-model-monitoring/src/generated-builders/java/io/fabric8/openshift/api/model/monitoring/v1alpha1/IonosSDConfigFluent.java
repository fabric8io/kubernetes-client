...
public class IonosSDConfigFluent<A extends io.fabric8.openshift.api.model.monitoring.v1alpha1.IonosSDConfigFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(IonosSDConfig instance) {
    instance = instance != null ? instance : new IonosSDConfig();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(datacenterID, that.datacenterID))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(authorization, datacenterID, enableHTTP2, followRedirects, noProxy, oauth2, port, proxyConnectHeader, proxyFromEnvironment, proxyUrl, refreshInterval, tlsConfig, additionalProperties);
  }
  ...
  public class AuthorizationNested<N> extends SafeAuthorizationFluent<AuthorizationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IonosSDConfigFluent.this.withAuthorization(builder.build());
    }
  ...
  public class Oauth2Nested<N> extends OAuth2Fluent<Oauth2Nested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IonosSDConfigFluent.this.withOauth2(builder.build());
    }
  ...
  public class TlsConfigNested<N> extends SafeTLSConfigFluent<TlsConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IonosSDConfigFluent.this.withTlsConfig(builder.build());
    }
