...
public class WebConfigFileFieldsFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.WebConfigFileFieldsFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private WebHTTPConfigBuilder httpConfig;
  private WebTLSConfigBuilder tlsConfig;

  public WebConfigFileFieldsFluent() {
  }
  
  public WebConfigFileFieldsFluent(WebConfigFileFields instance) {
  ...
  protected void copyInstance(WebConfigFileFields instance) {
    instance = instance != null ? instance : new WebConfigFileFields();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    WebConfigFileFieldsFluent that = (WebConfigFileFieldsFluent) o;
  ...
  public class HttpConfigNested<N> extends WebHTTPConfigFluent<HttpConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WebConfigFileFieldsFluent.this.withHttpConfig(builder.build());
    }
  ...
  public class TlsConfigNested<N> extends WebTLSConfigFluent<TlsConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) WebConfigFileFieldsFluent.this.withTlsConfig(builder.build());
    }
