...
public class OpsGenieConfigBuilder extends OpsGenieConfigFluent<OpsGenieConfigBuilder> implements VisitableBuilder<OpsGenieConfig,OpsGenieConfigBuilder>{
  ...
  public OpsGenieConfig build() {
    OpsGenieConfig buildable = new OpsGenieConfig(fluent.getActions(), fluent.buildApiKey(), fluent.getApiURL(), fluent.getDescription(), fluent.buildDetails(), fluent.getEntity(), fluent.buildHttpConfig(), fluent.getMessage(), fluent.getNote(), fluent.getPriority(), fluent.buildResponders(), fluent.getSendResolved(), fluent.getSource(), fluent.getTags());
