...
public class TelegramConfigBuilder extends TelegramConfigFluent<TelegramConfigBuilder> implements VisitableBuilder<TelegramConfig,TelegramConfigBuilder>{
  ...
  public TelegramConfig build() {
    TelegramConfig buildable = new TelegramConfig(fluent.getApiURL(), fluent.getBotToken(), fluent.getBotTokenFile(), fluent.getChatID(), fluent.getDisableNotifications(), fluent.buildHttpConfig(), fluent.getMessage(), fluent.getMessageThreadID(), fluent.getParseMode(), fluent.getSendResolved());
