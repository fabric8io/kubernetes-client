...
public class NomadSDConfigFluent<A extends io.fabric8.openshift.api.model.monitoring.v1alpha1.NomadSDConfigFluent<A>> extends BaseFluent<A>{
  ...
  public NomadSDConfigFluent() {
  }
  
  public NomadSDConfigFluent(NomadSDConfig instance) {
  ...
  protected void copyInstance(NomadSDConfig instance) {
    instance = instance != null ? instance : new NomadSDConfig();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    NomadSDConfigFluent that = (NomadSDConfigFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(allowStale, authorization, basicAuth, enableHTTP2, followRedirects, namespace, noProxy, oauth2, proxyConnectHeader, proxyFromEnvironment, proxyUrl, refreshInterval, region, server, tagSeparator, tlsConfig, additionalProperties);
  }
  ...
  public class AuthorizationNested<N> extends SafeAuthorizationFluent<AuthorizationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NomadSDConfigFluent.this.withAuthorization(builder.build());
    }
  ...
  public class BasicAuthNested<N> extends BasicAuthFluent<BasicAuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NomadSDConfigFluent.this.withBasicAuth(builder.build());
    }
  ...
  public class Oauth2Nested<N> extends OAuth2Fluent<Oauth2Nested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NomadSDConfigFluent.this.withOauth2(builder.build());
    }
  ...
  public class TlsConfigNested<N> extends SafeTLSConfigFluent<TlsConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NomadSDConfigFluent.this.withTlsConfig(builder.build());
    }
