...
public class WebhookConfigBuilder extends WebhookConfigFluent<WebhookConfigBuilder> implements VisitableBuilder<WebhookConfig,WebhookConfigBuilder>{
  ...
  public WebhookConfig build() {
    WebhookConfig buildable = new WebhookConfig(fluent.buildHttpConfig(), fluent.getMaxAlerts(), fluent.getPayload(), fluent.getSendResolved(), fluent.getTimeout(), fluent.getUrl(), fluent.getUrlSecret());
