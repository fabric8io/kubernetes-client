...
public class DigitalOceanSDConfigFluent<A extends io.fabric8.openshift.api.model.monitoring.v1alpha1.DigitalOceanSDConfigFluent<A>> extends BaseFluent<A>{
  ...
  public DigitalOceanSDConfigFluent() {
  }
  
  public DigitalOceanSDConfigFluent(DigitalOceanSDConfig instance) {
  ...
  protected void copyInstance(DigitalOceanSDConfig instance) {
    instance = instance != null ? instance : new DigitalOceanSDConfig();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    DigitalOceanSDConfigFluent that = (DigitalOceanSDConfigFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(authorization, enableHTTP2, followRedirects, noProxy, oauth2, port, proxyConnectHeader, proxyFromEnvironment, proxyUrl, refreshInterval, tlsConfig, additionalProperties);
  }
  ...
  public class AuthorizationNested<N> extends SafeAuthorizationFluent<AuthorizationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DigitalOceanSDConfigFluent.this.withAuthorization(builder.build());
    }
  ...
  public class Oauth2Nested<N> extends OAuth2Fluent<Oauth2Nested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DigitalOceanSDConfigFluent.this.withOauth2(builder.build());
    }
  ...
  public class TlsConfigNested<N> extends SafeTLSConfigFluent<TlsConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DigitalOceanSDConfigFluent.this.withTlsConfig(builder.build());
    }
