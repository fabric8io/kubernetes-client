...
public class EmailConfigFluent<A extends io.fabric8.openshift.api.model.monitoring.v1beta1.EmailConfigFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String authIdentity;
  private SecretKeySelectorBuilder authPassword;
  private SecretKeySelectorBuilder authSecret;
  ...
  public SecretKeySelector buildAuthPassword() {
    return this.authPassword != null ? this.authPassword.build() : null;
  }
  
  public SecretKeySelector buildAuthSecret() {
    return this.authSecret != null ? this.authSecret.build() : null;
  }
  ...
  public AuthPasswordNested<A> editAuthPassword() {
    return this.withNewAuthPasswordLike(Optional.ofNullable(this.buildAuthPassword()).orElse(null));
  }
  
  public AuthSecretNested<A> editAuthSecret() {
    return this.withNewAuthSecretLike(Optional.ofNullable(this.buildAuthSecret()).orElse(null));
  }
  ...
  public AuthPasswordNested<A> editOrNewAuthPassword() {
    return this.withNewAuthPasswordLike(Optional.ofNullable(this.buildAuthPassword()).orElse(new SecretKeySelectorBuilder().build()));
  }
  
  public AuthPasswordNested<A> editOrNewAuthPasswordLike(SecretKeySelector item) {
    return this.withNewAuthPasswordLike(Optional.ofNullable(this.buildAuthPassword()).orElse(item));
  }
  
  public AuthSecretNested<A> editOrNewAuthSecret() {
    return this.withNewAuthSecretLike(Optional.ofNullable(this.buildAuthSecret()).orElse(new SecretKeySelectorBuilder().build()));
  }
  
  public AuthSecretNested<A> editOrNewAuthSecretLike(SecretKeySelector item) {
    return this.withNewAuthSecretLike(Optional.ofNullable(this.buildAuthSecret()).orElse(item));
  }
  ...
  public A withAuthPassword(SecretKeySelector authPassword) {
    this._visitables.remove("authPassword");
    if (authPassword != null) {
        this.authPassword = new SecretKeySelectorBuilder(authPassword);
        this._visitables.get("authPassword").add(this.authPassword);
    } else {
        this.authPassword = null;
        this._visitables.get("authPassword").remove(this.authPassword);
    }
    return (A) this;
  }
  
  public A withAuthSecret(SecretKeySelector authSecret) {
    this._visitables.remove("authSecret");
    if (authSecret != null) {
        this.authSecret = new SecretKeySelectorBuilder(authSecret);
        this._visitables.get("authSecret").add(this.authSecret);
    } else {
        this.authSecret = null;
        this._visitables.get("authSecret").remove(this.authSecret);
    }
    return (A) this;
  }
  ...
  public AuthPasswordNested<A> withNewAuthPassword() {
    return new AuthPasswordNested(null);
  }
  
  public A withNewAuthPassword(String key,String name) {
    return (A) this.withAuthPassword(new SecretKeySelector(key, name));
  }
  
  public AuthPasswordNested<A> withNewAuthPasswordLike(SecretKeySelector item) {
    return new AuthPasswordNested(item);
  }
  
  public AuthSecretNested<A> withNewAuthSecret() {
    return new AuthSecretNested(null);
  }
  
  public A withNewAuthSecret(String key,String name) {
    return (A) this.withAuthSecret(new SecretKeySelector(key, name));
  }
  
  public AuthSecretNested<A> withNewAuthSecretLike(SecretKeySelector item) {
    return new AuthSecretNested(item);
  }
  ...
  public class AuthPasswordNested<N> extends SecretKeySelectorFluent<AuthPasswordNested<N>> implements Nested<N>{
  
    SecretKeySelectorBuilder builder;
  
    AuthPasswordNested(SecretKeySelector item) {
      this.builder = new SecretKeySelectorBuilder(this, item);
    }
  
    public N and() {
      return (N) EmailConfigFluent.this.withAuthPassword(builder.build());
    }
    
    public N endAuthPassword() {
      return and();
    }
    
  }
  public class AuthSecretNested<N> extends SecretKeySelectorFluent<AuthSecretNested<N>> implements Nested<N>{
  
    SecretKeySelectorBuilder builder;
  
    AuthSecretNested(SecretKeySelector item) {
      this.builder = new SecretKeySelectorBuilder(this, item);
    }
  
    public N and() {
      return (N) EmailConfigFluent.this.withAuthSecret(builder.build());
    }
    
    public N endAuthSecret() {
      return and();
    }
