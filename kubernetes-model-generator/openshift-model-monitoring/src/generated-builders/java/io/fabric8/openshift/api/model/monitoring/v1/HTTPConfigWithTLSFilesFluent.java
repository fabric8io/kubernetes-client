...
public class HTTPConfigWithTLSFilesFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.HTTPConfigWithTLSFilesFluent<A>> extends BaseFluent<A>{
  ...
  public HTTPConfigWithTLSFilesFluent() {
  }
  
  public HTTPConfigWithTLSFilesFluent(HTTPConfigWithTLSFiles instance) {
  ...
  protected void copyInstance(HTTPConfigWithTLSFiles instance) {
    instance = instance != null ? instance : new HTTPConfigWithTLSFiles();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    HTTPConfigWithTLSFilesFluent that = (HTTPConfigWithTLSFilesFluent) o;
  ...
  public class AuthorizationNested<N> extends SafeAuthorizationFluent<AuthorizationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithTLSFilesFluent.this.withAuthorization(builder.build());
    }
  ...
  public class BasicAuthNested<N> extends BasicAuthFluent<BasicAuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithTLSFilesFluent.this.withBasicAuth(builder.build());
    }
  ...
  public class Oauth2Nested<N> extends OAuth2Fluent<Oauth2Nested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithTLSFilesFluent.this.withOauth2(builder.build());
    }
  ...
  public class TlsConfigNested<N> extends TLSConfigFluent<TlsConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithTLSFilesFluent.this.withTlsConfig(builder.build());
    }
