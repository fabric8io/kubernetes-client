...
public class AlertmanagerListFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.AlertmanagerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<AlertmanagerBuilder> items = new ArrayList<AlertmanagerBuilder>();
  private String kind;
  ...
  public A addAllToItems(Collection<Alertmanager> items) {
    ...
    for (Alertmanager item : items) {
        AlertmanagerBuilder builder = new AlertmanagerBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(Alertmanager item) {
  ...
  public Alertmanager buildMatchingItem(Predicate<AlertmanagerBuilder> predicate) {
      for (AlertmanagerBuilder item : items) {
  ...
  protected void copyInstance(AlertmanagerList instance) {
    instance = instance != null ? instance : new AlertmanagerList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<AlertmanagerBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    AlertmanagerListFluent that = (AlertmanagerListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<AlertmanagerBuilder> predicate) {
    ...
    Iterator<AlertmanagerBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        AlertmanagerBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Alertmanager item) {
  ...
  public class ItemsNested<N> extends AlertmanagerFluent<ItemsNested<N>> implements Nested<N>{
  
    AlertmanagerBuilder builder;
    int index;
  
    ItemsNested(int index,Alertmanager item) {
      this.index = index;
      this.builder = new AlertmanagerBuilder(this, item);
    }
  
    public N and() {
      return (N) AlertmanagerListFluent.this.setToItems(index, builder.build());
    }
