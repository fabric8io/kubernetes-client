...
public class ArgumentFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.ArgumentFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(Argument instance) {
    instance = instance != null ? instance : new Argument();
    if (instance != null) {
