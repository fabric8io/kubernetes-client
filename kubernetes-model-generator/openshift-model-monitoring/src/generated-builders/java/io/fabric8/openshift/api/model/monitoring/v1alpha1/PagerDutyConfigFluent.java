...
public class PagerDutyConfigFluent<A extends io.fabric8.openshift.api.model.monitoring.v1alpha1.PagerDutyConfigFluent<A>> extends BaseFluent<A>{
  ...
  public A withNewRoutingKey(String key,String name,Boolean optional) {
    return (A) this.withRoutingKey(new SecretKeySelector(key, name, optional));
  }
  
  public A withNewServiceKey(String key,String name,Boolean optional) {
    return (A) this.withServiceKey(new SecretKeySelector(key, name, optional));
  }
