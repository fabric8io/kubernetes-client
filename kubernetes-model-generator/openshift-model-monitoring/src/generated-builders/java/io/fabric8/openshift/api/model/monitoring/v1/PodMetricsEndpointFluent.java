...
public class PodMetricsEndpointFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.PodMetricsEndpointFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(PodMetricsEndpoint instance) {
  ...
  public int hashCode() {
    return Objects.hash(authorization, basicAuth, bearerTokenSecret, enableHttp2, filterRunning, followRedirects, honorLabels, honorTimestamps, interval, metricRelabelings, noProxy, oauth2, params, path, port, portNumber, proxyConnectHeader, proxyFromEnvironment, proxyUrl, relabelings, scheme, scrapeTimeout, targetPort, tlsConfig, trackTimestampsStaleness, additionalProperties);
  }
