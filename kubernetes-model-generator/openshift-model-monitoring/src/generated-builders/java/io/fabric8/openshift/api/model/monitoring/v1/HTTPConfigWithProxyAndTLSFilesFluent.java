...
public class HTTPConfigWithProxyAndTLSFilesFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.HTTPConfigWithProxyAndTLSFilesFluent<A>> extends BaseFluent<A>{
  ...
  public HTTPConfigWithProxyAndTLSFilesFluent() {
  }
  
  public HTTPConfigWithProxyAndTLSFilesFluent(HTTPConfigWithProxyAndTLSFiles instance) {
  ...
  protected void copyInstance(HTTPConfigWithProxyAndTLSFiles instance) {
    instance = instance != null ? instance : new HTTPConfigWithProxyAndTLSFiles();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    HTTPConfigWithProxyAndTLSFilesFluent that = (HTTPConfigWithProxyAndTLSFilesFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(authorization, basicAuth, bearerTokenSecret, enableHttp2, followRedirects, noProxy, oauth2, proxyConnectHeader, proxyFromEnvironment, proxyUrl, tlsConfig, additionalProperties);
  }
  ...
  public class AuthorizationNested<N> extends SafeAuthorizationFluent<AuthorizationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithProxyAndTLSFilesFluent.this.withAuthorization(builder.build());
    }
  ...
  public class BasicAuthNested<N> extends BasicAuthFluent<BasicAuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithProxyAndTLSFilesFluent.this.withBasicAuth(builder.build());
    }
  ...
  public class Oauth2Nested<N> extends OAuth2Fluent<Oauth2Nested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithProxyAndTLSFilesFluent.this.withOauth2(builder.build());
    }
  ...
  public class TlsConfigNested<N> extends TLSConfigFluent<TlsConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithProxyAndTLSFilesFluent.this.withTlsConfig(builder.build());
    }
