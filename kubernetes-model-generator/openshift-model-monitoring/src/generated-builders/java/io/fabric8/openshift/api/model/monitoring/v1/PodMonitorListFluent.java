...
public class PodMonitorListFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.PodMonitorListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<PodMonitorBuilder> items = new ArrayList<PodMonitorBuilder>();
  private String kind;
  private ListMeta metadata;

  public PodMonitorListFluent() {
  }
  
  public PodMonitorListFluent(PodMonitorList instance) {
  ...
  public A addAllToItems(Collection<PodMonitor> items) {
    ...
    for (PodMonitor item : items) {
        PodMonitorBuilder builder = new PodMonitorBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(PodMonitor item) {
  ...
  public PodMonitor buildMatchingItem(Predicate<PodMonitorBuilder> predicate) {
      for (PodMonitorBuilder item : items) {
  ...
  protected void copyInstance(PodMonitorList instance) {
    instance = instance != null ? instance : new PodMonitorList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<PodMonitorBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    PodMonitorListFluent that = (PodMonitorListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<PodMonitorBuilder> predicate) {
    ...
    Iterator<PodMonitorBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        PodMonitorBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,PodMonitor item) {
  ...
  public class ItemsNested<N> extends PodMonitorFluent<ItemsNested<N>> implements Nested<N>{
  
    PodMonitorBuilder builder;
    int index;
  
    ItemsNested(int index,PodMonitor item) {
      this.index = index;
      this.builder = new PodMonitorBuilder(this, item);
    }
  
    public N and() {
      return (N) PodMonitorListFluent.this.setToItems(index, builder.build());
    }
