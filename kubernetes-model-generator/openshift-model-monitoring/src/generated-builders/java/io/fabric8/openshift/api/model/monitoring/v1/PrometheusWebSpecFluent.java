...
public class PrometheusWebSpecFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.PrometheusWebSpecFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(PrometheusWebSpec instance) {
    instance = instance != null ? instance : new PrometheusWebSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    PrometheusWebSpecFluent that = (PrometheusWebSpecFluent) o;
    ...
    if (!(Objects.equals(pageTitle, that.pageTitle))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(httpConfig, maxConnections, pageTitle, tlsConfig, additionalProperties);
  }
  ...
  public class HttpConfigNested<N> extends WebHTTPConfigFluent<HttpConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PrometheusWebSpecFluent.this.withHttpConfig(builder.build());
    }
  ...
  public class TlsConfigNested<N> extends WebTLSConfigFluent<TlsConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PrometheusWebSpecFluent.this.withTlsConfig(builder.build());
    }
