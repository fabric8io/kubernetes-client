...
public class EurekaSDConfigFluent<A extends io.fabric8.openshift.api.model.monitoring.v1alpha1.EurekaSDConfigFluent<A>> extends BaseFluent<A>{
  ...
  public EurekaSDConfigFluent() {
  }
  
  public EurekaSDConfigFluent(EurekaSDConfig instance) {
  ...
  protected void copyInstance(EurekaSDConfig instance) {
    instance = instance != null ? instance : new EurekaSDConfig();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    EurekaSDConfigFluent that = (EurekaSDConfigFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(authorization, basicAuth, enableHTTP2, followRedirects, noProxy, oauth2, proxyConnectHeader, proxyFromEnvironment, proxyUrl, refreshInterval, server, tlsConfig, additionalProperties);
  }
  ...
  public class AuthorizationNested<N> extends SafeAuthorizationFluent<AuthorizationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EurekaSDConfigFluent.this.withAuthorization(builder.build());
    }
  ...
  public class BasicAuthNested<N> extends BasicAuthFluent<BasicAuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EurekaSDConfigFluent.this.withBasicAuth(builder.build());
    }
  ...
  public class Oauth2Nested<N> extends OAuth2Fluent<Oauth2Nested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EurekaSDConfigFluent.this.withOauth2(builder.build());
    }
  ...
  public class TlsConfigNested<N> extends SafeTLSConfigFluent<TlsConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EurekaSDConfigFluent.this.withTlsConfig(builder.build());
    }
