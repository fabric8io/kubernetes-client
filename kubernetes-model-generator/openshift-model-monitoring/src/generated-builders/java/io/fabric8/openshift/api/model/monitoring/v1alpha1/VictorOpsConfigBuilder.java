...
public class VictorOpsConfigBuilder extends VictorOpsConfigFluent<VictorOpsConfigBuilder> implements VisitableBuilder<VictorOpsConfig,VictorOpsConfigBuilder>{
  ...
  public VictorOpsConfig build() {
    VictorOpsConfig buildable = new VictorOpsConfig(fluent.getApiKey(), fluent.getApiUrl(), fluent.buildCustomFields(), fluent.getEntityDisplayName(), fluent.buildHttpConfig(), fluent.getMessageType(), fluent.getMonitoringTool(), fluent.getRoutingKey(), fluent.getSendResolved(), fluent.getStateMessage());
