...
public class HTTPConfigWithProxyFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.HTTPConfigWithProxyFluent<A>> extends BaseFluent<A>{
  ...
  public HTTPConfigWithProxyFluent() {
  }
  
  public HTTPConfigWithProxyFluent(HTTPConfigWithProxy instance) {
  ...
  protected void copyInstance(HTTPConfigWithProxy instance) {
    instance = instance != null ? instance : new HTTPConfigWithProxy();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    HTTPConfigWithProxyFluent that = (HTTPConfigWithProxyFluent) o;
  ...
  public class AuthorizationNested<N> extends SafeAuthorizationFluent<AuthorizationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithProxyFluent.this.withAuthorization(builder.build());
    }
  ...
  public class BasicAuthNested<N> extends BasicAuthFluent<BasicAuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithProxyFluent.this.withBasicAuth(builder.build());
    }
  ...
  public class Oauth2Nested<N> extends OAuth2Fluent<Oauth2Nested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithProxyFluent.this.withOauth2(builder.build());
    }
  ...
  public class TlsConfigNested<N> extends SafeTLSConfigFluent<TlsConfigNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPConfigWithProxyFluent.this.withTlsConfig(builder.build());
    }
