...
public class ThanosRulerStatusFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.ThanosRulerStatusFluent<A>> extends BaseFluent<A>{
  ...
  public ThanosRulerStatusFluent() {
  }
  
  public ThanosRulerStatusFluent(ThanosRulerStatus instance) {
  ...
  protected void copyInstance(ThanosRulerStatus instance) {
    instance = instance != null ? instance : new ThanosRulerStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ThanosRulerStatusFluent that = (ThanosRulerStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(availableReplicas, conditions, paused, replicas, unavailableReplicas, updatedReplicas, additionalProperties);
  }
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ThanosRulerStatusFluent.this.setToConditions(index, builder.build());
    }
