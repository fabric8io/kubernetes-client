...
public class TimePeriodFluent<A extends io.fabric8.openshift.api.model.monitoring.v1beta1.TimePeriodFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(TimePeriod instance) {
    instance = instance != null ? instance : new TimePeriod();
    if (instance != null) {
  ...
  public class DaysOfMonthNested<N> extends DayOfMonthRangeFluent<DaysOfMonthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TimePeriodFluent.this.setToDaysOfMonth(index, builder.build());
    }
  ...
  public class TimesNested<N> extends TimeRangeFluent<TimesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TimePeriodFluent.this.setToTimes(index, builder.build());
    }
