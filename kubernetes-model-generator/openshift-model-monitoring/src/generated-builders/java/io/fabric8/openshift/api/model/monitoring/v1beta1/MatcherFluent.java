...
public class MatcherFluent<A extends io.fabric8.openshift.api.model.monitoring.v1beta1.MatcherFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(matchType, name, value, additionalProperties);
  }
