...
public class AlertmanagerConfigSpecFluent<A extends io.fabric8.openshift.api.model.monitoring.v1beta1.AlertmanagerConfigSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(inhibitRules, receivers, route, timeIntervals, additionalProperties);
  }
