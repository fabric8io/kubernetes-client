...
public class AuthorizationFluent<A extends io.fabric8.openshift.api.model.monitoring.v1.AuthorizationFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(Authorization instance) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(credentialsFile, that.credentialsFile))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(credentials, credentialsFile, type, additionalProperties);
  }
  ...
  public A withNewCredentials(String key,String name,Boolean optional) {
    return (A) this.withCredentials(new SecretKeySelector(key, name, optional));
  }
