...
public class HTTPRouteFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1beta1.HTTPRouteFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new HTTPRouteSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(HTTPRouteSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new HTTPRouteStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(HTTPRouteStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(HTTPRouteSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(HTTPRouteStatus item) {
    return new StatusNested(item);
  }
  
  public A withSpec(HTTPRouteSpec spec) {
  ...
  public A withStatus(HTTPRouteStatus status) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPRouteFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends HTTPRouteSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPRouteFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends HTTPRouteStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPRouteFluent.this.withStatus(builder.build());
    }
