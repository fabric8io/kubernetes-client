...
public class GatewayFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1beta1.GatewayFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new GatewaySpecBuilder().build()));
  }
  ...
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new GatewayStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(GatewayStatus item) {
  ...
  public StatusNested<A> withNewStatusLike(GatewayStatus item) {
  ...
  public class SpecNested<N> extends GatewaySpecFluent<SpecNested<N>> implements Nested<N>{
  ...
  public class StatusNested<N> extends GatewayStatusFluent<StatusNested<N>> implements Nested<N>{
