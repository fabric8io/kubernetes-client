...
public class TCPRouteStatusFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1alpha2.TCPRouteStatusFluent<A>> extends BaseFluent<A>{
  ...
  public class ParentsNested<N> extends RouteParentStatusFluent<ParentsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TCPRouteStatusFluent.this.setToParents(index, builder.build());
    }
