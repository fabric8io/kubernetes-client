...
public class GatewayInfrastructureFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1.GatewayInfrastructureFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(annotations, labels, parametersRef, additionalProperties);
  }
  ...
  public A withNewParametersRef(String group,String kind,String name) {
    return (A) this.withParametersRef(new LocalParametersReference(group, kind, name));
  }
  ...
  public class ParametersRefNested<N> extends LocalParametersReferenceFluent<ParametersRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GatewayInfrastructureFluent.this.withParametersRef(builder.build());
    }
