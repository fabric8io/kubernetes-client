...
import io.fabric8.kubernetes.api.model.gatewayapi.v1.BackendTLSPolicySpecBuilder;
import io.fabric8.kubernetes.api.model.gatewayapi.v1.BackendTLSPolicySpecFluent;
import io.fabric8.kubernetes.api.model.gatewayapi.v1.PolicyStatus;
import io.fabric8.kubernetes.api.model.gatewayapi.v1.PolicyStatusBuilder;
import io.fabric8.kubernetes.api.model.gatewayapi.v1.PolicyStatusFluent;
...
public class BackendTLSPolicyFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1alpha3.BackendTLSPolicyFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new BackendTLSPolicySpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(BackendTLSPolicySpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new PolicyStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(PolicyStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(BackendTLSPolicySpec item) {
  ...
  public StatusNested<A> withNewStatusLike(PolicyStatus item) {
    return new StatusNested(item);
  }
  
  public A withSpec(BackendTLSPolicySpec spec) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BackendTLSPolicyFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends BackendTLSPolicySpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BackendTLSPolicyFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends PolicyStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BackendTLSPolicyFluent.this.withStatus(builder.build());
    }
