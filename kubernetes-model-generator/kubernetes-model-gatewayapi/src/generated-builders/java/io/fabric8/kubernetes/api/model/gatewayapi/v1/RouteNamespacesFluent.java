...
public class RouteNamespacesFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1.RouteNamespacesFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(from, selector, additionalProperties);
  }
  ...
  public class SelectorNested<N> extends LabelSelectorFluent<SelectorNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RouteNamespacesFluent.this.withSelector(builder.build());
    }
