...
public class GRPCRouteSpecFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1.GRPCRouteSpecFluent<A>> extends BaseFluent<A>{
  ...
  public A addToRules(GRPCRouteRule... items) {
    if (this.rules == null) {
      this.rules = new ArrayList();
    }
    for (GRPCRouteRule item : items) {
  ...
  public A removeFromRules(GRPCRouteRule... items) {
    if (this.rules == null) {
      return (A) this;
    }
    for (GRPCRouteRule item : items) {
  ...
  public A removeMatchingFromRules(Predicate<GRPCRouteRuleBuilder> predicate) {
    ...
    Iterator<GRPCRouteRuleBuilder> each = rules.iterator();
  ...
  public A withRules(GRPCRouteRule... rules) {
    if (this.rules != null) {
        this.rules.clear();
