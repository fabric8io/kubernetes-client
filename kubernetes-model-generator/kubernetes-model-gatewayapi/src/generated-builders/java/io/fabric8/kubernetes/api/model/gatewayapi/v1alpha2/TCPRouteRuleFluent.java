...
public class TCPRouteRuleFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1alpha2.TCPRouteRuleFluent<A>> extends BaseFluent<A>{
  ...
  public class BackendRefsNested<N> extends BackendRefFluent<BackendRefsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TCPRouteRuleFluent.this.setToBackendRefs(index, builder.build());
    }
