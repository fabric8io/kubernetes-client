...
public class BackendRefFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1.BackendRefFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(group, kind, name, namespace, port, weight, additionalProperties);
  }
