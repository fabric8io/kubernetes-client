...
public class UDPRouteRuleFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1alpha2.UDPRouteRuleFluent<A>> extends BaseFluent<A>{
  ...
  public class BackendRefsNested<N> extends BackendRefFluent<BackendRefsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) UDPRouteRuleFluent.this.setToBackendRefs(index, builder.build());
    }
