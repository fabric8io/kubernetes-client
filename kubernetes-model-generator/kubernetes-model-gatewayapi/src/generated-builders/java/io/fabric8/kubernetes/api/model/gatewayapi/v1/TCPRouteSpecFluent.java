...
public class TCPRouteSpecFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1.TCPRouteSpecFluent<A>> extends BaseFluent<A>{
  ...
  public RulesNested<A> addNewRuleLike(TCPRouteRule item) {
  ...
  public TCPRouteRule buildMatchingRule(Predicate<TCPRouteRuleBuilder> predicate) {
      for (TCPRouteRuleBuilder item : rules) {
        if (predicate.test(item)) {
          return item.build();
        }
      }
  ...
  public RulesNested<A> editMatchingRule(Predicate<TCPRouteRuleBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromRules(Predicate<TCPRouteRuleBuilder> predicate) {
    ...
    Iterator<TCPRouteRuleBuilder> each = rules.iterator();
  ...
  public RulesNested<A> setNewRuleLike(int index,TCPRouteRule item) {
  ...
  public class ParentRefsNested<N> extends ParentReferenceFluent<ParentRefsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TCPRouteSpecFluent.this.setToParentRefs(index, builder.build());
    }
  ...
  public class RulesNested<N> extends TCPRouteRuleFluent<RulesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TCPRouteSpecFluent.this.setToRules(index, builder.build());
    }
