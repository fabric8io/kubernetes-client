...
public class GRPCRouteStatusFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1.GRPCRouteStatusFluent<A>> extends BaseFluent<A>{
  ...
  public class ParentsNested<N> extends RouteParentStatusFluent<ParentsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GRPCRouteStatusFluent.this.setToParents(index, builder.build());
    }
