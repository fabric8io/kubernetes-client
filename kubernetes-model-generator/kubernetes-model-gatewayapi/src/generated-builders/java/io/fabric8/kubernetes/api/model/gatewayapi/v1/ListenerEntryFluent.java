...
public class ListenerEntryFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1.ListenerEntryFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(ListenerEntry instance) {
    instance = instance != null ? instance : new ListenerEntry();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ListenerEntryFluent that = (ListenerEntryFluent) o;
  ...
  public class AllowedRoutesNested<N> extends AllowedRoutesFluent<AllowedRoutesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ListenerEntryFluent.this.withAllowedRoutes(builder.build());
    }
  ...
  public class TlsNested<N> extends ListenerTLSConfigFluent<TlsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ListenerEntryFluent.this.withTls(builder.build());
    }
