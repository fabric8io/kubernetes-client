...
public class GatewayListFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1beta1.GatewayListFluent<A>> extends BaseFluent<A>{
  ...
  public ItemsNested<A> addNewItemLike(Gateway item) {
  ...
  public A addToItems(Gateway... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (Gateway item : items) {
  ...
  public A addToItems(int index,Gateway item) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    GatewayBuilder builder = new GatewayBuilder(item);
  ...
  public ItemsNested<A> editMatchingItem(Predicate<GatewayBuilder> predicate) {
    int index = -1;
  ...
  public A removeFromItems(Gateway... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (Gateway item : items) {
  ...
  public A removeMatchingFromItems(Predicate<GatewayBuilder> predicate) {
    ...
    Iterator<GatewayBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,Gateway item) {
    return new ItemsNested(index, item);
  }
  
  public A setToItems(int index,Gateway item) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    GatewayBuilder builder = new GatewayBuilder(item);
  ...
  public A withItems(Gateway... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends GatewayFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GatewayListFluent.this.setToItems(index, builder.build());
    }
