...
public class HTTPRouteStatusFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1.HTTPRouteStatusFluent<A>> extends BaseFluent<A>{
  ...
  public class ParentsNested<N> extends RouteParentStatusFluent<ParentsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HTTPRouteStatusFluent.this.setToParents(index, builder.build());
    }
