...
public class TLSRouteStatusFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1.TLSRouteStatusFluent<A>> extends BaseFluent<A>{
  ...
  public class ParentsNested<N> extends RouteParentStatusFluent<ParentsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TLSRouteStatusFluent.this.setToParents(index, builder.build());
    }
