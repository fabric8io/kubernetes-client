...
public class ListenerEntryStatusFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1.ListenerEntryStatusFluent<A>> extends BaseFluent<A>{
  ...
  public ListenerEntryStatusFluent() {
  }
  
  public ListenerEntryStatusFluent(ListenerEntryStatus instance) {
  ...
  protected void copyInstance(ListenerEntryStatus instance) {
    instance = instance != null ? instance : new ListenerEntryStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ListenerEntryStatusFluent that = (ListenerEntryStatusFluent) o;
  ...
  public class SupportedKindsNested<N> extends RouteGroupKindFluent<SupportedKindsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ListenerEntryStatusFluent.this.setToSupportedKinds(index, builder.build());
    }
