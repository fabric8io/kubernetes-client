...
public class ParentReferenceFluent<A extends io.fabric8.kubernetes.api.model.gatewayapi.v1.ParentReferenceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(group, kind, name, namespace, port, sectionName, additionalProperties);
  }
