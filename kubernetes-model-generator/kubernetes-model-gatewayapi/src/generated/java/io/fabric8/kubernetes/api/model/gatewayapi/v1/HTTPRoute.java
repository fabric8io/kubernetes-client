...
public class HTTPRoute implements Editable<HTTPRouteBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "HTTPRoute(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
