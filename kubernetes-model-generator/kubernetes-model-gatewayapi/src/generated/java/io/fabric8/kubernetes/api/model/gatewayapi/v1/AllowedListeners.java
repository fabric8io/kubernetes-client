...
public class AllowedListeners implements Editable<AllowedListenersBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AllowedListeners)) {
            return false;
        }
        AllowedListeners other = (AllowedListeners) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AllowedListeners;
    }
    ...
    public String toString() {
        return "AllowedListeners(" + "namespaces=" + this.getNamespaces() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
