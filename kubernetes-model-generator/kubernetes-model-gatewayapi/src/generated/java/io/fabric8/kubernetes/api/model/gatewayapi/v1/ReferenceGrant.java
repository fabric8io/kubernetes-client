...
public class ReferenceGrant implements Editable<ReferenceGrantBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReferenceGrant)) {
            return false;
        }
    ...
    public String toString() {
        return "ReferenceGrant(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
