...
public class GRPCRoute implements Editable<GRPCRouteBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "GRPCRoute(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
