...
public class ReferenceGrantTo implements Editable<ReferenceGrantToBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReferenceGrantTo)) {
            return false;
        }
    ...
    public String toString() {
        return "ReferenceGrantTo(" + "group=" + this.getGroup() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
