...
public class ParentGatewayReference implements Editable<ParentGatewayReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ParentGatewayReference)) {
            return false;
        }
        ParentGatewayReference other = (ParentGatewayReference) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ParentGatewayReference;
    }
    ...
    public String toString() {
        return "ParentGatewayReference(" + "group=" + this.getGroup() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
