...
public class Listener implements Editable<ListenerBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "Listener(" + "allowedRoutes=" + this.getAllowedRoutes() + ", hostname=" + this.getHostname() + ", name=" + this.getName() + ", port=" + this.getPort() + ", protocol=" + this.getProtocol() + ", tls=" + this.getTls() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
