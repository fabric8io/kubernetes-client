...
public class ReferenceGrantFrom implements Editable<ReferenceGrantFromBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReferenceGrantFrom)) {
            return false;
        }
    ...
    public String toString() {
        return "ReferenceGrantFrom(" + "group=" + this.getGroup() + ", kind=" + this.getKind() + ", namespace=" + this.getNamespace() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
