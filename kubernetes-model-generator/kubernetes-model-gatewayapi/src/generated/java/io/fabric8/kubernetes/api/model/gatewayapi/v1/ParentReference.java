...
public class ParentReference implements Editable<ParentReferenceBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "ParentReference(" + "group=" + this.getGroup() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", port=" + this.getPort() + ", sectionName=" + this.getSectionName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
