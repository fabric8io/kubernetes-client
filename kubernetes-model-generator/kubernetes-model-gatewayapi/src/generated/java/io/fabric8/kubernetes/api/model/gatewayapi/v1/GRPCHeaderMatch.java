...
public class GRPCHeaderMatch implements Editable<GRPCHeaderMatchBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GRPCHeaderMatch)) {
            return false;
        }
    ...
    public String toString() {
        return "GRPCHeaderMatch(" + "name=" + this.getName() + ", type=" + this.getType() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
