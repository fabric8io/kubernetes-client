...
public class HTTPRouteFilter implements KubernetesResource
{
    ...
    private io.fabric8.kubernetes.api.model.gatewayapi.v1alpha2.LocalObjectReference extensionRef;
     ...
     * @param extensionRef
     */
    public HTTPRouteFilter(io.fabric8.kubernetes.api.model.gatewayapi.v1alpha2.LocalObjectReference extensionRef, HTTPRequestHeaderFilter requestHeaderModifier, HTTPRequestMirrorFilter requestMirror, HTTPRequestRedirectFilter requestRedirect, String type, HTTPURLRewriteFilter urlRewrite) {
        super();
    ...
    @JsonProperty("extensionRef")
    public io.fabric8.kubernetes.api.model.gatewayapi.v1alpha2.LocalObjectReference getExtensionRef() {
        return extensionRef;
    }

    @JsonProperty("extensionRef")
    public void setExtensionRef(io.fabric8.kubernetes.api.model.gatewayapi.v1alpha2.LocalObjectReference extensionRef) {
        this.extensionRef = extensionRef;
    }
