...
public class HTTPQueryParamMatch implements Editable<HTTPQueryParamMatchBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HTTPQueryParamMatch)) {
            return false;
        }
    ...
    public String toString() {
        return "HTTPQueryParamMatch(" + "name=" + this.getName() + ", type=" + this.getType() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
