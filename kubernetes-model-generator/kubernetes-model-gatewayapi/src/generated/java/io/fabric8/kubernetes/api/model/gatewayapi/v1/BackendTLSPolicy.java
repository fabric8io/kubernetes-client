...
public class BackendTLSPolicy implements Editable<BackendTLSPolicyBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BackendTLSPolicy)) {
            return false;
        }
    ...
    public String toString() {
        return "BackendTLSPolicy(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
