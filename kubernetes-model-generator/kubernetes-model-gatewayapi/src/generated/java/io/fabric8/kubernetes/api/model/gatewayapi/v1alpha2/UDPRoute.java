...
public class UDPRoute implements HasMetadata, Namespaced
{
    ...
    public UDPRoute(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, UDPRouteSpec spec, UDPRouteStatus status) {
        super();
