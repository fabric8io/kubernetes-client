...
public class LocalParametersReference implements Editable<LocalParametersReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LocalParametersReference)) {
            return false;
        }
    ...
    public String toString() {
        return "LocalParametersReference(" + "group=" + this.getGroup() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
