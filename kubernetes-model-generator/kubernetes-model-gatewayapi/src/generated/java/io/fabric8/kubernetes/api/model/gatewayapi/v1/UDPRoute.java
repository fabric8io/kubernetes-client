...
public class UDPRoute implements Editable<UDPRouteBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "UDPRoute(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
