...
public class SecretObjectReference implements Editable<SecretObjectReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecretObjectReference)) {
            return false;
        }
    ...
    public String toString() {
        return "SecretObjectReference(" + "group=" + this.getGroup() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
