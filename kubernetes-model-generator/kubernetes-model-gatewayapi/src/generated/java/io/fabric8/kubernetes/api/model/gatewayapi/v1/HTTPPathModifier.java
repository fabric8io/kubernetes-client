...
public class HTTPPathModifier implements Editable<HTTPPathModifierBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HTTPPathModifier)) {
            return false;
        }
        ...
        if (this$replaceFullPath == null ? other$replaceFullPath != null : !this$replaceFullPath.equals(other$replaceFullPath)) {
            return false;
        }
        Object this$replacePrefixMatch = this.getReplacePrefixMatch();
        Object other$replacePrefixMatch = other.getReplacePrefixMatch();
        if (this$replacePrefixMatch == null ? other$replacePrefixMatch != null : !this$replacePrefixMatch.equals(other$replacePrefixMatch)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = result * prime + ($replaceFullPath == null ? 43 : $replaceFullPath.hashCode());
        Object $replacePrefixMatch = this.getReplacePrefixMatch();
        result = result * prime + ($replacePrefixMatch == null ? 43 : $replacePrefixMatch.hashCode());
    ...
    public String toString() {
        return "HTTPPathModifier(" + "replaceFullPath=" + this.getReplaceFullPath() + ", replacePrefixMatch=" + this.getReplacePrefixMatch() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
