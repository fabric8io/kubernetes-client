...
public class GatewayInfrastructure implements Editable<GatewayInfrastructureBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GatewayInfrastructure)) {
            return false;
        }
    ...
    public String toString() {
        return "GatewayInfrastructure(" + "annotations=" + this.getAnnotations() + ", labels=" + this.getLabels() + ", parametersRef=" + this.getParametersRef() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
