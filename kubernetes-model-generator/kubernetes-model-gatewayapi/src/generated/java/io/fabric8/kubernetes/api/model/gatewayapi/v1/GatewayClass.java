...
public class GatewayClass implements Editable<GatewayClassBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "GatewayClass(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
