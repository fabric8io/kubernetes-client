...
public class LocalPolicyTargetReference implements Editable<LocalPolicyTargetReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LocalPolicyTargetReference)) {
            return false;
        }
    ...
    public String toString() {
        return "LocalPolicyTargetReference(" + "group=" + this.getGroup() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
