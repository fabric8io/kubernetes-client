...
public class TCPRoute implements Editable<TCPRouteBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "TCPRoute(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
