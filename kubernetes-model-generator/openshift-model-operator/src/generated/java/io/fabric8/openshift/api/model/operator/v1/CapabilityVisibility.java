...
public class CapabilityVisibility implements Editable<CapabilityVisibilityBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CapabilityVisibility)) {
            return false;
        }
        CapabilityVisibility other = (CapabilityVisibility) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CapabilityVisibility;
    }
    ...
    public String toString() {
        return "CapabilityVisibility(" + "state=" + this.getState() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
