...
public class NetworkSpecDNOKCIpv6 implements Editable<NetworkSpecDNOKCIpv6Builder> , KubernetesResource
{
     ...
     * 
     */
    public NetworkSpecDNOKCIpv6() {
    }

    public NetworkSpecDNOKCIpv6(String internalJoinSubnet, String internalTransitSwitchSubnet) {
        super();
    ...
    @JsonIgnore
    public NetworkSpecDNOKCIpv6Builder edit() {
        return new NetworkSpecDNOKCIpv6Builder(this);
    }

    @JsonIgnore
    public NetworkSpecDNOKCIpv6Builder toBuilder() {
        return edit();
    }
