...
public class OLMSpec implements Editable<OLMSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OLMSpec)) {
            return false;
        }
        OLMSpec other = (OLMSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof OLMSpec;
    }
    ...
    public String toString() {
        return "OLMSpec(" + "logLevel=" + this.getLogLevel() + ", managementState=" + this.getManagementState() + ", observedConfig=" + this.getObservedConfig() + ", operatorLogLevel=" + this.getOperatorLogLevel() + ", unsupportedConfigOverrides=" + this.getUnsupportedConfigOverrides() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
