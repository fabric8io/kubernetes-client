...
public class PodNetworkConnectivityCheckCondition implements Editable<PodNetworkConnectivityCheckConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodNetworkConnectivityCheckCondition)) {
            return false;
        }
        PodNetworkConnectivityCheckCondition other = (PodNetworkConnectivityCheckCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PodNetworkConnectivityCheckCondition;
    }
    ...
    public String toString() {
        return "PodNetworkConnectivityCheckCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
