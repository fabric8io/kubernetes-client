...
public class ConfigSpecSAzureNAInternal implements Editable<ConfigSpecSAzureNAInternalBuilder> , KubernetesResource
{
     ...
     * 
     */
    public ConfigSpecSAzureNAInternal() {
    }

    public ConfigSpecSAzureNAInternal(String networkResourceGroupName, String privateEndpointName, String subnetName, String vnetName) {
        super();
    ...
    @JsonIgnore
    public ConfigSpecSAzureNAInternalBuilder edit() {
        return new ConfigSpecSAzureNAInternalBuilder(this);
    }

    @JsonIgnore
    public ConfigSpecSAzureNAInternalBuilder toBuilder() {
        return edit();
    }
