...
public class EgressRouter implements Editable<EgressRouterBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EgressRouter)) {
            return false;
        }
        EgressRouter other = (EgressRouter) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EgressRouter;
    }
    ...
    public String toString() {
        return "EgressRouter(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
