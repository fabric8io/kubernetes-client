...
public class IngressControllerCaptureHTTPHeader implements Editable<IngressControllerCaptureHTTPHeaderBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IngressControllerCaptureHTTPHeader)) {
            return false;
        }
        IngressControllerCaptureHTTPHeader other = (IngressControllerCaptureHTTPHeader) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IngressControllerCaptureHTTPHeader;
    }
    ...
    public String toString() {
        return "IngressControllerCaptureHTTPHeader(" + "maxLength=" + this.getMaxLength() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
