...
public class S3TrustedCASource implements Editable<S3TrustedCASourceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S3TrustedCASource)) {
            return false;
        }
        S3TrustedCASource other = (S3TrustedCASource) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof S3TrustedCASource;
    }
    ...
    public String toString() {
        return "S3TrustedCASource(" + "name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
