...
public class AzureCSIDriverConfigSpec implements Editable<AzureCSIDriverConfigSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AzureCSIDriverConfigSpec)) {
            return false;
        }
        AzureCSIDriverConfigSpec other = (AzureCSIDriverConfigSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AzureCSIDriverConfigSpec;
    }
    ...
    public String toString() {
        return "AzureCSIDriverConfigSpec(" + "diskEncryptionSet=" + this.getDiskEncryptionSet() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
