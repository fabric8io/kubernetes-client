...
public class OpenShiftControllerManagerSpec implements Editable<OpenShiftControllerManagerSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OpenShiftControllerManagerSpec)) {
            return false;
        }
        OpenShiftControllerManagerSpec other = (OpenShiftControllerManagerSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof OpenShiftControllerManagerSpec;
    }
    ...
    public String toString() {
        return "OpenShiftControllerManagerSpec(" + "logLevel=" + this.getLogLevel() + ", managementState=" + this.getManagementState() + ", observedConfig=" + this.getObservedConfig() + ", operatorLogLevel=" + this.getOperatorLogLevel() + ", unsupportedConfigOverrides=" + this.getUnsupportedConfigOverrides() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
