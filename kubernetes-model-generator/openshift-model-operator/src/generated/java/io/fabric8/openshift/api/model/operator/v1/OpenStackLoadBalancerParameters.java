...
public class OpenStackLoadBalancerParameters implements Editable<OpenStackLoadBalancerParametersBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OpenStackLoadBalancerParameters)) {
            return false;
        }
        OpenStackLoadBalancerParameters other = (OpenStackLoadBalancerParameters) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof OpenStackLoadBalancerParameters;
    }
    ...
    public String toString() {
        return "OpenStackLoadBalancerParameters(" + "floatingIP=" + this.getFloatingIP() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
