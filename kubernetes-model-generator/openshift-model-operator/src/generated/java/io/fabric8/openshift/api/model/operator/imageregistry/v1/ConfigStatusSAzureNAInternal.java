...
public class ConfigStatusSAzureNAInternal implements Editable<ConfigStatusSAzureNAInternalBuilder> , KubernetesResource
{
    ...
    public ConfigStatusSAzureNAInternal(String networkResourceGroupName, String privateEndpointName, String subnetName, String vnetName) {
        super();
    ...
    @JsonIgnore
    public ConfigStatusSAzureNAInternalBuilder edit() {
        return new ConfigStatusSAzureNAInternalBuilder(this);
    }

    @JsonIgnore
    public ConfigStatusSAzureNAInternalBuilder toBuilder() {
        return edit();
    }
