...
public class ReloadService implements Editable<ReloadServiceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReloadService)) {
            return false;
        }
        ReloadService other = (ReloadService) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ReloadService;
    }
    ...
    public String toString() {
        return "ReloadService(" + "serviceName=" + this.getServiceName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
