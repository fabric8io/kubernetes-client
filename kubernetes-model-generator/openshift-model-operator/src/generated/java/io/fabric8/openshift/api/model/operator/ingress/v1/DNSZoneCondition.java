...
public class DNSZoneCondition implements Editable<DNSZoneConditionBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "DNSZoneCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
