...
public class IPv6GatewayConfig implements Editable<IPv6GatewayConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IPv6GatewayConfig)) {
            return false;
        }
        IPv6GatewayConfig other = (IPv6GatewayConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IPv6GatewayConfig;
    }
    ...
    public String toString() {
        return "IPv6GatewayConfig(" + "internalMasqueradeSubnet=" + this.getInternalMasqueradeSubnet() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
