...
public class IngressController implements Editable<IngressControllerBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IngressController)) {
            return false;
        }
        IngressController other = (IngressController) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IngressController;
    }
    ...
    public String toString() {
        return "IngressController(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
