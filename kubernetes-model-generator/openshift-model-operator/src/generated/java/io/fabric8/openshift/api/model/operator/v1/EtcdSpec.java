...
public class EtcdSpec implements Editable<EtcdSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EtcdSpec)) {
            return false;
        }
        EtcdSpec other = (EtcdSpec) o;
        if (!other.canEqual(this)) {
            return false;
        }
        Object this$backendQuotaGiB = this.getBackendQuotaGiB();
        Object other$backendQuotaGiB = other.getBackendQuotaGiB();
        if (this$backendQuotaGiB == null ? other$backendQuotaGiB != null : !this$backendQuotaGiB.equals(other$backendQuotaGiB)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EtcdSpec;
    }
    ...
    public int hashCode() {
        final int prime = 59;
        int result = 1;
        Object $backendQuotaGiB = this.getBackendQuotaGiB();
        result = result * prime + ($backendQuotaGiB == null ? 43 : $backendQuotaGiB.hashCode());
