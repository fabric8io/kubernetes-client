...
public class IBMLoadBalancerParameters implements Editable<IBMLoadBalancerParametersBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IBMLoadBalancerParameters)) {
            return false;
        }
        IBMLoadBalancerParameters other = (IBMLoadBalancerParameters) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IBMLoadBalancerParameters;
    }
    ...
    public String toString() {
        return "IBMLoadBalancerParameters(" + "protocol=" + this.getProtocol() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
