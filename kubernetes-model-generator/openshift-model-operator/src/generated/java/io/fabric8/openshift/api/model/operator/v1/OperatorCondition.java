...
public class OperatorCondition implements Editable<OperatorConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        OperatorCondition other = (OperatorCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof OperatorCondition;
    }
    ...
    public String toString() {
        return "OperatorCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
