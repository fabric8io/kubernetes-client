...
public class InsightsOperatorSpec implements Editable<InsightsOperatorSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InsightsOperatorSpec)) {
            return false;
        }
        InsightsOperatorSpec other = (InsightsOperatorSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof InsightsOperatorSpec;
    }
    ...
    public String toString() {
        return "InsightsOperatorSpec(" + "logLevel=" + this.getLogLevel() + ", managementState=" + this.getManagementState() + ", observedConfig=" + this.getObservedConfig() + ", operatorLogLevel=" + this.getOperatorLogLevel() + ", unsupportedConfigOverrides=" + this.getUnsupportedConfigOverrides() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
