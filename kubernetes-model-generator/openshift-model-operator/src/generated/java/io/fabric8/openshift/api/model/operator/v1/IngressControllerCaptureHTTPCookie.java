...
public class IngressControllerCaptureHTTPCookie implements Editable<IngressControllerCaptureHTTPCookieBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IngressControllerCaptureHTTPCookie)) {
            return false;
        }
        IngressControllerCaptureHTTPCookie other = (IngressControllerCaptureHTTPCookie) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IngressControllerCaptureHTTPCookie;
    }
    ...
    public String toString() {
        return "IngressControllerCaptureHTTPCookie(" + "matchType=" + this.getMatchType() + ", maxLength=" + this.getMaxLength() + ", name=" + this.getName() + ", namePrefix=" + this.getNamePrefix() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
