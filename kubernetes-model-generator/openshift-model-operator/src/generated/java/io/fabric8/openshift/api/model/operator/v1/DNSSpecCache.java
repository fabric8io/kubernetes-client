...
public class DNSSpecCache implements Editable<DNSSpecCacheBuilder> , KubernetesResource
{
    ...
    public DNSSpecCache(String negativeTTL, String positiveTTL) {
        super();
    ...
    @JsonIgnore
    public DNSSpecCacheBuilder edit() {
        return new DNSSpecCacheBuilder(this);
    }

    @JsonIgnore
    public DNSSpecCacheBuilder toBuilder() {
        return edit();
    }
