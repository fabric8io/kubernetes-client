...
public class LoggingDestination implements Editable<LoggingDestinationBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LoggingDestination)) {
            return false;
        }
        LoggingDestination other = (LoggingDestination) o;
        ...
        Object this$syslog = this.getSyslog();
        Object other$syslog = other.getSyslog();
        if (this$syslog == null ? other$syslog != null : !this$syslog.equals(other$syslog)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LoggingDestination;
    }
    ...
    public int hashCode() {
        ...
        Object $syslog = this.getSyslog();
        result = result * prime + ($syslog == null ? 43 : $syslog.hashCode());
    ...
    public String toString() {
        return "LoggingDestination(" + "container=" + this.getContainer() + ", syslog=" + this.getSyslog() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
