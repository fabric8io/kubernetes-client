...
public class KubeStorageVersionMigratorSpec implements Editable<KubeStorageVersionMigratorSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KubeStorageVersionMigratorSpec)) {
            return false;
        }
        KubeStorageVersionMigratorSpec other = (KubeStorageVersionMigratorSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof KubeStorageVersionMigratorSpec;
    }
    ...
    public String toString() {
        return "KubeStorageVersionMigratorSpec(" + "logLevel=" + this.getLogLevel() + ", managementState=" + this.getManagementState() + ", observedConfig=" + this.getObservedConfig() + ", operatorLogLevel=" + this.getOperatorLogLevel() + ", unsupportedConfigOverrides=" + this.getUnsupportedConfigOverrides() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
