...
public class Config implements Editable<ConfigBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "Config(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
