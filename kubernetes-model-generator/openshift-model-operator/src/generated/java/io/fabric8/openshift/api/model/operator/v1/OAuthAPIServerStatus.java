...
public class OAuthAPIServerStatus implements Editable<OAuthAPIServerStatusBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OAuthAPIServerStatus)) {
            return false;
        }
        OAuthAPIServerStatus other = (OAuthAPIServerStatus) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof OAuthAPIServerStatus;
    }
    ...
    public String toString() {
        return "OAuthAPIServerStatus(" + "latestAvailableRevision=" + this.getLatestAvailableRevision() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
