...
public class NodePortStrategy implements Editable<NodePortStrategyBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NodePortStrategy)) {
            return false;
        }
        NodePortStrategy other = (NodePortStrategy) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof NodePortStrategy;
    }
    ...
    public String toString() {
        return "NodePortStrategy(" + "protocol=" + this.getProtocol() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
