...
public class EgressRouterStatusCondition implements Editable<EgressRouterStatusConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EgressRouterStatusCondition)) {
            return false;
        }
        EgressRouterStatusCondition other = (EgressRouterStatusCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EgressRouterStatusCondition;
    }
    ...
    public String toString() {
        return "EgressRouterStatusCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
