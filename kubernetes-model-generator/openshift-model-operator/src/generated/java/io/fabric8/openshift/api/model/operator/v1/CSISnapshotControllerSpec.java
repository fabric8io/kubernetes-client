...
public class CSISnapshotControllerSpec implements Editable<CSISnapshotControllerSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CSISnapshotControllerSpec)) {
            return false;
        }
        CSISnapshotControllerSpec other = (CSISnapshotControllerSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CSISnapshotControllerSpec;
    }
    ...
    public String toString() {
        return "CSISnapshotControllerSpec(" + "logLevel=" + this.getLogLevel() + ", managementState=" + this.getManagementState() + ", observedConfig=" + this.getObservedConfig() + ", operatorLogLevel=" + this.getOperatorLogLevel() + ", unsupportedConfigOverrides=" + this.getUnsupportedConfigOverrides() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
