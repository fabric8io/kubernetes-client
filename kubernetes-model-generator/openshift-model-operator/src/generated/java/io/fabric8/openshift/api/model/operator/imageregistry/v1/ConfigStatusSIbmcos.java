...
public class ConfigStatusSIbmcos implements Editable<ConfigStatusSIbmcosBuilder> , KubernetesResource
{
     ...
     * 
     */
    public ConfigStatusSIbmcos() {
    }

    public ConfigStatusSIbmcos(String bucket, String location, String resourceGroupName, String resourceKeyCRN, String serviceInstanceCRN) {
        super();
        this.bucket = bucket;
    ...
    @JsonIgnore
    public ConfigStatusSIbmcosBuilder edit() {
        return new ConfigStatusSIbmcosBuilder(this);
    }

    @JsonIgnore
    public ConfigStatusSIbmcosBuilder toBuilder() {
        return edit();
    }
