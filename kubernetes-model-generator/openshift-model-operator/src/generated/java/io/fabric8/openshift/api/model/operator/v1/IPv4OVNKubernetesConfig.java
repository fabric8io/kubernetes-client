...
public class IPv4OVNKubernetesConfig implements Editable<IPv4OVNKubernetesConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IPv4OVNKubernetesConfig)) {
            return false;
        }
        IPv4OVNKubernetesConfig other = (IPv4OVNKubernetesConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IPv4OVNKubernetesConfig;
    }
    ...
    public String toString() {
        return "IPv4OVNKubernetesConfig(" + "internalJoinSubnet=" + this.getInternalJoinSubnet() + ", internalTransitSwitchSubnet=" + this.getInternalTransitSwitchSubnet() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
