...
public class OpenShiftAPIServerSpec implements Editable<OpenShiftAPIServerSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OpenShiftAPIServerSpec)) {
            return false;
        }
        OpenShiftAPIServerSpec other = (OpenShiftAPIServerSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof OpenShiftAPIServerSpec;
    }
    ...
    public String toString() {
        return "OpenShiftAPIServerSpec(" + "logLevel=" + this.getLogLevel() + ", managementState=" + this.getManagementState() + ", observedConfig=" + this.getObservedConfig() + ", operatorLogLevel=" + this.getOperatorLogLevel() + ", unsupportedConfigOverrides=" + this.getUnsupportedConfigOverrides() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
