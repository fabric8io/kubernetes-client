...
public class IngressControllerSpecTuningOptions implements Editable<IngressControllerSpecTuningOptionsBuilder> , KubernetesResource
{
     ...
     * 
     */
    public IngressControllerSpecTuningOptions() {
    }

    public IngressControllerSpecTuningOptions(String clientFinTimeout, String clientTimeout, String connectTimeout, Integer headerBufferBytes, Integer headerBufferMaxRewriteBytes, String healthCheckInterval, Integer maxConnections, String reloadInterval, String serverFinTimeout, String serverTimeout, Integer threadCount, String tlsInspectDelay, String tunnelTimeout) {
        super();
    ...
    @JsonIgnore
    public IngressControllerSpecTuningOptionsBuilder edit() {
        return new IngressControllerSpecTuningOptionsBuilder(this);
    }

    @JsonIgnore
    public IngressControllerSpecTuningOptionsBuilder toBuilder() {
        return edit();
    }
