...
public class Console implements Editable<ConsoleBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "Console(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
