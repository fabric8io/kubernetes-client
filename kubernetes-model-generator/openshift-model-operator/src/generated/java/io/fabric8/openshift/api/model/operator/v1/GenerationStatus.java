...
public class GenerationStatus implements Editable<GenerationStatusBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "GenerationStatus(" + "group=" + this.getGroup() + ", hash=" + this.getHash() + ", lastGeneration=" + this.getLastGeneration() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", resource=" + this.getResource() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
