...
public class RestartService implements Editable<RestartServiceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestartService)) {
            return false;
        }
        RestartService other = (RestartService) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RestartService;
    }
    ...
    public String toString() {
        return "RestartService(" + "serviceName=" + this.getServiceName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
