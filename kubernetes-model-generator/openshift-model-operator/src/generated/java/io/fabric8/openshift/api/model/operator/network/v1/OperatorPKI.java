...
public class OperatorPKI implements Editable<OperatorPKIBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OperatorPKI)) {
            return false;
        }
        OperatorPKI other = (OperatorPKI) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof OperatorPKI;
    }
    ...
    public String toString() {
        return "OperatorPKI(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
