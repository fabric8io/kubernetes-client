...
public class EncryptionAlibaba implements Editable<EncryptionAlibabaBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EncryptionAlibaba)) {
            return false;
        }
        EncryptionAlibaba other = (EncryptionAlibaba) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EncryptionAlibaba;
    }
    ...
    public String toString() {
        return "EncryptionAlibaba(" + "kms=" + this.getKms() + ", method=" + this.getMethod() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
