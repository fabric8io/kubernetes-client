...
public class CloudCredentialSpec implements Editable<CloudCredentialSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudCredentialSpec)) {
            return false;
        }
        CloudCredentialSpec other = (CloudCredentialSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CloudCredentialSpec;
    }
    ...
    public String toString() {
        return "CloudCredentialSpec(" + "credentialsMode=" + this.getCredentialsMode() + ", logLevel=" + this.getLogLevel() + ", managementState=" + this.getManagementState() + ", observedConfig=" + this.getObservedConfig() + ", operatorLogLevel=" + this.getOperatorLogLevel() + ", unsupportedConfigOverrides=" + this.getUnsupportedConfigOverrides() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
