...
public class IngressControllerHTTPUniqueIdHeaderPolicy implements Editable<IngressControllerHTTPUniqueIdHeaderPolicyBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IngressControllerHTTPUniqueIdHeaderPolicy)) {
            return false;
        }
        IngressControllerHTTPUniqueIdHeaderPolicy other = (IngressControllerHTTPUniqueIdHeaderPolicy) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IngressControllerHTTPUniqueIdHeaderPolicy;
    }
    ...
    public String toString() {
        return "IngressControllerHTTPUniqueIdHeaderPolicy(" + "format=" + this.getFormat() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
