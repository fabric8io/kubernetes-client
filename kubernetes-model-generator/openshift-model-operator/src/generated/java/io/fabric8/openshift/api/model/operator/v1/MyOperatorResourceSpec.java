...
public class MyOperatorResourceSpec implements Editable<MyOperatorResourceSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyOperatorResourceSpec)) {
            return false;
        }
        MyOperatorResourceSpec other = (MyOperatorResourceSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MyOperatorResourceSpec;
    }
    ...
    public String toString() {
        return "MyOperatorResourceSpec(" + "logLevel=" + this.getLogLevel() + ", managementState=" + this.getManagementState() + ", observedConfig=" + this.getObservedConfig() + ", operatorLogLevel=" + this.getOperatorLogLevel() + ", unsupportedConfigOverrides=" + this.getUnsupportedConfigOverrides() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
