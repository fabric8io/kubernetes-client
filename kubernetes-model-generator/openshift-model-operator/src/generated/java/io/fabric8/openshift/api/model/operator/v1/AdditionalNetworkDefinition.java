...
public class AdditionalNetworkDefinition implements Editable<AdditionalNetworkDefinitionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdditionalNetworkDefinition)) {
            return false;
        }
        AdditionalNetworkDefinition other = (AdditionalNetworkDefinition) o;
        ...
        Object this$rawCNIConfig = this.getRawCNIConfig();
        Object other$rawCNIConfig = other.getRawCNIConfig();
        if (this$rawCNIConfig == null ? other$rawCNIConfig != null : !this$rawCNIConfig.equals(other$rawCNIConfig)) {
            return false;
        }
        Object this$simpleMacvlanConfig = this.getSimpleMacvlanConfig();
        Object other$simpleMacvlanConfig = other.getSimpleMacvlanConfig();
        if (this$simpleMacvlanConfig == null ? other$simpleMacvlanConfig != null : !this$simpleMacvlanConfig.equals(other$simpleMacvlanConfig)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AdditionalNetworkDefinition;
    }
    ...
    public int hashCode() {
        ...
        Object $rawCNIConfig = this.getRawCNIConfig();
        result = result * prime + ($rawCNIConfig == null ? 43 : $rawCNIConfig.hashCode());
        Object $simpleMacvlanConfig = this.getSimpleMacvlanConfig();
        result = result * prime + ($simpleMacvlanConfig == null ? 43 : $simpleMacvlanConfig.hashCode());
    ...
    public String toString() {
        return "AdditionalNetworkDefinition(" + "name=" + this.getName() + ", namespace=" + this.getNamespace() + ", rawCNIConfig=" + this.getRawCNIConfig() + ", simpleMacvlanConfig=" + this.getSimpleMacvlanConfig() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
