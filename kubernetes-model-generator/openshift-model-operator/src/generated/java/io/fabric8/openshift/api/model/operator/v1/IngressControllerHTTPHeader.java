...
public class IngressControllerHTTPHeader implements Editable<IngressControllerHTTPHeaderBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IngressControllerHTTPHeader)) {
            return false;
        }
        IngressControllerHTTPHeader other = (IngressControllerHTTPHeader) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IngressControllerHTTPHeader;
    }
    ...
    public String toString() {
        return "IngressControllerHTTPHeader(" + "action=" + this.getAction() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
