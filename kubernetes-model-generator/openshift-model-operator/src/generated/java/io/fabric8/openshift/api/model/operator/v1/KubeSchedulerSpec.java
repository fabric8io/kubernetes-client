...
public class KubeSchedulerSpec implements KubernetesResource
{
     ...
     */
    public KubeSchedulerSpec(Integer failedRevisionLimit, String forceRedeploymentReason, String logLevel, String managementState, KubernetesResource observedConfig, String operatorLogLevel, Integer succeededRevisionLimit, KubernetesResource unsupportedConfigOverrides) {
        super();
