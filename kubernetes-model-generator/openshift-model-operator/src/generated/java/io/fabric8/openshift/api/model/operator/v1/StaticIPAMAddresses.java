...
public class StaticIPAMAddresses implements Editable<StaticIPAMAddressesBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StaticIPAMAddresses)) {
            return false;
        }
        StaticIPAMAddresses other = (StaticIPAMAddresses) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof StaticIPAMAddresses;
    }
    ...
    public String toString() {
        return "StaticIPAMAddresses(" + "address=" + this.getAddress() + ", gateway=" + this.getGateway() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
