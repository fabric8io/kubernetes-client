...
public class NetworkSpecKubeProxyConfig implements Editable<NetworkSpecKubeProxyConfigBuilder> , KubernetesResource
{
     ...
     * 
     */
    public NetworkSpecKubeProxyConfig() {
    }

    public NetworkSpecKubeProxyConfig(String bindAddress, String iptablesSyncPeriod, Map<String, List<String>> proxyArguments) {
        super();
    ...
    @JsonIgnore
    public NetworkSpecKubeProxyConfigBuilder edit() {
        return new NetworkSpecKubeProxyConfigBuilder(this);
    }

    @JsonIgnore
    public NetworkSpecKubeProxyConfigBuilder toBuilder() {
        return edit();
    }
