...
public class ConfigSpecRRead implements Editable<ConfigSpecRReadBuilder> , KubernetesResource
{
     ...
     * 
     */
    public ConfigSpecRRead() {
    }

    public ConfigSpecRRead(Integer maxInQueue, Integer maxRunning, String maxWaitInQueue) {
        super();
    ...
    @JsonIgnore
    public ConfigSpecRReadBuilder edit() {
        return new ConfigSpecRReadBuilder(this);
    }

    @JsonIgnore
    public ConfigSpecRReadBuilder toBuilder() {
        return edit();
    }
