...
public class ServiceCASpec implements Editable<ServiceCASpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ServiceCASpec)) {
            return false;
        }
        ServiceCASpec other = (ServiceCASpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ServiceCASpec;
    }
    ...
    public String toString() {
        return "ServiceCASpec(" + "logLevel=" + this.getLogLevel() + ", managementState=" + this.getManagementState() + ", observedConfig=" + this.getObservedConfig() + ", operatorLogLevel=" + this.getOperatorLogLevel() + ", unsupportedConfigOverrides=" + this.getUnsupportedConfigOverrides() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
