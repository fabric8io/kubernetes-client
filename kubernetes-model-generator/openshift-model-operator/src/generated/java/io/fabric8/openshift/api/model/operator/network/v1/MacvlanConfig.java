...
public class MacvlanConfig implements Editable<MacvlanConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MacvlanConfig)) {
            return false;
        }
        MacvlanConfig other = (MacvlanConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MacvlanConfig;
    }
    ...
    public String toString() {
        return "MacvlanConfig(" + "master=" + this.getMaster() + ", mode=" + this.getMode() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
