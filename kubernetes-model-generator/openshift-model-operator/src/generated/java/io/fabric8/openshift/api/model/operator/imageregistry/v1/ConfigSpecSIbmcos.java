...
public class ConfigSpecSIbmcos implements Editable<ConfigSpecSIbmcosBuilder> , KubernetesResource
{
     ...
     * 
     */
    public ConfigSpecSIbmcos() {
    }

    public ConfigSpecSIbmcos(String bucket, String location, String resourceGroupName, String resourceKeyCRN, String serviceInstanceCRN) {
        super();
        this.bucket = bucket;
    ...
    @JsonIgnore
    public ConfigSpecSIbmcosBuilder edit() {
        return new ConfigSpecSIbmcosBuilder(this);
    }

    @JsonIgnore
    public ConfigSpecSIbmcosBuilder toBuilder() {
        return edit();
    }
