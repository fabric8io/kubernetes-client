...
public class IPv4GatewayConfig implements Editable<IPv4GatewayConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IPv4GatewayConfig)) {
            return false;
        }
        IPv4GatewayConfig other = (IPv4GatewayConfig) o;
        if (!other.canEqual(this)) {
            return false;
        }
        Object this$internalMasqueradeSubnet = this.getInternalMasqueradeSubnet();
        Object other$internalMasqueradeSubnet = other.getInternalMasqueradeSubnet();
        if (this$internalMasqueradeSubnet == null ? other$internalMasqueradeSubnet != null : !this$internalMasqueradeSubnet.equals(other$internalMasqueradeSubnet)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IPv4GatewayConfig;
    }
    ...
    public int hashCode() {
        final int prime = 59;
        int result = 1;
        Object $internalMasqueradeSubnet = this.getInternalMasqueradeSubnet();
        result = result * prime + ($internalMasqueradeSubnet == null ? 43 : $internalMasqueradeSubnet.hashCode());
    ...
    public String toString() {
        return "IPv4GatewayConfig(" + "internalMasqueradeSubnet=" + this.getInternalMasqueradeSubnet() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
