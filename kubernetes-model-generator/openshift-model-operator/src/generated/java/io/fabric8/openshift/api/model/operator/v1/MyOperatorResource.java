...
public class MyOperatorResource implements Editable<MyOperatorResourceBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyOperatorResource)) {
            return false;
        }
        MyOperatorResource other = (MyOperatorResource) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MyOperatorResource;
    }
    ...
    public String toString() {
        return "MyOperatorResource(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
