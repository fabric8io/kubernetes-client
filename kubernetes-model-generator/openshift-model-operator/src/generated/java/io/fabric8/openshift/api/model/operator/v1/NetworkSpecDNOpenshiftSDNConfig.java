...
public class NetworkSpecDNOpenshiftSDNConfig implements Editable<NetworkSpecDNOpenshiftSDNConfigBuilder> , KubernetesResource
{
     ...
     * 
     */
    public NetworkSpecDNOpenshiftSDNConfig() {
    }

    public NetworkSpecDNOpenshiftSDNConfig(Boolean enableUnidling, String mode, Integer mtu, Boolean useExternalOpenvswitch, Integer vxlanPort) {
        super();
    ...
    @JsonIgnore
    public NetworkSpecDNOpenshiftSDNConfigBuilder edit() {
        return new NetworkSpecDNOpenshiftSDNConfigBuilder(this);
    }

    @JsonIgnore
    public NetworkSpecDNOpenshiftSDNConfigBuilder toBuilder() {
        return edit();
    }
