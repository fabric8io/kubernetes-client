...
public class ClusterVersionOperatorSpec implements Editable<ClusterVersionOperatorSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterVersionOperatorSpec)) {
            return false;
        }
        ClusterVersionOperatorSpec other = (ClusterVersionOperatorSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClusterVersionOperatorSpec;
    }
    ...
    public String toString() {
        return "ClusterVersionOperatorSpec(" + "operatorLogLevel=" + this.getOperatorLogLevel() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
