...
public class ProviderLoadBalancerParameters implements Editable<ProviderLoadBalancerParametersBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProviderLoadBalancerParameters)) {
            return false;
        }
        ProviderLoadBalancerParameters other = (ProviderLoadBalancerParameters) o;
        ...
        Object this$ibm = this.getIbm();
        Object other$ibm = other.getIbm();
        if (this$ibm == null ? other$ibm != null : !this$ibm.equals(other$ibm)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ProviderLoadBalancerParameters;
    }
    ...
    public int hashCode() {
        ...
        Object $ibm = this.getIbm();
        result = result * prime + ($ibm == null ? 43 : $ibm.hashCode());
    ...
    public String toString() {
        return "ProviderLoadBalancerParameters(" + "aws=" + this.getAws() + ", gcp=" + this.getGcp() + ", ibm=" + this.getIbm() + ", openstack=" + this.getOpenstack() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
