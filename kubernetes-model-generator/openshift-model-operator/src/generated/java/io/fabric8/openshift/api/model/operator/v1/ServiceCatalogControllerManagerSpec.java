...
public class ServiceCatalogControllerManagerSpec implements Editable<ServiceCatalogControllerManagerSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ServiceCatalogControllerManagerSpec)) {
            return false;
        }
        ServiceCatalogControllerManagerSpec other = (ServiceCatalogControllerManagerSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ServiceCatalogControllerManagerSpec;
    }
    ...
    public String toString() {
        return "ServiceCatalogControllerManagerSpec(" + "logLevel=" + this.getLogLevel() + ", managementState=" + this.getManagementState() + ", observedConfig=" + this.getObservedConfig() + ", operatorLogLevel=" + this.getOperatorLogLevel() + ", unsupportedConfigOverrides=" + this.getUnsupportedConfigOverrides() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
