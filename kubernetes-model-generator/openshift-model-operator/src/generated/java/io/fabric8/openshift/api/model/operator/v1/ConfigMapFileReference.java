...
public class ConfigMapFileReference implements Editable<ConfigMapFileReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigMapFileReference)) {
            return false;
        }
        ConfigMapFileReference other = (ConfigMapFileReference) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ConfigMapFileReference;
    }
    ...
    public String toString() {
        return "ConfigMapFileReference(" + "key=" + this.getKey() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
