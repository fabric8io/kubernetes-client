...
public class CertSpec implements Editable<CertSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CertSpec)) {
            return false;
        }
        CertSpec other = (CertSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CertSpec;
    }
    ...
    public String toString() {
        return "CertSpec(" + "commonName=" + this.getCommonName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
