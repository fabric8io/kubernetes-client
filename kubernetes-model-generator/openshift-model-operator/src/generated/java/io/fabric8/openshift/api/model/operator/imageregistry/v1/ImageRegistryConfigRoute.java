...
public class ImageRegistryConfigRoute implements Editable<ImageRegistryConfigRouteBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImageRegistryConfigRoute)) {
            return false;
        }
        ImageRegistryConfigRoute other = (ImageRegistryConfigRoute) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ImageRegistryConfigRoute;
    }
    ...
    public String toString() {
        return "ImageRegistryConfigRoute(" + "hostname=" + this.getHostname() + ", name=" + this.getName() + ", secretName=" + this.getSecretName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
