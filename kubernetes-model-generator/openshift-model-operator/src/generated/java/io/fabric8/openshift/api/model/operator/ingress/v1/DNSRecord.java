...
public class DNSRecord implements Editable<DNSRecordBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "DNSRecord(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
