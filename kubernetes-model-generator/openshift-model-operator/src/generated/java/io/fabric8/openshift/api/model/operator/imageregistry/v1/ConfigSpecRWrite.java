...
public class ConfigSpecRWrite implements Editable<ConfigSpecRWriteBuilder> , KubernetesResource
{
    ...
    public ConfigSpecRWrite(Integer maxInQueue, Integer maxRunning, String maxWaitInQueue) {
        super();
    ...
    @JsonIgnore
    public ConfigSpecRWriteBuilder edit() {
        return new ConfigSpecRWriteBuilder(this);
    }

    @JsonIgnore
    public ConfigSpecRWriteBuilder toBuilder() {
        return edit();
    }
