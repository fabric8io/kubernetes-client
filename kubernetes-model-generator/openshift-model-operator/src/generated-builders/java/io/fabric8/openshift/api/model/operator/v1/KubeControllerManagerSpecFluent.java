...
public class KubeControllerManagerSpecFluent<A extends io.fabric8.openshift.api.model.operator.v1.KubeControllerManagerSpecFluent<A>> extends BaseFluent<A>{
  ...
  public KubeControllerManagerSpecFluent(KubeControllerManagerSpec instance) {
  ...
  protected void copyInstance(KubeControllerManagerSpec instance) {
    instance = instance != null ? instance : new KubeControllerManagerSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    KubeControllerManagerSpecFluent that = (KubeControllerManagerSpecFluent) o;
    ...
    if (!(Objects.equals(useMoreSecureServiceCA, that.useMoreSecureServiceCA))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(failedRevisionLimit, forceRedeploymentReason, logLevel, managementState, observedConfig, operatorLogLevel, succeededRevisionLimit, unsupportedConfigOverrides, useMoreSecureServiceCA, additionalProperties);
  }
  ...
  public String toString() {
    ...
    if (!(useMoreSecureServiceCA == null)) {
  ...
  public A withUseMoreSecureServiceCA(Boolean useMoreSecureServiceCA) {
