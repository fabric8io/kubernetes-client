...
public class KubeSchedulerListFluent<A extends io.fabric8.openshift.api.model.operator.v1.KubeSchedulerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<KubeSchedulerBuilder> items = new ArrayList<KubeSchedulerBuilder>();
  private String kind;
  private ListMeta metadata;

  public KubeSchedulerListFluent() {
  }
  
  public KubeSchedulerListFluent(KubeSchedulerList instance) {
  ...
  public A addAllToItems(Collection<KubeScheduler> items) {
    ...
    for (KubeScheduler item : items) {
        KubeSchedulerBuilder builder = new KubeSchedulerBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(KubeScheduler item) {
  ...
  public KubeScheduler buildMatchingItem(Predicate<KubeSchedulerBuilder> predicate) {
      for (KubeSchedulerBuilder item : items) {
  ...
  protected void copyInstance(KubeSchedulerList instance) {
    instance = instance != null ? instance : new KubeSchedulerList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<KubeSchedulerBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    KubeSchedulerListFluent that = (KubeSchedulerListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<KubeSchedulerBuilder> predicate) {
    ...
    Iterator<KubeSchedulerBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        KubeSchedulerBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,KubeScheduler item) {
  ...
  public class ItemsNested<N> extends KubeSchedulerFluent<ItemsNested<N>> implements Nested<N>{
  
    KubeSchedulerBuilder builder;
    int index;
  
    ItemsNested(int index,KubeScheduler item) {
      this.index = index;
      this.builder = new KubeSchedulerBuilder(this, item);
    }
  
    public N and() {
      return (N) KubeSchedulerListFluent.this.setToItems(index, builder.build());
    }
