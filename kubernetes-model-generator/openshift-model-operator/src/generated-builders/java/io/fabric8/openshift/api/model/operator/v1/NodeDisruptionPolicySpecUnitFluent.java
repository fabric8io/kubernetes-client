...
public class NodeDisruptionPolicySpecUnitFluent<A extends io.fabric8.openshift.api.model.operator.v1.NodeDisruptionPolicySpecUnitFluent<A>> extends BaseFluent<A>{
  ...
  public NodeDisruptionPolicySpecUnitFluent() {
  }
  
  public NodeDisruptionPolicySpecUnitFluent(NodeDisruptionPolicySpecUnit instance) {
  ...
  protected void copyInstance(NodeDisruptionPolicySpecUnit instance) {
    instance = instance != null ? instance : new NodeDisruptionPolicySpecUnit();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    NodeDisruptionPolicySpecUnitFluent that = (NodeDisruptionPolicySpecUnitFluent) o;
  ...
  public class ActionsNested<N> extends NodeDisruptionPolicySpecActionFluent<ActionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NodeDisruptionPolicySpecUnitFluent.this.setToActions(index, builder.build());
    }
