...
public class OpenShiftControllerManagerStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.OpenShiftControllerManagerStatusFluent<A>> extends BaseFluent<A>{
  ...
  public OpenShiftControllerManagerStatusFluent() {
  }
  
  public OpenShiftControllerManagerStatusFluent(OpenShiftControllerManagerStatus instance) {
  ...
  protected void copyInstance(OpenShiftControllerManagerStatus instance) {
    instance = instance != null ? instance : new OpenShiftControllerManagerStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    OpenShiftControllerManagerStatusFluent that = (OpenShiftControllerManagerStatusFluent) o;
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) OpenShiftControllerManagerStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) OpenShiftControllerManagerStatusFluent.this.setToGenerations(index, builder.build());
    }
