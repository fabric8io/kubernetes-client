...
import io.fabric8.openshift.api.model.operator.v1.GenerationStatusBuilder;
...
public class ImageRegistryStatusFluent<A extends io.fabric8.openshift.api.model.operator.imageregistry.v1.ImageRegistryStatusFluent<A>> extends BaseFluent<A>{
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(storageManaged, that.storageManaged))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(conditions, generations, latestAvailableRevision, observedGeneration, readyReplicas, storage, storageManaged, version, additionalProperties);
  }
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ImageRegistryStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ImageRegistryStatusFluent.this.setToGenerations(index, builder.build());
    }
  ...
  public class StorageNested<N> extends ImageRegistryConfigStorageFluent<StorageNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ImageRegistryStatusFluent.this.withStorage(builder.build());
    }
