...
public class StorageStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.StorageStatusFluent<A>> extends BaseFluent<A>{
  ...
  public StorageStatusFluent() {
  }
  
  public StorageStatusFluent(StorageStatus instance) {
  ...
  protected void copyInstance(StorageStatus instance) {
    instance = instance != null ? instance : new StorageStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    StorageStatusFluent that = (StorageStatusFluent) o;
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StorageStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StorageStatusFluent.this.setToGenerations(index, builder.build());
    }
