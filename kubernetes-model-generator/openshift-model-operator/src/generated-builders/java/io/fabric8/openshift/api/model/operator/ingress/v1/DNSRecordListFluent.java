...
public class DNSRecordListFluent<A extends io.fabric8.openshift.api.model.operator.ingress.v1.DNSRecordListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<DNSRecordBuilder> items = new ArrayList<DNSRecordBuilder>();
  private String kind;
  private ListMeta metadata;

  public DNSRecordListFluent() {
  }
  
  public DNSRecordListFluent(DNSRecordList instance) {
  ...
  public A addAllToItems(Collection<DNSRecord> items) {
    ...
    for (DNSRecord item : items) {
        DNSRecordBuilder builder = new DNSRecordBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(DNSRecord item) {
  ...
  public DNSRecord buildMatchingItem(Predicate<DNSRecordBuilder> predicate) {
      for (DNSRecordBuilder item : items) {
  ...
  protected void copyInstance(DNSRecordList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<DNSRecordBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    DNSRecordListFluent that = (DNSRecordListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<DNSRecordBuilder> predicate) {
    ...
    Iterator<DNSRecordBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        DNSRecordBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,DNSRecord item) {
  ...
  public class ItemsNested<N> extends DNSRecordFluent<ItemsNested<N>> implements Nested<N>{
  
    DNSRecordBuilder builder;
    int index;
  
    ItemsNested(int index,DNSRecord item) {
      this.index = index;
      this.builder = new DNSRecordBuilder(this, item);
    }
  
    public N and() {
      return (N) DNSRecordListFluent.this.setToItems(index, builder.build());
    }
