...
public class CSISnapshotControllerStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.CSISnapshotControllerStatusFluent<A>> extends BaseFluent<A>{
  ...
  public CSISnapshotControllerStatusFluent() {
  }
  
  public CSISnapshotControllerStatusFluent(CSISnapshotControllerStatus instance) {
  ...
  protected void copyInstance(CSISnapshotControllerStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    CSISnapshotControllerStatusFluent that = (CSISnapshotControllerStatusFluent) o;
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CSISnapshotControllerStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CSISnapshotControllerStatusFluent.this.setToGenerations(index, builder.build());
    }
