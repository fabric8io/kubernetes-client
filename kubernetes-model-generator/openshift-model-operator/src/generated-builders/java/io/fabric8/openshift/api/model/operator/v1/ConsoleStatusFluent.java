...
public class ConsoleStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.ConsoleStatusFluent<A>> extends BaseFluent<A>{
  ...
  public ConsoleStatusFluent() {
  }
  
  public ConsoleStatusFluent(ConsoleStatus instance) {
  ...
  protected void copyInstance(ConsoleStatus instance) {
    instance = instance != null ? instance : new ConsoleStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ConsoleStatusFluent that = (ConsoleStatusFluent) o;
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ConsoleStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ConsoleStatusFluent.this.setToGenerations(index, builder.build());
    }
