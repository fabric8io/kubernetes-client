...
public class NetworkListFluent<A extends io.fabric8.openshift.api.model.operator.v1.NetworkListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<NetworkBuilder> items = new ArrayList<NetworkBuilder>();
  private String kind;
  private ListMeta metadata;

  public NetworkListFluent() {
  }
  
  public NetworkListFluent(NetworkList instance) {
  ...
  public ItemsNested<A> addNewItemLike(Network item) {
  ...
  protected void copyInstance(NetworkList instance) {
    instance = instance != null ? instance : new NetworkList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<NetworkBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    NetworkListFluent that = (NetworkListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<NetworkBuilder> predicate) {
    ...
    Iterator<NetworkBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,Network item) {
  ...
  public class ItemsNested<N> extends NetworkFluent<ItemsNested<N>> implements Nested<N>{
  
    NetworkBuilder builder;
    int index;
  
    ItemsNested(int index,Network item) {
      this.index = index;
      this.builder = new NetworkBuilder(this, item);
    }
  
    public N and() {
      return (N) NetworkListFluent.this.setToItems(index, builder.build());
    }
