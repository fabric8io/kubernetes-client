...
public class NodeDisruptionPolicyStatusFileFluent<A extends io.fabric8.openshift.api.model.operator.v1.NodeDisruptionPolicyStatusFileFluent<A>> extends BaseFluent<A>{
  ...
  public NodeDisruptionPolicyStatusFileFluent() {
  }
  
  public NodeDisruptionPolicyStatusFileFluent(NodeDisruptionPolicyStatusFile instance) {
  ...
  protected void copyInstance(NodeDisruptionPolicyStatusFile instance) {
    instance = instance != null ? instance : new NodeDisruptionPolicyStatusFile();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    NodeDisruptionPolicyStatusFileFluent that = (NodeDisruptionPolicyStatusFileFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(actions, path, additionalProperties);
  }
  ...
  public class ActionsNested<N> extends NodeDisruptionPolicyStatusActionFluent<ActionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NodeDisruptionPolicyStatusFileFluent.this.setToActions(index, builder.build());
    }
