...
public class DNSFluent<A extends io.fabric8.openshift.api.model.operator.v1.DNSFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new DNSSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(DNSSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new DNSStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(DNSStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(DNSSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(DNSStatus item) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DNSFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends DNSSpecFluent<SpecNested<N>> implements Nested<N>{
  
    DNSSpecBuilder builder;
  
    SpecNested(DNSSpec item) {
      this.builder = new DNSSpecBuilder(this, item);
    }
  
    public N and() {
      return (N) DNSFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends DNSStatusFluent<StatusNested<N>> implements Nested<N>{
  
    DNSStatusBuilder builder;
  
    StatusNested(DNSStatus item) {
      this.builder = new DNSStatusBuilder(this, item);
    }
  
    public N and() {
      return (N) DNSFluent.this.withStatus(builder.build());
    }
