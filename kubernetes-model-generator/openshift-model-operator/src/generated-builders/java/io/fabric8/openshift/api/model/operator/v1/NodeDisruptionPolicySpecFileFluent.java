...
public class NodeDisruptionPolicySpecFileFluent<A extends io.fabric8.openshift.api.model.operator.v1.NodeDisruptionPolicySpecFileFluent<A>> extends BaseFluent<A>{
  ...
  public NodeDisruptionPolicySpecFileFluent(NodeDisruptionPolicySpecFile instance) {
  ...
  protected void copyInstance(NodeDisruptionPolicySpecFile instance) {
    instance = instance != null ? instance : new NodeDisruptionPolicySpecFile();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    NodeDisruptionPolicySpecFileFluent that = (NodeDisruptionPolicySpecFileFluent) o;
  ...
  public class ActionsNested<N> extends NodeDisruptionPolicySpecActionFluent<ActionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NodeDisruptionPolicySpecFileFluent.this.setToActions(index, builder.build());
    }
