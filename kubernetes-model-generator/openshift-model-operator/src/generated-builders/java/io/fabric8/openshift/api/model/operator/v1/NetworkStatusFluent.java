...
public class NetworkStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.NetworkStatusFluent<A>> extends BaseFluent<A>{
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NetworkStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NetworkStatusFluent.this.setToGenerations(index, builder.build());
    }
