...
public class ImageContentSourcePolicySpecFluent<A extends io.fabric8.openshift.api.model.operator.v1alpha1.ImageContentSourcePolicySpecFluent<A>> extends BaseFluent<A>{
  ...
  public ImageContentSourcePolicySpecFluent() {
  }
  
  public ImageContentSourcePolicySpecFluent(ImageContentSourcePolicySpec instance) {
  ...
  protected void copyInstance(ImageContentSourcePolicySpec instance) {
    instance = instance != null ? instance : new ImageContentSourcePolicySpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ImageContentSourcePolicySpecFluent that = (ImageContentSourcePolicySpecFluent) o;
  ...
  public class RepositoryDigestMirrorsNested<N> extends RepositoryDigestMirrorsFluent<RepositoryDigestMirrorsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ImageContentSourcePolicySpecFluent.this.setToRepositoryDigestMirrors(index, builder.build());
    }
