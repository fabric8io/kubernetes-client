...
public class DNSStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.DNSStatusFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(clusterDomain, clusterIP, conditions, additionalProperties);
  }
