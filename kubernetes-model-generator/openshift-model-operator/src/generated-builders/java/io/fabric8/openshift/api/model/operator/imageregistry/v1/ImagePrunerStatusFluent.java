...
public class ImagePrunerStatusFluent<A extends io.fabric8.openshift.api.model.operator.imageregistry.v1.ImagePrunerStatusFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private ArrayList<OperatorConditionBuilder> conditions = new ArrayList<OperatorConditionBuilder>();
  private Long observedGeneration;

  public ImagePrunerStatusFluent() {
  }
  
  public ImagePrunerStatusFluent(ImagePrunerStatus instance) {
  ...
  protected void copyInstance(ImagePrunerStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    ImagePrunerStatusFluent that = (ImagePrunerStatusFluent) o;
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ImagePrunerStatusFluent.this.setToConditions(index, builder.build());
    }
