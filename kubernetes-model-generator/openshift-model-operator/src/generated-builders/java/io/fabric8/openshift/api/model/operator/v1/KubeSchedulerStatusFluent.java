...
public class KubeSchedulerStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.KubeSchedulerStatusFluent<A>> extends BaseFluent<A>{
  ...
  public KubeSchedulerStatusFluent() {
  }
  
  public KubeSchedulerStatusFluent(KubeSchedulerStatus instance) {
  ...
  protected void copyInstance(KubeSchedulerStatus instance) {
    instance = instance != null ? instance : new KubeSchedulerStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    KubeSchedulerStatusFluent that = (KubeSchedulerStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(conditions, generations, latestAvailableRevision, latestAvailableRevisionReason, nodeStatuses, observedGeneration, readyReplicas, version, additionalProperties);
  }
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KubeSchedulerStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KubeSchedulerStatusFluent.this.setToGenerations(index, builder.build());
    }
  ...
  public class NodeStatusesNested<N> extends NodeStatusFluent<NodeStatusesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KubeSchedulerStatusFluent.this.setToNodeStatuses(index, builder.build());
    }
