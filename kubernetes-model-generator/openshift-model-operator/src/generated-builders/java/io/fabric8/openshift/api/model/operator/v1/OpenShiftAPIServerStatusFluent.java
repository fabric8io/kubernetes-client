...
public class OpenShiftAPIServerStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.OpenShiftAPIServerStatusFluent<A>> extends BaseFluent<A>{
  ...
  public OpenShiftAPIServerStatusFluent() {
  }
  
  public OpenShiftAPIServerStatusFluent(OpenShiftAPIServerStatus instance) {
  ...
  protected void copyInstance(OpenShiftAPIServerStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    OpenShiftAPIServerStatusFluent that = (OpenShiftAPIServerStatusFluent) o;
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) OpenShiftAPIServerStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) OpenShiftAPIServerStatusFluent.this.setToGenerations(index, builder.build());
    }
