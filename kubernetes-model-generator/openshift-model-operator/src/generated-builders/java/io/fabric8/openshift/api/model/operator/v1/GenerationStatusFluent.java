...
public class GenerationStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.GenerationStatusFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(group, hash, lastGeneration, name, namespace, resource, additionalProperties);
  }
