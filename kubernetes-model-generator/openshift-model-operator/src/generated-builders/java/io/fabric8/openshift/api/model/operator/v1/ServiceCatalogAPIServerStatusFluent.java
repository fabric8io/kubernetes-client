...
public class ServiceCatalogAPIServerStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.ServiceCatalogAPIServerStatusFluent<A>> extends BaseFluent<A>{
  ...
  public ServiceCatalogAPIServerStatusFluent() {
  }
  
  public ServiceCatalogAPIServerStatusFluent(ServiceCatalogAPIServerStatus instance) {
  ...
  protected void copyInstance(ServiceCatalogAPIServerStatus instance) {
    instance = instance != null ? instance : new ServiceCatalogAPIServerStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceCatalogAPIServerStatusFluent that = (ServiceCatalogAPIServerStatusFluent) o;
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceCatalogAPIServerStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceCatalogAPIServerStatusFluent.this.setToGenerations(index, builder.build());
    }
