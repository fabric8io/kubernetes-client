...
public class AuthenticationListFluent<A extends io.fabric8.openshift.api.model.operator.v1.AuthenticationListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<AuthenticationBuilder> items = new ArrayList<AuthenticationBuilder>();
  private String kind;
  private ListMeta metadata;

  public AuthenticationListFluent() {
  }
  
  public AuthenticationListFluent(AuthenticationList instance) {
  ...
  public A addAllToItems(Collection<Authentication> items) {
    ...
    for (Authentication item : items) {
        AuthenticationBuilder builder = new AuthenticationBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(Authentication item) {
  ...
  public Authentication buildMatchingItem(Predicate<AuthenticationBuilder> predicate) {
      for (AuthenticationBuilder item : items) {
  ...
  protected void copyInstance(AuthenticationList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<AuthenticationBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    AuthenticationListFluent that = (AuthenticationListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<AuthenticationBuilder> predicate) {
    ...
    Iterator<AuthenticationBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        AuthenticationBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Authentication item) {
  ...
  public class ItemsNested<N> extends AuthenticationFluent<ItemsNested<N>> implements Nested<N>{
  
    AuthenticationBuilder builder;
    int index;
  
    ItemsNested(int index,Authentication item) {
      this.index = index;
      this.builder = new AuthenticationBuilder(this, item);
    }
  
    public N and() {
      return (N) AuthenticationListFluent.this.setToItems(index, builder.build());
    }
