...
public class CloudCredentialStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.CloudCredentialStatusFluent<A>> extends BaseFluent<A>{
  ...
  public CloudCredentialStatusFluent() {
  }
  
  public CloudCredentialStatusFluent(CloudCredentialStatus instance) {
  ...
  protected void copyInstance(CloudCredentialStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    CloudCredentialStatusFluent that = (CloudCredentialStatusFluent) o;
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CloudCredentialStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CloudCredentialStatusFluent.this.setToGenerations(index, builder.build());
    }
