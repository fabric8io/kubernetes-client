...
public class ClusterAPIInstallerComponentFluent<A extends io.fabric8.openshift.api.model.operator.v1alpha1.ClusterAPIInstallerComponentFluent<A>> extends BaseFluent<A>{
  ...
  public ClusterAPIInstallerComponentFluent() {
  }
  
  public ClusterAPIInstallerComponentFluent(ClusterAPIInstallerComponent instance) {
  ...
  protected void copyInstance(ClusterAPIInstallerComponent instance) {
    instance = instance != null ? instance : new ClusterAPIInstallerComponent();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ClusterAPIInstallerComponentFluent that = (ClusterAPIInstallerComponentFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(image, name, type, additionalProperties);
  }
  ...
  public class ImageNested<N> extends ClusterAPIInstallerComponentImageFluent<ImageNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ClusterAPIInstallerComponentFluent.this.withImage(builder.build());
    }
