...
public class ServiceCatalogAPIServerListFluent<A extends io.fabric8.openshift.api.model.operator.v1.ServiceCatalogAPIServerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ServiceCatalogAPIServerBuilder> items = new ArrayList<ServiceCatalogAPIServerBuilder>();
  private String kind;
  private ListMeta metadata;

  public ServiceCatalogAPIServerListFluent() {
  }
  
  public ServiceCatalogAPIServerListFluent(ServiceCatalogAPIServerList instance) {
  ...
  public A addAllToItems(Collection<ServiceCatalogAPIServer> items) {
    ...
    for (ServiceCatalogAPIServer item : items) {
        ServiceCatalogAPIServerBuilder builder = new ServiceCatalogAPIServerBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(ServiceCatalogAPIServer item) {
  ...
  public ServiceCatalogAPIServer buildMatchingItem(Predicate<ServiceCatalogAPIServerBuilder> predicate) {
      for (ServiceCatalogAPIServerBuilder item : items) {
  ...
  protected void copyInstance(ServiceCatalogAPIServerList instance) {
    instance = instance != null ? instance : new ServiceCatalogAPIServerList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ServiceCatalogAPIServerBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ServiceCatalogAPIServerListFluent that = (ServiceCatalogAPIServerListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ServiceCatalogAPIServerBuilder> predicate) {
    ...
    Iterator<ServiceCatalogAPIServerBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ServiceCatalogAPIServerBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ServiceCatalogAPIServer item) {
  ...
  public class ItemsNested<N> extends ServiceCatalogAPIServerFluent<ItemsNested<N>> implements Nested<N>{
  
    ServiceCatalogAPIServerBuilder builder;
    int index;
  
    ItemsNested(int index,ServiceCatalogAPIServer item) {
      this.index = index;
      this.builder = new ServiceCatalogAPIServerBuilder(this, item);
    }
  
    public N and() {
      return (N) ServiceCatalogAPIServerListFluent.this.setToItems(index, builder.build());
    }
