...
public class EtcdListFluent<A extends io.fabric8.openshift.api.model.operator.v1.EtcdListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<EtcdBuilder> items = new ArrayList<EtcdBuilder>();
  private String kind;
  private ListMeta metadata;

  public EtcdListFluent() {
  }
  
  public EtcdListFluent(EtcdList instance) {
  ...
  public A addAllToItems(Collection<Etcd> items) {
    ...
    for (Etcd item : items) {
        EtcdBuilder builder = new EtcdBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(Etcd item) {
  ...
  protected void copyInstance(EtcdList instance) {
    instance = instance != null ? instance : new EtcdList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<EtcdBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    EtcdListFluent that = (EtcdListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<EtcdBuilder> predicate) {
    ...
    Iterator<EtcdBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        EtcdBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Etcd item) {
  ...
  public class ItemsNested<N> extends EtcdFluent<ItemsNested<N>> implements Nested<N>{
  
    EtcdBuilder builder;
    int index;
  
    ItemsNested(int index,Etcd item) {
      this.index = index;
      this.builder = new EtcdBuilder(this, item);
    }
  
    public N and() {
      return (N) EtcdListFluent.this.setToItems(index, builder.build());
    }
