...
public class StaticPodOperatorStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.StaticPodOperatorStatusFluent<A>> extends BaseFluent<A>{
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StaticPodOperatorStatusFluent.this.setToGenerations(index, builder.build());
    }
