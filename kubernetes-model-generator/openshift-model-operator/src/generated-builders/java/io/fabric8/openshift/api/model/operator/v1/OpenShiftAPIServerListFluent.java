...
public class OpenShiftAPIServerListFluent<A extends io.fabric8.openshift.api.model.operator.v1.OpenShiftAPIServerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<OpenShiftAPIServerBuilder> items = new ArrayList<OpenShiftAPIServerBuilder>();
  private String kind;
  ...
  public A addAllToItems(Collection<OpenShiftAPIServer> items) {
    ...
    for (OpenShiftAPIServer item : items) {
        OpenShiftAPIServerBuilder builder = new OpenShiftAPIServerBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(OpenShiftAPIServer item) {
  ...
  public OpenShiftAPIServer buildMatchingItem(Predicate<OpenShiftAPIServerBuilder> predicate) {
      for (OpenShiftAPIServerBuilder item : items) {
  ...
  protected void copyInstance(OpenShiftAPIServerList instance) {
    instance = instance != null ? instance : new OpenShiftAPIServerList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<OpenShiftAPIServerBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    OpenShiftAPIServerListFluent that = (OpenShiftAPIServerListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<OpenShiftAPIServerBuilder> predicate) {
    ...
    Iterator<OpenShiftAPIServerBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        OpenShiftAPIServerBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,OpenShiftAPIServer item) {
  ...
  public class ItemsNested<N> extends OpenShiftAPIServerFluent<ItemsNested<N>> implements Nested<N>{
  
    OpenShiftAPIServerBuilder builder;
    int index;
  
    ItemsNested(int index,OpenShiftAPIServer item) {
      this.index = index;
      this.builder = new OpenShiftAPIServerBuilder(this, item);
    }
  
    public N and() {
      return (N) OpenShiftAPIServerListFluent.this.setToItems(index, builder.build());
    }
