...
public class AuthenticationFluent<A extends io.fabric8.openshift.api.model.operator.v1.AuthenticationFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new AuthenticationSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(AuthenticationSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new AuthenticationStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(AuthenticationStatus item) {
  ...
  public A withNewSpec(String logLevel,String managementState,Object observedConfig,String operatorLogLevel,Object unsupportedConfigOverrides) {
    return (A) this.withSpec(new AuthenticationSpec(logLevel, managementState, observedConfig, operatorLogLevel, unsupportedConfigOverrides));
  }
  
  public SpecNested<A> withNewSpecLike(AuthenticationSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(AuthenticationStatus item) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AuthenticationFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends AuthenticationSpecFluent<SpecNested<N>> implements Nested<N>{
  
    AuthenticationSpecBuilder builder;
  
    SpecNested(AuthenticationSpec item) {
      this.builder = new AuthenticationSpecBuilder(this, item);
    }
  
    public N and() {
      return (N) AuthenticationFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends AuthenticationStatusFluent<StatusNested<N>> implements Nested<N>{
  
    AuthenticationStatusBuilder builder;
  
    StatusNested(AuthenticationStatus item) {
      this.builder = new AuthenticationStatusBuilder(this, item);
    }
  
    public N and() {
      return (N) AuthenticationFluent.this.withStatus(builder.build());
    }
