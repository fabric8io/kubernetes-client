...
public class CSISnapshotControllerListFluent<A extends io.fabric8.openshift.api.model.operator.v1.CSISnapshotControllerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<CSISnapshotControllerBuilder> items = new ArrayList<CSISnapshotControllerBuilder>();
  private String kind;
  private ListMeta metadata;

  public CSISnapshotControllerListFluent() {
  }
  
  public CSISnapshotControllerListFluent(CSISnapshotControllerList instance) {
  ...
  public A addAllToItems(Collection<CSISnapshotController> items) {
    ...
    for (CSISnapshotController item : items) {
        CSISnapshotControllerBuilder builder = new CSISnapshotControllerBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(CSISnapshotController item) {
  ...
  public CSISnapshotController buildMatchingItem(Predicate<CSISnapshotControllerBuilder> predicate) {
      for (CSISnapshotControllerBuilder item : items) {
  ...
  protected void copyInstance(CSISnapshotControllerList instance) {
    instance = instance != null ? instance : new CSISnapshotControllerList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<CSISnapshotControllerBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    CSISnapshotControllerListFluent that = (CSISnapshotControllerListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<CSISnapshotControllerBuilder> predicate) {
    ...
    Iterator<CSISnapshotControllerBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        CSISnapshotControllerBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,CSISnapshotController item) {
  ...
  public class ItemsNested<N> extends CSISnapshotControllerFluent<ItemsNested<N>> implements Nested<N>{
  
    CSISnapshotControllerBuilder builder;
    int index;
  
    ItemsNested(int index,CSISnapshotController item) {
      this.index = index;
      this.builder = new CSISnapshotControllerBuilder(this, item);
    }
  
    public N and() {
      return (N) CSISnapshotControllerListFluent.this.setToItems(index, builder.build());
    }
