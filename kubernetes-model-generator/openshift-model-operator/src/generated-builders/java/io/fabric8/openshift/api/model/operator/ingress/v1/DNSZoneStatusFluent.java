...
public class DNSZoneStatusFluent<A extends io.fabric8.openshift.api.model.operator.ingress.v1.DNSZoneStatusFluent<A>> extends BaseFluent<A>{
  ...
  public A addNewCondition(String lastTransitionTime,String message,String reason,String status,String type) {
    return (A) this.addToConditions(new DNSZoneCondition(lastTransitionTime, message, reason, status, type));
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(dnsZone, that.dnsZone))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(conditions, dnsZone, additionalProperties);
  }
