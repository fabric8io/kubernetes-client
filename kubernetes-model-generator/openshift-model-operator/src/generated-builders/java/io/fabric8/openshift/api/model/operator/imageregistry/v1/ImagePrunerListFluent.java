...
public class ImagePrunerListFluent<A extends io.fabric8.openshift.api.model.operator.imageregistry.v1.ImagePrunerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ImagePrunerBuilder> items = new ArrayList<ImagePrunerBuilder>();
  private String kind;
  private ListMeta metadata;

  public ImagePrunerListFluent() {
  }
  
  public ImagePrunerListFluent(ImagePrunerList instance) {
  ...
  public A addAllToItems(Collection<ImagePruner> items) {
    ...
    for (ImagePruner item : items) {
        ImagePrunerBuilder builder = new ImagePrunerBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(ImagePruner item) {
  ...
  public ImagePruner buildMatchingItem(Predicate<ImagePrunerBuilder> predicate) {
      for (ImagePrunerBuilder item : items) {
  ...
  protected void copyInstance(ImagePrunerList instance) {
    instance = instance != null ? instance : new ImagePrunerList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ImagePrunerBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ImagePrunerListFluent that = (ImagePrunerListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ImagePrunerBuilder> predicate) {
    ...
    Iterator<ImagePrunerBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ImagePrunerBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ImagePruner item) {
  ...
  public class ItemsNested<N> extends ImagePrunerFluent<ItemsNested<N>> implements Nested<N>{
  
    ImagePrunerBuilder builder;
    int index;
  
    ItemsNested(int index,ImagePruner item) {
      this.index = index;
      this.builder = new ImagePrunerBuilder(this, item);
    }
  
    public N and() {
      return (N) ImagePrunerListFluent.this.setToItems(index, builder.build());
    }
