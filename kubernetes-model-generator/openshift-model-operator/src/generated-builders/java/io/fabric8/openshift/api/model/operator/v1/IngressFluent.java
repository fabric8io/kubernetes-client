...
public class IngressFluent<A extends io.fabric8.openshift.api.model.operator.v1.IngressFluent<A>> extends BaseFluent<A>{
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(clientDownloadsURL, that.clientDownloadsURL))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(clientDownloadsURL, consoleURL, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("{");
    if (!(clientDownloadsURL == null)) {
        sb.append("clientDownloadsURL:");
        sb.append(clientDownloadsURL);
        sb.append(",");
    }
    if (!(consoleURL == null)) {
