...
public class KubeControllerManagerListFluent<A extends io.fabric8.openshift.api.model.operator.v1.KubeControllerManagerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<KubeControllerManagerBuilder> items = new ArrayList<KubeControllerManagerBuilder>();
  private String kind;
  private ListMeta metadata;

  public KubeControllerManagerListFluent() {
  }
  
  public KubeControllerManagerListFluent(KubeControllerManagerList instance) {
  ...
  public A addAllToItems(Collection<KubeControllerManager> items) {
    ...
    for (KubeControllerManager item : items) {
        KubeControllerManagerBuilder builder = new KubeControllerManagerBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(KubeControllerManager item) {
  ...
  public KubeControllerManager buildMatchingItem(Predicate<KubeControllerManagerBuilder> predicate) {
      for (KubeControllerManagerBuilder item : items) {
  ...
  protected void copyInstance(KubeControllerManagerList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<KubeControllerManagerBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    KubeControllerManagerListFluent that = (KubeControllerManagerListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<KubeControllerManagerBuilder> predicate) {
    ...
    Iterator<KubeControllerManagerBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        KubeControllerManagerBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,KubeControllerManager item) {
  ...
  public class ItemsNested<N> extends KubeControllerManagerFluent<ItemsNested<N>> implements Nested<N>{
  
    KubeControllerManagerBuilder builder;
    int index;
  
    ItemsNested(int index,KubeControllerManager item) {
      this.index = index;
      this.builder = new KubeControllerManagerBuilder(this, item);
    }
  
    public N and() {
      return (N) KubeControllerManagerListFluent.this.setToItems(index, builder.build());
    }
