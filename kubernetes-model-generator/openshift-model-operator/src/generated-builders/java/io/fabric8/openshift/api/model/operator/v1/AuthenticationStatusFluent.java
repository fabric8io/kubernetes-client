...
public class AuthenticationStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.AuthenticationStatusFluent<A>> extends BaseFluent<A>{
  ...
  public OauthAPIServerNested<A> editOauthAPIServer() {
    return this.withNewOauthAPIServerLike(Optional.ofNullable(this.buildOauthAPIServer()).orElse(null));
  }
  
  public OauthAPIServerNested<A> editOrNewOauthAPIServer() {
    return this.withNewOauthAPIServerLike(Optional.ofNullable(this.buildOauthAPIServer()).orElse(new OAuthAPIServerStatusBuilder().build()));
  }
  
  public OauthAPIServerNested<A> editOrNewOauthAPIServerLike(OAuthAPIServerStatus item) {
    return this.withNewOauthAPIServerLike(Optional.ofNullable(this.buildOauthAPIServer()).orElse(item));
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(oauthAPIServer, that.oauthAPIServer))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(conditions, generations, latestAvailableRevision, oauthAPIServer, observedGeneration, readyReplicas, version, additionalProperties);
  }
  ...
  public String toString() {
    ...
    if (!(oauthAPIServer == null)) {
        sb.append("oauthAPIServer:");
        sb.append(oauthAPIServer);
        sb.append(",");
    }
  ...
  public OauthAPIServerNested<A> withNewOauthAPIServer() {
    return new OauthAPIServerNested(null);
  }
  
  public A withNewOauthAPIServer(Integer latestAvailableRevision) {
    return (A) this.withOauthAPIServer(new OAuthAPIServerStatus(latestAvailableRevision));
  }
  
  public OauthAPIServerNested<A> withNewOauthAPIServerLike(OAuthAPIServerStatus item) {
    return new OauthAPIServerNested(item);
  }
  
  public A withOauthAPIServer(OAuthAPIServerStatus oauthAPIServer) {
    this._visitables.remove("oauthAPIServer");
    if (oauthAPIServer != null) {
        this.oauthAPIServer = new OAuthAPIServerStatusBuilder(oauthAPIServer);
        this._visitables.get("oauthAPIServer").add(this.oauthAPIServer);
    } else {
        this.oauthAPIServer = null;
        this._visitables.get("oauthAPIServer").remove(this.oauthAPIServer);
    }
    return (A) this;
  }
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AuthenticationStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) AuthenticationStatusFluent.this.setToGenerations(index, builder.build());
    }
  ...
  public class OauthAPIServerNested<N> extends OAuthAPIServerStatusFluent<OauthAPIServerNested<N>> implements Nested<N>{
  
    OAuthAPIServerStatusBuilder builder;
  
    OauthAPIServerNested(OAuthAPIServerStatus item) {
      this.builder = new OAuthAPIServerStatusBuilder(this, item);
    }
  
    public N and() {
      return (N) AuthenticationStatusFluent.this.withOauthAPIServer(builder.build());
    }
