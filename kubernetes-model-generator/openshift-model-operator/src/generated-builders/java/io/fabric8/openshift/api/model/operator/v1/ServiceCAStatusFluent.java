...
public class ServiceCAStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.ServiceCAStatusFluent<A>> extends BaseFluent<A>{
  ...
  public ServiceCAStatusFluent() {
  }
  
  public ServiceCAStatusFluent(ServiceCAStatus instance) {
  ...
  protected void copyInstance(ServiceCAStatus instance) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceCAStatusFluent that = (ServiceCAStatusFluent) o;
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceCAStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceCAStatusFluent.this.setToGenerations(index, builder.build());
    }
