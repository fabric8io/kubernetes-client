...
public class InsightsOperatorStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.InsightsOperatorStatusFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private ArrayList<OperatorConditionBuilder> conditions = new ArrayList<OperatorConditionBuilder>();
  private GatherStatusBuilder gatherStatus;
  ...
  public InsightsOperatorStatusFluent() {
  }
  
  public InsightsOperatorStatusFluent(InsightsOperatorStatus instance) {
  ...
  public GatherStatus buildGatherStatus() {
    return this.gatherStatus != null ? this.gatherStatus.build() : null;
  }
  ...
  protected void copyInstance(InsightsOperatorStatus instance) {
    instance = instance != null ? instance : new InsightsOperatorStatus();
    if (instance != null) {
        this.withConditions(instance.getConditions());
        this.withGatherStatus(instance.getGatherStatus());
  ...
  public GatherStatusNested<A> editGatherStatus() {
    return this.withNewGatherStatusLike(Optional.ofNullable(this.buildGatherStatus()).orElse(null));
  }
  ...
  public GatherStatusNested<A> editOrNewGatherStatus() {
    return this.withNewGatherStatusLike(Optional.ofNullable(this.buildGatherStatus()).orElse(new GatherStatusBuilder().build()));
  }
  
  public GatherStatusNested<A> editOrNewGatherStatusLike(GatherStatus item) {
    return this.withNewGatherStatusLike(Optional.ofNullable(this.buildGatherStatus()).orElse(item));
  }
  ...
  public boolean equals(Object o) {
    ...
    InsightsOperatorStatusFluent that = (InsightsOperatorStatusFluent) o;
    if (!(Objects.equals(conditions, that.conditions))) {
      return false;
    }
    if (!(Objects.equals(gatherStatus, that.gatherStatus))) {
      return false;
    }
  ...
  public boolean hasGatherStatus() {
    return this.gatherStatus != null;
  }
  ...
  public int hashCode() {
    return Objects.hash(conditions, gatherStatus, generations, insightsReport, latestAvailableRevision, observedGeneration, readyReplicas, version, additionalProperties);
  }
  ...
  public A withGatherStatus(GatherStatus gatherStatus) {
    this._visitables.remove("gatherStatus");
    if (gatherStatus != null) {
        this.gatherStatus = new GatherStatusBuilder(gatherStatus);
        this._visitables.get("gatherStatus").add(this.gatherStatus);
    } else {
        this.gatherStatus = null;
        this._visitables.get("gatherStatus").remove(this.gatherStatus);
    }
    return (A) this;
  }
  ...
  public GatherStatusNested<A> withNewGatherStatus() {
    return new GatherStatusNested(null);
  }
  
  public GatherStatusNested<A> withNewGatherStatusLike(GatherStatus item) {
    return new GatherStatusNested(item);
  }
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) InsightsOperatorStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GatherStatusNested<N> extends GatherStatusFluent<GatherStatusNested<N>> implements Nested<N>{
  
    GatherStatusBuilder builder;
  
    GatherStatusNested(GatherStatus item) {
      this.builder = new GatherStatusBuilder(this, item);
    }
  
    public N and() {
      return (N) InsightsOperatorStatusFluent.this.withGatherStatus(builder.build());
    }
    
    public N endGatherStatus() {
      return and();
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) InsightsOperatorStatusFluent.this.setToGenerations(index, builder.build());
    }
  ...
  public class InsightsReportNested<N> extends InsightsReportFluent<InsightsReportNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) InsightsOperatorStatusFluent.this.withInsightsReport(builder.build());
    }
