...
public class OLMStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1alpha1.OLMStatusFluent<A>> extends BaseFluent<A>{
  ...
  public OLMStatusFluent() {
  }
  
  public OLMStatusFluent(OLMStatus instance) {
  ...
  protected void copyInstance(OLMStatus instance) {
    instance = instance != null ? instance : new OLMStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    OLMStatusFluent that = (OLMStatusFluent) o;
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) OLMStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) OLMStatusFluent.this.setToGenerations(index, builder.build());
    }
