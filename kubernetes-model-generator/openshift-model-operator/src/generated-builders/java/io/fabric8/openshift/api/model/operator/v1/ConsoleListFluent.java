...
public class ConsoleListFluent<A extends io.fabric8.openshift.api.model.operator.v1.ConsoleListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ConsoleBuilder> items = new ArrayList<ConsoleBuilder>();
  private String kind;
  private ListMeta metadata;

  public ConsoleListFluent() {
  }
  
  public ConsoleListFluent(ConsoleList instance) {
  ...
  public ItemsNested<A> addNewItemLike(Console item) {
  ...
  protected void copyInstance(ConsoleList instance) {
    instance = instance != null ? instance : new ConsoleList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ConsoleBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ConsoleListFluent that = (ConsoleListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ConsoleBuilder> predicate) {
    ...
    Iterator<ConsoleBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,Console item) {
  ...
  public class ItemsNested<N> extends ConsoleFluent<ItemsNested<N>> implements Nested<N>{
  
    ConsoleBuilder builder;
    int index;
  
    ItemsNested(int index,Console item) {
      this.index = index;
      this.builder = new ConsoleBuilder(this, item);
    }
  
    public N and() {
      return (N) ConsoleListFluent.this.setToItems(index, builder.build());
    }
