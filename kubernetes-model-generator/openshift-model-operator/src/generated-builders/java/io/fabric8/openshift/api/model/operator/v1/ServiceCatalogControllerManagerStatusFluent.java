...
public class ServiceCatalogControllerManagerStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.ServiceCatalogControllerManagerStatusFluent<A>> extends BaseFluent<A>{
  ...
  public ServiceCatalogControllerManagerStatusFluent() {
  }
  
  public ServiceCatalogControllerManagerStatusFluent(ServiceCatalogControllerManagerStatus instance) {
  ...
  protected void copyInstance(ServiceCatalogControllerManagerStatus instance) {
    instance = instance != null ? instance : new ServiceCatalogControllerManagerStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceCatalogControllerManagerStatusFluent that = (ServiceCatalogControllerManagerStatusFluent) o;
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceCatalogControllerManagerStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceCatalogControllerManagerStatusFluent.this.setToGenerations(index, builder.build());
    }
