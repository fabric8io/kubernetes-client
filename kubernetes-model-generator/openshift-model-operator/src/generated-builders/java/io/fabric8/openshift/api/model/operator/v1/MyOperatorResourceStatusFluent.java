...
public class MyOperatorResourceStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.MyOperatorResourceStatusFluent<A>> extends BaseFluent<A>{
  ...
  public MyOperatorResourceStatusFluent() {
  }
  
  public MyOperatorResourceStatusFluent(MyOperatorResourceStatus instance) {
  ...
  protected void copyInstance(MyOperatorResourceStatus instance) {
    instance = instance != null ? instance : new MyOperatorResourceStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    MyOperatorResourceStatusFluent that = (MyOperatorResourceStatusFluent) o;
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) MyOperatorResourceStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) MyOperatorResourceStatusFluent.this.setToGenerations(index, builder.build());
    }
