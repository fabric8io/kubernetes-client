...
public class NodeDisruptionPolicyStatusUnitFluent<A extends io.fabric8.openshift.api.model.operator.v1.NodeDisruptionPolicyStatusUnitFluent<A>> extends BaseFluent<A>{
  ...
  public NodeDisruptionPolicyStatusUnitFluent() {
  }
  
  public NodeDisruptionPolicyStatusUnitFluent(NodeDisruptionPolicyStatusUnit instance) {
  ...
  protected void copyInstance(NodeDisruptionPolicyStatusUnit instance) {
    instance = instance != null ? instance : new NodeDisruptionPolicyStatusUnit();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    NodeDisruptionPolicyStatusUnitFluent that = (NodeDisruptionPolicyStatusUnitFluent) o;
  ...
  public class ActionsNested<N> extends NodeDisruptionPolicyStatusActionFluent<ActionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NodeDisruptionPolicyStatusUnitFluent.this.setToActions(index, builder.build());
    }
