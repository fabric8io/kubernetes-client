...
public class IngressControllerListFluent<A extends io.fabric8.openshift.api.model.operator.v1.IngressControllerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<IngressControllerBuilder> items = new ArrayList<IngressControllerBuilder>();
  private String kind;
  private ListMeta metadata;

  public IngressControllerListFluent() {
  }
  
  public IngressControllerListFluent(IngressControllerList instance) {
  ...
  public A addAllToItems(Collection<IngressController> items) {
    ...
    for (IngressController item : items) {
        IngressControllerBuilder builder = new IngressControllerBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(IngressController item) {
  ...
  public IngressController buildMatchingItem(Predicate<IngressControllerBuilder> predicate) {
      for (IngressControllerBuilder item : items) {
  ...
  protected void copyInstance(IngressControllerList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<IngressControllerBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    IngressControllerListFluent that = (IngressControllerListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<IngressControllerBuilder> predicate) {
    ...
    Iterator<IngressControllerBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        IngressControllerBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,IngressController item) {
  ...
  public class ItemsNested<N> extends IngressControllerFluent<ItemsNested<N>> implements Nested<N>{
  
    IngressControllerBuilder builder;
    int index;
  
    ItemsNested(int index,IngressController item) {
      this.index = index;
      this.builder = new IngressControllerBuilder(this, item);
    }
  
    public N and() {
      return (N) IngressControllerListFluent.this.setToItems(index, builder.build());
    }
