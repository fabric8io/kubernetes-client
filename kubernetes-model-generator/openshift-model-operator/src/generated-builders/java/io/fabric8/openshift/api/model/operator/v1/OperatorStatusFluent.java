...
public class OperatorStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.OperatorStatusFluent<A>> extends BaseFluent<A>{
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) OperatorStatusFluent.this.setToGenerations(index, builder.build());
    }
