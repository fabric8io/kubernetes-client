...
public class OAuthAPIServerStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.OAuthAPIServerStatusFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private Integer latestAvailableRevision;

  public OAuthAPIServerStatusFluent() {
  }
  
  public OAuthAPIServerStatusFluent(OAuthAPIServerStatus instance) {
  ...
  protected void copyInstance(OAuthAPIServerStatus instance) {
    instance = instance != null ? instance : new OAuthAPIServerStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    OAuthAPIServerStatusFluent that = (OAuthAPIServerStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(latestAvailableRevision, additionalProperties);
  }
