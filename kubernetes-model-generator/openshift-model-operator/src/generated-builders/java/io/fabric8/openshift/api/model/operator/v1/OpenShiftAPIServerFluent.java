...
public class OpenShiftAPIServerFluent<A extends io.fabric8.openshift.api.model.operator.v1.OpenShiftAPIServerFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new OpenShiftAPIServerSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(OpenShiftAPIServerSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new OpenShiftAPIServerStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(OpenShiftAPIServerStatus item) {
  ...
  public boolean equals(Object o) {
    ...
    OpenShiftAPIServerFluent that = (OpenShiftAPIServerFluent) o;
  ...
  public A withNewSpec(String logLevel,String managementState,Object observedConfig,String operatorLogLevel,Object unsupportedConfigOverrides) {
    return (A) this.withSpec(new OpenShiftAPIServerSpec(logLevel, managementState, observedConfig, operatorLogLevel, unsupportedConfigOverrides));
  }
  
  public SpecNested<A> withNewSpecLike(OpenShiftAPIServerSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(OpenShiftAPIServerStatus item) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) OpenShiftAPIServerFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends OpenShiftAPIServerSpecFluent<SpecNested<N>> implements Nested<N>{
  
    OpenShiftAPIServerSpecBuilder builder;
  
    SpecNested(OpenShiftAPIServerSpec item) {
      this.builder = new OpenShiftAPIServerSpecBuilder(this, item);
    }
  
    public N and() {
      return (N) OpenShiftAPIServerFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends OpenShiftAPIServerStatusFluent<StatusNested<N>> implements Nested<N>{
  
    OpenShiftAPIServerStatusBuilder builder;
  
    StatusNested(OpenShiftAPIServerStatus item) {
      this.builder = new OpenShiftAPIServerStatusBuilder(this, item);
    }
  
    public N and() {
      return (N) OpenShiftAPIServerFluent.this.withStatus(builder.build());
    }
