...
public class EtcdStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.EtcdStatusFluent<A>> extends BaseFluent<A>{
  ...
  public EtcdStatusFluent() {
  }
  
  public EtcdStatusFluent(EtcdStatus instance) {
  ...
  protected void copyInstance(EtcdStatus instance) {
    instance = instance != null ? instance : new EtcdStatus();
    if (instance != null) {
        this.withConditions(instance.getConditions());
        this.withControlPlaneHardwareSpeed(instance.getControlPlaneHardwareSpeed());
  ...
  public boolean equals(Object o) {
    ...
    EtcdStatusFluent that = (EtcdStatusFluent) o;
    if (!(Objects.equals(conditions, that.conditions))) {
      return false;
    }
    if (!(Objects.equals(controlPlaneHardwareSpeed, that.controlPlaneHardwareSpeed))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(conditions, controlPlaneHardwareSpeed, generations, latestAvailableRevision, latestAvailableRevisionReason, nodeStatuses, observedGeneration, readyReplicas, version, additionalProperties);
  }
  ...
  public String toString() {
    ...
    if (!(controlPlaneHardwareSpeed == null)) {
  ...
  public A withControlPlaneHardwareSpeed(String controlPlaneHardwareSpeed) {
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EtcdStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EtcdStatusFluent.this.setToGenerations(index, builder.build());
    }
  ...
  public class NodeStatusesNested<N> extends NodeStatusFluent<NodeStatusesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EtcdStatusFluent.this.setToNodeStatuses(index, builder.build());
    }
