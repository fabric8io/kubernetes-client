...
public class IngressControllerCaptureHTTPCookieFluent<A extends io.fabric8.openshift.api.model.operator.v1.IngressControllerCaptureHTTPCookieFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(IngressControllerCaptureHTTPCookie instance) {
    instance = instance != null ? instance : new IngressControllerCaptureHTTPCookie();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    IngressControllerCaptureHTTPCookieFluent that = (IngressControllerCaptureHTTPCookieFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(matchType, maxLength, name, namePrefix, additionalProperties);
  }
