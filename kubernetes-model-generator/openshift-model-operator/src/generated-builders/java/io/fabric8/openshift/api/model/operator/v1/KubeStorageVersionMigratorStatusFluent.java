...
public class KubeStorageVersionMigratorStatusFluent<A extends io.fabric8.openshift.api.model.operator.v1.KubeStorageVersionMigratorStatusFluent<A>> extends BaseFluent<A>{
  ...
  public KubeStorageVersionMigratorStatusFluent() {
  }
  
  public KubeStorageVersionMigratorStatusFluent(KubeStorageVersionMigratorStatus instance) {
  ...
  protected void copyInstance(KubeStorageVersionMigratorStatus instance) {
    instance = instance != null ? instance : new KubeStorageVersionMigratorStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    KubeStorageVersionMigratorStatusFluent that = (KubeStorageVersionMigratorStatusFluent) o;
  ...
  public class ConditionsNested<N> extends OperatorConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KubeStorageVersionMigratorStatusFluent.this.setToConditions(index, builder.build());
    }
  ...
  public class GenerationsNested<N> extends GenerationStatusFluent<GenerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KubeStorageVersionMigratorStatusFluent.this.setToGenerations(index, builder.build());
    }
