...
public class OperatorPKIListFluent<A extends io.fabric8.openshift.api.model.operator.network.v1.OperatorPKIListFluent<A>> extends BaseFluent<A>{
  ...
  public ItemsNested<A> addNewItemLike(OperatorPKI item) {
  ...
  public OperatorPKI buildMatchingItem(Predicate<OperatorPKIBuilder> predicate) {
      for (OperatorPKIBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<OperatorPKIBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    OperatorPKIListFluent that = (OperatorPKIListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<OperatorPKIBuilder> predicate) {
    ...
    Iterator<OperatorPKIBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,OperatorPKI item) {
  ...
  public class ItemsNested<N> extends OperatorPKIFluent<ItemsNested<N>> implements Nested<N>{
  
    OperatorPKIBuilder builder;
    int index;
  
    ItemsNested(int index,OperatorPKI item) {
      this.index = index;
      this.builder = new OperatorPKIBuilder(this, item);
    }
  
    public N and() {
      return (N) OperatorPKIListFluent.this.setToItems(index, builder.build());
    }
