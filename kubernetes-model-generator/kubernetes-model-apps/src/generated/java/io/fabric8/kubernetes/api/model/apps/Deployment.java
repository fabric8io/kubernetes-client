...
public class Deployment implements Editable<DeploymentBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Deployment(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
