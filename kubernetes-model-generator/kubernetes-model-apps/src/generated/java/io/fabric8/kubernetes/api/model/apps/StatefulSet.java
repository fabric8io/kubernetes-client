...
public class StatefulSet implements Editable<StatefulSetBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "StatefulSet(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
