...
public class DaemonSet implements Editable<DaemonSetBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "DaemonSet(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
