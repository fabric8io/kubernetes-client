...
public class RollingUpdateStatefulSetStrategyFluent<A extends io.fabric8.kubernetes.api.model.apps.RollingUpdateStatefulSetStrategyFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(maxUnavailable, partition, additionalProperties);
  }
