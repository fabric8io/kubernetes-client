...
public class ReplicaSetStatusFluent<A extends io.fabric8.kubernetes.api.model.apps.ReplicaSetStatusFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(availableReplicas, conditions, fullyLabeledReplicas, observedGeneration, readyReplicas, replicas, terminatingReplicas, additionalProperties);
  }
