...
public class StatefulSetOrdinalsFluent<A extends io.fabric8.kubernetes.api.model.apps.StatefulSetOrdinalsFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(start, additionalProperties);
  }
