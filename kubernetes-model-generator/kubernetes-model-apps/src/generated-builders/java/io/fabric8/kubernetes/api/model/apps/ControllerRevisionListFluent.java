...
public class ControllerRevisionListFluent<A extends io.fabric8.kubernetes.api.model.apps.ControllerRevisionListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ControllerRevisionBuilder> items = new ArrayList<ControllerRevisionBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(ControllerRevision item) {
  ...
  public A addToItems(ControllerRevision... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (ControllerRevision item : items) {
  ...
  public ControllerRevision buildMatchingItem(Predicate<ControllerRevisionBuilder> predicate) {
      for (ControllerRevisionBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ControllerRevisionBuilder> predicate) {
    int index = -1;
  ...
  public A removeFromItems(ControllerRevision... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (ControllerRevision item : items) {
  ...
  public A removeMatchingFromItems(Predicate<ControllerRevisionBuilder> predicate) {
    ...
    Iterator<ControllerRevisionBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ControllerRevisionBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ControllerRevision item) {
  ...
  public A withItems(ControllerRevision... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends ControllerRevisionFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ControllerRevisionListFluent.this.setToItems(index, builder.build());
    }
