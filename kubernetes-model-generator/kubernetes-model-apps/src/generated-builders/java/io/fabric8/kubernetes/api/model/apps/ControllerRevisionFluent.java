...
public class ControllerRevisionFluent<A extends io.fabric8.kubernetes.api.model.apps.ControllerRevisionFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, data, kind, metadata, revision, additionalProperties);
  }
