...
public class DaemonSetSpecFluent<A extends io.fabric8.kubernetes.api.model.apps.DaemonSetSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(minReadySeconds, revisionHistoryLimit, selector, template, updateStrategy, additionalProperties);
  }
