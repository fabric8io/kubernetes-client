...
public class DeploymentSpecFluent<A extends io.fabric8.kubernetes.api.model.apps.DeploymentSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(minReadySeconds, paused, progressDeadlineSeconds, replicas, revisionHistoryLimit, selector, strategy, template, additionalProperties);
  }
