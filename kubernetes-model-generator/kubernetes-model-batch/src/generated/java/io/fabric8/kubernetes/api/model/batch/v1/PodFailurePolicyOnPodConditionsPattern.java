...
public class PodFailurePolicyOnPodConditionsPattern implements Editable<PodFailurePolicyOnPodConditionsPatternBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodFailurePolicyOnPodConditionsPattern)) {
            return false;
        }
    ...
    public String toString() {
        return "PodFailurePolicyOnPodConditionsPattern(" + "status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
