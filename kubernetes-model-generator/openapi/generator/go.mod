...
replace (
	...
	// cluster-api-provider-metal3/api v1.13.x still imports sigs.k8s.io/cluster-api/errors, removed in cluster-api v1.14.0
	sigs.k8s.io/cluster-api => sigs.k8s.io/cluster-api v1.13.6
