...
public class MachineSetListFluent<A extends io.fabric8.openshift.api.model.machine.v1beta1.MachineSetListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<MachineSetBuilder> items = new ArrayList<MachineSetBuilder>();
  private String kind;
  ...
  public MachineSet buildMatchingItem(Predicate<MachineSetBuilder> predicate) {
      for (MachineSetBuilder item : items) {
  ...
  protected void copyInstance(MachineSetList instance) {
    instance = instance != null ? instance : new MachineSetList();
    if (instance != null) {
  ...
  public A removeMatchingFromItems(Predicate<MachineSetBuilder> predicate) {
    ...
    Iterator<MachineSetBuilder> each = items.iterator();
  ...
  public class ItemsNested<N> extends MachineSetFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) MachineSetListFluent.this.setToItems(index, builder.build());
    }
