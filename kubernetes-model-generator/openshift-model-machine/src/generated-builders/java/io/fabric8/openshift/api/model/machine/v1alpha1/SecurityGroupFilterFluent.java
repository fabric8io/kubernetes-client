...
public class SecurityGroupFilterFluent<A extends io.fabric8.openshift.api.model.machine.v1alpha1.SecurityGroupFilterFluent<A>> extends BaseFluent<A>{
  ...
  public SecurityGroupFilterFluent() {
  }
  
  public SecurityGroupFilterFluent(SecurityGroupFilter instance) {
  ...
  protected void copyInstance(SecurityGroupFilter instance) {
    instance = instance != null ? instance : new SecurityGroupFilter();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    SecurityGroupFilterFluent that = (SecurityGroupFilterFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(description, id, limit, marker, name, notTags, notTagsAny, projectId, sortDir, sortKey, tags, tagsAny, tenantId, additionalProperties);
  }
