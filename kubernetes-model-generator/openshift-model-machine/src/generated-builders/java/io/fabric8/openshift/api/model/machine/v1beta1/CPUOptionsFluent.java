...
public class CPUOptionsFluent<A extends io.fabric8.openshift.api.model.machine.v1beta1.CPUOptionsFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String confidentialCompute;

  public CPUOptionsFluent() {
  }
  
  public CPUOptionsFluent(CPUOptions instance) {
  ...
  protected void copyInstance(CPUOptions instance) {
    instance = instance != null ? instance : new CPUOptions();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    CPUOptionsFluent that = (CPUOptionsFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(confidentialCompute, additionalProperties);
  }
