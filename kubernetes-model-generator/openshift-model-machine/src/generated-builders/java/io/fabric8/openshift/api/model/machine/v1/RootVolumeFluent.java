...
public class RootVolumeFluent<A extends io.fabric8.openshift.api.model.machine.v1.RootVolumeFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(availabilityZone, volumeType, additionalProperties);
  }
