...
public class MachineTemplateSpecFluent<A extends io.fabric8.openshift.api.model.machine.v1beta1.MachineTemplateSpecFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private ObjectMetaBuilder metadata;
  private MachineSpecBuilder spec;

  public MachineTemplateSpecFluent() {
  }
  
  public MachineTemplateSpecFluent(MachineTemplateSpec instance) {
  ...
  protected void copyInstance(MachineTemplateSpec instance) {
  ...
  public boolean equals(Object o) {
    ...
    MachineTemplateSpecFluent that = (MachineTemplateSpecFluent) o;
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) MachineTemplateSpecFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends MachineSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) MachineTemplateSpecFluent.this.withSpec(builder.build());
    }
