...
public class MachineHealthCheckStatusFluent<A extends io.fabric8.openshift.api.model.machine.v1beta1.MachineHealthCheckStatusFluent<A>> extends BaseFluent<A>{
  ...
  public MachineHealthCheckStatusFluent() {
  }
  
  public MachineHealthCheckStatusFluent(MachineHealthCheckStatus instance) {
  ...
  protected void copyInstance(MachineHealthCheckStatus instance) {
    instance = instance != null ? instance : new MachineHealthCheckStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    MachineHealthCheckStatusFluent that = (MachineHealthCheckStatusFluent) o;
    ...
    if (!(Objects.equals(expectedMachines, that.expectedMachines))) {
      return false;
    }
    if (!(Objects.equals(remediationsAllowed, that.remediationsAllowed))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(conditions, currentHealthy, expectedMachines, remediationsAllowed, additionalProperties);
  }
  ...
  public String toString() {
    ...
    if (!(expectedMachines == null)) {
        sb.append("expectedMachines:");
        sb.append(expectedMachines);
        sb.append(",");
    }
    if (!(remediationsAllowed == null)) {
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) MachineHealthCheckStatusFluent.this.setToConditions(index, builder.build());
    }
