...
public class DataDiskBuilder extends DataDiskFluent<DataDiskBuilder> implements VisitableBuilder<DataDisk,DataDiskBuilder>{
  ...
  public DataDisk build() {
    DataDisk buildable = new DataDisk(fluent.getCachingType(), fluent.getDeletionPolicy(), fluent.getDiskSizeGB(), fluent.getLun(), fluent.buildManagedDisk(), fluent.getNameSuffix());
