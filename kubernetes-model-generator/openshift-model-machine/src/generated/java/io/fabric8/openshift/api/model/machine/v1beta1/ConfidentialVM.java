...
public class ConfidentialVM implements Editable<ConfidentialVMBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfidentialVM)) {
            return false;
        }
        ConfidentialVM other = (ConfidentialVM) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ConfidentialVM;
    }
    ...
    public String toString() {
        return "ConfidentialVM(" + "uefiSettings=" + this.getUefiSettings() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
