...
public class ResourceManagerTag implements Editable<ResourceManagerTagBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResourceManagerTag)) {
            return false;
        }
        ResourceManagerTag other = (ResourceManagerTag) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ResourceManagerTag;
    }
    ...
    public String toString() {
        return "ResourceManagerTag(" + "key=" + this.getKey() + ", parentID=" + this.getParentID() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
