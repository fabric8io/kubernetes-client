...
public class MetadataServiceOptions implements Editable<MetadataServiceOptionsBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MetadataServiceOptions)) {
            return false;
        }
        MetadataServiceOptions other = (MetadataServiceOptions) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MetadataServiceOptions;
    }
    ...
    public String toString() {
        return "MetadataServiceOptions(" + "authentication=" + this.getAuthentication() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
