...
public class ProviderSpec implements Editable<ProviderSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProviderSpec)) {
            return false;
        }
        ProviderSpec other = (ProviderSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ProviderSpec;
    }
    ...
    public String toString() {
        return "ProviderSpec(" + "value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
