...
public class Machine implements Editable<MachineBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Machine(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
