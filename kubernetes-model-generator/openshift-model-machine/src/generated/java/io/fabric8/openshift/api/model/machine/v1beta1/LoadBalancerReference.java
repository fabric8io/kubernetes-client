...
public class LoadBalancerReference implements Editable<LoadBalancerReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LoadBalancerReference)) {
            return false;
        }
        LoadBalancerReference other = (LoadBalancerReference) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LoadBalancerReference;
    }
    ...
    public String toString() {
        return "LoadBalancerReference(" + "name=" + this.getName() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
