...
public class PriorityLevelConfiguration implements Editable<PriorityLevelConfigurationBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PriorityLevelConfiguration)) {
            return false;
        }
    ...
    public String toString() {
        return "PriorityLevelConfiguration(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
