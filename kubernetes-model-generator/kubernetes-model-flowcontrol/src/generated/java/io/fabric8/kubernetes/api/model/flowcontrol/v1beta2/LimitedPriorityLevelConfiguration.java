...
public class LimitedPriorityLevelConfiguration implements Editable<LimitedPriorityLevelConfigurationBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (this$assuredConcurrencyShares == null ? other$assuredConcurrencyShares != null : !this$assuredConcurrencyShares.equals(other$assuredConcurrencyShares)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = result * prime + ($assuredConcurrencyShares == null ? 43 : $assuredConcurrencyShares.hashCode());
    ...
    public String toString() {
        return "LimitedPriorityLevelConfiguration(" + "assuredConcurrencyShares=" + this.getAssuredConcurrencyShares() + ", borrowingLimitPercent=" + this.getBorrowingLimitPercent() + ", lendablePercent=" + this.getLendablePercent() + ", limitResponse=" + this.getLimitResponse() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
