...
public class FlowSchema implements Editable<FlowSchemaBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "FlowSchema(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
