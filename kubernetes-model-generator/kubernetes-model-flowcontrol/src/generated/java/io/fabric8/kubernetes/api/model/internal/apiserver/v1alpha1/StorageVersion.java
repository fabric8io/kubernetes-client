...
public class StorageVersion implements HasMetadata
{
     ...
     */
    @JsonProperty("kind")
    private String kind = "StorageVersion";
    ...
    public StorageVersion(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, StorageVersionSpec spec, StorageVersionStatus status) {
        super();
    ...
    @JsonProperty("spec")
    public StorageVersionSpec getSpec() {
        return spec;
    }

    @JsonProperty("spec")
    public void setSpec(StorageVersionSpec spec) {
        this.spec = spec;
    }
