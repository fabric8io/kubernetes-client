...
public class ServiceAccountSubject implements Editable<ServiceAccountSubjectBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ServiceAccountSubject)) {
            return false;
        }
    ...
    public String toString() {
        return "ServiceAccountSubject(" + "name=" + this.getName() + ", namespace=" + this.getNamespace() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
