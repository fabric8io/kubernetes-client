...
public class LimitedPriorityLevelConfiguration implements Editable<LimitedPriorityLevelConfigurationBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "LimitedPriorityLevelConfiguration(" + "assuredConcurrencyShares=" + this.getAssuredConcurrencyShares() + ", limitResponse=" + this.getLimitResponse() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
