...
public class PriorityLevelConfigurationCondition implements Editable<PriorityLevelConfigurationConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PriorityLevelConfigurationCondition)) {
            return false;
        }
    ...
    public String toString() {
        return "PriorityLevelConfigurationCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
