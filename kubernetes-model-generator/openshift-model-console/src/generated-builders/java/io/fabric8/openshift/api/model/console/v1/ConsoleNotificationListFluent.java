...
public class ConsoleNotificationListFluent<A extends io.fabric8.openshift.api.model.console.v1.ConsoleNotificationListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ConsoleNotificationBuilder> items = new ArrayList<ConsoleNotificationBuilder>();
  private String kind;
  ...
  public A addAllToItems(Collection<ConsoleNotification> items) {
    ...
    for (ConsoleNotification item : items) {
        ConsoleNotificationBuilder builder = new ConsoleNotificationBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(ConsoleNotification item) {
  ...
  public ConsoleNotification buildMatchingItem(Predicate<ConsoleNotificationBuilder> predicate) {
      for (ConsoleNotificationBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ConsoleNotificationBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ConsoleNotificationListFluent that = (ConsoleNotificationListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ConsoleNotificationBuilder> predicate) {
    ...
    Iterator<ConsoleNotificationBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ConsoleNotificationBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ConsoleNotification item) {
  ...
  public class ItemsNested<N> extends ConsoleNotificationFluent<ItemsNested<N>> implements Nested<N>{
  
    ConsoleNotificationBuilder builder;
    int index;
  
    ItemsNested(int index,ConsoleNotification item) {
      this.index = index;
      this.builder = new ConsoleNotificationBuilder(this, item);
    }
  
    public N and() {
      return (N) ConsoleNotificationListFluent.this.setToItems(index, builder.build());
    }
