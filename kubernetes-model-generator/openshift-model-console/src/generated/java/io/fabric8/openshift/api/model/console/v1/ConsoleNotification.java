...
public class ConsoleNotification implements Editable<ConsoleNotificationBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConsoleNotification)) {
            return false;
        }
        ConsoleNotification other = (ConsoleNotification) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ConsoleNotification;
    }
    ...
    public String toString() {
        return "ConsoleNotification(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
