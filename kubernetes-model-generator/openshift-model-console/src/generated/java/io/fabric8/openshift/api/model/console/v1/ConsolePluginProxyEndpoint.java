...
public class ConsolePluginProxyEndpoint implements Editable<ConsolePluginProxyEndpointBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConsolePluginProxyEndpoint)) {
            return false;
        }
        ConsolePluginProxyEndpoint other = (ConsolePluginProxyEndpoint) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ConsolePluginProxyEndpoint;
    }
    ...
    public String toString() {
        return "ConsolePluginProxyEndpoint(" + "service=" + this.getService() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
