...
public class CLIDownloadLink implements Editable<CLIDownloadLinkBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CLIDownloadLink)) {
            return false;
        }
        CLIDownloadLink other = (CLIDownloadLink) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CLIDownloadLink;
    }
    ...
    public String toString() {
        return "CLIDownloadLink(" + "href=" + this.getHref() + ", text=" + this.getText() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
