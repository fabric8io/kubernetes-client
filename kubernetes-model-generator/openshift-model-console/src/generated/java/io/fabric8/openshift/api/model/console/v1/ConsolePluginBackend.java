...
public class ConsolePluginBackend implements Editable<ConsolePluginBackendBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConsolePluginBackend)) {
            return false;
        }
        ConsolePluginBackend other = (ConsolePluginBackend) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ConsolePluginBackend;
    }
    ...
    public String toString() {
        return "ConsolePluginBackend(" + "service=" + this.getService() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
