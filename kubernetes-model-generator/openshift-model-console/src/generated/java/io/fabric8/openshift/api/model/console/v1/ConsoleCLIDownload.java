...
public class ConsoleCLIDownload implements Editable<ConsoleCLIDownloadBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConsoleCLIDownload)) {
            return false;
        }
        ConsoleCLIDownload other = (ConsoleCLIDownload) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ConsoleCLIDownload;
    }
    ...
    public String toString() {
        return "ConsoleCLIDownload(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
