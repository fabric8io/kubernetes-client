...
public class ConsoleExternalLogLink implements Editable<ConsoleExternalLogLinkBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConsoleExternalLogLink)) {
            return false;
        }
        ConsoleExternalLogLink other = (ConsoleExternalLogLink) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ConsoleExternalLogLink;
    }
    ...
    public String toString() {
        return "ConsoleExternalLogLink(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
