...
public class ConsolePluginProxyServiceConfig implements Editable<ConsolePluginProxyServiceConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConsolePluginProxyServiceConfig)) {
            return false;
        }
        ConsolePluginProxyServiceConfig other = (ConsolePluginProxyServiceConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ConsolePluginProxyServiceConfig;
    }
    ...
    public String toString() {
        return "ConsolePluginProxyServiceConfig(" + "name=" + this.getName() + ", namespace=" + this.getNamespace() + ", port=" + this.getPort() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
