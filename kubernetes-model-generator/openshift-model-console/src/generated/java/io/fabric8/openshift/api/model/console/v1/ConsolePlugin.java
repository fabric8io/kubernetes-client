...
public class ConsolePlugin implements Editable<ConsolePluginBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConsolePlugin)) {
            return false;
        }
        ConsolePlugin other = (ConsolePlugin) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ConsolePlugin;
    }
    ...
    public String toString() {
        return "ConsolePlugin(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
