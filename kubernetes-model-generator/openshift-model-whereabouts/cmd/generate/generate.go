...
type Schema struct {
  ...
  Patch                                    metav1.Patch
  Time                                     metav1.Time
  IPPool                                   whereabouts.IPPool
  IPPoolList                               whereabouts.IPPoolList
  OverlappingRangeIPReservation            whereabouts.OverlappingRangeIPReservation
  OverlappingRangeIPReservationList        whereabouts.OverlappingRangeIPReservationList
  IPAllocation                             whereabouts.IPAllocation
}
...
func main() {
  ...
  schema, err := schemagen.GenerateSchema(reflect.TypeOf(Schema{}), packages, typeMap, manualTypeMap,"whereabouts")
  if err != nil {
