...
public class IPPool implements Editable<IPPoolBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IPPool)) {
            return false;
        }
        IPPool other = (IPPool) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IPPool;
    }
    ...
    public String toString() {
        return "IPPool(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
