...
public class NodeSlicePool implements Editable<NodeSlicePoolBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NodeSlicePool)) {
            return false;
        }
        NodeSlicePool other = (NodeSlicePool) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof NodeSlicePool;
    }
    ...
    public String toString() {
        return "NodeSlicePool(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
