...
public class OverlappingRangeIPReservation implements Editable<OverlappingRangeIPReservationBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OverlappingRangeIPReservation)) {
            return false;
        }
        OverlappingRangeIPReservation other = (OverlappingRangeIPReservation) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof OverlappingRangeIPReservation;
    }
    ...
    public String toString() {
        return "OverlappingRangeIPReservation(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
