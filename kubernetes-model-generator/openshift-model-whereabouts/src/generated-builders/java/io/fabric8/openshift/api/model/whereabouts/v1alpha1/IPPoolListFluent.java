...
public class IPPoolListFluent<A extends io.fabric8.openshift.api.model.whereabouts.v1alpha1.IPPoolListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<IPPoolBuilder> items = new ArrayList<IPPoolBuilder>();
  private String kind;
  private ListMeta metadata;

  public IPPoolListFluent() {
  }
  
  public IPPoolListFluent(IPPoolList instance) {
  ...
  public ItemsNested<A> addNewItemLike(IPPool item) {
  ...
  public A addToItems(int index,IPPool item) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    IPPoolBuilder builder = new IPPoolBuilder(item);
  ...
  public IPPool buildItem(int index) {
  ...
  protected void copyInstance(IPPoolList instance) {
    instance = instance != null ? instance : new IPPoolList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<IPPoolBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    IPPoolListFluent that = (IPPoolListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<IPPoolBuilder> predicate) {
    ...
    Iterator<IPPoolBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,IPPool item) {
    return new ItemsNested(index, item);
  }
  
  public A setToItems(int index,IPPool item) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    IPPoolBuilder builder = new IPPoolBuilder(item);
  ...
  public class ItemsNested<N> extends IPPoolFluent<ItemsNested<N>> implements Nested<N>{
  
    IPPoolBuilder builder;
    int index;
  
    ItemsNested(int index,IPPool item) {
      this.index = index;
      this.builder = new IPPoolBuilder(this, item);
    }
  
    public N and() {
      return (N) IPPoolListFluent.this.setToItems(index, builder.build());
    }
