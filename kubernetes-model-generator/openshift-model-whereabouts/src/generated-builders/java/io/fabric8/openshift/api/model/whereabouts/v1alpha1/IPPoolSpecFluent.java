...
public class IPPoolSpecFluent<A extends io.fabric8.openshift.api.model.whereabouts.v1alpha1.IPPoolSpecFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private Map<String,IPPoolSpecAllocations> allocations;
  ...
  protected void copyInstance(IPPoolSpec instance) {
    instance = instance != null ? instance : new IPPoolSpec();
    if (instance != null) {
  ...
  public int hashCode() {
    return Objects.hash(allocations, range, additionalProperties);
  }
