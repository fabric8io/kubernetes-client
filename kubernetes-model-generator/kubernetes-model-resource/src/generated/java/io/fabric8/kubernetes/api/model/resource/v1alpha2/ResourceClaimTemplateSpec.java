...
public class ResourceClaimTemplateSpec implements Editable<ResourceClaimTemplateSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResourceClaimTemplateSpec)) {
            return false;
        }
    ...
    public String toString() {
        return "ResourceClaimTemplateSpec(" + "metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
