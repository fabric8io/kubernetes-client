...
public class DeviceTaintRule implements Editable<DeviceTaintRuleBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeviceTaintRule)) {
            return false;
        }
        DeviceTaintRule other = (DeviceTaintRule) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DeviceTaintRule;
    }
    ...
    public String toString() {
        return "DeviceTaintRule(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
