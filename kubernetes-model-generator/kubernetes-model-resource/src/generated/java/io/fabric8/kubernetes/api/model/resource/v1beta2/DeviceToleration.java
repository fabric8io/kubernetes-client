...
public class DeviceToleration implements Editable<DeviceTolerationBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeviceToleration)) {
            return false;
        }
        DeviceToleration other = (DeviceToleration) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DeviceToleration;
    }
    ...
    public String toString() {
        return "DeviceToleration(" + "effect=" + this.getEffect() + ", key=" + this.getKey() + ", operator=" + this.getOperator() + ", tolerationSeconds=" + this.getTolerationSeconds() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
