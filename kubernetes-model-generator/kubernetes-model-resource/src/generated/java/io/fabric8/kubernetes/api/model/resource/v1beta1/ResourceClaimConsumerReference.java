...
public class ResourceClaimConsumerReference implements Editable<ResourceClaimConsumerReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResourceClaimConsumerReference)) {
            return false;
        }
    ...
    public String toString() {
        return "ResourceClaimConsumerReference(" + "apiGroup=" + this.getApiGroup() + ", name=" + this.getName() + ", resource=" + this.getResource() + ", uid=" + this.getUid() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
