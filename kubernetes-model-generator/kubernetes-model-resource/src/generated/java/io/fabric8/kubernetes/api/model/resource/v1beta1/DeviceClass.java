...
public class DeviceClass implements Editable<DeviceClassBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "DeviceClass(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
