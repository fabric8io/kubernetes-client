...
public class ResourceSlice implements Editable<ResourceSliceBuilder> , HasMetadata
{
    ...
    public ResourceSlice(String apiVersion, String driverName, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, NamedResourcesResources namedResources, String nodeName) {
        super();
