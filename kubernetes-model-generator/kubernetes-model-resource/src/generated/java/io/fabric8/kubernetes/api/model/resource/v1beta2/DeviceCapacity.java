...
public class DeviceCapacity implements Editable<DeviceCapacityBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeviceCapacity)) {
            return false;
        }
        ...
        Object this$requestPolicy = this.getRequestPolicy();
        Object other$requestPolicy = other.getRequestPolicy();
        if (this$requestPolicy == null ? other$requestPolicy != null : !this$requestPolicy.equals(other$requestPolicy)) {
            return false;
        }
    ...
    public int hashCode() {
        final int prime = 59;
        int result = 1;
        Object $requestPolicy = this.getRequestPolicy();
        result = result * prime + ($requestPolicy == null ? 43 : $requestPolicy.hashCode());
    ...
    public String toString() {
        return "DeviceCapacity(" + "requestPolicy=" + this.getRequestPolicy() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
