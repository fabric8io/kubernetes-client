...
public class ResourceClaim implements Editable<ResourceClaimBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "ResourceClaim(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
