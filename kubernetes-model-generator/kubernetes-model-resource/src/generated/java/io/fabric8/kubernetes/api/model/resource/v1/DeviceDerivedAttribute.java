...
public class DeviceDerivedAttribute implements Editable<DeviceDerivedAttributeBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeviceDerivedAttribute)) {
            return false;
        }
        DeviceDerivedAttribute other = (DeviceDerivedAttribute) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DeviceDerivedAttribute;
    }
    ...
    public String toString() {
        return "DeviceDerivedAttribute(" + "expression=" + this.getExpression() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
