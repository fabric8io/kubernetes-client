...
public class ResourceClassParametersReference implements Editable<ResourceClassParametersReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResourceClassParametersReference)) {
            return false;
        }
    ...
    public String toString() {
        return "ResourceClassParametersReference(" + "apiGroup=" + this.getApiGroup() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
