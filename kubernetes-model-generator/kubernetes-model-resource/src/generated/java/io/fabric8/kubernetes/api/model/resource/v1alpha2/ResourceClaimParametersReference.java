...
public class ResourceClaimParametersReference implements Editable<ResourceClaimParametersReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResourceClaimParametersReference)) {
            return false;
        }
    ...
    public String toString() {
        return "ResourceClaimParametersReference(" + "apiGroup=" + this.getApiGroup() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
