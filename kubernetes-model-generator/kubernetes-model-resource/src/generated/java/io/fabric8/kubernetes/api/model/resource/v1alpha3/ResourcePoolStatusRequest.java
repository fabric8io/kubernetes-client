...
public class ResourcePoolStatusRequest implements Editable<ResourcePoolStatusRequestBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResourcePoolStatusRequest)) {
            return false;
        }
        ResourcePoolStatusRequest other = (ResourcePoolStatusRequest) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ResourcePoolStatusRequest;
    }
    ...
    public String toString() {
        return "ResourcePoolStatusRequest(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
