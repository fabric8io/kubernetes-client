...
public class CapacityRequirements implements Editable<CapacityRequirementsBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CapacityRequirements)) {
            return false;
        }
        CapacityRequirements other = (CapacityRequirements) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CapacityRequirements;
    }
    ...
    public String toString() {
        return "CapacityRequirements(" + "requests=" + this.getRequests() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
