...
public class DeviceTaint implements Editable<DeviceTaintBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeviceTaint)) {
            return false;
        }
        DeviceTaint other = (DeviceTaint) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DeviceTaint;
    }
    ...
    public String toString() {
        return "DeviceTaint(" + "effect=" + this.getEffect() + ", key=" + this.getKey() + ", timeAdded=" + this.getTimeAdded() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
