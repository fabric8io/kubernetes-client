...
public class PodSchedulingContextListFluent<A extends io.fabric8.kubernetes.api.model.resource.v1alpha2.PodSchedulingContextListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<PodSchedulingContextBuilder> items = new ArrayList<PodSchedulingContextBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(PodSchedulingContext item) {
  ...
  public PodSchedulingContext buildMatchingItem(Predicate<PodSchedulingContextBuilder> predicate) {
      for (PodSchedulingContextBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<PodSchedulingContextBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<PodSchedulingContextBuilder> predicate) {
    ...
    Iterator<PodSchedulingContextBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        PodSchedulingContextBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,PodSchedulingContext item) {
  ...
  public class ItemsNested<N> extends PodSchedulingContextFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodSchedulingContextListFluent.this.setToItems(index, builder.build());
    }
