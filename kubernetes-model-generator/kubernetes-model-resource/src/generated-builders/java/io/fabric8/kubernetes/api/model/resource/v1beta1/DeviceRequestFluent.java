...
public class DeviceRequestFluent<A extends io.fabric8.kubernetes.api.model.resource.v1beta1.DeviceRequestFluent<A>> extends BaseFluent<A>{
  ...
  public class CapacityNested<N> extends CapacityRequirementsFluent<CapacityNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DeviceRequestFluent.this.withCapacity(builder.build());
    }
  ...
  public class SelectorsNested<N> extends DeviceSelectorFluent<SelectorsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DeviceRequestFluent.this.setToSelectors(index, builder.build());
    }
  ...
  public class TolerationsNested<N> extends DeviceTolerationFluent<TolerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DeviceRequestFluent.this.setToTolerations(index, builder.build());
    }
