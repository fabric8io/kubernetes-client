...
public class ExactDeviceRequestFluent<A extends io.fabric8.kubernetes.api.model.resource.v1beta2.ExactDeviceRequestFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(ExactDeviceRequest instance) {
    instance = instance != null ? instance : new ExactDeviceRequest();
    if (instance != null) {
  ...
  public int hashCode() {
    return Objects.hash(adminAccess, allocationMode, capacity, count, derivedAttributes, deviceClassName, selectors, tolerations, additionalProperties);
  }
  ...
  public class CapacityNested<N> extends CapacityRequirementsFluent<CapacityNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ExactDeviceRequestFluent.this.withCapacity(builder.build());
    }
  ...
  public class DerivedAttributesNested<N> extends DeviceDerivedAttributeFluent<DerivedAttributesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ExactDeviceRequestFluent.this.setToDerivedAttributes(index, builder.build());
    }
  ...
  public class SelectorsNested<N> extends DeviceSelectorFluent<SelectorsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ExactDeviceRequestFluent.this.setToSelectors(index, builder.build());
    }
  ...
  public class TolerationsNested<N> extends DeviceTolerationFluent<TolerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ExactDeviceRequestFluent.this.setToTolerations(index, builder.build());
    }
