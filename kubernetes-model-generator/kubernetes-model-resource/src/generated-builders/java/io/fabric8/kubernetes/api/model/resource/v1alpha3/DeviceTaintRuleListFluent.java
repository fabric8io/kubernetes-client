...
public class DeviceTaintRuleListFluent<A extends io.fabric8.kubernetes.api.model.resource.v1alpha3.DeviceTaintRuleListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<DeviceTaintRuleBuilder> items = new ArrayList<DeviceTaintRuleBuilder>();
  private String kind;
  ...
  public A addAllToItems(Collection<DeviceTaintRule> items) {
    ...
    for (DeviceTaintRule item : items) {
        DeviceTaintRuleBuilder builder = new DeviceTaintRuleBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(DeviceTaintRule item) {
  ...
  public DeviceTaintRule buildMatchingItem(Predicate<DeviceTaintRuleBuilder> predicate) {
      for (DeviceTaintRuleBuilder item : items) {
  ...
  protected void copyInstance(DeviceTaintRuleList instance) {
    instance = instance != null ? instance : new DeviceTaintRuleList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<DeviceTaintRuleBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    DeviceTaintRuleListFluent that = (DeviceTaintRuleListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<DeviceTaintRuleBuilder> predicate) {
    ...
    Iterator<DeviceTaintRuleBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        DeviceTaintRuleBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,DeviceTaintRule item) {
  ...
  public class ItemsNested<N> extends DeviceTaintRuleFluent<ItemsNested<N>> implements Nested<N>{
  
    DeviceTaintRuleBuilder builder;
    int index;
  
    ItemsNested(int index,DeviceTaintRule item) {
      this.index = index;
      this.builder = new DeviceTaintRuleBuilder(this, item);
    }
  
    public N and() {
      return (N) DeviceTaintRuleListFluent.this.setToItems(index, builder.build());
    }
