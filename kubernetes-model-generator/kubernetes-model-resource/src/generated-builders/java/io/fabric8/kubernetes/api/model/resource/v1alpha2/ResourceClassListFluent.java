...
public class ResourceClassListFluent<A extends io.fabric8.kubernetes.api.model.resource.v1alpha2.ResourceClassListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ResourceClassBuilder> items = new ArrayList<ResourceClassBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(ResourceClass item) {
  ...
  public A addToItems(ResourceClass... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (ResourceClass item : items) {
  ...
  public ResourceClass buildMatchingItem(Predicate<ResourceClassBuilder> predicate) {
      for (ResourceClassBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ResourceClassBuilder> predicate) {
    int index = -1;
  ...
  public A removeFromItems(ResourceClass... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (ResourceClass item : items) {
  ...
  public A removeMatchingFromItems(Predicate<ResourceClassBuilder> predicate) {
    ...
    Iterator<ResourceClassBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ResourceClassBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ResourceClass item) {
  ...
  public A withItems(ResourceClass... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends ResourceClassFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ResourceClassListFluent.this.setToItems(index, builder.build());
    }
