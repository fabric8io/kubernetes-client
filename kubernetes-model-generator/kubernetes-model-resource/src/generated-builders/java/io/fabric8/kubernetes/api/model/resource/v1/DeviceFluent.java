...
public class DeviceFluent<A extends io.fabric8.kubernetes.api.model.resource.v1.DeviceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(allNodes, allowMultipleAllocations, attributes, bindingConditions, bindingFailureConditions, bindsToNode, capacity, consumesCounters, name, nodeAllocatableResources, nodeName, nodeSelector, taints, additionalProperties);
  }
