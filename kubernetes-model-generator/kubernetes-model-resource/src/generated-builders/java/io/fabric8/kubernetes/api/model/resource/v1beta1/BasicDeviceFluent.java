...
public class BasicDeviceFluent<A extends io.fabric8.kubernetes.api.model.resource.v1beta1.BasicDeviceFluent<A>> extends BaseFluent<A>{
  ...
  public class ConsumesCountersNested<N> extends DeviceCounterConsumptionFluent<ConsumesCountersNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BasicDeviceFluent.this.setToConsumesCounters(index, builder.build());
    }
  ...
  public class TaintsNested<N> extends DeviceTaintFluent<TaintsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BasicDeviceFluent.this.setToTaints(index, builder.build());
    }
