...
public class ResourceClaimTemplateFluent<A extends io.fabric8.kubernetes.api.model.resource.v1alpha2.ResourceClaimTemplateFluent<A>> extends BaseFluent<A>{
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ResourceClaimTemplateFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends ResourceClaimTemplateSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ResourceClaimTemplateFluent.this.withSpec(builder.build());
    }
