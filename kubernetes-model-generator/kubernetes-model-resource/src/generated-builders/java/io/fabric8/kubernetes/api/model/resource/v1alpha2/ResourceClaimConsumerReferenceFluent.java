...
public class ResourceClaimConsumerReferenceFluent<A extends io.fabric8.kubernetes.api.model.resource.v1alpha2.ResourceClaimConsumerReferenceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(apiGroup, name, resource, uid, additionalProperties);
  }
