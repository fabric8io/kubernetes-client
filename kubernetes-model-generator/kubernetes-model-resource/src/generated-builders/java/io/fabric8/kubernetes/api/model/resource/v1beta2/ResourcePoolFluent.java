...
public class ResourcePoolFluent<A extends io.fabric8.kubernetes.api.model.resource.v1beta2.ResourcePoolFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(generation, name, resourceSliceCount, additionalProperties);
  }
