...
public class StorageStateSpecResource implements Editable<StorageStateSpecResourceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StorageStateSpecResource)) {
            return false;
        }
        StorageStateSpecResource other = (StorageStateSpecResource) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof StorageStateSpecResource;
    }
    ...
    public String toString() {
        return "StorageStateSpecResource(" + "group=" + this.getGroup() + ", resource=" + this.getResource() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
