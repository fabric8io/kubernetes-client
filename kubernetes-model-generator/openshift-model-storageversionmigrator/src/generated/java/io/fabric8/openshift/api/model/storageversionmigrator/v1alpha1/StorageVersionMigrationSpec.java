...
public class StorageVersionMigrationSpec implements Editable<StorageVersionMigrationSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (this$continueToken == null ? other$continueToken != null : !this$continueToken.equals(other$continueToken)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = result * prime + ($continueToken == null ? 43 : $continueToken.hashCode());
    ...
    public String toString() {
        return "StorageVersionMigrationSpec(" + "continueToken=" + this.getContinueToken() + ", resource=" + this.getResource() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
