...
public class StorageVersionMigrationSpecResource implements Editable<StorageVersionMigrationSpecResourceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StorageVersionMigrationSpecResource)) {
            return false;
        }
        StorageVersionMigrationSpecResource other = (StorageVersionMigrationSpecResource) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof StorageVersionMigrationSpecResource;
    }
    ...
    public String toString() {
        return "StorageVersionMigrationSpecResource(" + "group=" + this.getGroup() + ", resource=" + this.getResource() + ", version=" + this.getVersion() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
