...
public class StorageStateSpec implements Editable<StorageStateSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StorageStateSpec)) {
            return false;
        }
        StorageStateSpec other = (StorageStateSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof StorageStateSpec;
    }
    ...
    public String toString() {
        return "StorageStateSpec(" + "resource=" + this.getResource() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
