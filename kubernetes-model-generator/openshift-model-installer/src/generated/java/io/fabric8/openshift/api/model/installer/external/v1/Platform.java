...
public class Platform implements Editable<PlatformBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "Platform(" + "cloudControllerManager=" + this.getCloudControllerManager() + ", platformName=" + this.getPlatformName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
