...
public class FixedIP implements Editable<FixedIPBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FixedIP)) {
            return false;
        }
        FixedIP other = (FixedIP) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof FixedIP;
    }
    ...
    public String toString() {
        return "FixedIP(" + "subnet=" + this.getSubnet() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
