...
public class ClusterPlatformMetadata implements Editable<ClusterPlatformMetadataBuilder>, KubernetesResource
{
    ...
    @JsonProperty("azure")
    private com.github.openshift.installer.pkg.types.azure.Metadata azure;
     ...
     */
    @JsonProperty("azure")
    public com.github.openshift.installer.pkg.types.azure.Metadata getAzure() {
        return azure;
    }
     ...
     */
    @JsonProperty("azure")
    public void setAzure(com.github.openshift.installer.pkg.types.azure.Metadata azure) {
        this.azure = azure;
    }
