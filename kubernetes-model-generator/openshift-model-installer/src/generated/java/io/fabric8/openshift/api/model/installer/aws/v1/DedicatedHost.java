...
public class DedicatedHost implements Editable<DedicatedHostBuilder>, KubernetesResource
{
    ...
    public DedicatedHost(String id) {
        super();
        this.id = id;
    }

    /**
     * id identifies the AWS Dedicated Host on which the instance must run. The value must start with "h-" followed by 17 lowercase hexadecimal characters (0-9 and a-f). Must be exactly 19 characters in length.
     */
    @JsonProperty("id")
    public String getId() {
        return id;
