...
public class DiskSwap implements Editable<DiskSwapBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DiskSwap)) {
            return false;
        }
        DiskSwap other = (DiskSwap) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DiskSwap;
    }
    ...
    public String toString() {
        return "DiskSwap(" + "platformDiskID=" + this.getPlatformDiskID() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
