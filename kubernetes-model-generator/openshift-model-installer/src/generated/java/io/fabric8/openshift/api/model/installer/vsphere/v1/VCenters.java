...
public class VCenters implements Editable<VCentersBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VCenters)) {
            return false;
        }
        VCenters other = (VCenters) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof VCenters;
    }
    ...
    public String toString() {
        return "VCenters(" + "password=" + this.getPassword() + ", username=" + this.getUsername() + ", vCenter=" + this.getVCenter() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
