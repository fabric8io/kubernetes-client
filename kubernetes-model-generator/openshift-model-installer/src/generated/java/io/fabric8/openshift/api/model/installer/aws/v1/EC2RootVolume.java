...
public class EC2RootVolume implements Editable<EC2RootVolumeBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        Object this$throughput = this.getThroughput();
        Object other$throughput = other.getThroughput();
        if (this$throughput == null ? other$throughput != null : !this$throughput.equals(other$throughput)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        Object $throughput = this.getThroughput();
        result = result * prime + ($throughput == null ? 43 : $throughput.hashCode());
    ...
    public String toString() {
        return "EC2RootVolume(" + "iops=" + this.getIops() + ", kmsKeyARN=" + this.getKmsKeyARN() + ", size=" + this.getSize() + ", throughput=" + this.getThroughput() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
