...
public class SubnetRole implements Editable<SubnetRoleBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SubnetRole)) {
            return false;
        }
        SubnetRole other = (SubnetRole) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SubnetRole;
    }
    ...
    public String toString() {
        return "SubnetRole(" + "type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
