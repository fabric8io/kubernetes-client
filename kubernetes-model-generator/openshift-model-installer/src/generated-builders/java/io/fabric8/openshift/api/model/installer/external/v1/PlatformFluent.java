...
public class PlatformFluent<A extends io.fabric8.openshift.api.model.installer.external.v1.PlatformFluent<A>> extends BaseFluent<A>{
  ...
  public String getCloudControllerManager() {
    return this.cloudControllerManager;
  }
  ...
  public int hashCode() {
    return Objects.hash(cloudControllerManager, platformName, additionalProperties);
  }
  ...
  public A withCloudControllerManager(String cloudControllerManager) {
