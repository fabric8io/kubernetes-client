...
public class PlatformBuilder extends PlatformFluent<PlatformBuilder> implements VisitableBuilder<Platform,PlatformBuilder>{
  ...
  public Platform build() {
    Platform buildable = new Platform(fluent.getComputeSubnets(), fluent.getControlPlaneSubnets(), fluent.buildDefaultMachinePlatform(), fluent.getNetworkResourceGroupName(), fluent.getRegion(), fluent.getResourceGroupName(), fluent.getServiceEndpoints(), fluent.getVpcName());
