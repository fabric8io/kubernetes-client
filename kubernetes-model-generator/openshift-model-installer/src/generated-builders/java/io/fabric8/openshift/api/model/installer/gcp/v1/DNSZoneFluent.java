...
public class DNSZoneFluent<A extends io.fabric8.openshift.api.model.installer.gcp.v1.DNSZoneFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(name, projectID, additionalProperties);
  }
