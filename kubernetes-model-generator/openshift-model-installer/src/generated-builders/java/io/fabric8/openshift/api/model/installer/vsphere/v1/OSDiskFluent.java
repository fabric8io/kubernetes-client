...
public class OSDiskFluent<A extends io.fabric8.openshift.api.model.installer.vsphere.v1.OSDiskFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(diskSizeGB, additionalProperties);
  }
