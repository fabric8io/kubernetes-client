...
public class ClusterMetadataFluent<A extends io.fabric8.openshift.api.model.installer.v1.ClusterMetadataFluent<A>> extends BaseFluent<A>{
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(customFeatureSet, that.customFeatureSet))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(aws, azure, baremetal, clusterID, clusterName, customFeatureSet, featureSet, gcp, ibmcloud, infraID, nutanix, openstack, ovirt, powervc, powervs, vsphere, additionalProperties);
  }
  ...
  public class PowervcNested<N> extends io.fabric8.openshift.api.model.installer.powervc.v1.MetadataFluent<PowervcNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ClusterMetadataFluent.this.withPowervc(builder.build());
    }
