...
public class CPUFluent<A extends io.fabric8.openshift.api.model.installer.ovirt.v1.CPUFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(cores, sockets, threads, additionalProperties);
  }
