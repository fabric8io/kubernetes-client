...
public class MachinePoolBuilder extends MachinePoolFluent<MachinePoolBuilder> implements VisitableBuilder<MachinePool,MachinePoolBuilder>{
  ...
  public MachinePool build() {
    MachinePool buildable = new MachinePool(fluent.getAffinityGroupsNames(), fluent.getAutoPinningPolicy(), fluent.getClone(), fluent.buildCpu(), fluent.getFormat(), fluent.getHugepages(), fluent.getInstanceTypeID(), fluent.getMemoryMB(), fluent.buildOsDisk(), fluent.getSparse(), fluent.getVmType());
