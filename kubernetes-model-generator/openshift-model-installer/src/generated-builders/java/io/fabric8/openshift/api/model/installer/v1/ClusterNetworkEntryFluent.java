...
public class ClusterNetworkEntryFluent<A extends io.fabric8.openshift.api.model.installer.v1.ClusterNetworkEntryFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(cidr, hostPrefix, hostSubnetLength, additionalProperties);
  }
  ...
  public A withHostPrefix(Integer hostPrefix) {
