...
public class MachinePoolBuilder extends MachinePoolFluent<MachinePoolBuilder> implements VisitableBuilder<MachinePool,MachinePoolBuilder>{
  ...
  public MachinePool build() {
    MachinePool buildable = new MachinePool(fluent.getAdditionalNetworkIDs(), fluent.getAdditionalSecurityGroupIDs(), fluent.buildRootVolume(), fluent.getServerGroupPolicy(), fluent.getType(), fluent.getZones());
