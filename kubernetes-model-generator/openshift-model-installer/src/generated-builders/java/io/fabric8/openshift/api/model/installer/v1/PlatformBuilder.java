...
public class PlatformBuilder extends PlatformFluent<PlatformBuilder> implements VisitableBuilder<Platform,PlatformBuilder>{
  ...
  public Platform build() {
    Platform buildable = new Platform(fluent.buildAws(), fluent.getAzure(), fluent.buildBaremetal(), fluent.buildExternal(), fluent.buildGcp(), fluent.buildIbmcloud(), fluent.buildNone(), fluent.buildNutanix(), fluent.buildOpenstack(), fluent.buildOvirt(), fluent.buildPowervc(), fluent.buildPowervs(), fluent.buildVsphere());
