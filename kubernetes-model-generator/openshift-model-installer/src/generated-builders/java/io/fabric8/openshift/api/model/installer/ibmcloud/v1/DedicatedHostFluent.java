...
public class DedicatedHostFluent<A extends io.fabric8.openshift.api.model.installer.ibmcloud.v1.DedicatedHostFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(name, profile, additionalProperties);
  }
