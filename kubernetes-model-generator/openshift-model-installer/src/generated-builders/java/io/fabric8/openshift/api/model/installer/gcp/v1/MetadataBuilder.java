...
public class MetadataBuilder extends MetadataFluent<MetadataBuilder> implements VisitableBuilder<Metadata,MetadataBuilder>{
  ...
  public Metadata build() {
    Metadata buildable = new Metadata(fluent.buildEndpoint(), fluent.getFirewallRulesManagement(), fluent.getNetworkProjectID(), fluent.getPrivateZoneDomain(), fluent.getPrivateZoneProjectID(), fluent.getProjectID(), fluent.getRegion());
