...
public class ClusterAutoscaler implements Editable<ClusterAutoscalerBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterAutoscaler)) {
            return false;
        }
        ClusterAutoscaler other = (ClusterAutoscaler) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClusterAutoscaler;
    }
    ...
    public String toString() {
        return "ClusterAutoscaler(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
