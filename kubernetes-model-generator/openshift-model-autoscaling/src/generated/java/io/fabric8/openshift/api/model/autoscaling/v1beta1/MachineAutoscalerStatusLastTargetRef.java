...
public class MachineAutoscalerStatusLastTargetRef implements Editable<MachineAutoscalerStatusLastTargetRefBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MachineAutoscalerStatusLastTargetRef)) {
            return false;
        }
        MachineAutoscalerStatusLastTargetRef other = (MachineAutoscalerStatusLastTargetRef) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MachineAutoscalerStatusLastTargetRef;
    }
    ...
    public String toString() {
        return "MachineAutoscalerStatusLastTargetRef(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
