...
public class ClusterAutoscalerSpecRLCores implements Editable<ClusterAutoscalerSpecRLCoresBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterAutoscalerSpecRLCores)) {
            return false;
        }
        ClusterAutoscalerSpecRLCores other = (ClusterAutoscalerSpecRLCores) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClusterAutoscalerSpecRLCores;
    }
    ...
    public String toString() {
        return "ClusterAutoscalerSpecRLCores(" + "max=" + this.getMax() + ", min=" + this.getMin() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
