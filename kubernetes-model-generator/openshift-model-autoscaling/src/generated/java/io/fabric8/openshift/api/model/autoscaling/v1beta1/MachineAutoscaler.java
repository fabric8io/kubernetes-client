...
public class MachineAutoscaler implements Editable<MachineAutoscalerBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MachineAutoscaler)) {
            return false;
        }
        MachineAutoscaler other = (MachineAutoscaler) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MachineAutoscaler;
    }
    ...
    public String toString() {
        return "MachineAutoscaler(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
