...
public class RoleListFluent<A extends io.fabric8.kubernetes.api.model.rbac.RoleListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<RoleBuilder> items = new ArrayList<RoleBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(Role item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<RoleBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<RoleBuilder> predicate) {
    ...
    Iterator<RoleBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        RoleBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Role item) {
  ...
  public class ItemsNested<N> extends RoleFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RoleListFluent.this.setToItems(index, builder.build());
    }
