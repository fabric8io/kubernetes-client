...
public class RoleFluent<A extends io.fabric8.kubernetes.api.model.rbac.RoleFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, kind, metadata, rules, additionalProperties);
  }
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RoleFluent.this.withMetadata(builder.build());
    }
  ...
  public class RulesNested<N> extends PolicyRuleFluent<RulesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) RoleFluent.this.setToRules(index, builder.build());
    }
