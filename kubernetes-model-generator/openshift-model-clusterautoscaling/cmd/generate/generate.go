...
import (
  ...
  "strings"
  "time"
  clusterautoscalerv1beta1 "github.com/openshift/cluster-autoscaler-operator/pkg/apis/autoscaling/v1beta1"
  clusterautoscalerv1 "github.com/openshift/cluster-autoscaler-operator/pkg/apis/autoscaling/v1"
...
type Schema struct {
  ...
  Patch                                    metav1.Patch
  Time                                     metav1.Time
  ClusterAutoscaler                        clusterautoscalerv1.ClusterAutoscaler
  ClusterAutoscalerList                    clusterautoscalerv1.ClusterAutoscalerList
  V1beta1MachineAutoscaler                 clusterautoscalerv1beta1.MachineAutoscaler
  V1beta1MachineAutoscalerList             clusterautoscalerv1beta1.MachineAutoscalerList
}
...
func main() {
  packages := []schemagen.PackageDescriptor{
    ...
    {"github.com/openshift/cluster-autoscaler-operator/pkg/apis/autoscaling/v1", "autoscaling", "io.fabric8.openshift.api.model.clusterautoscaling.v1", "os_clusterautoscaling_v1_", true},
    {"github.com/openshift/cluster-autoscaler-operator/pkg/apis/autoscaling/v1beta1", "autoscaling", "io.fabric8.openshift.api.model.clusterautoscaling.v1beta1", "os_clusterautoscaling_v1beta1_", true},
  }
  ...
  schema, err := schemagen.GenerateSchema(reflect.TypeOf(Schema{}), packages, typeMap, manualTypeMap,"clusterautoscaling")
  if err != nil {
