...
public class EgressNetworkPolicyListFluent<A extends io.fabric8.openshift.api.model.miscellaneous.network.v1.EgressNetworkPolicyListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<EgressNetworkPolicyBuilder> items = new ArrayList<EgressNetworkPolicyBuilder>();
  private String kind;
  private ListMeta metadata;

  public EgressNetworkPolicyListFluent() {
  }
  
  public EgressNetworkPolicyListFluent(EgressNetworkPolicyList instance) {
  ...
  public A addAllToItems(Collection<EgressNetworkPolicy> items) {
    ...
    for (EgressNetworkPolicy item : items) {
  ...
  public ItemsNested<A> addNewItemLike(EgressNetworkPolicy item) {
  ...
  public EgressNetworkPolicy buildMatchingItem(Predicate<EgressNetworkPolicyBuilder> predicate) {
      for (EgressNetworkPolicyBuilder item : items) {
  ...
  protected void copyInstance(EgressNetworkPolicyList instance) {
    instance = instance != null ? instance : new EgressNetworkPolicyList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<EgressNetworkPolicyBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    EgressNetworkPolicyListFluent that = (EgressNetworkPolicyListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<EgressNetworkPolicyBuilder> predicate) {
    ...
    Iterator<EgressNetworkPolicyBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        EgressNetworkPolicyBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,EgressNetworkPolicy item) {
  ...
  public class ItemsNested<N> extends EgressNetworkPolicyFluent<ItemsNested<N>> implements Nested<N>{
  
    EgressNetworkPolicyBuilder builder;
    int index;
  
    ItemsNested(int index,EgressNetworkPolicy item) {
      this.index = index;
      this.builder = new EgressNetworkPolicyBuilder(this, item);
    }
  
    public N and() {
      return (N) EgressNetworkPolicyListFluent.this.setToItems(index, builder.build());
    }
