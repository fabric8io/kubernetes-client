...
public class Metal3DataClaimSpecFluent<A extends io.fabric8.openshift.api.model.miscellaneous.metal3.v1beta1.Metal3DataClaimSpecFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private ObjectReferenceBuilder template;

  public Metal3DataClaimSpecFluent() {
  }
  
  public Metal3DataClaimSpecFluent(Metal3DataClaimSpec instance) {
  ...
  protected void copyInstance(Metal3DataClaimSpec instance) {
    instance = instance != null ? instance : new Metal3DataClaimSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    Metal3DataClaimSpecFluent that = (Metal3DataClaimSpecFluent) o;
  ...
  public class TemplateNested<N> extends ObjectReferenceFluent<TemplateNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) Metal3DataClaimSpecFluent.this.withTemplate(builder.build());
    }
