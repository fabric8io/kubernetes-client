...
public class Metal3RemediationFluent<A extends io.fabric8.openshift.api.model.miscellaneous.metal3.v1beta1.Metal3RemediationFluent<A>> extends BaseFluent<A>{
  ...
  public Metal3RemediationFluent() {
  }
  
  public Metal3RemediationFluent(Metal3Remediation instance) {
  ...
  protected void copyInstance(Metal3Remediation instance) {
    instance = instance != null ? instance : new Metal3Remediation();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    Metal3RemediationFluent that = (Metal3RemediationFluent) o;
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) Metal3RemediationFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends Metal3RemediationSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) Metal3RemediationFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends Metal3RemediationStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) Metal3RemediationFluent.this.withStatus(builder.build());
    }
