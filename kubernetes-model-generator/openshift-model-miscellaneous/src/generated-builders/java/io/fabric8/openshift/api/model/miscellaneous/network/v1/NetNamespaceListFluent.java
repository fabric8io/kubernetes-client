...
public class NetNamespaceListFluent<A extends io.fabric8.openshift.api.model.miscellaneous.network.v1.NetNamespaceListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<NetNamespaceBuilder> items = new ArrayList<NetNamespaceBuilder>();
  private String kind;
  private ListMeta metadata;

  public NetNamespaceListFluent() {
  }
  
  public NetNamespaceListFluent(NetNamespaceList instance) {
  ...
  public ItemsNested<A> addNewItemLike(NetNamespace item) {
  ...
  public NetNamespace buildMatchingItem(Predicate<NetNamespaceBuilder> predicate) {
      for (NetNamespaceBuilder item : items) {
  ...
  protected void copyInstance(NetNamespaceList instance) {
    instance = instance != null ? instance : new NetNamespaceList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<NetNamespaceBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    NetNamespaceListFluent that = (NetNamespaceListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<NetNamespaceBuilder> predicate) {
    ...
    Iterator<NetNamespaceBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,NetNamespace item) {
  ...
  public class ItemsNested<N> extends NetNamespaceFluent<ItemsNested<N>> implements Nested<N>{
  
    NetNamespaceBuilder builder;
    int index;
  
    ItemsNested(int index,NetNamespace item) {
      this.index = index;
      this.builder = new NetNamespaceBuilder(this, item);
    }
  
    public N and() {
      return (N) NetNamespaceListFluent.this.setToItems(index, builder.build());
    }
