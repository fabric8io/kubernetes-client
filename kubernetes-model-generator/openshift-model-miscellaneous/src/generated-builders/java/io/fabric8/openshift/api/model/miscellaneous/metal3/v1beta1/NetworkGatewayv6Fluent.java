...
public class NetworkGatewayv6Fluent<A extends io.fabric8.openshift.api.model.miscellaneous.metal3.v1beta1.NetworkGatewayv6Fluent<A>> extends BaseFluent<A>{
  ...
  public NetworkGatewayv6Fluent() {
  }
  
  public NetworkGatewayv6Fluent(NetworkGatewayv6 instance) {
  ...
  protected void copyInstance(NetworkGatewayv6 instance) {
    instance = instance != null ? instance : new NetworkGatewayv6();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkGatewayv6Fluent that = (NetworkGatewayv6Fluent) o;
  ...
  public class FromPoolAnnotationNested<N> extends FromPoolAnnotationFluent<FromPoolAnnotationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NetworkGatewayv6Fluent.this.withFromPoolAnnotation(builder.build());
    }
