...
public class ImageFluent<A extends io.fabric8.openshift.api.model.miscellaneous.metal3.v1alpha1.ImageFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(Image instance) {
    ...
    if (instance != null) {
        ...
        this.withOciAuthSecretName(instance.getOciAuthSecretName());
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(ociAuthSecretName, that.ociAuthSecretName))) {
      return false;
    }
  ...
  public boolean hasOciAuthSecretName() {
    return this.ociAuthSecretName != null;
  }
  ...
  public int hashCode() {
    return Objects.hash(checksum, checksumType, format, ociAuthSecretName, url, additionalProperties);
  }
  ...
  public String toString() {
    ...
    if (!(ociAuthSecretName == null)) {
        sb.append("ociAuthSecretName:");
        sb.append(ociAuthSecretName);
        sb.append(",");
    }
    if (!(url == null)) {
  ...
  public A withOciAuthSecretName(String ociAuthSecretName) {
