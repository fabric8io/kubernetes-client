...
public class Metal3DataListFluent<A extends io.fabric8.openshift.api.model.miscellaneous.metal3.v1beta1.Metal3DataListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<Metal3DataBuilder> items = new ArrayList<Metal3DataBuilder>();
  private String kind;
  ...
  public Metal3Data buildMatchingItem(Predicate<Metal3DataBuilder> predicate) {
      for (Metal3DataBuilder item : items) {
  ...
  protected void copyInstance(Metal3DataList instance) {
    instance = instance != null ? instance : new Metal3DataList();
    if (instance != null) {
  ...
  public A removeMatchingFromItems(Predicate<Metal3DataBuilder> predicate) {
    ...
    Iterator<Metal3DataBuilder> each = items.iterator();
  ...
  public class ItemsNested<N> extends Metal3DataFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) Metal3DataListFluent.this.setToItems(index, builder.build());
    }
