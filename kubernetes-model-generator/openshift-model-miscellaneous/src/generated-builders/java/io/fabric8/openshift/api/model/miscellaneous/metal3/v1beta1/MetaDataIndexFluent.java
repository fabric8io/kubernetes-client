...
public class MetaDataIndexFluent<A extends io.fabric8.openshift.api.model.miscellaneous.metal3.v1beta1.MetaDataIndexFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(MetaDataIndex instance) {
    instance = instance != null ? instance : new MetaDataIndex();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    MetaDataIndexFluent that = (MetaDataIndexFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(key, offset, prefix, step, suffix, additionalProperties);
  }
