...
public class Metal3Data implements Editable<Metal3DataBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Metal3Data)) {
            return false;
        }
        Metal3Data other = (Metal3Data) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Metal3Data;
    }
    ...
    public String toString() {
        return "Metal3Data(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
