...
public class BareMetalHostStatusPFirmware implements Editable<BareMetalHostStatusPFirmwareBuilder> , KubernetesResource
{
     ...
     * 
     */
    public BareMetalHostStatusPFirmware() {
    }

    public BareMetalHostStatusPFirmware(Boolean simultaneousMultithreadingEnabled, Boolean sriovEnabled, Boolean virtualizationEnabled) {
        super();
    ...
    @JsonIgnore
    public BareMetalHostStatusPFirmwareBuilder edit() {
        return new BareMetalHostStatusPFirmwareBuilder(this);
    }

    @JsonIgnore
    public BareMetalHostStatusPFirmwareBuilder toBuilder() {
        return edit();
    }
