...
public class BMCEventSubscription implements Editable<BMCEventSubscriptionBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BMCEventSubscription)) {
            return false;
        }
        BMCEventSubscription other = (BMCEventSubscription) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof BMCEventSubscription;
    }
    ...
    public String toString() {
        return "BMCEventSubscription(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
