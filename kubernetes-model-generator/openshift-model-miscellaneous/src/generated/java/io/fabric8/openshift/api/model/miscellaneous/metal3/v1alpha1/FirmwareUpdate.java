...
public class FirmwareUpdate implements Editable<FirmwareUpdateBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        FirmwareUpdate other = (FirmwareUpdate) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof FirmwareUpdate;
    }
    ...
    public String toString() {
        return "FirmwareUpdate(" + "component=" + this.getComponent() + ", url=" + this.getUrl() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
