...
public class Cluster implements Editable<ClusterBuilder>, HasMetadata, Namespaced
{
    ...
    public Cluster(String apiVersion, String kind, ObjectMeta metadata, ClusterSpec spec, ClusterStatus status) {
        super();
