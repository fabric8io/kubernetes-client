...
public class HostDeployPolicyStatus implements Editable<HostDeployPolicyStatusBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostDeployPolicyStatus)) {
            return false;
        }
        HostDeployPolicyStatus other = (HostDeployPolicyStatus) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HostDeployPolicyStatus;
    }
    ...
    public String toString() {
        return "HostDeployPolicyStatus(" + "additionalProperties=" + this.getAdditionalProperties() + ")";
    }
