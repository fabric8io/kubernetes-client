...
public class BareMetalHostSpecFirmware implements Editable<BareMetalHostSpecFirmwareBuilder> , KubernetesResource
{
     ...
     * 
     */
    public BareMetalHostSpecFirmware() {
    }

    public BareMetalHostSpecFirmware(Boolean simultaneousMultithreadingEnabled, Boolean sriovEnabled, Boolean virtualizationEnabled) {
        super();
    ...
    @JsonIgnore
    public BareMetalHostSpecFirmwareBuilder edit() {
        return new BareMetalHostSpecFirmwareBuilder(this);
    }

    @JsonIgnore
    public BareMetalHostSpecFirmwareBuilder toBuilder() {
        return edit();
    }
