...
public class ImagePlan implements Editable<ImagePlanBuilder>, KubernetesResource
{
    ...
    public ImagePlan(String offer, String publisher, String sku) {
        super();
        this.offer = offer;
    ...
    @JsonIgnore
    public ImagePlanBuilder edit() {
        return new ImagePlanBuilder(this);
    }

    @JsonIgnore
    public ImagePlanBuilder toBuilder() {
        return edit();
    }
