...
public class BareMetalHostSpecRootDeviceHints implements Editable<BareMetalHostSpecRootDeviceHintsBuilder> , KubernetesResource
{
     ...
     * 
     */
    public BareMetalHostSpecRootDeviceHints() {
    }

    public BareMetalHostSpecRootDeviceHints(String deviceName, String hctl, Integer minSizeGigabytes, String model, Boolean rotational, String serialNumber, String vendor, String wwn, String wwnVendorExtension, String wwnWithExtension) {
        super();
    ...
    @JsonIgnore
    public BareMetalHostSpecRootDeviceHintsBuilder edit() {
        return new BareMetalHostSpecRootDeviceHintsBuilder(this);
    }

    @JsonIgnore
    public BareMetalHostSpecRootDeviceHintsBuilder toBuilder() {
        return edit();
    }
