...
public class Metal3RemediationSpec implements Editable<Metal3RemediationSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Metal3RemediationSpec)) {
            return false;
        }
        Metal3RemediationSpec other = (Metal3RemediationSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Metal3RemediationSpec;
    }
    ...
    public String toString() {
        return "Metal3RemediationSpec(" + "strategy=" + this.getStrategy() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
