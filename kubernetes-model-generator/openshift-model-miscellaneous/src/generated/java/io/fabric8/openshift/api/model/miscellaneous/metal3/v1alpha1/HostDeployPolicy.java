...
public class HostDeployPolicy implements Editable<HostDeployPolicyBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostDeployPolicy)) {
            return false;
        }
        HostDeployPolicy other = (HostDeployPolicy) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HostDeployPolicy;
    }
    ...
    public String toString() {
        return "HostDeployPolicy(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
