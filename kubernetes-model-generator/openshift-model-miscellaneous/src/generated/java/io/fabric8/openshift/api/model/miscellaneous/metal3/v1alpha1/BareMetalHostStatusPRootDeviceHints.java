...
public class BareMetalHostStatusPRootDeviceHints implements Editable<BareMetalHostStatusPRootDeviceHintsBuilder> , KubernetesResource
{
     ...
     * 
     */
    public BareMetalHostStatusPRootDeviceHints() {
    }

    public BareMetalHostStatusPRootDeviceHints(String deviceName, String hctl, Integer minSizeGigabytes, String model, Boolean rotational, String serialNumber, String vendor, String wwn, String wwnVendorExtension, String wwnWithExtension) {
        super();
    ...
    @JsonIgnore
    public BareMetalHostStatusPRootDeviceHintsBuilder edit() {
        return new BareMetalHostStatusPRootDeviceHintsBuilder(this);
    }

    @JsonIgnore
    public BareMetalHostStatusPRootDeviceHintsBuilder toBuilder() {
        return edit();
    }
