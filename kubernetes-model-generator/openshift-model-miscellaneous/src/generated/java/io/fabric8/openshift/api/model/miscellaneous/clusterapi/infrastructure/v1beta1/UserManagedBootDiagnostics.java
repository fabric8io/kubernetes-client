...
public class UserManagedBootDiagnostics implements Editable<UserManagedBootDiagnosticsBuilder>, KubernetesResource
{
     ...
     */
    public UserManagedBootDiagnostics() {
    }

    public UserManagedBootDiagnostics(String storageAccountURI) {
        super();
    ...
    @JsonIgnore
    public UserManagedBootDiagnosticsBuilder edit() {
        return new UserManagedBootDiagnosticsBuilder(this);
    }

    @JsonIgnore
    public UserManagedBootDiagnosticsBuilder toBuilder() {
        return edit();
    }
