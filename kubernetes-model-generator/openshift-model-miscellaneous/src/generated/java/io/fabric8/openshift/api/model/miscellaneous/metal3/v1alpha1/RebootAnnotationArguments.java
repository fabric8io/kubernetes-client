...
public class RebootAnnotationArguments implements Editable<RebootAnnotationArgumentsBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RebootAnnotationArguments)) {
            return false;
        }
        RebootAnnotationArguments other = (RebootAnnotationArguments) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RebootAnnotationArguments;
    }
    ...
    public String toString() {
        return "RebootAnnotationArguments(" + "force=" + this.getForce() + ", mode=" + this.getMode() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
