...
public class HostClaim implements Editable<HostClaimBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostClaim)) {
            return false;
        }
        HostClaim other = (HostClaim) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HostClaim;
    }
    ...
    public String toString() {
        return "HostClaim(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
