...
public class ProjectHelmChartRepositorySpec implements Editable<ProjectHelmChartRepositorySpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProjectHelmChartRepositorySpec)) {
            return false;
        }
        ProjectHelmChartRepositorySpec other = (ProjectHelmChartRepositorySpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ProjectHelmChartRepositorySpec;
    }
    ...
    public String toString() {
        return "ProjectHelmChartRepositorySpec(" + "connectionConfig=" + this.getConnectionConfig() + ", description=" + this.getDescription() + ", disabled=" + this.getDisabled() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
