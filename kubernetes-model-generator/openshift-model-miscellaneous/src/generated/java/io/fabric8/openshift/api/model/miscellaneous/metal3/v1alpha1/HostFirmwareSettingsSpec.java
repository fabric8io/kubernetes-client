...
public class HostFirmwareSettingsSpec implements Editable<HostFirmwareSettingsSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostFirmwareSettingsSpec)) {
            return false;
        }
        HostFirmwareSettingsSpec other = (HostFirmwareSettingsSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HostFirmwareSettingsSpec;
    }
    ...
    public String toString() {
        return "HostFirmwareSettingsSpec(" + "settings=" + this.getSettings() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
