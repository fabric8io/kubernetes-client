...
public class AzureProviderStatus implements Editable<AzureProviderStatusBuilder>, KubernetesResource, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AzureProviderStatus)) {
            return false;
        }
        AzureProviderStatus other = (AzureProviderStatus) o;
        ...
        Object this$secretLastResourceVersion = this.getSecretLastResourceVersion();
        Object other$secretLastResourceVersion = other.getSecretLastResourceVersion();
        if (this$secretLastResourceVersion == null ? other$secretLastResourceVersion != null : !this$secretLastResourceVersion.equals(other$secretLastResourceVersion)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AzureProviderStatus;
    }
    ...
    public int hashCode() {
        ...
        Object $secretLastResourceVersion = this.getSecretLastResourceVersion();
        result = result * prime + ($secretLastResourceVersion == null ? 43 : $secretLastResourceVersion.hashCode());
    ...
    public String toString() {
        return "AzureProviderStatus(" + "apiVersion=" + this.getApiVersion() + ", appID=" + this.getAppID() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", secretLastResourceVersion=" + this.getSecretLastResourceVersion() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
