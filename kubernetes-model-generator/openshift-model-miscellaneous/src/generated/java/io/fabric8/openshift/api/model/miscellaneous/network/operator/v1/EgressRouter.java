...
public class EgressRouter implements HasMetadata, Namespaced
{
    ...
    public EgressRouter(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, EgressRouterSpec spec, EgressRouterStatus status) {
        super();
