...
public class NetworkGatewayv4 implements Editable<NetworkGatewayv4Builder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkGatewayv4)) {
            return false;
        }
        NetworkGatewayv4 other = (NetworkGatewayv4) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof NetworkGatewayv4;
    }
    ...
    public String toString() {
        return "NetworkGatewayv4(" + "fromIPPool=" + this.getFromIPPool() + ", fromPoolAnnotation=" + this.getFromPoolAnnotation() + ", fromPoolRef=" + this.getFromPoolRef() + ", string=" + this.getString() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
