...
public class IPTag implements Editable<IPTagBuilder>, KubernetesResource
{
    ...
    public IPTag(String tag, String type) {
        super();
        this.tag = tag;
        this.type = type;
    }
    ...
    @JsonIgnore
    public IPTagBuilder edit() {
        return new IPTagBuilder(this);
    }

    @JsonIgnore
    public IPTagBuilder toBuilder() {
        return edit();
    }
