...
public class NetworkDataRoutev4 implements Editable<NetworkDataRoutev4Builder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkDataRoutev4)) {
            return false;
        }
        NetworkDataRoutev4 other = (NetworkDataRoutev4) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof NetworkDataRoutev4;
    }
    ...
    public String toString() {
        return "NetworkDataRoutev4(" + "gateway=" + this.getGateway() + ", network=" + this.getNetwork() + ", prefix=" + this.getPrefix() + ", services=" + this.getServices() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
