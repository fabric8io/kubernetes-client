...
public class VnetPeeringSpec implements Editable<VnetPeeringSpecBuilder>, KubernetesResource
{
     ...
     */
    public VnetPeeringSpec() {
    }

    public VnetPeeringSpec(VnetPeeringProperties forwardPeeringProperties, String remoteVnetName, String resourceGroup, VnetPeeringProperties reversePeeringProperties) {
        super();
    ...
    @JsonIgnore
    public VnetPeeringSpecBuilder edit() {
        return new VnetPeeringSpecBuilder(this);
    }

    @JsonIgnore
    public VnetPeeringSpecBuilder toBuilder() {
        return edit();
    }
