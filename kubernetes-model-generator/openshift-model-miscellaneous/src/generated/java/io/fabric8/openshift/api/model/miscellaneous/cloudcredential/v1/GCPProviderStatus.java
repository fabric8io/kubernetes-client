...
public class GCPProviderStatus implements Editable<GCPProviderStatusBuilder>, KubernetesResource, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GCPProviderStatus)) {
            return false;
        }
        GCPProviderStatus other = (GCPProviderStatus) o;
        ...
        Object this$serviceAccountID = this.getServiceAccountID();
        Object other$serviceAccountID = other.getServiceAccountID();
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GCPProviderStatus;
    }
    ...
    public int hashCode() {
        ...
        Object $serviceAccountID = this.getServiceAccountID();
        result = result * prime + ($serviceAccountID == null ? 43 : $serviceAccountID.hashCode());
    ...
    public String toString() {
        return "GCPProviderStatus(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", roleID=" + this.getRoleID() + ", serviceAccountID=" + this.getServiceAccountID() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
