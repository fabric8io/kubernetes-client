...
public class AttachedImageReference implements Editable<AttachedImageReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachedImageReference)) {
            return false;
        }
        AttachedImageReference other = (AttachedImageReference) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AttachedImageReference;
    }
    ...
    public String toString() {
        return "AttachedImageReference(" + "url=" + this.getUrl() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
