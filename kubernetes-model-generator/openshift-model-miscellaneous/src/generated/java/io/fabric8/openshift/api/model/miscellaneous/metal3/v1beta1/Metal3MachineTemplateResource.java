...
public class Metal3MachineTemplateResource implements Editable<Metal3MachineTemplateResourceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Metal3MachineTemplateResource)) {
            return false;
        }
        Metal3MachineTemplateResource other = (Metal3MachineTemplateResource) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Metal3MachineTemplateResource;
    }
    ...
    public String toString() {
        return "Metal3MachineTemplateResource(" + "spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
