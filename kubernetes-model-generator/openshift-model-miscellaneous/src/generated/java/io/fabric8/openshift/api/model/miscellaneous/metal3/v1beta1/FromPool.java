...
public class FromPool implements Editable<FromPoolBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FromPool)) {
            return false;
        }
        FromPool other = (FromPool) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof FromPool;
    }
    ...
    public String toString() {
        return "FromPool(" + "apiGroup=" + this.getApiGroup() + ", key=" + this.getKey() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
