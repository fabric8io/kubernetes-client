...
public class Metal3Cluster implements Editable<Metal3ClusterBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Metal3Cluster)) {
            return false;
        }
        Metal3Cluster other = (Metal3Cluster) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Metal3Cluster;
    }
    ...
    public String toString() {
        return "Metal3Cluster(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
