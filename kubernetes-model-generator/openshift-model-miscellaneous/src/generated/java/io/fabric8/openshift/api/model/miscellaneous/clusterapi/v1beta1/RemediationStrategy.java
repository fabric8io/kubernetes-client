...
public class RemediationStrategy implements Editable<RemediationStrategyBuilder>, KubernetesResource
{
    ...
    @JsonProperty("maxInFlight")
    private IntOrString maxInFlight;
    @JsonIgnore
    ...
    public RemediationStrategy(IntOrString maxInFlight) {
        super();
     ...
     */
    @JsonProperty("maxInFlight")
    public IntOrString getMaxInFlight() {
        return maxInFlight;
    }
     ...
     */
    @JsonProperty("maxInFlight")
    public void setMaxInFlight(IntOrString maxInFlight) {
        this.maxInFlight = maxInFlight;
    }
