...
public class DiffDiskSettings implements Editable<DiffDiskSettingsBuilder>, KubernetesResource
{
    ...
    public DiffDiskSettings(String option, String placement) {
        super();
        this.option = option;
    ...
    @JsonIgnore
    public DiffDiskSettingsBuilder edit() {
        return new DiffDiskSettingsBuilder(this);
    }

    @JsonIgnore
    public DiffDiskSettingsBuilder toBuilder() {
        return edit();
    }
