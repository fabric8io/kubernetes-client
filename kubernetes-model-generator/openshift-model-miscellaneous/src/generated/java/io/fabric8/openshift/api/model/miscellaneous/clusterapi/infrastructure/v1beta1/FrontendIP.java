...
public class FrontendIP implements Editable<FrontendIPBuilder>, KubernetesResource
{
    ...
    public FrontendIP(String name, String privateIP, PublicIPSpec publicIP) {
        super();
        this.name = name;
    ...
    @JsonIgnore
    public FrontendIPBuilder edit() {
        return new FrontendIPBuilder(this);
    }

    @JsonIgnore
    public FrontendIPBuilder toBuilder() {
        return edit();
    }
