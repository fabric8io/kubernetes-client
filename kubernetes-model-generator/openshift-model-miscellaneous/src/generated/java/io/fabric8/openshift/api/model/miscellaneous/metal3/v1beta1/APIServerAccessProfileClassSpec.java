...
public class APIServerAccessProfileClassSpec implements Editable<APIServerAccessProfileClassSpecBuilder>, KubernetesResource
{
     ...
     */
    public APIServerAccessProfileClassSpec() {
    }

    public APIServerAccessProfileClassSpec(Boolean enablePrivateCluster, Boolean enablePrivateClusterPublicFQDN, String privateDNSZone) {
        super();
    ...
    @JsonIgnore
    public APIServerAccessProfileClassSpecBuilder edit() {
        return new APIServerAccessProfileClassSpecBuilder(this);
    }

    @JsonIgnore
    public APIServerAccessProfileClassSpecBuilder toBuilder() {
        return edit();
    }
