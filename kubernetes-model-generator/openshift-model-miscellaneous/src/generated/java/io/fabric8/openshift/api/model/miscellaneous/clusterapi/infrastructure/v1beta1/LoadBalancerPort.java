...
public class LoadBalancerPort implements Editable<LoadBalancerPortBuilder>, KubernetesResource
{
    ...
    public LoadBalancerPort(String name, Integer port) {
        super();
        this.name = name;
        this.port = port;
    }
    ...
    @JsonIgnore
    public LoadBalancerPortBuilder edit() {
        return new LoadBalancerPortBuilder(this);
    }

    @JsonIgnore
    public LoadBalancerPortBuilder toBuilder() {
        return edit();
    }
