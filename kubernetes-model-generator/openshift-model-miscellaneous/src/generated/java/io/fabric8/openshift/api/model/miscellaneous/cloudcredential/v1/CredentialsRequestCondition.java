...
public class CredentialsRequestCondition implements Editable<CredentialsRequestConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CredentialsRequestCondition)) {
            return false;
        }
        CredentialsRequestCondition other = (CredentialsRequestCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CredentialsRequestCondition;
    }
    ...
    public String toString() {
        return "CredentialsRequestCondition(" + "lastProbeTime=" + this.getLastProbeTime() + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
