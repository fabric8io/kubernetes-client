...
public class CertificateSigningRequest implements Editable<CertificateSigningRequestBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CertificateSigningRequest)) {
            return false;
        }
    ...
    public String toString() {
        return "CertificateSigningRequest(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
