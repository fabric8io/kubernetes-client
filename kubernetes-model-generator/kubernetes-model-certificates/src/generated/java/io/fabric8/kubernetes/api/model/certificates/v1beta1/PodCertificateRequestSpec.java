...
public class PodCertificateRequestSpec implements Editable<PodCertificateRequestSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        Object this$pkixPublicKey = this.getPkixPublicKey();
        Object other$pkixPublicKey = other.getPkixPublicKey();
        if (this$pkixPublicKey == null ? other$pkixPublicKey != null : !this$pkixPublicKey.equals(other$pkixPublicKey)) {
            return false;
        }
        ...
        Object this$proofOfPossession = this.getProofOfPossession();
        Object other$proofOfPossession = other.getProofOfPossession();
        if (this$proofOfPossession == null ? other$proofOfPossession != null : !this$proofOfPossession.equals(other$proofOfPossession)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        Object $pkixPublicKey = this.getPkixPublicKey();
        result = result * prime + ($pkixPublicKey == null ? 43 : $pkixPublicKey.hashCode());
        ...
        Object $proofOfPossession = this.getProofOfPossession();
        result = result * prime + ($proofOfPossession == null ? 43 : $proofOfPossession.hashCode());
    ...
    public String toString() {
        return "PodCertificateRequestSpec(" + "maxExpirationSeconds=" + this.getMaxExpirationSeconds() + ", nodeName=" + this.getNodeName() + ", nodeUID=" + this.getNodeUID() + ", pkixPublicKey=" + this.getPkixPublicKey() + ", podName=" + this.getPodName() + ", podUID=" + this.getPodUID() + ", proofOfPossession=" + this.getProofOfPossession() + ", serviceAccountName=" + this.getServiceAccountName() + ", serviceAccountUID=" + this.getServiceAccountUID() + ", signerName=" + this.getSignerName() + ", stubPKCS10Request=" + this.getStubPKCS10Request() + ", unverifiedUserAnnotations=" + this.getUnverifiedUserAnnotations() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
