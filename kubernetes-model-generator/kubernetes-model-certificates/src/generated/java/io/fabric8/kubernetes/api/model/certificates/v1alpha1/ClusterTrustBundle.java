...
public class ClusterTrustBundle implements HasMetadata
{
    ...
    public ClusterTrustBundle(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, ClusterTrustBundleSpec spec) {
        super();
