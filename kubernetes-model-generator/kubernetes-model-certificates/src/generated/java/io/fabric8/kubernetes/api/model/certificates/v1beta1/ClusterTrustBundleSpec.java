...
public class ClusterTrustBundleSpec implements Editable<ClusterTrustBundleSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterTrustBundleSpec)) {
            return false;
        }
        ...
        if (this$trustBundle == null ? other$trustBundle != null : !this$trustBundle.equals(other$trustBundle)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = result * prime + ($trustBundle == null ? 43 : $trustBundle.hashCode());
    ...
    public String toString() {
        return "ClusterTrustBundleSpec(" + "signerName=" + this.getSignerName() + ", trustBundle=" + this.getTrustBundle() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
