...
public class PodCertificateRequest implements Editable<PodCertificateRequestBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodCertificateRequest)) {
            return false;
        }
        PodCertificateRequest other = (PodCertificateRequest) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PodCertificateRequest;
    }
    ...
    public String toString() {
        return "PodCertificateRequest(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
