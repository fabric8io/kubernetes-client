...
public class PodCertificateRequestSpecFluent<A extends io.fabric8.kubernetes.api.model.certificates.v1.PodCertificateRequestSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(maxExpirationSeconds, nodeName, nodeUID, podName, podUID, serviceAccountName, serviceAccountUID, signerName, stubPKCS10Request, unverifiedUserAnnotations, additionalProperties);
  }
