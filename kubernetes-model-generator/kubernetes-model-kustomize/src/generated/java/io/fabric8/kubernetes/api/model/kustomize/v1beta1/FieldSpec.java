...
public class FieldSpec implements Editable<FieldSpecBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "FieldSpec(" + "create=" + this.getCreate() + ", group=" + this.getGroup() + ", kind=" + this.getKind() + ", path=" + this.getPath() + ", version=" + this.getVersion() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
