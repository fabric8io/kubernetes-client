...
public class SourceSelector implements Editable<SourceSelectorBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SourceSelector)) {
            return false;
        }
        SourceSelector other = (SourceSelector) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SourceSelector;
    }
    ...
    public String toString() {
        return "SourceSelector(" + "fieldPath=" + this.getFieldPath() + ", group=" + this.getGroup() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", options=" + this.getOptions() + ", version=" + this.getVersion() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
