...
public class ImageVolumeStatus implements Editable<ImageVolumeStatusBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImageVolumeStatus)) {
            return false;
        }
        ImageVolumeStatus other = (ImageVolumeStatus) o;
        if (!other.canEqual(this)) {
            return false;
        }
        Object this$imageRef = this.getImageRef();
        Object other$imageRef = other.getImageRef();
        if (this$imageRef == null ? other$imageRef != null : !this$imageRef.equals(other$imageRef)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ImageVolumeStatus;
    }
    ...
    public int hashCode() {
        final int prime = 59;
        int result = 1;
        Object $imageRef = this.getImageRef();
        result = result * prime + ($imageRef == null ? 43 : $imageRef.hashCode());
    ...
    public String toString() {
        return "ImageVolumeStatus(" + "imageRef=" + this.getImageRef() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
