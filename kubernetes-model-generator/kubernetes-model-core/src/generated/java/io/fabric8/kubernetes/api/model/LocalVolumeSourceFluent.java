...
public class LocalVolumeSourceFluent<A extends io.fabric8.kubernetes.api.model.LocalVolumeSourceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(fsType, path, additionalProperties);
  }
