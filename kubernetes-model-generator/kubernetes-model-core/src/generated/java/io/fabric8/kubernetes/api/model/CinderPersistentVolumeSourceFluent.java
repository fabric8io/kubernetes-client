...
public class CinderPersistentVolumeSourceFluent<A extends io.fabric8.kubernetes.api.model.CinderPersistentVolumeSourceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(fsType, readOnly, secretRef, volumeID, additionalProperties);
  }
  ...
  public class SecretRefNested<N> extends SecretReferenceFluent<SecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CinderPersistentVolumeSourceFluent.this.withSecretRef(builder.build());
    }
