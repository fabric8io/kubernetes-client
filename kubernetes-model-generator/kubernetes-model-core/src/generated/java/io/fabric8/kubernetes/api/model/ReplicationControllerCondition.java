...
public class ReplicationControllerCondition implements Editable<ReplicationControllerConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReplicationControllerCondition)) {
            return false;
        }
    ...
    public String toString() {
        return "ReplicationControllerCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
