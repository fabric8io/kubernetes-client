...
public class GCEPersistentDiskVolumeSource implements Editable<GCEPersistentDiskVolumeSourceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GCEPersistentDiskVolumeSource)) {
            return false;
        }
        ...
        if (this$pdName == null ? other$pdName != null : !this$pdName.equals(other$pdName)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = result * prime + ($pdName == null ? 43 : $pdName.hashCode());
    ...
    public String toString() {
        return "GCEPersistentDiskVolumeSource(" + "fsType=" + this.getFsType() + ", partition=" + this.getPartition() + ", pdName=" + this.getPdName() + ", readOnly=" + this.getReadOnly() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
