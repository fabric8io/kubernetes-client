...
public class PodListFluent<A extends io.fabric8.kubernetes.api.model.PodListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<PodBuilder> items = new ArrayList<PodBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(Pod item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<PodBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<PodBuilder> predicate) {
    ...
    Iterator<PodBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        PodBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Pod item) {
  ...
  public class ItemsNested<N> extends PodFluent<ItemsNested<N>> implements Nested<N>{
  ...
  public class MetadataNested<N> extends ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodListFluent.this.withMetadata(builder.build());
    }
