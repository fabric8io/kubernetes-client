...
public class AzureFileVolumeSourceFluent<A extends io.fabric8.kubernetes.api.model.AzureFileVolumeSourceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(readOnly, secretName, shareName, additionalProperties);
  }
