...
public class WatchEventFluent<A extends io.fabric8.kubernetes.api.model.WatchEventFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(object, type, additionalProperties);
  }
