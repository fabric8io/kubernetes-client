...
public class APIResourceListFluent<A extends io.fabric8.kubernetes.api.model.APIResourceListFluent<A>> extends BaseFluent<A>{
  ...
  public APIResource buildMatchingResource(Predicate<APIResourceBuilder> predicate) {
      for (APIResourceBuilder item : resources) {
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, groupVersion, kind, resources, additionalProperties);
  }
  ...
  public A removeMatchingFromResources(Predicate<APIResourceBuilder> predicate) {
    ...
    Iterator<APIResourceBuilder> each = resources.iterator();
