...
public class PersistentVolumeClaimFluent<A extends io.fabric8.kubernetes.api.model.PersistentVolumeClaimFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new PersistentVolumeClaimSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(PersistentVolumeClaimSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new PersistentVolumeClaimStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(PersistentVolumeClaimStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(PersistentVolumeClaimSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(PersistentVolumeClaimStatus item) {
  ...
  public class StatusNested<N> extends PersistentVolumeClaimStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PersistentVolumeClaimFluent.this.withStatus(builder.build());
    }
