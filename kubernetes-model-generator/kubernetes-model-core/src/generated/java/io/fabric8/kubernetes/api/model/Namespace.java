...
public class Namespace implements Editable<NamespaceBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "Namespace(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
