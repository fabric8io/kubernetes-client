...
public class HostIP implements Editable<HostIPBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "HostIP(" + "ip=" + this.getIp() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
