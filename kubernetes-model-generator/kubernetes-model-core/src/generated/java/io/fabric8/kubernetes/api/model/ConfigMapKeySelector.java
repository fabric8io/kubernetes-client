...
public class ConfigMapKeySelector implements Editable<ConfigMapKeySelectorBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigMapKeySelector)) {
            return false;
        }
    ...
    public String toString() {
        return "ConfigMapKeySelector(" + "key=" + this.getKey() + ", name=" + this.getName() + ", optional=" + this.getOptional() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
