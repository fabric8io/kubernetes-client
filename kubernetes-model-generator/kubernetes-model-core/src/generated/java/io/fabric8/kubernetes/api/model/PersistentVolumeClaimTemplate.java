...
public class PersistentVolumeClaimTemplate implements Editable<PersistentVolumeClaimTemplateBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PersistentVolumeClaimTemplate)) {
            return false;
        }
    ...
    public String toString() {
        return "PersistentVolumeClaimTemplate(" + "metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
