...
public class CinderPersistentVolumeSource implements Editable<CinderPersistentVolumeSourceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CinderPersistentVolumeSource)) {
            return false;
        }
    ...
    public String toString() {
        return "CinderPersistentVolumeSource(" + "fsType=" + this.getFsType() + ", readOnly=" + this.getReadOnly() + ", secretRef=" + this.getSecretRef() + ", volumeID=" + this.getVolumeID() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
