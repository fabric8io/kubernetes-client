...
public class PersistentVolumeClaimCondition implements Editable<PersistentVolumeClaimConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PersistentVolumeClaimCondition)) {
            return false;
        }
    ...
    public String toString() {
        return "PersistentVolumeClaimCondition(" + "lastProbeTime=" + this.getLastProbeTime() + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
