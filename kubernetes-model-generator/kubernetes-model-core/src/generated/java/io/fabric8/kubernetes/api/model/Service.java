...
public class Service implements Editable<ServiceBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Service(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
