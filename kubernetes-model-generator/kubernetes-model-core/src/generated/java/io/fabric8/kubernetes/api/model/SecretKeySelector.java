...
public class SecretKeySelector implements Editable<SecretKeySelectorBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecretKeySelector)) {
            return false;
        }
    ...
    public String toString() {
        return "SecretKeySelector(" + "key=" + this.getKey() + ", name=" + this.getName() + ", optional=" + this.getOptional() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
