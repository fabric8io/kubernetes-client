...
public class NodeDaemonEndpoints implements Editable<NodeDaemonEndpointsBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NodeDaemonEndpoints)) {
            return false;
        }
        ...
        if (this$kubeletEndpoint == null ? other$kubeletEndpoint != null : !this$kubeletEndpoint.equals(other$kubeletEndpoint)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = result * prime + ($kubeletEndpoint == null ? 43 : $kubeletEndpoint.hashCode());
    ...
    public String toString() {
        return "NodeDaemonEndpoints(" + "kubeletEndpoint=" + this.getKubeletEndpoint() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
