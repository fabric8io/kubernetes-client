...
public class NodeCondition implements Editable<NodeConditionBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "NodeCondition(" + "lastHeartbeatTime=" + this.getLastHeartbeatTime() + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
