...
public class ResourceQuota implements Editable<ResourceQuotaBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "ResourceQuota(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
