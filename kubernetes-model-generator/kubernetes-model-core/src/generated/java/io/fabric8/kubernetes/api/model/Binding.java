...
public class Binding implements Editable<BindingBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Binding(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", target=" + this.getTarget() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
