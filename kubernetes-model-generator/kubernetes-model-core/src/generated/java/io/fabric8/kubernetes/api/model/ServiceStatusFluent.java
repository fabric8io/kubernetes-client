...
public class ServiceStatusFluent<A extends io.fabric8.kubernetes.api.model.ServiceStatusFluent<A>> extends BaseFluent<A>{
  ...
  public LoadBalancerNested<A> editOrNewLoadBalancer() {
    return this.withNewLoadBalancerLike(Optional.ofNullable(this.buildLoadBalancer()).orElse(new LoadBalancerStatusBuilder().build()));
  }
  
  public LoadBalancerNested<A> editOrNewLoadBalancerLike(LoadBalancerStatus item) {
  ...
  public int hashCode() {
    return Objects.hash(conditions, loadBalancer, additionalProperties);
  }
