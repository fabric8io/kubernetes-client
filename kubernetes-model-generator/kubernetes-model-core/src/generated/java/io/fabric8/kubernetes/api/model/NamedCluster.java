...
public class NamedCluster implements Editable<NamedClusterBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "NamedCluster(" + "cluster=" + this.getCluster() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
