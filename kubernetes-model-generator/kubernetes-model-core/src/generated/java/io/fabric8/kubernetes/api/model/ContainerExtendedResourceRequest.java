...
public class ContainerExtendedResourceRequest implements Editable<ContainerExtendedResourceRequestBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ContainerExtendedResourceRequest)) {
            return false;
        }
        ContainerExtendedResourceRequest other = (ContainerExtendedResourceRequest) o;
        ...
        Object this$requestName = this.getRequestName();
        Object other$requestName = other.getRequestName();
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ContainerExtendedResourceRequest;
    }
    ...
    public int hashCode() {
        ...
        Object $requestName = this.getRequestName();
        result = result * prime + ($requestName == null ? 43 : $requestName.hashCode());
    ...
    public String toString() {
        return "ContainerExtendedResourceRequest(" + "containerName=" + this.getContainerName() + ", requestName=" + this.getRequestName() + ", resourceName=" + this.getResourceName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
