...
public class NamedExtensionFluent<A extends io.fabric8.kubernetes.api.model.NamedExtensionFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(extension, name, additionalProperties);
  }
