...
public class LimitRange implements Editable<LimitRangeBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "LimitRange(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
