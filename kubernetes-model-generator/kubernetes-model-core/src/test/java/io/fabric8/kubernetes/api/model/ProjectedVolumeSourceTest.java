...
class ProjectedVolumeSourceTest {
  ...
  void deserializationWithOctalValueShouldWorkAsExpected() throws IOException {
    // Given
    InputStream inputStream = getClass().getResourceAsStream("/projectedvolumesource.json");

    // When
    ProjectedVolumeSource projectedVolumeSource = objectMapper.readValue(inputStream, ProjectedVolumeSource.class);
