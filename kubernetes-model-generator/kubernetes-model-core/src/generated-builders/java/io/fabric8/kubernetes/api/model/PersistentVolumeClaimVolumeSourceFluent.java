...
public class PersistentVolumeClaimVolumeSourceFluent<A extends io.fabric8.kubernetes.api.model.PersistentVolumeClaimVolumeSourceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(claimName, readOnly, additionalProperties);
  }
