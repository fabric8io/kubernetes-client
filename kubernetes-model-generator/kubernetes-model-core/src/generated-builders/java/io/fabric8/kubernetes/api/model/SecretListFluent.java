...
public class SecretListFluent<A extends io.fabric8.kubernetes.api.model.SecretListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<SecretBuilder> items = new ArrayList<SecretBuilder>();
  private String kind;
  ...
  public ItemsNested<A> editMatchingItem(Predicate<SecretBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<SecretBuilder> predicate) {
    ...
    Iterator<SecretBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        SecretBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Secret item) {
  ...
  public class ItemsNested<N> extends SecretFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SecretListFluent.this.setToItems(index, builder.build());
    }
  ...
  public class MetadataNested<N> extends ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SecretListFluent.this.withMetadata(builder.build());
    }
