...
public class SecretProjectionFluent<A extends io.fabric8.kubernetes.api.model.SecretProjectionFluent<A>> extends BaseFluent<A>{
  ...
  public class ItemsNested<N> extends KeyToPathFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SecretProjectionFluent.this.setToItems(index, builder.build());
    }
