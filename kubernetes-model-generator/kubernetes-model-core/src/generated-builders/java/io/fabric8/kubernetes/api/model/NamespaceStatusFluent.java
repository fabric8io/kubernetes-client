...
public class NamespaceStatusFluent<A extends io.fabric8.kubernetes.api.model.NamespaceStatusFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private ArrayList<NamespaceConditionBuilder> conditions = new ArrayList<NamespaceConditionBuilder>();
  ...
  public ConditionsNested<A> addNewConditionLike(NamespaceCondition item) {
  ...
  public NamespaceCondition buildMatchingCondition(Predicate<NamespaceConditionBuilder> predicate) {
      for (NamespaceConditionBuilder item : conditions) {
  ...
  public ConditionsNested<A> editMatchingCondition(Predicate<NamespaceConditionBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromConditions(Predicate<NamespaceConditionBuilder> predicate) {
    ...
    Iterator<NamespaceConditionBuilder> each = conditions.iterator();
  ...
  public ConditionsNested<A> setNewConditionLike(int index,NamespaceCondition item) {
  ...
  public class ConditionsNested<N> extends NamespaceConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NamespaceStatusFluent.this.setToConditions(index, builder.build());
    }
