...
public class NodeListFluent<A extends io.fabric8.kubernetes.api.model.NodeListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<NodeBuilder> items = new ArrayList<NodeBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(Node item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<NodeBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<NodeBuilder> predicate) {
    ...
    Iterator<NodeBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        NodeBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Node item) {
  ...
  public class ItemsNested<N> extends NodeFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NodeListFluent.this.setToItems(index, builder.build());
    }
  ...
  public class MetadataNested<N> extends ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NodeListFluent.this.withMetadata(builder.build());
    }
