...
public class LimitRangeFluent<A extends io.fabric8.kubernetes.api.model.LimitRangeFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new LimitRangeSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(LimitRangeSpec item) {
  ...
  public SpecNested<A> withNewSpecLike(LimitRangeSpec item) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) LimitRangeFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends LimitRangeSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) LimitRangeFluent.this.withSpec(builder.build());
    }
