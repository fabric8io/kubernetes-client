...
public class PodReadinessGateFluent<A extends io.fabric8.kubernetes.api.model.PodReadinessGateFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(conditionType, additionalProperties);
  }
