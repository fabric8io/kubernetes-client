...
public class AttachedVolumeFluent<A extends io.fabric8.kubernetes.api.model.AttachedVolumeFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(devicePath, name, additionalProperties);
  }
