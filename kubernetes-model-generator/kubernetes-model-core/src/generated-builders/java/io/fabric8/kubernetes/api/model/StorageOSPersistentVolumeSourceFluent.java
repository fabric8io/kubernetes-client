...
public class StorageOSPersistentVolumeSourceFluent<A extends io.fabric8.kubernetes.api.model.StorageOSPersistentVolumeSourceFluent<A>> extends BaseFluent<A>{
  ...
  public class SecretRefNested<N> extends ObjectReferenceFluent<SecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StorageOSPersistentVolumeSourceFluent.this.withSecretRef(builder.build());
    }
