...
import io.fabric8.kubernetes.api.model.ConditionFluent;
...
public class MachineV1Beta2StatusFluent<A extends io.fabric8.kubernetes.api.model.clusterapi.core.v1beta1.MachineV1Beta2StatusFluent<A>> extends BaseFluent<A>{
  ...
  public class ConditionsNested<N> extends ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) MachineV1Beta2StatusFluent.this.setToConditions(index, builder.build());
    }
