...
public class ResourceClaimFluent<A extends io.fabric8.kubernetes.api.model.ResourceClaimFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(name, request, additionalProperties);
  }
