...
public class NamespaceFluent<A extends io.fabric8.kubernetes.api.model.NamespaceFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new NamespaceSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(NamespaceSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new NamespaceStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(NamespaceStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(NamespaceSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(NamespaceStatus item) {
