...
public class MachineAddressFluent<A extends io.fabric8.kubernetes.api.model.clusterapi.core.v1beta1.MachineAddressFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(address, type, additionalProperties);
  }
