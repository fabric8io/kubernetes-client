...
public class EndpointsListFluent<A extends io.fabric8.kubernetes.api.model.EndpointsListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<EndpointsBuilder> items = new ArrayList<EndpointsBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(Endpoints item) {
  ...
  public Endpoints buildMatchingItem(Predicate<EndpointsBuilder> predicate) {
      for (EndpointsBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<EndpointsBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<EndpointsBuilder> predicate) {
    ...
    Iterator<EndpointsBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        EndpointsBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Endpoints item) {
  ...
  public class ItemsNested<N> extends EndpointsFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EndpointsListFluent.this.setToItems(index, builder.build());
    }
  ...
  public class MetadataNested<N> extends ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EndpointsListFluent.this.withMetadata(builder.build());
    }
