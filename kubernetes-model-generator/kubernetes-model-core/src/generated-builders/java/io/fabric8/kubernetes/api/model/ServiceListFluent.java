...
public class ServiceListFluent<A extends io.fabric8.kubernetes.api.model.ServiceListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ServiceBuilder> items = new ArrayList<ServiceBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(Service item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ServiceBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<ServiceBuilder> predicate) {
    ...
    Iterator<ServiceBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,Service item) {
  ...
  public class ItemsNested<N> extends ServiceFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceListFluent.this.setToItems(index, builder.build());
    }
