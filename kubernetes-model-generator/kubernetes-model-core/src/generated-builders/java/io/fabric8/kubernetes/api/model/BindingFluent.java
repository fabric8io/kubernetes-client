...
public class BindingFluent<A extends io.fabric8.kubernetes.api.model.BindingFluent<A>> extends BaseFluent<A>{
  ...
  public TargetNested<A> editOrNewTarget() {
    return this.withNewTargetLike(Optional.ofNullable(this.buildTarget()).orElse(new ObjectReferenceBuilder().build()));
  }
  
  public TargetNested<A> editOrNewTargetLike(ObjectReference item) {
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, kind, metadata, target, additionalProperties);
  }
  ...
  public TargetNested<A> withNewTargetLike(ObjectReference item) {
  ...
  public class TargetNested<N> extends ObjectReferenceFluent<TargetNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BindingFluent.this.withTarget(builder.build());
    }
