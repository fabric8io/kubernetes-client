...
public class MachineFluent<A extends io.fabric8.kubernetes.api.model.clusterapi.core.v1beta1.MachineFluent<A>> extends BaseFluent<A>{
  ...
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new MachineStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(MachineStatus item) {
  ...
  public StatusNested<A> withNewStatusLike(MachineStatus item) {
  ...
  public A withStatus(MachineStatus status) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) MachineFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends MachineSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) MachineFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends MachineStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) MachineFluent.this.withStatus(builder.build());
    }
