...
public class ReplicationControllerStatusFluent<A extends io.fabric8.kubernetes.api.model.ReplicationControllerStatusFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private Integer availableReplicas;
  private ArrayList<ReplicationControllerConditionBuilder> conditions = new ArrayList<ReplicationControllerConditionBuilder>();
  ...
  public A addNewCondition(String lastTransitionTime,String message,String reason,String status,String type) {
    return (A) this.addToConditions(new ReplicationControllerCondition(lastTransitionTime, message, reason, status, type));
  }
  ...
  public ReplicationControllerCondition buildMatchingCondition(Predicate<ReplicationControllerConditionBuilder> predicate) {
      for (ReplicationControllerConditionBuilder item : conditions) {
  ...
  public A removeMatchingFromConditions(Predicate<ReplicationControllerConditionBuilder> predicate) {
    ...
    Iterator<ReplicationControllerConditionBuilder> each = conditions.iterator();
  ...
  public class ConditionsNested<N> extends ReplicationControllerConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ReplicationControllerStatusFluent.this.setToConditions(index, builder.build());
    }
