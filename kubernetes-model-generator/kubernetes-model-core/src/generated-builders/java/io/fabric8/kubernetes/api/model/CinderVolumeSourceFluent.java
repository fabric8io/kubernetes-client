...
public class CinderVolumeSourceFluent<A extends io.fabric8.kubernetes.api.model.CinderVolumeSourceFluent<A>> extends BaseFluent<A>{
  ...
  public class SecretRefNested<N> extends LocalObjectReferenceFluent<SecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) CinderVolumeSourceFluent.this.withSecretRef(builder.build());
    }
