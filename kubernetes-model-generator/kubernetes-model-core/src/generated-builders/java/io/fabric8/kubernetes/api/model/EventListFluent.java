...
public class EventListFluent<A extends io.fabric8.kubernetes.api.model.EventListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<EventBuilder> items = new ArrayList<EventBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(Event item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<EventBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<EventBuilder> predicate) {
    ...
    Iterator<EventBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,Event item) {
  ...
  public class ItemsNested<N> extends EventFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EventListFluent.this.setToItems(index, builder.build());
    }
  ...
  public class MetadataNested<N> extends ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EventListFluent.this.withMetadata(builder.build());
    }
