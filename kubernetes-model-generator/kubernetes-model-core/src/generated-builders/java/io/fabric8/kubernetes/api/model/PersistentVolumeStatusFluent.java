...
public class PersistentVolumeStatusFluent<A extends io.fabric8.kubernetes.api.model.PersistentVolumeStatusFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(lastPhaseTransitionTime, message, phase, reason, additionalProperties);
  }
  ...
  public A withLastPhaseTransitionTime(String lastPhaseTransitionTime) {
