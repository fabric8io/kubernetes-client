...
public class VolumeHealthStatusFluent<A extends io.fabric8.kubernetes.api.model.VolumeHealthStatusFluent<A>> extends BaseFluent<A>{
  ...
  public VolumeHealthStatusFluent() {
  }
  
  public VolumeHealthStatusFluent(VolumeHealthStatus instance) {
  ...
  protected void copyInstance(VolumeHealthStatus instance) {
    instance = instance != null ? instance : new VolumeHealthStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    VolumeHealthStatusFluent that = (VolumeHealthStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(healthConditions, lastTransitionTime, additionalProperties);
  }
  ...
  public class HealthConditionsNested<N> extends VolumeHealthConditionFluent<HealthConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) VolumeHealthStatusFluent.this.setToHealthConditions(index, builder.build());
    }
