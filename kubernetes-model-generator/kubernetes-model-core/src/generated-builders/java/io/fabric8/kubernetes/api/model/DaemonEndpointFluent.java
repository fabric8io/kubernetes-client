...
public class DaemonEndpointFluent<A extends io.fabric8.kubernetes.api.model.DaemonEndpointFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(port, additionalProperties);
  }
