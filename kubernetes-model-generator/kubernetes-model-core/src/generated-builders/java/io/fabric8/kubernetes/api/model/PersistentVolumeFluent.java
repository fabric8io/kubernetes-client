...
public class PersistentVolumeFluent<A extends io.fabric8.kubernetes.api.model.PersistentVolumeFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new PersistentVolumeSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(PersistentVolumeSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new PersistentVolumeStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(PersistentVolumeStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(PersistentVolumeSpec item) {
  ...
  public A withNewStatus(String lastPhaseTransitionTime,String message,String phase,String reason) {
    return (A) this.withStatus(new PersistentVolumeStatus(lastPhaseTransitionTime, message, phase, reason));
  }
  
  public StatusNested<A> withNewStatusLike(PersistentVolumeStatus item) {
