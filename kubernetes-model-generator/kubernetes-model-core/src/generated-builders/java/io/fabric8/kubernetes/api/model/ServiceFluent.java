...
public class ServiceFluent<A extends io.fabric8.kubernetes.api.model.ServiceFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new ServiceSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(ServiceSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new ServiceStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(ServiceStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(ServiceSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(ServiceStatus item) {
  ...
  public class SpecNested<N> extends ServiceSpecFluent<SpecNested<N>> implements Nested<N>{
  ...
  public class StatusNested<N> extends ServiceStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceFluent.this.withStatus(builder.build());
    }
