...
public class ComponentStatusListFluent<A extends io.fabric8.kubernetes.api.model.ComponentStatusListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ComponentStatusBuilder> items = new ArrayList<ComponentStatusBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(ComponentStatus item) {
  ...
  public ComponentStatus buildMatchingItem(Predicate<ComponentStatusBuilder> predicate) {
      for (ComponentStatusBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ComponentStatusBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<ComponentStatusBuilder> predicate) {
    ...
    Iterator<ComponentStatusBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ComponentStatusBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ComponentStatus item) {
  ...
  public class ItemsNested<N> extends ComponentStatusFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ComponentStatusListFluent.this.setToItems(index, builder.build());
    }
  ...
  public class MetadataNested<N> extends ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ComponentStatusListFluent.this.withMetadata(builder.build());
    }
