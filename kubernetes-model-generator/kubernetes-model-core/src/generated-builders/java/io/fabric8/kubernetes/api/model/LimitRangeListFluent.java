...
public class LimitRangeListFluent<A extends io.fabric8.kubernetes.api.model.LimitRangeListFluent<A>> extends BaseFluent<A>{
  ...
  public ItemsNested<A> addNewItemLike(LimitRange item) {
  ...
  public LimitRange buildMatchingItem(Predicate<LimitRangeBuilder> predicate) {
      for (LimitRangeBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<LimitRangeBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<LimitRangeBuilder> predicate) {
    ...
    Iterator<LimitRangeBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,LimitRange item) {
  ...
  public class ItemsNested<N> extends LimitRangeFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) LimitRangeListFluent.this.setToItems(index, builder.build());
    }
  ...
  public class MetadataNested<N> extends ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) LimitRangeListFluent.this.withMetadata(builder.build());
    }
