...
public class ConfigMapKeySelectorFluent<A extends io.fabric8.kubernetes.api.model.ConfigMapKeySelectorFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(key, name, optional, additionalProperties);
  }
