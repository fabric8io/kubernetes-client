...
public class DownwardAPIVolumeSourceFluent<A extends io.fabric8.kubernetes.api.model.DownwardAPIVolumeSourceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(defaultMode, defaultUser, items, additionalProperties);
  }
  ...
  public class ItemsNested<N> extends DownwardAPIVolumeFileFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DownwardAPIVolumeSourceFluent.this.setToItems(index, builder.build());
    }
