...
public class PodFluent<A extends io.fabric8.kubernetes.api.model.PodFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new PodSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(PodSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new PodStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(PodStatus item) {
