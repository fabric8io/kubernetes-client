...
public class ObjectReferenceFluent<A extends io.fabric8.kubernetes.api.model.ObjectReferenceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(apiVersion, fieldPath, kind, name, namespace, resourceVersion, uid, additionalProperties);
  }
