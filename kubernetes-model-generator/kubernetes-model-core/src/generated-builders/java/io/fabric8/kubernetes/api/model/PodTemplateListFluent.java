...
public class PodTemplateListFluent<A extends io.fabric8.kubernetes.api.model.PodTemplateListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<PodTemplateBuilder> items = new ArrayList<PodTemplateBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(PodTemplate item) {
  ...
  public PodTemplate buildMatchingItem(Predicate<PodTemplateBuilder> predicate) {
      for (PodTemplateBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<PodTemplateBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<PodTemplateBuilder> predicate) {
    ...
    Iterator<PodTemplateBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        PodTemplateBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,PodTemplate item) {
  ...
  public class ItemsNested<N> extends PodTemplateFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodTemplateListFluent.this.setToItems(index, builder.build());
    }
  ...
  public class MetadataNested<N> extends ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodTemplateListFluent.this.withMetadata(builder.build());
    }
