...
public class ConfigMapVolumeSourceFluent<A extends io.fabric8.kubernetes.api.model.ConfigMapVolumeSourceFluent<A>> extends BaseFluent<A>{
  ...
  public class ItemsNested<N> extends KeyToPathFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ConfigMapVolumeSourceFluent.this.setToItems(index, builder.build());
    }
