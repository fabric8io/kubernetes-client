...
public class ReplicationControllerListFluent<A extends io.fabric8.kubernetes.api.model.ReplicationControllerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ReplicationControllerBuilder> items = new ArrayList<ReplicationControllerBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(ReplicationController item) {
  ...
  public ReplicationController buildMatchingItem(Predicate<ReplicationControllerBuilder> predicate) {
      for (ReplicationControllerBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ReplicationControllerBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<ReplicationControllerBuilder> predicate) {
    ...
    Iterator<ReplicationControllerBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ReplicationControllerBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ReplicationController item) {
  ...
  public class ItemsNested<N> extends ReplicationControllerFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ReplicationControllerListFluent.this.setToItems(index, builder.build());
    }
  ...
  public class MetadataNested<N> extends ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ReplicationControllerListFluent.this.withMetadata(builder.build());
    }
