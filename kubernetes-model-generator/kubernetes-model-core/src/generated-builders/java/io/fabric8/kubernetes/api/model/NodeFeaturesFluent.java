...
public class NodeFeaturesFluent<A extends io.fabric8.kubernetes.api.model.NodeFeaturesFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(supplementalGroupsPolicy, additionalProperties);
  }
