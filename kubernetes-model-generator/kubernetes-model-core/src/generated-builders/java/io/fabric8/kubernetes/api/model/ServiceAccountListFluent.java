...
public class ServiceAccountListFluent<A extends io.fabric8.kubernetes.api.model.ServiceAccountListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ServiceAccountBuilder> items = new ArrayList<ServiceAccountBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(ServiceAccount item) {
  ...
  public ServiceAccount buildMatchingItem(Predicate<ServiceAccountBuilder> predicate) {
      for (ServiceAccountBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ServiceAccountBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<ServiceAccountBuilder> predicate) {
    ...
    Iterator<ServiceAccountBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ServiceAccountBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ServiceAccount item) {
  ...
  public class ItemsNested<N> extends ServiceAccountFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceAccountListFluent.this.setToItems(index, builder.build());
    }
