...
public class ContainerPortFluent<A extends io.fabric8.kubernetes.api.model.ContainerPortFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(containerPort, hostIP, hostPort, name, protocol, additionalProperties);
  }
