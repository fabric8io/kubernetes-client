...
public class ConditionFluent<A extends io.fabric8.kubernetes.api.model.clusterapi.core.v1beta1.ConditionFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(lastTransitionTime, message, reason, severity, status, type, additionalProperties);
  }
