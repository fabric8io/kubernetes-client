...
public class FailureDomainSpecFluent<A extends io.fabric8.kubernetes.api.model.clusterapi.core.v1beta1.FailureDomainSpecFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private Map<String,String> attributes;
  private Boolean controlPlane;

  public FailureDomainSpecFluent() {
  }
  
  public FailureDomainSpecFluent(FailureDomainSpec instance) {
  ...
  protected void copyInstance(FailureDomainSpec instance) {
    instance = instance != null ? instance : new FailureDomainSpec();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    FailureDomainSpecFluent that = (FailureDomainSpecFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(attributes, controlPlane, additionalProperties);
  }
  ...
  public A withControlPlane() {
    return withControlPlane(true);
  }
  
  public A withControlPlane(Boolean controlPlane) {
