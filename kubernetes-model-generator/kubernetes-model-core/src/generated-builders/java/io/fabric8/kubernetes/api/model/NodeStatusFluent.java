...
public class NodeStatusFluent<A extends io.fabric8.kubernetes.api.model.NodeStatusFluent<A>> extends BaseFluent<A>{
  ...
  public A addAllToDeclaredFeatures(Collection<String> items) {
    if (this.declaredFeatures == null) {
      this.declaredFeatures = new ArrayList();
    }
    for (String item : items) {
      this.declaredFeatures.add(item);
    }
    return (A) this;
  }
  ...
  public A addNewVolumesAttached(String devicePath,String name) {
    return (A) this.addToVolumesAttached(new AttachedVolume(devicePath, name));
  }
  ...
  public A addToDeclaredFeatures(String... items) {
    if (this.declaredFeatures == null) {
      this.declaredFeatures = new ArrayList();
    }
    for (String item : items) {
  ...
  public A addToDeclaredFeatures(int index,String item) {
    if (this.declaredFeatures == null) {
      this.declaredFeatures = new ArrayList();
    }
    this.declaredFeatures.add(index, item);
    return (A) this;
  }
  ...
  protected void copyInstance(NodeStatus instance) {
    ...
    if (instance != null) {
        ...
        this.withDeclaredFeatures(instance.getDeclaredFeatures());
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(declaredFeatures, that.declaredFeatures))) {
      return false;
    }
  ...
  public String getDeclaredFeature(int index) {
    return this.declaredFeatures.get(index);
  }
  ...
  public String getFirstDeclaredFeature() {
    return this.declaredFeatures.get(0);
  }
  ...
  public String getLastDeclaredFeature() {
    return this.declaredFeatures.get(declaredFeatures.size() - 1);
  }
  ...
  public String getMatchingDeclaredFeature(Predicate<String> predicate) {
      for (String item : declaredFeatures) {
        if (predicate.test(item)) {
          return item;
        }
      }
  ...
  public boolean hasDeclaredFeatures() {
    return this.declaredFeatures != null && !(this.declaredFeatures.isEmpty());
  }
  ...
  public boolean hasMatchingDeclaredFeature(Predicate<String> predicate) {
      for (String item : declaredFeatures) {
        if (predicate.test(item)) {
          return true;
        }
  ...
  public int hashCode() {
    return Objects.hash(addresses, allocatable, capacity, conditions, config, daemonEndpoints, declaredFeatures, features, images, nodeInfo, phase, runtimeHandlers, volumesAttached, volumesInUse, additionalProperties);
  }
  ...
  public A removeAllFromDeclaredFeatures(Collection<String> items) {
    if (this.declaredFeatures == null) {
      return (A) this;
    }
    for (String item : items) {
      this.declaredFeatures.remove(item);
    }
    return (A) this;
  }
  ...
  public A removeFromDeclaredFeatures(String... items) {
    if (this.declaredFeatures == null) {
      return (A) this;
    }
    for (String item : items) {
  ...
  public A removeMatchingFromAddresses(Predicate<NodeAddressBuilder> predicate) {
    ...
    Iterator<NodeAddressBuilder> each = addresses.iterator();
  ...
  public A removeMatchingFromConditions(Predicate<NodeConditionBuilder> predicate) {
    ...
    Iterator<NodeConditionBuilder> each = conditions.iterator();
  ...
  public A removeMatchingFromImages(Predicate<ContainerImageBuilder> predicate) {
    ...
    Iterator<ContainerImageBuilder> each = images.iterator();
  ...
  public A removeMatchingFromRuntimeHandlers(Predicate<NodeRuntimeHandlerBuilder> predicate) {
    ...
    Iterator<NodeRuntimeHandlerBuilder> each = runtimeHandlers.iterator();
  ...
  public A removeMatchingFromVolumesAttached(Predicate<AttachedVolumeBuilder> predicate) {
    ...
    Iterator<AttachedVolumeBuilder> each = volumesAttached.iterator();
  ...
  public A setToDeclaredFeatures(int index,String item) {
    if (this.declaredFeatures == null) {
      this.declaredFeatures = new ArrayList();
    }
    this.declaredFeatures.set(index, item);
    return (A) this;
  }
  ...
  public String toString() {
    ...
    if (!(declaredFeatures == null) && !(declaredFeatures.isEmpty())) {
        sb.append("declaredFeatures:");
        sb.append(declaredFeatures);
        sb.append(",");
    }
    if (!(features == null)) {
  ...
  public A withDeclaredFeatures(List<String> declaredFeatures) {
    if (declaredFeatures != null) {
        this.declaredFeatures = new ArrayList();
        for (String item : declaredFeatures) {
          this.addToDeclaredFeatures(item);
        }
    } else {
  ...
  public A withDeclaredFeatures(String... declaredFeatures) {
    if (this.declaredFeatures != null) {
        this.declaredFeatures.clear();
        _visitables.remove("declaredFeatures");
    }
    if (declaredFeatures != null) {
      for (String item : declaredFeatures) {
        this.addToDeclaredFeatures(item);
  ...
  public A withNewFeatures(Boolean supplementalGroupsPolicy) {
    return (A) this.withFeatures(new NodeFeatures(supplementalGroupsPolicy));
  }
