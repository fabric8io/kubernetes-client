...
public class GenericKubernetesResourceFluent<A extends io.fabric8.kubernetes.api.model.GenericKubernetesResourceFluent<A>> extends BaseFluent<A>{
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) GenericKubernetesResourceFluent.this.withMetadata(builder.build());
    }
