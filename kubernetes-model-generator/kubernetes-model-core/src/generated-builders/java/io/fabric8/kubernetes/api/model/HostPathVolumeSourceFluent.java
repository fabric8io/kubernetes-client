...
public class HostPathVolumeSourceFluent<A extends io.fabric8.kubernetes.api.model.HostPathVolumeSourceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(path, type, additionalProperties);
  }
