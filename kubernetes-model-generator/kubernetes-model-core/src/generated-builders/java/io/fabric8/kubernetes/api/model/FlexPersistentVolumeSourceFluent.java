...
public class FlexPersistentVolumeSourceFluent<A extends io.fabric8.kubernetes.api.model.FlexPersistentVolumeSourceFluent<A>> extends BaseFluent<A>{
  ...
  public class SecretRefNested<N> extends SecretReferenceFluent<SecretRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) FlexPersistentVolumeSourceFluent.this.withSecretRef(builder.build());
    }
