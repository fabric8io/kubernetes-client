...
public class ConfigMapListFluent<A extends io.fabric8.kubernetes.api.model.ConfigMapListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ConfigMapBuilder> items = new ArrayList<ConfigMapBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(ConfigMap item) {
  ...
  public ConfigMap buildMatchingItem(Predicate<ConfigMapBuilder> predicate) {
      for (ConfigMapBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ConfigMapBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<ConfigMapBuilder> predicate) {
    ...
    Iterator<ConfigMapBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ConfigMapBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ConfigMap item) {
  ...
  public class ItemsNested<N> extends ConfigMapFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ConfigMapListFluent.this.setToItems(index, builder.build());
    }
  ...
  public class MetadataNested<N> extends ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ConfigMapListFluent.this.withMetadata(builder.build());
    }
