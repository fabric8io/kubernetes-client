...
public class ClusterServiceVersionListFluent<A extends io.fabric8.openshift.api.model.operatorhub.v1alpha1.ClusterServiceVersionListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ClusterServiceVersionBuilder> items = new ArrayList<ClusterServiceVersionBuilder>();
  private String kind;
  private ListMeta metadata;

  public ClusterServiceVersionListFluent() {
  }
  
  public ClusterServiceVersionListFluent(ClusterServiceVersionList instance) {
  ...
  public ItemsNested<A> addNewItemLike(ClusterServiceVersion item) {
  ...
  public ClusterServiceVersion buildMatchingItem(Predicate<ClusterServiceVersionBuilder> predicate) {
      for (ClusterServiceVersionBuilder item : items) {
  ...
  protected void copyInstance(ClusterServiceVersionList instance) {
    instance = instance != null ? instance : new ClusterServiceVersionList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ClusterServiceVersionBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ClusterServiceVersionListFluent that = (ClusterServiceVersionListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ClusterServiceVersionBuilder> predicate) {
    ...
    Iterator<ClusterServiceVersionBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,ClusterServiceVersion item) {
  ...
  public class ItemsNested<N> extends ClusterServiceVersionFluent<ItemsNested<N>> implements Nested<N>{
  
    ClusterServiceVersionBuilder builder;
    int index;
  
    ItemsNested(int index,ClusterServiceVersion item) {
      this.index = index;
      this.builder = new ClusterServiceVersionBuilder(this, item);
    }
  
    public N and() {
      return (N) ClusterServiceVersionListFluent.this.setToItems(index, builder.build());
    }
