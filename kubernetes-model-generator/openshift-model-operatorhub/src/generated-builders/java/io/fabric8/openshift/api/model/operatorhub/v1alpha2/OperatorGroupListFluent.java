...
public class OperatorGroupListFluent<A extends io.fabric8.openshift.api.model.operatorhub.v1alpha2.OperatorGroupListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<OperatorGroupBuilder> items = new ArrayList<OperatorGroupBuilder>();
  private String kind;
  private ListMeta metadata;

  public OperatorGroupListFluent() {
  }
  
  public OperatorGroupListFluent(OperatorGroupList instance) {
  ...
  public A addAllToItems(Collection<OperatorGroup> items) {
    ...
    for (OperatorGroup item : items) {
        OperatorGroupBuilder builder = new OperatorGroupBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(OperatorGroup item) {
  ...
  public OperatorGroup buildMatchingItem(Predicate<OperatorGroupBuilder> predicate) {
      for (OperatorGroupBuilder item : items) {
  ...
  protected void copyInstance(OperatorGroupList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<OperatorGroupBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    OperatorGroupListFluent that = (OperatorGroupListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<OperatorGroupBuilder> predicate) {
    ...
    Iterator<OperatorGroupBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        OperatorGroupBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,OperatorGroup item) {
  ...
  public class ItemsNested<N> extends OperatorGroupFluent<ItemsNested<N>> implements Nested<N>{
  
    OperatorGroupBuilder builder;
    int index;
  
    ItemsNested(int index,OperatorGroup item) {
      this.index = index;
      this.builder = new OperatorGroupBuilder(this, item);
    }
  
    public N and() {
      return (N) OperatorGroupListFluent.this.setToItems(index, builder.build());
    }
