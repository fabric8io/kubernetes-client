...
public class SubscriptionListFluent<A extends io.fabric8.openshift.api.model.operatorhub.v1alpha1.SubscriptionListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<SubscriptionBuilder> items = new ArrayList<SubscriptionBuilder>();
  private String kind;
  private ListMeta metadata;

  public SubscriptionListFluent() {
  }
  
  public SubscriptionListFluent(SubscriptionList instance) {
  ...
  public ItemsNested<A> addNewItemLike(Subscription item) {
  ...
  public Subscription buildMatchingItem(Predicate<SubscriptionBuilder> predicate) {
      for (SubscriptionBuilder item : items) {
  ...
  protected void copyInstance(SubscriptionList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<SubscriptionBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    SubscriptionListFluent that = (SubscriptionListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<SubscriptionBuilder> predicate) {
    ...
    Iterator<SubscriptionBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,Subscription item) {
  ...
  public class ItemsNested<N> extends SubscriptionFluent<ItemsNested<N>> implements Nested<N>{
  
    SubscriptionBuilder builder;
    int index;
  
    ItemsNested(int index,Subscription item) {
      this.index = index;
      this.builder = new SubscriptionBuilder(this, item);
    }
  
    public N and() {
      return (N) SubscriptionListFluent.this.setToItems(index, builder.build());
    }
