...
public class CatalogSourceListFluent<A extends io.fabric8.openshift.api.model.operatorhub.v1alpha1.CatalogSourceListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<CatalogSourceBuilder> items = new ArrayList<CatalogSourceBuilder>();
  private String kind;
  private ListMeta metadata;

  public CatalogSourceListFluent() {
  }
  
  public CatalogSourceListFluent(CatalogSourceList instance) {
  ...
  public A addAllToItems(Collection<CatalogSource> items) {
    ...
    for (CatalogSource item : items) {
        CatalogSourceBuilder builder = new CatalogSourceBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(CatalogSource item) {
  ...
  public CatalogSource buildMatchingItem(Predicate<CatalogSourceBuilder> predicate) {
      for (CatalogSourceBuilder item : items) {
  ...
  protected void copyInstance(CatalogSourceList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<CatalogSourceBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    CatalogSourceListFluent that = (CatalogSourceListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<CatalogSourceBuilder> predicate) {
    ...
    Iterator<CatalogSourceBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        CatalogSourceBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,CatalogSource item) {
  ...
  public class ItemsNested<N> extends CatalogSourceFluent<ItemsNested<N>> implements Nested<N>{
  
    CatalogSourceBuilder builder;
    int index;
  
    ItemsNested(int index,CatalogSource item) {
      this.index = index;
      this.builder = new CatalogSourceBuilder(this, item);
    }
  
    public N and() {
      return (N) CatalogSourceListFluent.this.setToItems(index, builder.build());
    }
