...
public class InstallPlanListFluent<A extends io.fabric8.openshift.api.model.operatorhub.v1alpha1.InstallPlanListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<InstallPlanBuilder> items = new ArrayList<InstallPlanBuilder>();
  private String kind;
  private ListMeta metadata;

  public InstallPlanListFluent() {
  }
  
  public InstallPlanListFluent(InstallPlanList instance) {
  ...
  public A addAllToItems(Collection<InstallPlan> items) {
    ...
    for (InstallPlan item : items) {
        InstallPlanBuilder builder = new InstallPlanBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(InstallPlan item) {
  ...
  public InstallPlan buildMatchingItem(Predicate<InstallPlanBuilder> predicate) {
      for (InstallPlanBuilder item : items) {
  ...
  protected void copyInstance(InstallPlanList instance) {
    instance = instance != null ? instance : new InstallPlanList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<InstallPlanBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    InstallPlanListFluent that = (InstallPlanListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<InstallPlanBuilder> predicate) {
    ...
    Iterator<InstallPlanBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        InstallPlanBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,InstallPlan item) {
  ...
  public class ItemsNested<N> extends InstallPlanFluent<ItemsNested<N>> implements Nested<N>{
  
    InstallPlanBuilder builder;
    int index;
  
    ItemsNested(int index,InstallPlan item) {
      this.index = index;
      this.builder = new InstallPlanBuilder(this, item);
    }
  
    public N and() {
      return (N) InstallPlanListFluent.this.setToItems(index, builder.build());
    }
