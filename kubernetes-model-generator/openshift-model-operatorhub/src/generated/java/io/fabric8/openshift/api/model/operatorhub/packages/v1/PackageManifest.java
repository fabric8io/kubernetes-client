...
public class PackageManifest implements Editable<PackageManifestBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PackageManifest)) {
            return false;
        }
        PackageManifest other = (PackageManifest) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PackageManifest;
    }
    ...
    public String toString() {
        return "PackageManifest(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
