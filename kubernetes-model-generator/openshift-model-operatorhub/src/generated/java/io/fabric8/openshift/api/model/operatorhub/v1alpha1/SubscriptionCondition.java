...
public class SubscriptionCondition implements Editable<SubscriptionConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SubscriptionCondition)) {
            return false;
        }
        SubscriptionCondition other = (SubscriptionCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SubscriptionCondition;
    }
    ...
    public String toString() {
        return "SubscriptionCondition(" + "lastHeartbeatTime=" + this.getLastHeartbeatTime() + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
