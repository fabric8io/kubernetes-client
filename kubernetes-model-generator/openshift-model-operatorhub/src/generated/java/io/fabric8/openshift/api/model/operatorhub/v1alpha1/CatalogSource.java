...
public class CatalogSource implements Editable<CatalogSourceBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CatalogSource)) {
            return false;
        }
        CatalogSource other = (CatalogSource) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CatalogSource;
    }
    ...
    public String toString() {
        return "CatalogSource(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
