...
public class ClusterServiceVersionCondition implements Editable<ClusterServiceVersionConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterServiceVersionCondition)) {
            return false;
        }
        ClusterServiceVersionCondition other = (ClusterServiceVersionCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClusterServiceVersionCondition;
    }
    ...
    public String toString() {
        return "ClusterServiceVersionCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", lastUpdateTime=" + this.getLastUpdateTime() + ", message=" + this.getMessage() + ", phase=" + this.getPhase() + ", reason=" + this.getReason() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
