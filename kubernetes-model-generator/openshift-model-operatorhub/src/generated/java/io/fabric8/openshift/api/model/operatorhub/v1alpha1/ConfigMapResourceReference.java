...
public class ConfigMapResourceReference implements Editable<ConfigMapResourceReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigMapResourceReference)) {
            return false;
        }
        ConfigMapResourceReference other = (ConfigMapResourceReference) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ConfigMapResourceReference;
    }
    ...
    public String toString() {
        return "ConfigMapResourceReference(" + "lastUpdateTime=" + this.getLastUpdateTime() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", resourceVersion=" + this.getResourceVersion() + ", uid=" + this.getUid() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
