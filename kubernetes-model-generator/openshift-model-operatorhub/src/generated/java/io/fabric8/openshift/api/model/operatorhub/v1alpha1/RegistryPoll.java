...
public class RegistryPoll implements Editable<RegistryPollBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RegistryPoll)) {
            return false;
        }
        RegistryPoll other = (RegistryPoll) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RegistryPoll;
    }
    ...
    public String toString() {
        return "RegistryPoll(" + "interval=" + this.getInterval() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
