...
public class InstallPlanCondition implements Editable<InstallPlanConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstallPlanCondition)) {
            return false;
        }
        InstallPlanCondition other = (InstallPlanCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof InstallPlanCondition;
    }
    ...
    public String toString() {
        return "InstallPlanCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", lastUpdateTime=" + this.getLastUpdateTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
