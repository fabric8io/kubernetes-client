...
public class OperatorGroup implements Editable<OperatorGroupBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        OperatorGroup other = (OperatorGroup) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof OperatorGroup;
    }
    ...
    public String toString() {
        return "OperatorGroup(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
