...
public class IngressSpecFluent<A extends io.fabric8.kubernetes.api.model.extensions.IngressSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(backend, rules, tls, additionalProperties);
  }
