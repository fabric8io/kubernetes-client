...
public class ReplicaSetSpecFluent<A extends io.fabric8.kubernetes.api.model.extensions.ReplicaSetSpecFluent<A>> extends BaseFluent<A>{
  ...
  public class SelectorNested<N> extends LabelSelectorFluent<SelectorNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ReplicaSetSpecFluent.this.withSelector(builder.build());
    }
  ...
  public class TemplateNested<N> extends PodTemplateSpecFluent<TemplateNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ReplicaSetSpecFluent.this.withTemplate(builder.build());
    }
