...
public class DaemonSetUpdateStrategyFluent<A extends io.fabric8.kubernetes.api.model.extensions.DaemonSetUpdateStrategyFluent<A>> extends BaseFluent<A>{
  ...
  public RollingUpdateNested<A> editOrNewRollingUpdate() {
    return this.withNewRollingUpdateLike(Optional.ofNullable(this.buildRollingUpdate()).orElse(new RollingUpdateDaemonSetBuilder().build()));
  }
  
  public RollingUpdateNested<A> editOrNewRollingUpdateLike(RollingUpdateDaemonSet item) {
  ...
  public RollingUpdateNested<A> withNewRollingUpdateLike(RollingUpdateDaemonSet item) {
  ...
  public class RollingUpdateNested<N> extends RollingUpdateDaemonSetFluent<RollingUpdateNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DaemonSetUpdateStrategyFluent.this.withRollingUpdate(builder.build());
    }
