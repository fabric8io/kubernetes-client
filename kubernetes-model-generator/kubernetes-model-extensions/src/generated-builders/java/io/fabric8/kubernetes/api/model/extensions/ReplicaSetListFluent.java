...
public class ReplicaSetListFluent<A extends io.fabric8.kubernetes.api.model.extensions.ReplicaSetListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ReplicaSetBuilder> items = new ArrayList<ReplicaSetBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(ReplicaSet item) {
  ...
  public ReplicaSet buildMatchingItem(Predicate<ReplicaSetBuilder> predicate) {
      for (ReplicaSetBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ReplicaSetBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<ReplicaSetBuilder> predicate) {
    ...
    Iterator<ReplicaSetBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ReplicaSetBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,ReplicaSet item) {
  ...
  public class ItemsNested<N> extends ReplicaSetFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ReplicaSetListFluent.this.setToItems(index, builder.build());
    }
