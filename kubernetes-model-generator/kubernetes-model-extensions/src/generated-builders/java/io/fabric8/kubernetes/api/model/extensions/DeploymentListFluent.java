...
public class DeploymentListFluent<A extends io.fabric8.kubernetes.api.model.extensions.DeploymentListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<DeploymentBuilder> items = new ArrayList<DeploymentBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(Deployment item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<DeploymentBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<DeploymentBuilder> predicate) {
    ...
    Iterator<DeploymentBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,Deployment item) {
  ...
  public class ItemsNested<N> extends DeploymentFluent<ItemsNested<N>> implements Nested<N>{
