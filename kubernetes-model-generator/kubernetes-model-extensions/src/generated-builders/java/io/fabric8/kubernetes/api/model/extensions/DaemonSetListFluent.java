...
public class DaemonSetListFluent<A extends io.fabric8.kubernetes.api.model.extensions.DaemonSetListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<DaemonSetBuilder> items = new ArrayList<DaemonSetBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(DaemonSet item) {
  ...
  public DaemonSet buildMatchingItem(Predicate<DaemonSetBuilder> predicate) {
      for (DaemonSetBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<DaemonSetBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<DaemonSetBuilder> predicate) {
    ...
    Iterator<DaemonSetBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,DaemonSet item) {
  ...
  public class ItemsNested<N> extends DaemonSetFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) DaemonSetListFluent.this.setToItems(index, builder.build());
    }
