...
public class ReplicaSetFluent<A extends io.fabric8.kubernetes.api.model.extensions.ReplicaSetFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new ReplicaSetSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(ReplicaSetSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new ReplicaSetStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(ReplicaSetStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(ReplicaSetSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(ReplicaSetStatus item) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ReplicaSetFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends ReplicaSetSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ReplicaSetFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends ReplicaSetStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ReplicaSetFluent.this.withStatus(builder.build());
    }
