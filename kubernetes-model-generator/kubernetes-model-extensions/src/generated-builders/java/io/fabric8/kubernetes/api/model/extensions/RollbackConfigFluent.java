...
public class RollbackConfigFluent<A extends io.fabric8.kubernetes.api.model.extensions.RollbackConfigFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(revision, additionalProperties);
  }
