...
public class DeploymentStatusFluent<A extends io.fabric8.kubernetes.api.model.extensions.DeploymentStatusFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(availableReplicas, collisionCount, conditions, observedGeneration, readyReplicas, replicas, unavailableReplicas, updatedReplicas, additionalProperties);
  }
