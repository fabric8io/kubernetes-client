...
public class ReplicaSet implements Editable<ReplicaSetBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "ReplicaSet(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
