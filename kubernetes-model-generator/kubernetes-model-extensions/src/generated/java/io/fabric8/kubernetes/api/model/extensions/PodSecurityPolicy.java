...
public class PodSecurityPolicy implements Editable<PodSecurityPolicyBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PodSecurityPolicy)) {
            return false;
        }
    ...
    public String toString() {
        return "PodSecurityPolicy(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
