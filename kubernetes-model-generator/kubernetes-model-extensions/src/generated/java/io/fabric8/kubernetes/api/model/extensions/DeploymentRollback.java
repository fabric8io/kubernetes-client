...
public class DeploymentRollback implements Editable<DeploymentRollbackBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeploymentRollback)) {
            return false;
        }
    ...
    public String toString() {
        return "DeploymentRollback(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", rollbackTo=" + this.getRollbackTo() + ", updatedAnnotations=" + this.getUpdatedAnnotations() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
