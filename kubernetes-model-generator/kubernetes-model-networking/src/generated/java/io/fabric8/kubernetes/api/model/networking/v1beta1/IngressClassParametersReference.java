...
public class IngressClassParametersReference implements Editable<IngressClassParametersReferenceBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IngressClassParametersReference)) {
            return false;
        }
    ...
    public String toString() {
        return "IngressClassParametersReference(" + "apiGroup=" + this.getApiGroup() + ", kind=" + this.getKind() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", scope=" + this.getScope() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
