...
public class NetworkPolicy implements Editable<NetworkPolicyBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "NetworkPolicy(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
