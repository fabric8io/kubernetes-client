...
public class ClusterCIDR implements Editable<ClusterCIDRBuilder> , HasMetadata
{
     ...
     */
    @JsonProperty("kind")
    private String kind = "ClusterCIDR";
    ...
    @JsonProperty("spec")
    public void setSpec(ClusterCIDRSpec spec) {
        this.spec = spec;
    }

    @JsonIgnore
    public ClusterCIDRBuilder edit() {
        return new ClusterCIDRBuilder(this);
    }

    @JsonIgnore
    public ClusterCIDRBuilder toBuilder() {
        return edit();
    }
