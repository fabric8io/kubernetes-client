...
public class Ingress implements Editable<IngressBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Ingress(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
