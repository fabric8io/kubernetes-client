...
public class NetworkPolicyListFluent<A extends io.fabric8.kubernetes.api.model.networking.v1.NetworkPolicyListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<NetworkPolicyBuilder> items = new ArrayList<NetworkPolicyBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(NetworkPolicy item) {
  ...
  public NetworkPolicy buildMatchingItem(Predicate<NetworkPolicyBuilder> predicate) {
      for (NetworkPolicyBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<NetworkPolicyBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<NetworkPolicyBuilder> predicate) {
    ...
    Iterator<NetworkPolicyBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,NetworkPolicy item) {
  ...
  public class ItemsNested<N> extends NetworkPolicyFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NetworkPolicyListFluent.this.setToItems(index, builder.build());
    }
