...
public class IngressListFluent<A extends io.fabric8.kubernetes.api.model.networking.v1beta1.IngressListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<IngressBuilder> items = new ArrayList<IngressBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(Ingress item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<IngressBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<IngressBuilder> predicate) {
    ...
    Iterator<IngressBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        IngressBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Ingress item) {
  ...
  public class ItemsNested<N> extends IngressFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IngressListFluent.this.setToItems(index, builder.build());
    }
