...
public class NetworkPolicyFluent<A extends io.fabric8.kubernetes.api.model.networking.v1.NetworkPolicyFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new NetworkPolicySpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(NetworkPolicySpec item) {
  ...
  public SpecNested<A> withNewSpecLike(NetworkPolicySpec item) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NetworkPolicyFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends NetworkPolicySpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) NetworkPolicyFluent.this.withSpec(builder.build());
    }
