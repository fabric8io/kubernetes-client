...
public class IngressBackendFluent<A extends io.fabric8.kubernetes.api.model.networking.v1beta1.IngressBackendFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(resource, serviceName, servicePort, additionalProperties);
  }
