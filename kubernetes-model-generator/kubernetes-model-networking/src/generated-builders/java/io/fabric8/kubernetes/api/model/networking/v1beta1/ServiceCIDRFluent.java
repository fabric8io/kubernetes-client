...
public class ServiceCIDRFluent<A extends io.fabric8.kubernetes.api.model.networking.v1beta1.ServiceCIDRFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new ServiceCIDRSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(ServiceCIDRSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new ServiceCIDRStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(ServiceCIDRStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(ServiceCIDRSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(ServiceCIDRStatus item) {
    return new StatusNested(item);
  }
  
  public A withSpec(ServiceCIDRSpec spec) {
  ...
  public A withStatus(ServiceCIDRStatus status) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceCIDRFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends ServiceCIDRSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceCIDRFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends ServiceCIDRStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ServiceCIDRFluent.this.withStatus(builder.build());
    }
