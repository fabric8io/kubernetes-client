...
public class IngressPortStatusFluent<A extends io.fabric8.kubernetes.api.model.networking.v1.IngressPortStatusFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(error, port, protocol, additionalProperties);
  }
