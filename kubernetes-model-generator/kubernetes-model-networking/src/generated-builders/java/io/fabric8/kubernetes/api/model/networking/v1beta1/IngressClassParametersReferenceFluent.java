...
public class IngressClassParametersReferenceFluent<A extends io.fabric8.kubernetes.api.model.networking.v1beta1.IngressClassParametersReferenceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(apiGroup, kind, name, namespace, scope, additionalProperties);
  }
