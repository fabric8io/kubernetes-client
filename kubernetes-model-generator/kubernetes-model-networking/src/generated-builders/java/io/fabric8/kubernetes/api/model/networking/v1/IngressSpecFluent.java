...
public class IngressSpecFluent<A extends io.fabric8.kubernetes.api.model.networking.v1.IngressSpecFluent<A>> extends BaseFluent<A>{
  ...
  public boolean equals(Object o) {
    ...
    if (!(Objects.equals(defaultBackend, that.defaultBackend))) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(defaultBackend, ingressClassName, rules, tls, additionalProperties);
  }
  ...
  public class DefaultBackendNested<N> extends IngressBackendFluent<DefaultBackendNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IngressSpecFluent.this.withDefaultBackend(builder.build());
    }
