...
public class ImagePolicyPKIRootOfTrustFluent<A extends io.fabric8.openshift.api.model.config.v1.ImagePolicyPKIRootOfTrustFluent<A>> extends BaseFluent<A>{
  ...
  public ImagePolicyPKIRootOfTrustFluent() {
  }
  
  public ImagePolicyPKIRootOfTrustFluent(ImagePolicyPKIRootOfTrust instance) {
  ...
  protected void copyInstance(ImagePolicyPKIRootOfTrust instance) {
    instance = instance != null ? instance : new ImagePolicyPKIRootOfTrust();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ImagePolicyPKIRootOfTrustFluent that = (ImagePolicyPKIRootOfTrustFluent) o;
  ...
  public class PkiCertificateSubjectNested<N> extends PKICertificateSubjectFluent<PkiCertificateSubjectNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ImagePolicyPKIRootOfTrustFluent.this.withPkiCertificateSubject(builder.build());
    }
