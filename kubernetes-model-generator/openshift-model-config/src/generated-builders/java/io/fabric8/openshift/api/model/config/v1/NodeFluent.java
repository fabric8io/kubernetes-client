...
public class NodeFluent<A extends io.fabric8.openshift.api.model.config.v1.NodeFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new NodeSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(NodeSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new NodeStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(NodeStatus item) {
  ...
  public A withNewSpec(String cgroupMode,String minimumKubeletVersion,String workerLatencyProfile) {
    return (A) this.withSpec(new NodeSpec(cgroupMode, minimumKubeletVersion, workerLatencyProfile));
  }
  
  public SpecNested<A> withNewSpecLike(NodeSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(NodeStatus item) {
  ...
  public class SpecNested<N> extends NodeSpecFluent<SpecNested<N>> implements Nested<N>{
  ...
  public class StatusNested<N> extends NodeStatusFluent<StatusNested<N>> implements Nested<N>{
