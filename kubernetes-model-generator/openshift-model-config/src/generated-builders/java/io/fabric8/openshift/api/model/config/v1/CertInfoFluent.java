...
public class CertInfoFluent<A extends io.fabric8.openshift.api.model.config.v1.CertInfoFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(certFile, keyFile, additionalProperties);
  }
