...
public class OperatorHubListFluent<A extends io.fabric8.openshift.api.model.config.v1.OperatorHubListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<OperatorHubBuilder> items = new ArrayList<OperatorHubBuilder>();
  private String kind;
  private ListMeta metadata;

  public OperatorHubListFluent() {
  }
  
  public OperatorHubListFluent(OperatorHubList instance) {
  ...
  public A addAllToItems(Collection<OperatorHub> items) {
    ...
    for (OperatorHub item : items) {
        OperatorHubBuilder builder = new OperatorHubBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(OperatorHub item) {
  ...
  public OperatorHub buildMatchingItem(Predicate<OperatorHubBuilder> predicate) {
      for (OperatorHubBuilder item : items) {
  ...
  protected void copyInstance(OperatorHubList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<OperatorHubBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    OperatorHubListFluent that = (OperatorHubListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<OperatorHubBuilder> predicate) {
    ...
    Iterator<OperatorHubBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        OperatorHubBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,OperatorHub item) {
  ...
  public class ItemsNested<N> extends OperatorHubFluent<ItemsNested<N>> implements Nested<N>{
  
    OperatorHubBuilder builder;
    int index;
  
    ItemsNested(int index,OperatorHub item) {
      this.index = index;
      this.builder = new OperatorHubBuilder(this, item);
    }
  
    public N and() {
      return (N) OperatorHubListFluent.this.setToItems(index, builder.build());
    }
