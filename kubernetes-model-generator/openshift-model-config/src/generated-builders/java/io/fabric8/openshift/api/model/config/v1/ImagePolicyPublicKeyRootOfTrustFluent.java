...
public class ImagePolicyPublicKeyRootOfTrustFluent<A extends io.fabric8.openshift.api.model.config.v1.ImagePolicyPublicKeyRootOfTrustFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String keyData;
  private String rekorKeyData;

  public ImagePolicyPublicKeyRootOfTrustFluent() {
  }
  
  public ImagePolicyPublicKeyRootOfTrustFluent(ImagePolicyPublicKeyRootOfTrust instance) {
  ...
  protected void copyInstance(ImagePolicyPublicKeyRootOfTrust instance) {
    instance = instance != null ? instance : new ImagePolicyPublicKeyRootOfTrust();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ImagePolicyPublicKeyRootOfTrustFluent that = (ImagePolicyPublicKeyRootOfTrustFluent) o;
