...
public class OAuthListFluent<A extends io.fabric8.openshift.api.model.config.v1.OAuthListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<OAuthBuilder> items = new ArrayList<OAuthBuilder>();
  private String kind;
  private ListMeta metadata;

  public OAuthListFluent() {
  }
  
  public OAuthListFluent(OAuthList instance) {
  ...
  public A addAllToItems(Collection<OAuth> items) {
    ...
    for (OAuth item : items) {
        OAuthBuilder builder = new OAuthBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(OAuth item) {
  ...
  protected void copyInstance(OAuthList instance) {
    instance = instance != null ? instance : new OAuthList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<OAuthBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    OAuthListFluent that = (OAuthListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<OAuthBuilder> predicate) {
    ...
    Iterator<OAuthBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        OAuthBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,OAuth item) {
  ...
  public class ItemsNested<N> extends OAuthFluent<ItemsNested<N>> implements Nested<N>{
  
    OAuthBuilder builder;
    int index;
  
    ItemsNested(int index,OAuth item) {
      this.index = index;
      this.builder = new OAuthBuilder(this, item);
    }
  
    public N and() {
      return (N) OAuthListFluent.this.setToItems(index, builder.build());
    }
