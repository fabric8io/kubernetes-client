...
public class ClusterOperatorListFluent<A extends io.fabric8.openshift.api.model.config.v1.ClusterOperatorListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ClusterOperatorBuilder> items = new ArrayList<ClusterOperatorBuilder>();
  private String kind;
  private ListMeta metadata;

  public ClusterOperatorListFluent() {
  }
  
  public ClusterOperatorListFluent(ClusterOperatorList instance) {
  ...
  public ItemsNested<A> addNewItemLike(ClusterOperator item) {
  ...
  public ClusterOperator buildMatchingItem(Predicate<ClusterOperatorBuilder> predicate) {
      for (ClusterOperatorBuilder item : items) {
  ...
  protected void copyInstance(ClusterOperatorList instance) {
    instance = instance != null ? instance : new ClusterOperatorList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ClusterOperatorBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ClusterOperatorListFluent that = (ClusterOperatorListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ClusterOperatorBuilder> predicate) {
    ...
    Iterator<ClusterOperatorBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,ClusterOperator item) {
  ...
  public class ItemsNested<N> extends ClusterOperatorFluent<ItemsNested<N>> implements Nested<N>{
  
    ClusterOperatorBuilder builder;
    int index;
  
    ItemsNested(int index,ClusterOperator item) {
      this.index = index;
      this.builder = new ClusterOperatorBuilder(this, item);
    }
  
    public N and() {
      return (N) ClusterOperatorListFluent.this.setToItems(index, builder.build());
    }
