...
public class ProxyListFluent<A extends io.fabric8.openshift.api.model.config.v1.ProxyListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ProxyBuilder> items = new ArrayList<ProxyBuilder>();
  private String kind;
  ...
  public A addAllToItems(Collection<Proxy> items) {
    ...
    for (Proxy item : items) {
        ProxyBuilder builder = new ProxyBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(Proxy item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ProxyBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ProxyListFluent that = (ProxyListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ProxyBuilder> predicate) {
    ...
    Iterator<ProxyBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ProxyBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Proxy item) {
  ...
  public class ItemsNested<N> extends ProxyFluent<ItemsNested<N>> implements Nested<N>{
  
    ProxyBuilder builder;
    int index;
  
    ItemsNested(int index,Proxy item) {
      this.index = index;
      this.builder = new ProxyBuilder(this, item);
    }
  
    public N and() {
      return (N) ProxyListFluent.this.setToItems(index, builder.build());
    }
