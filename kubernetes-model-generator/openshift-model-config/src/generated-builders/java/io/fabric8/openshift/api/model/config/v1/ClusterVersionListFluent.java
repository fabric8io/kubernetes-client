...
public class ClusterVersionListFluent<A extends io.fabric8.openshift.api.model.config.v1.ClusterVersionListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ClusterVersionBuilder> items = new ArrayList<ClusterVersionBuilder>();
  private String kind;
  private ListMeta metadata;

  public ClusterVersionListFluent() {
  }
  
  public ClusterVersionListFluent(ClusterVersionList instance) {
  ...
  public ItemsNested<A> addNewItemLike(ClusterVersion item) {
  ...
  public ClusterVersion buildMatchingItem(Predicate<ClusterVersionBuilder> predicate) {
      for (ClusterVersionBuilder item : items) {
  ...
  protected void copyInstance(ClusterVersionList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ClusterVersionBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ClusterVersionListFluent that = (ClusterVersionListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ClusterVersionBuilder> predicate) {
    ...
    Iterator<ClusterVersionBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,ClusterVersion item) {
  ...
  public class ItemsNested<N> extends ClusterVersionFluent<ItemsNested<N>> implements Nested<N>{
  
    ClusterVersionBuilder builder;
    int index;
  
    ItemsNested(int index,ClusterVersion item) {
      this.index = index;
      this.builder = new ClusterVersionBuilder(this, item);
    }
  
    public N and() {
      return (N) ClusterVersionListFluent.this.setToItems(index, builder.build());
    }
