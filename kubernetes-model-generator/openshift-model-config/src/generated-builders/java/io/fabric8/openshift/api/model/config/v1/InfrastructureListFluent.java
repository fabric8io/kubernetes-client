...
public class InfrastructureListFluent<A extends io.fabric8.openshift.api.model.config.v1.InfrastructureListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<InfrastructureBuilder> items = new ArrayList<InfrastructureBuilder>();
  private String kind;
  private ListMeta metadata;

  public InfrastructureListFluent() {
  }
  
  public InfrastructureListFluent(InfrastructureList instance) {
  ...
  public A addAllToItems(Collection<Infrastructure> items) {
    ...
    for (Infrastructure item : items) {
        InfrastructureBuilder builder = new InfrastructureBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(Infrastructure item) {
  ...
  public Infrastructure buildMatchingItem(Predicate<InfrastructureBuilder> predicate) {
      for (InfrastructureBuilder item : items) {
  ...
  protected void copyInstance(InfrastructureList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<InfrastructureBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    InfrastructureListFluent that = (InfrastructureListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<InfrastructureBuilder> predicate) {
    ...
    Iterator<InfrastructureBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        InfrastructureBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Infrastructure item) {
  ...
  public class ItemsNested<N> extends InfrastructureFluent<ItemsNested<N>> implements Nested<N>{
  
    InfrastructureBuilder builder;
    int index;
  
    ItemsNested(int index,Infrastructure item) {
      this.index = index;
      this.builder = new InfrastructureBuilder(this, item);
    }
  
    public N and() {
      return (N) InfrastructureListFluent.this.setToItems(index, builder.build());
    }
