...
public class ProjectListFluent<A extends io.fabric8.openshift.api.model.config.v1.ProjectListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<ProjectBuilder> items = new ArrayList<ProjectBuilder>();
  private String kind;
  private ListMeta metadata;

  public ProjectListFluent() {
  }
  
  public ProjectListFluent(ProjectList instance) {
  ...
  public ItemsNested<A> addNewItemLike(Project item) {
  ...
  protected void copyInstance(ProjectList instance) {
    instance = instance != null ? instance : new ProjectList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<ProjectBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    ProjectListFluent that = (ProjectListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<ProjectBuilder> predicate) {
    ...
    Iterator<ProjectBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        ProjectBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Project item) {
  ...
  public class ItemsNested<N> extends ProjectFluent<ItemsNested<N>> implements Nested<N>{
  
    ProjectBuilder builder;
    int index;
  
    ItemsNested(int index,Project item) {
      this.index = index;
      this.builder = new ProjectBuilder(this, item);
    }
  
    public N and() {
      return (N) ProjectListFluent.this.setToItems(index, builder.build());
    }
