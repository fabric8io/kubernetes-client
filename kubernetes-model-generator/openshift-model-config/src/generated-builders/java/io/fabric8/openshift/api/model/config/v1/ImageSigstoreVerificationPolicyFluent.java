...
public class ImageSigstoreVerificationPolicyFluent<A extends io.fabric8.openshift.api.model.config.v1.ImageSigstoreVerificationPolicyFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private PolicyRootOfTrustBuilder rootOfTrust;
  private PolicyIdentityBuilder signedIdentity;

  public ImageSigstoreVerificationPolicyFluent() {
  }
  
  public ImageSigstoreVerificationPolicyFluent(ImageSigstoreVerificationPolicy instance) {
  ...
  protected void copyInstance(ImageSigstoreVerificationPolicy instance) {
    instance = instance != null ? instance : new ImageSigstoreVerificationPolicy();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ImageSigstoreVerificationPolicyFluent that = (ImageSigstoreVerificationPolicyFluent) o;
  ...
  public class RootOfTrustNested<N> extends PolicyRootOfTrustFluent<RootOfTrustNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ImageSigstoreVerificationPolicyFluent.this.withRootOfTrust(builder.build());
    }
  ...
  public class SignedIdentityNested<N> extends PolicyIdentityFluent<SignedIdentityNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ImageSigstoreVerificationPolicyFluent.this.withSignedIdentity(builder.build());
    }
