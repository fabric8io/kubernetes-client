...
public class KeystoneIdentityProviderFluent<A extends io.fabric8.openshift.api.model.config.v1.KeystoneIdentityProviderFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(KeystoneIdentityProvider instance) {
  ...
  public int hashCode() {
    return Objects.hash(ca, domainName, tlsClientCert, tlsClientKey, url, additionalProperties);
  }
