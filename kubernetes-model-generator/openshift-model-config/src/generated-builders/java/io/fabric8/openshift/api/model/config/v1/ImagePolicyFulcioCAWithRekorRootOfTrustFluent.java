...
public class ImagePolicyFulcioCAWithRekorRootOfTrustFluent<A extends io.fabric8.openshift.api.model.config.v1.ImagePolicyFulcioCAWithRekorRootOfTrustFluent<A>> extends BaseFluent<A>{
  ...
  public ImagePolicyFulcioCAWithRekorRootOfTrustFluent() {
  }
  
  public ImagePolicyFulcioCAWithRekorRootOfTrustFluent(ImagePolicyFulcioCAWithRekorRootOfTrust instance) {
  ...
  protected void copyInstance(ImagePolicyFulcioCAWithRekorRootOfTrust instance) {
    instance = instance != null ? instance : new ImagePolicyFulcioCAWithRekorRootOfTrust();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ImagePolicyFulcioCAWithRekorRootOfTrustFluent that = (ImagePolicyFulcioCAWithRekorRootOfTrustFluent) o;
  ...
  public class FulcioSubjectNested<N> extends PolicyFulcioSubjectFluent<FulcioSubjectNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ImagePolicyFulcioCAWithRekorRootOfTrustFluent.this.withFulcioSubject(builder.build());
    }
