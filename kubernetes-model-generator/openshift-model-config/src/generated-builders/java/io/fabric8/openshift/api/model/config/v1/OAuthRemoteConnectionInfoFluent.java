...
public class OAuthRemoteConnectionInfoFluent<A extends io.fabric8.openshift.api.model.config.v1.OAuthRemoteConnectionInfoFluent<A>> extends BaseFluent<A>{
  ...
  public OAuthRemoteConnectionInfoFluent() {
  }
  
  public OAuthRemoteConnectionInfoFluent(OAuthRemoteConnectionInfo instance) {
  ...
  protected void copyInstance(OAuthRemoteConnectionInfo instance) {
    instance = instance != null ? instance : new OAuthRemoteConnectionInfo();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    OAuthRemoteConnectionInfoFluent that = (OAuthRemoteConnectionInfoFluent) o;
  ...
  public class CaNested<N> extends ConfigMapNameReferenceFluent<CaNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) OAuthRemoteConnectionInfoFluent.this.withCa(builder.build());
    }
  ...
  public class TlsClientCertNested<N> extends SecretNameReferenceFluent<TlsClientCertNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) OAuthRemoteConnectionInfoFluent.this.withTlsClientCert(builder.build());
    }
  ...
  public class TlsClientKeyNested<N> extends SecretNameReferenceFluent<TlsClientKeyNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) OAuthRemoteConnectionInfoFluent.this.withTlsClientKey(builder.build());
    }
