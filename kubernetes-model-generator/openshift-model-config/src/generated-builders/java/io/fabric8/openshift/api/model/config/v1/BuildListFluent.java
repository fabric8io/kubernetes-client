...
public class BuildListFluent<A extends io.fabric8.openshift.api.model.config.v1.BuildListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<BuildBuilder> items = new ArrayList<BuildBuilder>();
  private String kind;
  private ListMeta metadata;

  public BuildListFluent() {
  }
  
  public BuildListFluent(BuildList instance) {
  ...
  public ItemsNested<A> addNewItemLike(Build item) {
  ...
  protected void copyInstance(BuildList instance) {
    instance = instance != null ? instance : new BuildList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<BuildBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    BuildListFluent that = (BuildListFluent) o;
  ...
  public A removeMatchingFromItems(Predicate<BuildBuilder> predicate) {
    ...
    Iterator<BuildBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,Build item) {
  ...
  public class ItemsNested<N> extends BuildFluent<ItemsNested<N>> implements Nested<N>{
  
    BuildBuilder builder;
    int index;
  
    ItemsNested(int index,Build item) {
      this.index = index;
      this.builder = new BuildBuilder(this, item);
    }
  
    public N and() {
      return (N) BuildListFluent.this.setToItems(index, builder.build());
    }
