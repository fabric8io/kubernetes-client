...
public class IdentityProviderConfigFluent<A extends io.fabric8.openshift.api.model.config.v1.IdentityProviderConfigFluent<A>> extends BaseFluent<A>{
  ...
  public IdentityProviderConfigFluent(IdentityProviderConfig instance) {
  ...
  protected void copyInstance(IdentityProviderConfig instance) {
    instance = instance != null ? instance : new IdentityProviderConfig();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    IdentityProviderConfigFluent that = (IdentityProviderConfigFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(basicAuth, github, gitlab, google, htpasswd, keystone, ldap, openID, requestHeader, type, additionalProperties);
  }
  ...
  public class BasicAuthNested<N> extends BasicAuthIdentityProviderFluent<BasicAuthNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IdentityProviderConfigFluent.this.withBasicAuth(builder.build());
    }
  ...
  public class GithubNested<N> extends GitHubIdentityProviderFluent<GithubNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IdentityProviderConfigFluent.this.withGithub(builder.build());
    }
  ...
  public class GitlabNested<N> extends GitLabIdentityProviderFluent<GitlabNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IdentityProviderConfigFluent.this.withGitlab(builder.build());
    }
  ...
  public class GoogleNested<N> extends GoogleIdentityProviderFluent<GoogleNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IdentityProviderConfigFluent.this.withGoogle(builder.build());
    }
  ...
  public class HtpasswdNested<N> extends HTPasswdIdentityProviderFluent<HtpasswdNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IdentityProviderConfigFluent.this.withHtpasswd(builder.build());
    }
  ...
  public class KeystoneNested<N> extends KeystoneIdentityProviderFluent<KeystoneNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IdentityProviderConfigFluent.this.withKeystone(builder.build());
    }
  ...
  public class LdapNested<N> extends LDAPIdentityProviderFluent<LdapNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IdentityProviderConfigFluent.this.withLdap(builder.build());
    }
  ...
  public class OpenIDNested<N> extends OpenIDIdentityProviderFluent<OpenIDNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IdentityProviderConfigFluent.this.withOpenID(builder.build());
    }
  ...
  public class RequestHeaderNested<N> extends RequestHeaderIdentityProviderFluent<RequestHeaderNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) IdentityProviderConfigFluent.this.withRequestHeader(builder.build());
    }
