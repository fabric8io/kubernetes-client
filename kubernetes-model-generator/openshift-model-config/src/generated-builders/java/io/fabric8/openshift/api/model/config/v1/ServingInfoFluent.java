...
public class ServingInfoFluent<A extends io.fabric8.openshift.api.model.config.v1.ServingInfoFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(bindAddress, bindNetwork, certFile, cipherSuites, clientCA, keyFile, minTLSVersion, namedCertificates, additionalProperties);
  }
