...
public class ProjectFluent<A extends io.fabric8.openshift.api.model.config.v1.ProjectFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new ProjectSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(ProjectSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new ProjectStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(ProjectStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(ProjectSpec item) {
  ...
  public StatusNested<A> withNewStatusLike(ProjectStatus item) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ProjectFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends ProjectSpecFluent<SpecNested<N>> implements Nested<N>{
  
    ProjectSpecBuilder builder;
  
    SpecNested(ProjectSpec item) {
      this.builder = new ProjectSpecBuilder(this, item);
    }
  
    public N and() {
      return (N) ProjectFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends ProjectStatusFluent<StatusNested<N>> implements Nested<N>{
  
    ProjectStatusBuilder builder;
  
    StatusNested(ProjectStatus item) {
      this.builder = new ProjectStatusBuilder(this, item);
    }
  
    public N and() {
      return (N) ProjectFluent.this.withStatus(builder.build());
    }
