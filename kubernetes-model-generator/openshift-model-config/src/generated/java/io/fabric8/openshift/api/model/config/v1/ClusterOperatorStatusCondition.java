...
public class ClusterOperatorStatusCondition implements Editable<ClusterOperatorStatusConditionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterOperatorStatusCondition)) {
            return false;
        }
        ClusterOperatorStatusCondition other = (ClusterOperatorStatusCondition) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClusterOperatorStatusCondition;
    }
    ...
    public String toString() {
        return "ClusterOperatorStatusCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
