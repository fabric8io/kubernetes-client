...
public class UsernamePrefix implements Editable<UsernamePrefixBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UsernamePrefix)) {
            return false;
        }
        UsernamePrefix other = (UsernamePrefix) o;
        if (!other.canEqual(this)) {
            return false;
        }
        Object this$prefixString = this.getPrefixString();
        Object other$prefixString = other.getPrefixString();
        if (this$prefixString == null ? other$prefixString != null : !this$prefixString.equals(other$prefixString)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof UsernamePrefix;
    }
    ...
    public int hashCode() {
        final int prime = 59;
        int result = 1;
        Object $prefixString = this.getPrefixString();
        result = result * prime + ($prefixString == null ? 43 : $prefixString.hashCode());
    ...
    public String toString() {
        return "UsernamePrefix(" + "prefixString=" + this.getPrefixString() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
