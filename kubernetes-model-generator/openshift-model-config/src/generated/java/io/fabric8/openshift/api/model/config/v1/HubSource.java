...
public class HubSource implements Editable<HubSourceBuilder>, KubernetesResource
{
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HubSource;
    }
    ...
    public String toString() {
        return "HubSource(" + "disabled=" + this.getDisabled() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
