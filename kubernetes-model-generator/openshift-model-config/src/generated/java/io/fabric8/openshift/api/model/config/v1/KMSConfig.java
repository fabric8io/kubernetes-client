...
public class KMSConfig implements Editable<KMSConfigBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KMSConfig)) {
            return false;
        }
        KMSConfig other = (KMSConfig) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof KMSConfig;
    }
    ...
    public String toString() {
        return "KMSConfig(" + "aws=" + this.getAws() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
