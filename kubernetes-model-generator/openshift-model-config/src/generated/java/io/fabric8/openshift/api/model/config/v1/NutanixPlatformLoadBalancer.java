...
public class NutanixPlatformLoadBalancer implements Editable<NutanixPlatformLoadBalancerBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NutanixPlatformLoadBalancer)) {
            return false;
        }
        NutanixPlatformLoadBalancer other = (NutanixPlatformLoadBalancer) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof NutanixPlatformLoadBalancer;
    }
    ...
    public String toString() {
        return "NutanixPlatformLoadBalancer(" + "type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
