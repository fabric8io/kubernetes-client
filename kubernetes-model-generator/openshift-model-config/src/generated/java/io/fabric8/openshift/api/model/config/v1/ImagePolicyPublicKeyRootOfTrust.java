...
public class ImagePolicyPublicKeyRootOfTrust implements Editable<ImagePolicyPublicKeyRootOfTrustBuilder>, KubernetesResource
{
     ...
     */
    public ImagePolicyPublicKeyRootOfTrust() {
    }

    public ImagePolicyPublicKeyRootOfTrust(String keyData, String rekorKeyData) {
        super();
    ...
    @JsonIgnore
    public ImagePolicyPublicKeyRootOfTrustBuilder edit() {
        return new ImagePolicyPublicKeyRootOfTrustBuilder(this);
    }

    @JsonIgnore
    public ImagePolicyPublicKeyRootOfTrustBuilder toBuilder() {
        return edit();
    }
