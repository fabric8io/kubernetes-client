...
public class PowerVSServiceEndpoint implements Editable<PowerVSServiceEndpointBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PowerVSServiceEndpoint)) {
            return false;
        }
        PowerVSServiceEndpoint other = (PowerVSServiceEndpoint) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PowerVSServiceEndpoint;
    }
    ...
    public String toString() {
        return "PowerVSServiceEndpoint(" + "name=" + this.getName() + ", url=" + this.getUrl() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
