...
public class DeprecatedWebhookTokenAuthenticator implements Editable<DeprecatedWebhookTokenAuthenticatorBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeprecatedWebhookTokenAuthenticator)) {
            return false;
        }
        DeprecatedWebhookTokenAuthenticator other = (DeprecatedWebhookTokenAuthenticator) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DeprecatedWebhookTokenAuthenticator;
    }
    ...
    public String toString() {
        return "DeprecatedWebhookTokenAuthenticator(" + "kubeConfig=" + this.getKubeConfig() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
