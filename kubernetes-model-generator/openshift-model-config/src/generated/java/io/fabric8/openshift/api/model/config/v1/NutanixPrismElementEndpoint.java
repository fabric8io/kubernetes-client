...
public class NutanixPrismElementEndpoint implements Editable<NutanixPrismElementEndpointBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NutanixPrismElementEndpoint)) {
            return false;
        }
        NutanixPrismElementEndpoint other = (NutanixPrismElementEndpoint) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof NutanixPrismElementEndpoint;
    }
    ...
    public String toString() {
        return "NutanixPrismElementEndpoint(" + "endpoint=" + this.getEndpoint() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
