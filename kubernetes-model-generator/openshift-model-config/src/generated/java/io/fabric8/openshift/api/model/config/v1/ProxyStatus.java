...
public class ProxyStatus implements Editable<ProxyStatusBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProxyStatus)) {
            return false;
        }
        ProxyStatus other = (ProxyStatus) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ProxyStatus;
    }
    ...
    public String toString() {
        return "ProxyStatus(" + "httpProxy=" + this.getHttpProxy() + ", httpsProxy=" + this.getHttpsProxy() + ", noProxy=" + this.getNoProxy() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
