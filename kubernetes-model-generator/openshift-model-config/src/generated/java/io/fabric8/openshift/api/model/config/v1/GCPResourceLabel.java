...
public class GCPResourceLabel implements Editable<GCPResourceLabelBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GCPResourceLabel)) {
            return false;
        }
        GCPResourceLabel other = (GCPResourceLabel) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GCPResourceLabel;
    }
    ...
    public String toString() {
        return "GCPResourceLabel(" + "key=" + this.getKey() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
