...
public class DNSPlatformSpec implements Editable<DNSPlatformSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DNSPlatformSpec)) {
            return false;
        }
        DNSPlatformSpec other = (DNSPlatformSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DNSPlatformSpec;
    }
    ...
    public String toString() {
        return "DNSPlatformSpec(" + "aws=" + this.getAws() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
