...
public class WebhookTokenAuthenticator implements Editable<WebhookTokenAuthenticatorBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebhookTokenAuthenticator)) {
            return false;
        }
        WebhookTokenAuthenticator other = (WebhookTokenAuthenticator) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof WebhookTokenAuthenticator;
    }
    ...
    public String toString() {
        return "WebhookTokenAuthenticator(" + "kubeConfig=" + this.getKubeConfig() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
