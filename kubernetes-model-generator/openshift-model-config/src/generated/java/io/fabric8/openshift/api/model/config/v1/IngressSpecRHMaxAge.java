...
public class IngressSpecRHMaxAge implements Editable<IngressSpecRHMaxAgeBuilder> , KubernetesResource
{
     ...
     * 
     */
    public IngressSpecRHMaxAge() {
    }

    public IngressSpecRHMaxAge(Integer largestMaxAge, Integer smallestMaxAge) {
        super();
    ...
    @JsonIgnore
    public IngressSpecRHMaxAgeBuilder edit() {
        return new IngressSpecRHMaxAgeBuilder(this);
    }

    @JsonIgnore
    public IngressSpecRHMaxAgeBuilder toBuilder() {
        return edit();
    }
