...
public class AWSResourceTag implements Editable<AWSResourceTagBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AWSResourceTag)) {
            return false;
        }
        AWSResourceTag other = (AWSResourceTag) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AWSResourceTag;
    }
    ...
    public String toString() {
        return "AWSResourceTag(" + "key=" + this.getKey() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
