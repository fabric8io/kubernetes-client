...
public class APIServer implements Editable<APIServerBuilder>, HasMetadata
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof APIServer)) {
            return false;
        }
        APIServer other = (APIServer) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof APIServer;
    }
    ...
    public String toString() {
        return "APIServer(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
