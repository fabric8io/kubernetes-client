...
public class PolicyIdentity implements Editable<PolicyIdentityBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PolicyIdentity)) {
            return false;
        }
        PolicyIdentity other = (PolicyIdentity) o;
        if (!other.canEqual(this)) {
            return false;
        }
        Object this$exactRepository = this.getExactRepository();
        Object other$exactRepository = other.getExactRepository();
        if (this$exactRepository == null ? other$exactRepository != null : !this$exactRepository.equals(other$exactRepository)) {
            return false;
        }
        ...
        Object this$remapIdentity = this.getRemapIdentity();
        Object other$remapIdentity = other.getRemapIdentity();
        if (this$remapIdentity == null ? other$remapIdentity != null : !this$remapIdentity.equals(other$remapIdentity)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PolicyIdentity;
    }
    ...
    public int hashCode() {
        final int prime = 59;
        int result = 1;
        Object $exactRepository = this.getExactRepository();
        result = result * prime + ($exactRepository == null ? 43 : $exactRepository.hashCode());
        Object $matchPolicy = this.getMatchPolicy();
        result = result * prime + ($matchPolicy == null ? 43 : $matchPolicy.hashCode());
        Object $remapIdentity = this.getRemapIdentity();
        result = result * prime + ($remapIdentity == null ? 43 : $remapIdentity.hashCode());
    ...
    public String toString() {
        return "PolicyIdentity(" + "exactRepository=" + this.getExactRepository() + ", matchPolicy=" + this.getMatchPolicy() + ", remapIdentity=" + this.getRemapIdentity() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
