...
public class ImagePolicyPKIRootOfTrust implements Editable<ImagePolicyPKIRootOfTrustBuilder>, KubernetesResource
{
     ...
     */
    public ImagePolicyPKIRootOfTrust() {
    }

    public ImagePolicyPKIRootOfTrust(String caIntermediatesData, String caRootsData, PKICertificateSubject pkiCertificateSubject) {
        super();
    ...
    @JsonIgnore
    public ImagePolicyPKIRootOfTrustBuilder edit() {
        return new ImagePolicyPKIRootOfTrustBuilder(this);
    }

    @JsonIgnore
    public ImagePolicyPKIRootOfTrustBuilder toBuilder() {
        return edit();
    }
