...
public class Project implements Editable<ProjectBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "Project(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
