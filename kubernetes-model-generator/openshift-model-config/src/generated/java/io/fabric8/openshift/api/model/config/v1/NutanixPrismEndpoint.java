...
public class NutanixPrismEndpoint implements Editable<NutanixPrismEndpointBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NutanixPrismEndpoint)) {
            return false;
        }
        NutanixPrismEndpoint other = (NutanixPrismEndpoint) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof NutanixPrismEndpoint;
    }
    ...
    public String toString() {
        return "NutanixPrismEndpoint(" + "address=" + this.getAddress() + ", port=" + this.getPort() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
