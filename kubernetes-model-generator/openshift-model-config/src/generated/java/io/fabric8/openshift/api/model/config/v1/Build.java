...
public class Build implements Editable<BuildBuilder>, HasMetadata
{
    ...
    public String toString() {
        return "Build(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
