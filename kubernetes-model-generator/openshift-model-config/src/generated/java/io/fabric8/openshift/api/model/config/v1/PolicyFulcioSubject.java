...
public class PolicyFulcioSubject implements Editable<PolicyFulcioSubjectBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PolicyFulcioSubject)) {
            return false;
        }
        PolicyFulcioSubject other = (PolicyFulcioSubject) o;
        if (!other.canEqual(this)) {
            return false;
        }
        Object this$oidcIssuer = this.getOidcIssuer();
        Object other$oidcIssuer = other.getOidcIssuer();
        if (this$oidcIssuer == null ? other$oidcIssuer != null : !this$oidcIssuer.equals(other$oidcIssuer)) {
            return false;
        }
        Object this$signedEmail = this.getSignedEmail();
        Object other$signedEmail = other.getSignedEmail();
        if (this$signedEmail == null ? other$signedEmail != null : !this$signedEmail.equals(other$signedEmail)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PolicyFulcioSubject;
    }
    ...
    public int hashCode() {
        final int prime = 59;
        int result = 1;
        Object $oidcIssuer = this.getOidcIssuer();
        result = result * prime + ($oidcIssuer == null ? 43 : $oidcIssuer.hashCode());
        Object $signedEmail = this.getSignedEmail();
        result = result * prime + ($signedEmail == null ? 43 : $signedEmail.hashCode());
    ...
    public String toString() {
        return "PolicyFulcioSubject(" + "oidcIssuer=" + this.getOidcIssuer() + ", signedEmail=" + this.getSignedEmail() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
