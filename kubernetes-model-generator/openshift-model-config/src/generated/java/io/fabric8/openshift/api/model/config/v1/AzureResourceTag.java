...
public class AzureResourceTag implements Editable<AzureResourceTagBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AzureResourceTag)) {
            return false;
        }
        AzureResourceTag other = (AzureResourceTag) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AzureResourceTag;
    }
    ...
    public String toString() {
        return "AzureResourceTag(" + "key=" + this.getKey() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
