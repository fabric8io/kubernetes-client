...
public class OAuthSpecTokenConfig implements Editable<OAuthSpecTokenConfigBuilder> , KubernetesResource
{
     ...
     * 
     */
    public OAuthSpecTokenConfig() {
    }

    public OAuthSpecTokenConfig(String accessTokenInactivityTimeout, Integer accessTokenInactivityTimeoutSeconds, Integer accessTokenMaxAgeSeconds) {
        super();
    ...
    @JsonIgnore
    public OAuthSpecTokenConfigBuilder edit() {
        return new OAuthSpecTokenConfigBuilder(this);
    }

    @JsonIgnore
    public OAuthSpecTokenConfigBuilder toBuilder() {
        return edit();
    }
