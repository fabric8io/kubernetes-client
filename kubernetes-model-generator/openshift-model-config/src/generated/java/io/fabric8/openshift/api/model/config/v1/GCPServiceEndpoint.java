...
public class GCPServiceEndpoint implements Editable<GCPServiceEndpointBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GCPServiceEndpoint)) {
            return false;
        }
        GCPServiceEndpoint other = (GCPServiceEndpoint) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GCPServiceEndpoint;
    }
    ...
    public String toString() {
        return "GCPServiceEndpoint(" + "name=" + this.getName() + ", url=" + this.getUrl() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
