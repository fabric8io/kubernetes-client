...
public class Scheduler implements Editable<SchedulerBuilder>, HasMetadata
{
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Scheduler;
    }
    ...
    public String toString() {
        return "Scheduler(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
