...
public class VSpherePlatformLoadBalancer implements Editable<VSpherePlatformLoadBalancerBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VSpherePlatformLoadBalancer)) {
            return false;
        }
        VSpherePlatformLoadBalancer other = (VSpherePlatformLoadBalancer) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof VSpherePlatformLoadBalancer;
    }
    ...
    public String toString() {
        return "VSpherePlatformLoadBalancer(" + "type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
