...
public class PolicyRootOfTrust implements Editable<PolicyRootOfTrustBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PolicyRootOfTrust)) {
            return false;
        }
        PolicyRootOfTrust other = (PolicyRootOfTrust) o;
        if (!other.canEqual(this)) {
            return false;
        }
        Object this$fulcioCAWithRekor = this.getFulcioCAWithRekor();
        Object other$fulcioCAWithRekor = other.getFulcioCAWithRekor();
        if (this$fulcioCAWithRekor == null ? other$fulcioCAWithRekor != null : !this$fulcioCAWithRekor.equals(other$fulcioCAWithRekor)) {
            return false;
        }
        Object this$pki = this.getPki();
        Object other$pki = other.getPki();
        if (this$pki == null ? other$pki != null : !this$pki.equals(other$pki)) {
            return false;
        }
        Object this$policyType = this.getPolicyType();
        Object other$policyType = other.getPolicyType();
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PolicyRootOfTrust;
    }
    ...
    public int hashCode() {
        final int prime = 59;
        int result = 1;
        Object $fulcioCAWithRekor = this.getFulcioCAWithRekor();
        result = result * prime + ($fulcioCAWithRekor == null ? 43 : $fulcioCAWithRekor.hashCode());
        Object $pki = this.getPki();
        result = result * prime + ($pki == null ? 43 : $pki.hashCode());
        Object $policyType = this.getPolicyType();
    ...
    public String toString() {
        return "PolicyRootOfTrust(" + "fulcioCAWithRekor=" + this.getFulcioCAWithRekor() + ", pki=" + this.getPki() + ", policyType=" + this.getPolicyType() + ", publicKey=" + this.getPublicKey() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
