...
public class EquinixMetalPlatformStatus implements Editable<EquinixMetalPlatformStatusBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EquinixMetalPlatformStatus)) {
            return false;
        }
        EquinixMetalPlatformStatus other = (EquinixMetalPlatformStatus) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof EquinixMetalPlatformStatus;
    }
    ...
    public String toString() {
        return "EquinixMetalPlatformStatus(" + "apiServerInternalIP=" + this.getApiServerInternalIP() + ", ingressIP=" + this.getIngressIP() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
