...
public class IBMCloudServiceEndpoint implements Editable<IBMCloudServiceEndpointBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IBMCloudServiceEndpoint)) {
            return false;
        }
        IBMCloudServiceEndpoint other = (IBMCloudServiceEndpoint) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IBMCloudServiceEndpoint;
    }
    ...
    public String toString() {
        return "IBMCloudServiceEndpoint(" + "name=" + this.getName() + ", url=" + this.getUrl() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
