...
public class ExternalPlatformSpec implements Editable<ExternalPlatformSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalPlatformSpec)) {
            return false;
        }
        ExternalPlatformSpec other = (ExternalPlatformSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ExternalPlatformSpec;
    }
    ...
    public int hashCode() {
        ...
        result = result * prime + ($platformName == null ? 43 : $platformName.hashCode());
    ...
    public String toString() {
        return "ExternalPlatformSpec(" + "platformName=" + this.getPlatformName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
