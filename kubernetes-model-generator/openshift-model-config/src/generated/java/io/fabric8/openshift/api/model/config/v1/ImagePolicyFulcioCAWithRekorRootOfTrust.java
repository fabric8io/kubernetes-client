...
public class ImagePolicyFulcioCAWithRekorRootOfTrust implements Editable<ImagePolicyFulcioCAWithRekorRootOfTrustBuilder>, KubernetesResource
{
     ...
     */
    public ImagePolicyFulcioCAWithRekorRootOfTrust() {
    }

    public ImagePolicyFulcioCAWithRekorRootOfTrust(String fulcioCAData, PolicyFulcioSubject fulcioSubject, String rekorKeyData) {
        super();
    ...
    @JsonIgnore
    public ImagePolicyFulcioCAWithRekorRootOfTrustBuilder edit() {
        return new ImagePolicyFulcioCAWithRekorRootOfTrustBuilder(this);
    }

    @JsonIgnore
    public ImagePolicyFulcioCAWithRekorRootOfTrustBuilder toBuilder() {
        return edit();
    }
