...
public class AWSIngressSpec implements Editable<AWSIngressSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AWSIngressSpec)) {
            return false;
        }
        AWSIngressSpec other = (AWSIngressSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AWSIngressSpec;
    }
    ...
    public String toString() {
        return "AWSIngressSpec(" + "type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
