...
public class FeatureGateSpec implements Editable<FeatureGateSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FeatureGateSpec)) {
            return false;
        }
        FeatureGateSpec other = (FeatureGateSpec) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof FeatureGateSpec;
    }
    ...
    public String toString() {
        return "FeatureGateSpec(" + "customNoUpgrade=" + this.getCustomNoUpgrade() + ", featureSet=" + this.getFeatureSet() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
