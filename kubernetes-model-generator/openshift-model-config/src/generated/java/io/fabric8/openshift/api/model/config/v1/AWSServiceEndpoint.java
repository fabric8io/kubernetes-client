...
public class AWSServiceEndpoint implements Editable<AWSServiceEndpointBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AWSServiceEndpoint)) {
            return false;
        }
        AWSServiceEndpoint other = (AWSServiceEndpoint) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AWSServiceEndpoint;
    }
    ...
    public String toString() {
        return "AWSServiceEndpoint(" + "name=" + this.getName() + ", url=" + this.getUrl() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
