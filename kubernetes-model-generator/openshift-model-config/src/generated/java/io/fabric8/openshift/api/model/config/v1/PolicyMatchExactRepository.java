...
public class PolicyMatchExactRepository implements Editable<PolicyMatchExactRepositoryBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PolicyMatchExactRepository)) {
            return false;
        }
        PolicyMatchExactRepository other = (PolicyMatchExactRepository) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PolicyMatchExactRepository;
    }
    ...
    public String toString() {
        return "PolicyMatchExactRepository(" + "repository=" + this.getRepository() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
