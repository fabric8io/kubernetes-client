...
public class GCPResourceTag implements Editable<GCPResourceTagBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GCPResourceTag)) {
            return false;
        }
        GCPResourceTag other = (GCPResourceTag) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GCPResourceTag;
    }
    ...
    public String toString() {
        return "GCPResourceTag(" + "key=" + this.getKey() + ", parentID=" + this.getParentID() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
