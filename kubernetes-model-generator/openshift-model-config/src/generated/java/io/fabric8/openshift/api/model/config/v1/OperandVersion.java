...
public class OperandVersion implements Editable<OperandVersionBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OperandVersion)) {
            return false;
        }
        OperandVersion other = (OperandVersion) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof OperandVersion;
    }
    ...
    public String toString() {
        return "OperandVersion(" + "name=" + this.getName() + ", version=" + this.getVersion() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
