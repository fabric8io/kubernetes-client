...
public class Gatherers implements Editable<GatherersBuilder>, KubernetesResource
{
    ...
    /**
     * mode is a required field that specifies the mode for gatherers. Allowed values are All, None, and Custom. When set to All, all gatherers will run and gather data. When set to None, all gatherers will be disabled and no data will be gathered. When set to Custom, the custom configuration from the custom field will be applied.
     */
    @JsonProperty("mode")
