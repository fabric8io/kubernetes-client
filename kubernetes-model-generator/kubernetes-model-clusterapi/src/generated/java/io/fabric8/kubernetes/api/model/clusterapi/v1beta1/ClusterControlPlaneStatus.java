...
public class ClusterControlPlaneStatus implements Editable<ClusterControlPlaneStatusBuilder>, KubernetesResource
{
     ...
     */
    public ClusterControlPlaneStatus() {
    }

    public ClusterControlPlaneStatus(Integer availableReplicas, Integer desiredReplicas, Integer readyReplicas, Integer replicas, Integer upToDateReplicas) {
        super();
    ...
    @JsonIgnore
    public ClusterControlPlaneStatusBuilder edit() {
        return new ClusterControlPlaneStatusBuilder(this);
    }

    @JsonIgnore
    public ClusterControlPlaneStatusBuilder toBuilder() {
        return edit();
    }
