...
public class JSONPatchValue implements Editable<JSONPatchValueBuilder>, KubernetesResource
{
     ...
     */
    public JSONPatchValue() {
    }

    public JSONPatchValue(String template, String variable) {
        super();
    ...
    @JsonIgnore
    public JSONPatchValueBuilder edit() {
        return new JSONPatchValueBuilder(this);
    }

    @JsonIgnore
    public JSONPatchValueBuilder toBuilder() {
        return edit();
    }
