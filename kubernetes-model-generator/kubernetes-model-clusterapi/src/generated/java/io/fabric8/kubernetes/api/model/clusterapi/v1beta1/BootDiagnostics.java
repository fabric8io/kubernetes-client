...
public class BootDiagnostics implements Editable<BootDiagnosticsBuilder>, KubernetesResource
{
    ...
    private UserManagedBootDiagnostics userManaged;
    @JsonIgnore
    ...
    public BootDiagnostics(String storageAccountType, UserManagedBootDiagnostics userManaged) {
        super();
     ...
     */
    @JsonProperty("userManaged")
    public UserManagedBootDiagnostics getUserManaged() {
        return userManaged;
    }
     ...
     */
    @JsonProperty("userManaged")
    public void setUserManaged(UserManagedBootDiagnostics userManaged) {
        this.userManaged = userManaged;
    }
