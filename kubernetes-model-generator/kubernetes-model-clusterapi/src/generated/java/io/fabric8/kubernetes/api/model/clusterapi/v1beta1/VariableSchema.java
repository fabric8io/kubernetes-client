...
public class VariableSchema implements Editable<VariableSchemaBuilder>, KubernetesResource
{
    ...
    public VariableSchema(JSONSchemaProps openAPIV3Schema) {
        super();
    ...
    @JsonIgnore
    public VariableSchemaBuilder edit() {
        return new VariableSchemaBuilder(this);
    }

    @JsonIgnore
    public VariableSchemaBuilder toBuilder() {
        return edit();
    }
