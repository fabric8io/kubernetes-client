...
public class MachineNamingStrategy implements Editable<MachineNamingStrategyBuilder>, KubernetesResource
{
     ...
     */
    public MachineNamingStrategy() {
    }

    public MachineNamingStrategy(String template) {
        super();
    ...
    @JsonIgnore
    public MachineNamingStrategyBuilder edit() {
        return new MachineNamingStrategyBuilder(this);
    }

    @JsonIgnore
    public MachineNamingStrategyBuilder toBuilder() {
        return edit();
    }
