...
public class VariableSchemaMetadata implements Editable<VariableSchemaMetadataBuilder>, KubernetesResource
{
     ...
     */
    public VariableSchemaMetadata() {
    }

    public VariableSchemaMetadata(Map<String, String> annotations, Map<String, String> labels) {
        super();
    ...
    @JsonIgnore
    public VariableSchemaMetadataBuilder edit() {
        return new VariableSchemaMetadataBuilder(this);
    }

    @JsonIgnore
    public VariableSchemaMetadataBuilder toBuilder() {
        return edit();
    }
