...
public class AdditionalCapabilities implements Editable<AdditionalCapabilitiesBuilder>, KubernetesResource
{
    ...
    public AdditionalCapabilities(Boolean ultraSSDEnabled) {
        super();
    ...
    @JsonIgnore
    public AdditionalCapabilitiesBuilder edit() {
        return new AdditionalCapabilitiesBuilder(this);
    }

    @JsonIgnore
    public AdditionalCapabilitiesBuilder toBuilder() {
        return edit();
    }
