...
public class MachinePoolClassNamingStrategy implements Editable<MachinePoolClassNamingStrategyBuilder>, KubernetesResource
{
     ...
     */
    public MachinePoolClassNamingStrategy() {
    }

    public MachinePoolClassNamingStrategy(String template) {
        super();
    ...
    @JsonIgnore
    public MachinePoolClassNamingStrategyBuilder edit() {
        return new MachinePoolClassNamingStrategyBuilder(this);
    }

    @JsonIgnore
    public MachinePoolClassNamingStrategyBuilder toBuilder() {
        return edit();
    }
