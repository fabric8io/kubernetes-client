...
public class ManagedClusterAutoUpgradeProfile implements Editable<ManagedClusterAutoUpgradeProfileBuilder>, KubernetesResource
{
    ...
    public ManagedClusterAutoUpgradeProfile(String upgradeChannel) {
        super();
    ...
    @JsonIgnore
    public ManagedClusterAutoUpgradeProfileBuilder edit() {
        return new ManagedClusterAutoUpgradeProfileBuilder(this);
    }

    @JsonIgnore
    public ManagedClusterAutoUpgradeProfileBuilder toBuilder() {
        return edit();
    }
