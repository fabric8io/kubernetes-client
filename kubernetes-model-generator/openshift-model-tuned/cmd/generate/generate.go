...
func main() {
  packages := []schemagen.PackageDescriptor{
    ...
    {"github.com/openshift/cluster-node-tuning-operator/pkg/apis/tuned/v1", "tuned", "io.fabric8.openshift.api.model.tuned.v1", "os_tuned_v1_", true},
  }
  ...
  schema, err := schemagen.GenerateSchema(reflect.TypeOf(Schema{}), packages, typeMap, manualTypeMap,"tuned")
  if err != nil {
