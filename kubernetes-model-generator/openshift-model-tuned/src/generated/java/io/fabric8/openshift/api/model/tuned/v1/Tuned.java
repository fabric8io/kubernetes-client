...
public class Tuned implements Editable<TunedBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Tuned(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
