...
public class Profile implements Editable<ProfileBuilder>, HasMetadata, Namespaced
{
    ...
    public String toString() {
        return "Profile(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
