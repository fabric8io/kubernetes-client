...
public class StatusCondition implements Editable<StatusConditionBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "StatusCondition(" + "lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
