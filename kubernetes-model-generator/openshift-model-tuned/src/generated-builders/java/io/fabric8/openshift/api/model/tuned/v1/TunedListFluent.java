...
public class TunedListFluent<A extends io.fabric8.openshift.api.model.tuned.v1.TunedListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<TunedBuilder> items = new ArrayList<TunedBuilder>();
  private String kind;
  private ListMeta metadata;

  public TunedListFluent() {
  }
  
  public TunedListFluent(TunedList instance) {
  ...
  public A addAllToItems(Collection<Tuned> items) {
    ...
    for (Tuned item : items) {
        TunedBuilder builder = new TunedBuilder(item);
  ...
  public ItemsNested<A> addNewItemLike(Tuned item) {
  ...
  public A addToItems(Tuned... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (Tuned item : items) {
  ...
  protected void copyInstance(TunedList instance) {
    instance = instance != null ? instance : new TunedList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<TunedBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    TunedListFluent that = (TunedListFluent) o;
  ...
  public A removeFromItems(Tuned... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (Tuned item : items) {
  ...
  public A removeMatchingFromItems(Predicate<TunedBuilder> predicate) {
    ...
    Iterator<TunedBuilder> each = items.iterator();
    List visitables = _visitables.get("items");
    while (each.hasNext()) {
        TunedBuilder builder = each.next();
  ...
  public ItemsNested<A> setNewItemLike(int index,Tuned item) {
  ...
  public A withItems(Tuned... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends TunedFluent<ItemsNested<N>> implements Nested<N>{
  
    TunedBuilder builder;
    int index;
  
    ItemsNested(int index,Tuned item) {
      this.index = index;
      this.builder = new TunedBuilder(this, item);
    }
  
    public N and() {
      return (N) TunedListFluent.this.setToItems(index, builder.build());
    }
