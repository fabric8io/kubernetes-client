...
public class ProfileStatusFluent<A extends io.fabric8.openshift.api.model.tuned.v1.ProfileStatusFluent<A>> extends BaseFluent<A>{
  ...
  public ProfileStatusFluent() {
  }
  
  public ProfileStatusFluent(ProfileStatus instance) {
  ...
  protected void copyInstance(ProfileStatus instance) {
    instance = instance != null ? instance : new ProfileStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ProfileStatusFluent that = (ProfileStatusFluent) o;
  ...
  public int hashCode() {
    return Objects.hash(conditions, observedGeneration, tunedProfile, additionalProperties);
  }
  ...
  public class ConditionsNested<N> extends StatusConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ProfileStatusFluent.this.setToConditions(index, builder.build());
    }
