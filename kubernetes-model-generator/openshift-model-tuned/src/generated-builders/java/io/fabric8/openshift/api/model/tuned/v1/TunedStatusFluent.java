...
public class TunedStatusFluent<A extends io.fabric8.openshift.api.model.tuned.v1.TunedStatusFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(TunedStatus instance) {
    instance = instance != null ? instance : new TunedStatus();
    if (instance != null) {
  ...
  public class ConditionsNested<N> extends StatusConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) TunedStatusFluent.this.setToConditions(index, builder.build());
    }
