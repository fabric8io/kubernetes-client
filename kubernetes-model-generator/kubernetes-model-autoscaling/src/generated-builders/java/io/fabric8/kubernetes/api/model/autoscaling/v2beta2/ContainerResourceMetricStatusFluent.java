...
public class ContainerResourceMetricStatusFluent<A extends io.fabric8.kubernetes.api.model.autoscaling.v2beta2.ContainerResourceMetricStatusFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(container, current, name, additionalProperties);
  }
  ...
  public class CurrentNested<N> extends MetricValueStatusFluent<CurrentNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainerResourceMetricStatusFluent.this.withCurrent(builder.build());
    }
