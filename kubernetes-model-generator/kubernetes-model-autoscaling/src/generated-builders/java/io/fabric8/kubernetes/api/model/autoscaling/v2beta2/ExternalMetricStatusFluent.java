...
public class ExternalMetricStatusFluent<A extends io.fabric8.kubernetes.api.model.autoscaling.v2beta2.ExternalMetricStatusFluent<A>> extends BaseFluent<A>{
  ...
  public class CurrentNested<N> extends MetricValueStatusFluent<CurrentNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ExternalMetricStatusFluent.this.withCurrent(builder.build());
    }
  ...
  public class MetricNested<N> extends MetricIdentifierFluent<MetricNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ExternalMetricStatusFluent.this.withMetric(builder.build());
    }
