...
public class MetricValueStatusFluent<A extends io.fabric8.kubernetes.api.model.autoscaling.v2beta2.MetricValueStatusFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(averageUtilization, averageValue, value, additionalProperties);
  }
