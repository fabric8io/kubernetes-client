...
public class HorizontalPodAutoscalerListFluent<A extends io.fabric8.kubernetes.api.model.autoscaling.v2beta2.HorizontalPodAutoscalerListFluent<A>> extends BaseFluent<A>{

  private Map<String,Object> additionalProperties;
  private String apiVersion;
  private ArrayList<HorizontalPodAutoscalerBuilder> items = new ArrayList<HorizontalPodAutoscalerBuilder>();
  private String kind;
  ...
  public ItemsNested<A> addNewItemLike(HorizontalPodAutoscaler item) {
  ...
  public HorizontalPodAutoscaler buildMatchingItem(Predicate<HorizontalPodAutoscalerBuilder> predicate) {
      for (HorizontalPodAutoscalerBuilder item : items) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<HorizontalPodAutoscalerBuilder> predicate) {
    int index = -1;
  ...
  public A removeMatchingFromItems(Predicate<HorizontalPodAutoscalerBuilder> predicate) {
    ...
    Iterator<HorizontalPodAutoscalerBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,HorizontalPodAutoscaler item) {
  ...
  public class ItemsNested<N> extends HorizontalPodAutoscalerFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HorizontalPodAutoscalerListFluent.this.setToItems(index, builder.build());
    }
