...
public class PodsMetricSourceFluent<A extends io.fabric8.kubernetes.api.model.autoscaling.v2beta2.PodsMetricSourceFluent<A>> extends BaseFluent<A>{
  ...
  public class MetricNested<N> extends MetricIdentifierFluent<MetricNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodsMetricSourceFluent.this.withMetric(builder.build());
    }
  ...
  public class TargetNested<N> extends MetricTargetFluent<TargetNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodsMetricSourceFluent.this.withTarget(builder.build());
    }
