...
public class MetricIdentifierFluent<A extends io.fabric8.kubernetes.api.model.autoscaling.v2beta2.MetricIdentifierFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(name, selector, additionalProperties);
  }
  ...
  public class SelectorNested<N> extends LabelSelectorFluent<SelectorNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) MetricIdentifierFluent.this.withSelector(builder.build());
    }
