...
public class HorizontalPodAutoscalerSpecFluent<A extends io.fabric8.kubernetes.api.model.autoscaling.v2.HorizontalPodAutoscalerSpecFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(behavior, maxReplicas, metrics, minReplicas, scaleTargetRef, additionalProperties);
  }
  ...
  public class BehaviorNested<N> extends HorizontalPodAutoscalerBehaviorFluent<BehaviorNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HorizontalPodAutoscalerSpecFluent.this.withBehavior(builder.build());
    }
