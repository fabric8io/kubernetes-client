...
public class ResourceMetricSourceFluent<A extends io.fabric8.kubernetes.api.model.autoscaling.v2beta2.ResourceMetricSourceFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return Objects.hash(name, target, additionalProperties);
  }
  ...
  public class TargetNested<N> extends MetricTargetFluent<TargetNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ResourceMetricSourceFluent.this.withTarget(builder.build());
    }
