...
public class HorizontalPodAutoscalerFluent<A extends io.fabric8.kubernetes.api.model.autoscaling.v1.HorizontalPodAutoscalerFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new HorizontalPodAutoscalerSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(HorizontalPodAutoscalerSpec item) {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(item));
  }
  
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new HorizontalPodAutoscalerStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(HorizontalPodAutoscalerStatus item) {
  ...
  public SpecNested<A> withNewSpecLike(HorizontalPodAutoscalerSpec item) {
  ...
  public A withNewStatus(Integer currentCPUUtilizationPercentage,Integer currentReplicas,Integer desiredReplicas,String lastScaleTime,Long observedGeneration) {
    return (A) this.withStatus(new HorizontalPodAutoscalerStatus(currentCPUUtilizationPercentage, currentReplicas, desiredReplicas, lastScaleTime, observedGeneration));
  }
  
  public StatusNested<A> withNewStatusLike(HorizontalPodAutoscalerStatus item) {
  ...
  public class MetadataNested<N> extends ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HorizontalPodAutoscalerFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends HorizontalPodAutoscalerSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HorizontalPodAutoscalerFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends HorizontalPodAutoscalerStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) HorizontalPodAutoscalerFluent.this.withStatus(builder.build());
    }
