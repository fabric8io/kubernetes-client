...
public class ContainerResourceMetricStatus implements Editable<ContainerResourceMetricStatusBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "ContainerResourceMetricStatus(" + "container=" + this.getContainer() + ", currentAverageUtilization=" + this.getCurrentAverageUtilization() + ", currentAverageValue=" + this.getCurrentAverageValue() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
