...
public class HorizontalPodAutoscaler implements Editable<HorizontalPodAutoscalerBuilder>, HasMetadata, Namespaced
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HorizontalPodAutoscaler)) {
            return false;
        }
    ...
    public String toString() {
        return "HorizontalPodAutoscaler(" + "apiVersion=" + this.getApiVersion() + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
