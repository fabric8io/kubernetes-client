...
public class HorizontalPodAutoscalerSpec implements Editable<HorizontalPodAutoscalerSpecBuilder>, KubernetesResource
{
    ...
    public boolean equals(Object o) {
        ...
        if (this$targetCPUUtilizationPercentage == null ? other$targetCPUUtilizationPercentage != null : !this$targetCPUUtilizationPercentage.equals(other$targetCPUUtilizationPercentage)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = result * prime + ($targetCPUUtilizationPercentage == null ? 43 : $targetCPUUtilizationPercentage.hashCode());
    ...
    public String toString() {
        return "HorizontalPodAutoscalerSpec(" + "maxReplicas=" + this.getMaxReplicas() + ", minReplicas=" + this.getMinReplicas() + ", scaleTargetRef=" + this.getScaleTargetRef() + ", targetCPUUtilizationPercentage=" + this.getTargetCPUUtilizationPercentage() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
