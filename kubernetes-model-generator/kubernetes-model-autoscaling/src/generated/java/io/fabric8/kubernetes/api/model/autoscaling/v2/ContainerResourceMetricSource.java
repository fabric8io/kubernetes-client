...
public class ContainerResourceMetricSource implements Editable<ContainerResourceMetricSourceBuilder>, KubernetesResource
{
    ...
    public String toString() {
        return "ContainerResourceMetricSource(" + "container=" + this.getContainer() + ", name=" + this.getName() + ", target=" + this.getTarget() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
