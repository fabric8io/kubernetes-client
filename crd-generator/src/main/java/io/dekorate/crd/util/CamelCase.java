...
public class CamelCase {
  ...
  public static final Function<String, String> TO_SHORTNAME = SPLIT
      .andThen(l -> l.stream().map(s -> s.substring(0, 1)).collect(Collectors.joining())).andThen(String::toLowerCase);
}
