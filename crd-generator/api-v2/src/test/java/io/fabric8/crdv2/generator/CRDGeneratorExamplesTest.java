...
import io.fabric8.crdv2.example.multiple.v2.MultipleSpec;
...
class CRDGeneratorExamplesTest {
  ...
  void multiple() throws IOException {
    assertCRDOutputEquals(newCRDGenerator(),
        io.fabric8.crdv2.example.multiple.v1.Multiple.class, io.fabric8.crdv2.example.multiple.v2.Multiple.class);
  }
