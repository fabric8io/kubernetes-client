...
public abstract class AbstractJsonSchema<T, B> {
  ...
  public static final String ANNOTATION_NULLABLE = "io.fabric8.crd.generator.annotation.constraints.Nullable";
  ...
  protected static class SchemaPropsOptions {
    ...
    final Optional<Boolean> nullable;
      ...
      annotations.forEach(a -> {
        switch (a.getClassRef().getFullyQualifiedName()) {
          ...
          case ANNOTATION_NULLABLE:
            ...
            break;
          case ANNOTATION_MAX:
            max = Optional.of(((Long) a.getParameters().get("value")).doubleValue());
            break;
          case ANNOTATION_MIN:
            min = Optional.of(((Long) a.getParameters().get("value")).doubleValue());
            break;
          case ANNOTATION_PATTERN:
            pattern = Optional.of((String) a.getParameters().get("regexp"));
            break;
        }
      });
    }
