...
class MapApprovalTest extends AbstractCRDGeneratorApprovalTest {
  protected Class<? extends CustomResource<?, ?>>[] crClasses() {
    return new Class[] {
        io.fabric8.crd.generator.approvaltests.map.api.ContainingMaps.class
    };
  }

  protected String[] expectedCRDs() {
    return new String[] {
        "containingmaps.sample.fabric8.io"
    };
  }
}
