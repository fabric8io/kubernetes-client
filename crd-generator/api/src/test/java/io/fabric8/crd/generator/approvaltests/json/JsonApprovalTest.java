...
class JsonApprovalTest extends AbstractCRDGeneratorApprovalTest {
  protected Class<? extends CustomResource<?, ?>>[] crClasses() {
    return new Class[] {
        io.fabric8.crd.generator.approvaltests.json.api.ContainingJson.class
    };
  }

  protected String[] expectedCRDs() {
    return new String[] {
        "containingjsons.sample.fabric8.io"
    };
  }
}
