...
public class AnnotatedApprovalTest extends AbstractCRDGeneratorApprovalTest {

  protected Class<? extends CustomResource<?, ?>>[] crClasses() {
    return new Class[] {
        io.fabric8.crd.generator.approvaltests.annotated.api.Annotated.class
    };
  }

  protected String[] expectedCRDs() {
    return new String[] {
        "annotateds.samples.fabric8.io"
    };
  }
}
