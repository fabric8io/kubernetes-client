...
class NoCyclicApprovalTest extends AbstractCRDGeneratorApprovalTest {
  protected Class<? extends CustomResource<?, ?>>[] crClasses() {
    return new Class[] {
        io.fabric8.crd.generator.approvaltests.nocyclic.api.NoCyclic.class
    };
  }

  protected String[] expectedCRDs() {
    return new String[] {
        "nocyclics.sample.fabric8.io"
    };
  }
}
