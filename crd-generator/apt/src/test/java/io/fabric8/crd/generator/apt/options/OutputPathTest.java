...
public class OutputPathTest extends AbstractCRDGeneratorCompilerTest {
  @Override
  ...
  protected String[] additionalCompilerOptions() {
    return new String[] {
        "-Aio.fabric8.crd.generator.outputPath=META-INF/my-product/"
    };
  }
