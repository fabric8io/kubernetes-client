 ...
 */
package io.fabric8.crd.generator.apt.k8svalidation;

import io.fabric8.crd.generator.apt.AbstractCRDGeneratorCompilerTest;

public class K8sValidationCRDTest extends AbstractCRDGeneratorCompilerTest {
  @Override
  ...
  protected String[] getExpectedCRDs() {
    return new String[] {
        ...
        "k8svalidations.samples.fabric8.io-v1beta1.yml"
    };
  }
}
